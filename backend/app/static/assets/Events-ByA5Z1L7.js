...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      ...
      const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-EqaCovwG.js').then(n => n.a6);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
      try {
        ...
        scope.value === "domestic" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          createBaseVNode("div", _hoisted_3, [
                  ...
                  riskOpen.value ? (openBlock(), createElementBlock("div", _hoisted_6, [
                    (openBlock(), createElementBlock(Fragment, null, renderList(riskOptions, (opt) => {
                      return createBaseVNode("button", {
                        ...
                        riskFilter.value === opt.value ? (openBlock(), createElementBlock("svg", _hoisted_9, [..._cache[31] || (_cache[31] = [
                  ...
                  shadowRiskOpen.value ? (openBlock(), createElementBlock("div", _hoisted_12, [
                    (openBlock(), createElementBlock(Fragment, null, renderList(shadowRiskOptions, (opt) => {
                      return createBaseVNode("button", {
                        ...
                        shadowRiskFilter.value === opt.value ? (openBlock(), createElementBlock("svg", _hoisted_15, [..._cache[33] || (_cache[33] = [
                          createBaseVNode("polyline", { points: "20 6 9 17 4 12" }, null, -1)
                        ])])) : createCommentVNode("", true)
                      ], 10, _hoisted_13);
                    }), 64))
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-30a0c6c4>全部趋势</option><option value="rising" data-v-30a0c6c4>↑ 升温</option><option value="stable" data-v-30a0c6c4>→ 平稳</option><option value="falling" data-v-30a0c6c4>↓ 下降</option><option value="unknown" data-v-30a0c6c4>未知</option>', 5)
            ])], 544), [
          ...
          createBaseVNode("div", _hoisted_25, [
            createBaseVNode("table", _hoisted_26, [
              ...
              createBaseVNode("tbody", null, [
                ...
                displayedRows.value.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_46, [..._cache[47] || (_cache[47] = [
                  createBaseVNode("td", {
                    colspan: "14",
                    class: "empty-row"
                  }, "暂无事件数据", -1)
          ...
          _cache[51] || (_cache[51] = createBaseVNode("div", { class: "foreign-events-head" }, [
          ...
          createBaseVNode("table", _hoisted_49, [
            ...
            createBaseVNode("tbody", null, [
              ...
              foreignRows.value.length === 0 && !foreignLoading.value ? (openBlock(), createElementBlock("tr", _hoisted_61, [..._cache[49] || (_cache[49] = [
                createBaseVNode("td", {
                  colspan: "12",
                  class: "empty-row"
                }, "暂无外网事件", -1)
...
const Events = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-30a0c6c4"]]);
