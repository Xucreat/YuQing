...
const _hoisted_74 = { class: "actions" };
...
const _hoisted_79 = { class: "alert-scope-note" };
const _hoisted_80 = { class: "toolbar" };
...
const _hoisted_84 = { class: "subtabs" };
const _hoisted_85 = {
  key: 2,
  class: "table-wrap"
};
const _hoisted_86 = { class: "title-cell" };
...
const _hoisted_93 = { class: "title-cell" };
...
const _hoisted_98 = { class: "event-provenance" };
const _hoisted_99 = { key: 0 };
const _hoisted_100 = { class: "event-detail-head" };
...
const _hoisted_106 = { class: "event-metrics" };
...
const _hoisted_110 = { class: "alert-scope-note" };
const _hoisted_111 = { class: "toolbar" };
...
const _hoisted_115 = { class: "table-wrap" };
const _hoisted_116 = { class: "title-cell" };
const _hoisted_117 = ["title", "onClick", "onKeydown"];
const _hoisted_118 = {
  key: 1,
  class: "alert-title"
};
const _hoisted_119 = { class: "muted" };
const _hoisted_120 = { class: "linked-cell" };
const _hoisted_121 = ["onClick"];
const _hoisted_122 = {
  key: 1,
  class: "muted"
};
const _hoisted_123 = { class: "actions" };
...
const _hoisted_130 = { class: "table-wrap" };
const _hoisted_131 = { class: "actions" };
...
const _hoisted_137 = { class: "detail history-dialog" };
...
const _hoisted_143 = { class: "detail rule-dialog" };
const _hoisted_144 = { class: "muted" };
const _hoisted_145 = ["disabled"];
const _hoisted_146 = { class: "rule-preview" };
const _hoisted_147 = { class: "actions" };
...
风险结果`, textAlign: "center", fill: "#1d1d1f", fontSize: 20, fontWeight: 700, lineHeight: 22 } },
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_67, [
          createBaseVNode("div", _hoisted_68, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-947a6a43>全部语言</option><option value="zh" data-v-947a6a43>中文</option><option value="en" data-v-947a6a43>英文</option><option value="mixed" data-v-947a6a43>中英混合</option><option value="unknown" data-v-947a6a43>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-947a6a43>全部风险等级</option><option value="high" data-v-947a6a43>高</option><option value="medium" data-v-947a6a43>中</option><option value="low" data-v-947a6a43>低</option><option value="unknown" data-v-947a6a43>未知</option>', 5)
            ])], 544), [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", null, [
                      ...
                      !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_73, "无")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_74, [
                      ...
                      }, toDisplayString(riskOf(row.id) ? "重新分析" : "分析"), 9, _hoisted_75)
                    ])
                  ], 8, _hoisted_71);
                }), 128)),
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_76, [..._cache[56] || (_cache[56] = [
                  createBaseVNode("td", {
                    colspan: "14",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_77, [
        ...
        ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_78, [
          createBaseVNode("div", _hoisted_79, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
          createBaseVNode("div", _hoisted_80, [
            ...
            }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_81),
            _cache[58] || (_cache[58] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
          ]),
          eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_82, [
          ...
          eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_83, [
          ...
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_85, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_86, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", _hoisted_87, [
                      ...
                      }, "确认", 8, _hoisted_88)) : createCommentVNode("", true),
                      row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn danger",
                        disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                        onClick: ($event) => rejectCandidate(row)
                      }, "拒绝", 8, _hoisted_89)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_90, [..._cache[61] || (_cache[61] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignEvents.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_93, toDisplayString(row.title || "无标题"), 1),
                    createBaseVNode("td", null, toDisplayString(zh(row.language)), 1),
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_96, [..._cache[63] || (_cache[63] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
          ...
          selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_97, [
            createBaseVNode("div", _hoisted_98, [
              ...
              selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_99, [
            ...
            createBaseVNode("p", _hoisted_105, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_107, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                createBaseVNode("a", {
                  href: opinion.url,
                  target: "_blank",
                  rel: "noreferrer",
        ...
        ])) : activeTab.value === "alerts" ? (openBlock(), createElementBlock("section", _hoisted_109, [
          createBaseVNode("div", _hoisted_110, "外网自动告警评估：" + toDisplayString(alertAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(alertAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 外部通知：" + toDisplayString(alertAutoStatus.value?.external_notifications_enabled ? "已启用" : "已停用"), 1),
          createBaseVNode("div", _hoisted_111, [
            ...
            }, toDisplayString(alertEvaluating.value ? "评估中..." : "手动 Dry-Run"), 9, _hoisted_112),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => alertFilters.status = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[67] || (_cache[67] = [
              createStaticVNode('<option value="" data-v-947a6a43>全部状态</option><option value="triggered" data-v-947a6a43>待处理</option><option value="acknowledged" data-v-947a6a43>已确认</option><option value="resolved" data-v-947a6a43>已解决</option><option value="suppressed" data-v-947a6a43>已抑制</option><option value="failed" data-v-947a6a43>失败</option>', 6)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-947a6a43>全部严重度</option><option value="low" data-v-947a6a43>低</option><option value="medium" data-v-947a6a43>中</option><option value="high" data-v-947a6a43>高</option><option value="critical" data-v-947a6a43>紧急</option>', 5)
            ])], 544), [
          ...
          alertLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_113, [
          ...
          alertRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_114, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignAlerts.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_116, [
                      ...
                      }, toDisplayString(row.title || "无标题告警"), 41, _hoisted_117)) : (openBlock(), createElementBlock("strong", _hoisted_118, toDisplayString(row.title || "无标题告警"), 1)),
                      createBaseVNode("div", _hoisted_119, toDisplayString(row.message), 1)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_120, [
                      ...
                      }, toDisplayString(row.opinion_title_snapshot || "#" + row.foreign_opinion_id), 9, _hoisted_121)) : (openBlock(), createElementBlock("span", _hoisted_122, "-"))
                    ]),
                    ...
                    createBaseVNode("td", _hoisted_123, [
                      ...
                      }, "确认", 8, _hoisted_125)) : createCommentVNode("", true),
                      ...
                      }, "解决", 8, _hoisted_126)) : createCommentVNode("", true),
                      row.status === "triggered" || row.status === "acknowledged" ? (openBlock(), createElementBlock("button", {
                        key: 2,
                        class: "link-btn danger",
                      ...
                      }, "抑制", 8, _hoisted_127)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !foreignAlerts.value.length ? (openBlock(), createElementBlock("tr", _hoisted_128, [..._cache[72] || (_cache[72] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无外网告警记录", -1)
        ...
        ])) : activeTab.value === "alertRules" ? (openBlock(), createElementBlock("section", _hoisted_129, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(alertRules.value, (rule) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_131, [
                      ...
                      }, "停用", 8, _hoisted_133)) : (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn",
                      ...
                      }, "删除", 8, _hoisted_135)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !alertRules.value.length ? (openBlock(), createElementBlock("tr", _hoisted_136, [..._cache[76] || (_cache[76] = [
                  createBaseVNode("td", {
                    colspan: "7",
                    class: "empty"
                  }, "暂无外网告警规则", -1)
        ...
        historyAlert.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_137, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭处置历史",
            ...
            createBaseVNode("p", _hoisted_138, toDisplayString(historyAlert.value.title || "告警 #" + historyAlert.value.id) + " · 当前状态：" + toDisplayString(zh(historyAlert.value.status)), 1),
            alertActionsLoading.value ? (openBlock(), createElementBlock("div", _hoisted_139, "处置历史加载中...")) : !alertActions.value.length ? (openBlock(), createElementBlock("div", _hoisted_140, "暂无处置历史")) : (openBlock(), createElementBlock("div", _hoisted_141, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(alertActions.value, (action) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_142, "操作人 #" + toDisplayString(action.actor_id ?? "-") + " · " + toDisplayString(formatTime(action.created_at)), 1)
                ]);
              }), 128))
            ]))
          ])
        ...
        alertRuleEditorVisible.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_143, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭规则编辑",
            ...
            createBaseVNode("label", null, [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="risk_score" data-v-947a6a43>风险分</option><option value="risk_level" data-v-947a6a43>风险等级</option><option value="risk_category" data-v-947a6a43>风险类别</option><option value="confirmed_event" data-v-947a6a43>确认事件</option><option value="keyword_combo" data-v-947a6a43>关键词组合</option>', 5)
              ])], 512), [
            ...
            createBaseVNode("div", _hoisted_147, [
              ...
              }, toDisplayString(alertRuleSaving.value ? "保存中..." : "保存规则"), 9, _hoisted_148)
            ])
          ])
        ])) : createCommentVNode("", true),
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-947a6a43"]]);
