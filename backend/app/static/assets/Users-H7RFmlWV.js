import { d as defineComponent, u as useAuthStore, z as usePermission, C as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, F as Fragment, i as renderList, s as createCommentVNode, L as withModifiers, t as toDisplayString, v as vModelText, J as vModelSelect, r as ref, g as api, E as ElMessage, B as resolveDirective, j as computed, o as openBlock, n as normalizeClass, H as unref, M as ElMessageBox, _ as _export_sfc } from './index-ZScWDPZM.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function toggleUser(user) {
      if (user.username === currentUsername.value) return ElMessage.warning("不能停用当前登录用户");
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
                ...
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", _hoisted_4, [
                    ...
                    unref(canActivate) ? (openBlock(), createElementBlock("button", {
                      key: 0,
                      class: "btn btn-mini",
                      disabled: user.username === currentUsername.value || userToggleId.value === user.id,
                      title: user.username === currentUsername.value ? "不能停用当前登录用户" : void 0,
                      onClick: ($event) => toggleUser(user)
                    }, toDisplayString(user.is_active ? "停用" : "启用"), 9, _hoisted_6)) : createCommentVNode("", true),
                    createBaseVNode("button", {
        ...
        showForm.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_9, [
            ...
            editingId.value && selectedUser.value ? (openBlock(), createElementBlock("div", _hoisted_14, [
            ...
            createBaseVNode("div", _hoisted_15, [
              ...
              }, toDisplayString(saving.value ? "保存中..." : "保存"), 9, _hoisted_16)
            ])
          ])
        ])) : createCommentVNode("", true),
        showPassword.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_17, [
            ...
            passwordMode.value === "self" ? (openBlock(), createElementBlock("div", _hoisted_18, [
            ...
            createBaseVNode("div", _hoisted_21, [
              ...
              }, toDisplayString(passwordSaving.value ? "提交中..." : "保存密码"), 9, _hoisted_22)
            ])
          ])
        ])) : createCommentVNode("", true)
      ])), [
...
const Users = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-15893872"]]);
