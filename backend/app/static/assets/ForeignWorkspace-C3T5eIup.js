        ...
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_67, [
          createBaseVNode("div", _hoisted_68, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-a4b40839>全部语言</option><option value="zh" data-v-a4b40839>中文</option><option value="en" data-v-a4b40839>英文</option><option value="mixed" data-v-a4b40839>中英混合</option><option value="unknown" data-v-a4b40839>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-a4b40839>全部风险等级</option><option value="high" data-v-a4b40839>高</option><option value="medium" data-v-a4b40839>中</option><option value="low" data-v-a4b40839>低</option><option value="unknown" data-v-a4b40839>未知</option>', 5)
            ])], 544), [
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a4b40839"]]);
