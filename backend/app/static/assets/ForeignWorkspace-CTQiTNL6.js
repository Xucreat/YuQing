...
const _hoisted_25 = { class: "fw-kpi" };
const _hoisted_26 = { class: "fw-kpi-value" };
const _hoisted_27 = { class: "fw-dash-grid" };
const _hoisted_28 = { class: "fw-card fw-card-trend fw-col-1" };
const _hoisted_29 = { class: "fw-card-head" };
const _hoisted_30 = { class: "fw-legend" };
const _hoisted_31 = ["onClick"];
const _hoisted_32 = {
  key: 0,
  class: "empty"
};
const _hoisted_33 = { class: "fw-card fw-card-alert fw-col-2" };
const _hoisted_34 = { class: "fw-card-head" };
...
const _hoisted_38 = { class: "fw-alert-summary" };
const _hoisted_39 = { class: "fw-alert-sum" };
const _hoisted_40 = { class: "fw-alert-sum" };
const _hoisted_41 = { class: "fw-alert-list" };
const _hoisted_42 = ["onClick"];
const _hoisted_43 = { class: "fw-alert-main" };
const _hoisted_44 = { class: "fw-alert-title" };
const _hoisted_45 = { class: "fw-alert-meta" };
const _hoisted_46 = {
  key: 0,
  class: "fw-alert-copy"
};
const _hoisted_47 = { class: "fw-alert-list" };
const _hoisted_48 = ["onClick"];
const _hoisted_49 = { class: "fw-alert-main" };
const _hoisted_50 = { class: "fw-alert-title" };
const _hoisted_51 = { class: "fw-alert-meta" };
const _hoisted_52 = { class: "fw-card fw-card-source fw-col-1" };
const _hoisted_53 = { class: "fw-card-head" };
const _hoisted_54 = { class: "muted" };
const _hoisted_55 = {
  key: 0,
  class: "empty"
};
const _hoisted_56 = { class: "fw-card fw-col-2" };
const _hoisted_57 = {
  key: 0,
  class: "empty"
};
const _hoisted_58 = { class: "fw-card fw-card-hotword fw-col-1" };
const _hoisted_59 = { class: "fw-card-head" };
const _hoisted_60 = { class: "muted" };
const _hoisted_61 = {
  key: 0,
  class: "empty"
};
const _hoisted_62 = { class: "fw-card fw-col-2" };
const _hoisted_63 = {
  key: 0,
  class: "empty"
};
const _hoisted_64 = { class: "visualization-meta" };
const _hoisted_65 = {
  key: 2,
  class: "state"
};
...
const _hoisted_67 = { class: "toolbar" };
const _hoisted_68 = ["value"];
const _hoisted_69 = { class: "table-wrap tbl-scroll" };
...
const _hoisted_73 = { class: "actions" };
const _hoisted_74 = ["disabled", "onClick"];
...
const _hoisted_78 = { class: "alert-scope-note" };
const _hoisted_79 = { class: "toolbar" };
...
const _hoisted_83 = { class: "subtabs" };
const _hoisted_84 = {
  key: 2,
  class: "table-wrap"
};
...
const _hoisted_97 = { class: "event-provenance" };
const _hoisted_98 = { key: 0 };
const _hoisted_99 = { class: "event-detail-head" };
...
const _hoisted_105 = { class: "event-metrics" };
const _hoisted_106 = { class: "muted" };
const _hoisted_107 = ["href"];
const _hoisted_108 = {
  key: 3,
  class: "panel"
};
const _hoisted_109 = { class: "alert-scope-note" };
const _hoisted_110 = { class: "toolbar" };
...
const _hoisted_114 = { class: "table-wrap" };
const _hoisted_115 = { class: "title-cell" };
const _hoisted_116 = ["title", "onClick", "onKeydown"];
const _hoisted_117 = {
  key: 1,
  class: "alert-title"
};
const _hoisted_118 = { class: "muted" };
const _hoisted_119 = { class: "linked-cell" };
...
const _hoisted_129 = { class: "table-wrap" };
const _hoisted_130 = { class: "actions" };
...
const _hoisted_136 = { class: "detail history-dialog" };
...
const _hoisted_142 = { class: "detail rule-dialog" };
const _hoisted_143 = { class: "muted" };
const _hoisted_144 = ["disabled"];
const _hoisted_145 = { class: "rule-preview" };
const _hoisted_146 = { class: "actions" };
...
风险结果`, textAlign: "center", fill: "#1d1d1f", fontSize: 20, fontWeight: 700, lineHeight: 22 } },
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          ...
          createBaseVNode("div", _hoisted_4, [
            ...
            createBaseVNode("button", {
              ...
              onClick: collectNow
            }, toDisplayString(collecting.value ? "采集中..." : "采集外网 RSS"), 9, _hoisted_5),
            createBaseVNode("button", {
              class: "btn btn-secondary btn-sm",
              disabled: collecting.value,
              onClick: collectAll
            }, "采集全部数据源", 8, _hoisted_6)
          ])
        ]),
          ...
          visualizationError.value ? (openBlock(), createElementBlock("div", _hoisted_12, [
            ...
            createBaseVNode("div", _hoisted_14, [
              ...
              createBaseVNode("div", _hoisted_25, [
                _cache[40] || (_cache[40] = createBaseVNode("span", { class: "fw-kpi-label" }, "外网采集", -1)),
                createBaseVNode("strong", _hoisted_26, toDisplayString(dashboardSummary.value.collection?.success ?? 0), 1),
            ...
            createBaseVNode("div", _hoisted_27, [
              createBaseVNode("article", _hoisted_28, [
                ...
                !(dashboardTrends.value?.items || []).length ? (openBlock(), createElementBlock("p", _hoisted_32, "该窗口内暂无趋势数据")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_33, [
                createBaseVNode("header", _hoisted_34, [
                  _cache[42] || (_cache[42] = createBaseVNode("h3", null, "外网告警", -1)),
                  createBaseVNode("span", _hoisted_35, "滚动播报 · 共 " + toDisplayString(alertFeed.value.length) + " 条", 1)
                ]),
                !alertFeed.value.length ? (openBlock(), createElementBlock("div", _hoisted_36, "该窗口内暂无外网告警")) : (openBlock(), createElementBlock("div", _hoisted_37, [
                  ...
                  createBaseVNode("div", {
                    ...
                    createBaseVNode("div", {
                        ...
                        (openBlock(true), createElementBlock(Fragment, null, renderList(alertFeed.value, (a) => {
                          return openBlock(), createElementBlock("li", {
                            ...
                            createBaseVNode("div", _hoisted_43, [
                              createBaseVNode("div", _hoisted_44, toDisplayString(a.title || "未命名告警"), 1),
                              createBaseVNode("div", _hoisted_45, toDisplayString(a.rule_snapshot?.name || a.source_name_snapshot || "外网告警") + " · " + toDisplayString(shortTime(a.triggered_at)), 1)
                            ]),
                            createBaseVNode("span", {
                      ...
                      alertNeedScroll.value ? (openBlock(), createElementBlock("div", _hoisted_46, [
                          ...
                          (openBlock(true), createElementBlock(Fragment, null, renderList(alertFeed.value, (a) => {
                            return openBlock(), createElementBlock("li", {
                              ...
                              createBaseVNode("div", _hoisted_49, [
                                createBaseVNode("div", _hoisted_50, toDisplayString(a.title || "未命名告警"), 1),
                                createBaseVNode("div", _hoisted_51, toDisplayString(a.rule_snapshot?.name || a.source_name_snapshot || "外网告警") + " · " + toDisplayString(shortTime(a.triggered_at)), 1)
                              ]),
                              createBaseVNode("span", {
                                class: normalizeClass(["fw-badge", isHandled(a.status) ? "is-teal" : "is-amber"])
                              }, toDisplayString(zh(a.status)), 3)
              ...
              createBaseVNode("article", _hoisted_52, [
                createBaseVNode("header", _hoisted_53, [
                  _cache[45] || (_cache[45] = createBaseVNode("h3", null, "数据源分布", -1)),
                  createBaseVNode("span", _hoisted_54, "近 " + toDisplayString(visualizationDays.value) + " 天 · 各来源文章量", 1)
                ]),
                withDirectives(createBaseVNode("div", {
                ...
                !(dashboardSources.value?.items || []).length ? (openBlock(), createElementBlock("p", _hoisted_55, "该窗口内暂无数据源分布")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_56, [
                ...
                !dashboardRisk.value || !Object.keys(dashboardRisk.value.risk_levels || {}).length ? (openBlock(), createElementBlock("p", _hoisted_57, "暂无已完成风险结果")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_58, [
                createBaseVNode("header", _hoisted_59, [
                  _cache[47] || (_cache[47] = createBaseVNode("h3", null, "外网热词", -1)),
                  createBaseVNode("span", _hoisted_60, "近 " + toDisplayString(visualizationDays.value) + " 天 · 共 " + toDisplayString(hotwordItems.value.length) + " 个热词", 1)
                ]),
                withDirectives(createBaseVNode("div", {
                ...
                !hotwordItems.value.length ? (openBlock(), createElementBlock("p", _hoisted_61, "该窗口内暂无外网热词")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_62, [
                _cache[48] || (_cache[48] = createBaseVNode("h3", null, "事件状态", -1)),
            ...
            createBaseVNode("div", _hoisted_64, "数据范围：" + toDisplayString(formatTime(dashboardSummary.value.window_start)) + " - " + toDisplayString(formatTime(dashboardSummary.value.window_end)) + " · 更新于：" + toDisplayString(formatTime(dashboardSummary.value.data_as_of)), 1)
          ])) : (openBlock(), createElementBlock("div", _hoisted_65, "加载外网看板中..."))
        ])) : createCommentVNode("", true),
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_66, [
          createBaseVNode("div", _hoisted_67, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-cf89f6a4>全部语言</option><option value="zh" data-v-cf89f6a4>中文</option><option value="en" data-v-cf89f6a4>英文</option><option value="mixed" data-v-cf89f6a4>中英混合</option><option value="unknown" data-v-cf89f6a4>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-cf89f6a4>全部风险等级</option><option value="high" data-v-cf89f6a4>高</option><option value="medium" data-v-cf89f6a4>中</option><option value="low" data-v-cf89f6a4>低</option><option value="unknown" data-v-cf89f6a4>未知</option>', 5)
            ])], 544), [
            ...
            _cache[53] || (_cache[53] = createBaseVNode("span", { class: "muted" }, "以舆情为主，右侧为已关联的风险研判（未分析显示 -）", -1))
          ]),
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", null, [
                      ...
                      !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_72, "无")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_73, [
                      ...
                      }, toDisplayString(riskOf(row.id) ? "重新分析" : "分析"), 9, _hoisted_74)
                    ])
                  ], 8, _hoisted_70);
                }), 128)),
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_75, [..._cache[54] || (_cache[54] = [
                  createBaseVNode("td", {
                    colspan: "14",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_76, [
        ...
        ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_77, [
          createBaseVNode("div", _hoisted_78, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
          createBaseVNode("div", _hoisted_79, [
            ...
            }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_80),
            _cache[56] || (_cache[56] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
          ]),
          eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_81, [
          ...
          eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_82, [
            _cache[58] || (_cache[58] = createBaseVNode("strong", null, "外网事件运行失败", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(eventRunFailures.value, (run) => {
              return openBlock(), createElementBlock("div", {
                key: run.id,
                class: "event-failure-row"
              }, [
                _cache[57] || (_cache[57] = createBaseVNode("span", { class: "status failed" }, "失败", -1)),
          ...
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_84, [
            createBaseVNode("table", null, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_86, [
                      ...
                      }, "确认", 8, _hoisted_87)) : createCommentVNode("", true),
                      row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn danger",
                        disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                        onClick: ($event) => rejectCandidate(row)
                      }, "拒绝", 8, _hoisted_88)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_89, [..._cache[59] || (_cache[59] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
            ...
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_95, [..._cache[61] || (_cache[61] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
          ...
          selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_96, [
            createBaseVNode("div", _hoisted_97, [
              _cache[64] || (_cache[64] = createBaseVNode("strong", null, "事件溯源", -1)),
              ...
              selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_98, [
                _cache[63] || (_cache[63] = createBaseVNode("summary", null, "聚合证据", -1)),
            ...
            createBaseVNode("p", _hoisted_104, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_106, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                createBaseVNode("a", {
                  href: opinion.url,
                  target: "_blank",
                  rel: "noreferrer",
        ...
        ])) : activeTab.value === "alerts" ? (openBlock(), createElementBlock("section", _hoisted_108, [
          createBaseVNode("div", _hoisted_109, "外网自动告警评估：" + toDisplayString(alertAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(alertAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 外部通知：" + toDisplayString(alertAutoStatus.value?.external_notifications_enabled ? "已启用" : "已停用"), 1),
          createBaseVNode("div", _hoisted_110, [
            ...
            }, toDisplayString(alertEvaluating.value ? "评估中..." : "手动 Dry-Run"), 9, _hoisted_111),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => alertFilters.status = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[65] || (_cache[65] = [
              createStaticVNode('<option value="" data-v-cf89f6a4>全部状态</option><option value="triggered" data-v-cf89f6a4>待处理</option><option value="acknowledged" data-v-cf89f6a4>已确认</option><option value="resolved" data-v-cf89f6a4>已解决</option><option value="suppressed" data-v-cf89f6a4>已抑制</option><option value="failed" data-v-cf89f6a4>失败</option>', 6)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-cf89f6a4>全部严重度</option><option value="low" data-v-cf89f6a4>低</option><option value="medium" data-v-cf89f6a4>中</option><option value="high" data-v-cf89f6a4>高</option><option value="critical" data-v-cf89f6a4>紧急</option>', 5)
            ])], 544), [
              [vModelSelect, alertFilters.severity]
            ]),
            _cache[67] || (_cache[67] = createBaseVNode("span", { class: "muted" }, "告警评估默认关闭 · 外部通知默认关闭 · 当前仅保存站内记录", -1))
          ]),
          _cache[72] || (_cache[72] = createBaseVNode("div", { class: "alert-scope-note" }, " 外网告警只读取外网风险和已确认外网事件；不会进入国内告警、Dashboard、地图、热词或事件链路。 ", -1)),
          alertLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_112, [
          ...
          alertRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_113, [
            _cache[69] || (_cache[69] = createBaseVNode("strong", null, "外网告警评估失败", -1)),
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignAlerts.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_115, [
                      ...
                      }, toDisplayString(row.title || "无标题告警"), 41, _hoisted_116)) : (openBlock(), createElementBlock("strong", _hoisted_117, toDisplayString(row.title || "无标题告警"), 1)),
                      createBaseVNode("div", _hoisted_118, toDisplayString(row.message), 1)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_119, [
                      ...
                      }, toDisplayString(row.opinion_title_snapshot || "#" + row.foreign_opinion_id), 9, _hoisted_120)) : (openBlock(), createElementBlock("span", _hoisted_121, "-"))
                    ]),
                    ...
                    createBaseVNode("td", _hoisted_122, [
                      ...
                      }, "确认", 8, _hoisted_124)) : createCommentVNode("", true),
                      ...
                      }, "解决", 8, _hoisted_125)) : createCommentVNode("", true),
                      row.status === "triggered" || row.status === "acknowledged" ? (openBlock(), createElementBlock("button", {
                        key: 2,
                        class: "link-btn danger",
                      ...
                      }, "抑制", 8, _hoisted_126)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !foreignAlerts.value.length ? (openBlock(), createElementBlock("tr", _hoisted_127, [..._cache[70] || (_cache[70] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无外网告警记录", -1)
        ...
        ])) : activeTab.value === "alertRules" ? (openBlock(), createElementBlock("section", _hoisted_128, [
          createBaseVNode("div", { class: "toolbar" }, [
            ...
            _cache[73] || (_cache[73] = createBaseVNode("span", { class: "muted" }, "外网规则独立管理；新规则保存后默认停用。", -1))
          ]),
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(alertRules.value, (rule) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_130, [
                      ...
                      }, "停用", 8, _hoisted_132)) : (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn",
                      ...
                      }, "删除", 8, _hoisted_134)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !alertRules.value.length ? (openBlock(), createElementBlock("tr", _hoisted_135, [..._cache[74] || (_cache[74] = [
                  createBaseVNode("td", {
                    colspan: "7",
                    class: "empty"
                  }, "暂无外网告警规则", -1)
        ...
        historyAlert.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_136, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭处置历史",
              onClick: _cache[18] || (_cache[18] = ($event) => historyAlert.value = null)
            }, "×"),
            _cache[76] || (_cache[76] = createBaseVNode("h3", null, "外网告警处置历史", -1)),
            createBaseVNode("p", _hoisted_137, toDisplayString(historyAlert.value.title || "告警 #" + historyAlert.value.id) + " · 当前状态：" + toDisplayString(zh(historyAlert.value.status)), 1),
            alertActionsLoading.value ? (openBlock(), createElementBlock("div", _hoisted_138, "处置历史加载中...")) : !alertActions.value.length ? (openBlock(), createElementBlock("div", _hoisted_139, "暂无处置历史")) : (openBlock(), createElementBlock("div", _hoisted_140, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(alertActions.value, (action) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_141, "操作人 #" + toDisplayString(action.actor_id ?? "-") + " · " + toDisplayString(formatTime(action.created_at)), 1)
                ]);
              }), 128))
            ]))
          ])
        ...
        alertRuleEditorVisible.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_142, [
            ...
            createBaseVNode("label", null, [
              _cache[77] || (_cache[77] = createTextVNode("规则名称", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[79] || (_cache[79] = createTextVNode("规则类型", -1)),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => alertRuleDraft.rule_type = $event),
                class: "input"
              }, [..._cache[78] || (_cache[78] = [
                createStaticVNode('<option value="risk_score" data-v-cf89f6a4>风险分</option><option value="risk_level" data-v-cf89f6a4>风险等级</option><option value="risk_category" data-v-cf89f6a4>风险类别</option><option value="confirmed_event" data-v-cf89f6a4>确认事件</option><option value="keyword_combo" data-v-cf89f6a4>关键词组合</option>', 5)
              ])], 512), [
                [vModelSelect, alertRuleDraft.rule_type]
              ])
            ]),
            createBaseVNode("label", null, [
              _cache[80] || (_cache[80] = createTextVNode("风险阈值或条件", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[82] || (_cache[82] = createTextVNode("严重等级", -1)),
              withDirectives(createBaseVNode("select", {
            ...
            createBaseVNode("label", null, [
              _cache[83] || (_cache[83] = createTextVNode("冷却时间", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[84] || (_cache[84] = createTextVNode("规则说明", -1)),
            ...
            createBaseVNode("label", _hoisted_143, [
              ...
              _cache[85] || (_cache[85] = createTextVNode(" 编辑时启用状态（新规则默认停用，启用仍需外网启用权限）", -1))
            ]),
            createBaseVNode("div", _hoisted_145, [
              _cache[86] || (_cache[86] = createBaseVNode("strong", null, "规则预览", -1)),
            ...
            createBaseVNode("div", _hoisted_146, [
              ...
              }, toDisplayString(alertRuleSaving.value ? "保存中..." : "保存规则"), 9, _hoisted_147)
            ])
          ])
        ])) : createCommentVNode("", true),
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cf89f6a4"]]);
