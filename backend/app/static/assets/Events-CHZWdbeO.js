...
const _hoisted_3 = { class: "scope-switch" };
const _hoisted_4 = { class: "toolbar" };
const _hoisted_5 = { class: "risk-filter" };
const _hoisted_6 = { class: "risk-trigger-label" };
const _hoisted_7 = {
  key: 0,
  class: "risk-menu",
  role: "listbox"
...
const _hoisted_9 = { class: "risk-opt-text" };
const _hoisted_10 = {
  key: 1,
  class: "check",
  viewBox: "0 0 24 24",
...
const _hoisted_11 = { class: "risk-filter" };
const _hoisted_12 = { class: "risk-trigger-label" };
const _hoisted_13 = {
  key: 0,
  class: "risk-menu",
  role: "listbox"
...
const _hoisted_15 = { class: "risk-opt-text" };
const _hoisted_16 = {
  key: 1,
  class: "check",
  viewBox: "0 0 24 24",
...
const _hoisted_21 = { class: "time-range" };
const _hoisted_22 = ["disabled"];
const _hoisted_23 = {
  key: 2,
  class: "agg-result"
};
const _hoisted_24 = { class: "quick-filters" };
const _hoisted_25 = ["onClick"];
const _hoisted_26 = { class: "card table-card" };
const _hoisted_27 = { class: "tbl" };
const _hoisted_28 = ["onClick"];
const _hoisted_29 = { class: "t-title" };
const _hoisted_30 = { class: "nowrap" };
const _hoisted_31 = { class: "col-center" };
const _hoisted_32 = {
  key: 0,
  class: "focus-mark"
};
const _hoisted_33 = { class: "col-center risk-num" };
const _hoisted_34 = { class: "legacy-risk" };
...
const _hoisted_39 = { class: "col-center risk-num" };
const _hoisted_40 = { class: "col-center" };
const _hoisted_41 = { class: "nowrap" };
const _hoisted_42 = { class: "nowrap" };
const _hoisted_43 = { class: "row-actions" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      ...
      const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-GDyWXHX0.js').then(n => n.a7);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
      try {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        (openBlock(), createBlock(Teleport, {
          ...
          createBaseVNode("div", _hoisted_2, [
            ...
            _cache[27] || (_cache[27] = createBaseVNode("div", { class: "head-divider" }, null, -1)),
        ...
        scope.value === "domestic" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          createBaseVNode("div", _hoisted_4, [
            createBaseVNode("div", {
              ...
              withDirectives(createBaseVNode("input", {
                ...
                type: "text",
                placeholder: "搜索事件标题",
                onFocus: _cache[3] || (_cache[3] = ($event) => searchFocused.value = true),
                onBlur: _cache[4] || (_cache[4] = ($event) => searchFocused.value = false),
            ...
            createBaseVNode("div", _hoisted_5, [
              createBaseVNode("button", {
                ...
                onClick: _cache[6] || (_cache[6] = ($event) => riskOpen.value = !riskOpen.value),
                onKeydown: _cache[7] || (_cache[7] = withKeys(($event) => riskOpen.value = false, ["esc"]))
              }, [
              ...
              riskOpen.value ? (openBlock(), createElementBlock("div", {
                key: 0,
                class: "risk-backdrop",
                onClick: _cache[8] || (_cache[8] = ($event) => riskOpen.value = false)
              })) : createCommentVNode("", true),
              createVNode(Transition, { name: "pop" }, {
                default: withCtx(() => [
                  riskOpen.value ? (openBlock(), createElementBlock("div", _hoisted_7, [
                    (openBlock(), createElementBlock(Fragment, null, renderList(riskOptions, (opt) => {
                      return createBaseVNode("button", {
                        ...
                        createBaseVNode("span", _hoisted_9, toDisplayString(opt.label), 1),
                        riskFilter.value === opt.value ? (openBlock(), createElementBlock("svg", _hoisted_10, [..._cache[31] || (_cache[31] = [
            ...
            createBaseVNode("div", _hoisted_11, [
              createBaseVNode("button", {
                ...
                onClick: _cache[9] || (_cache[9] = ($event) => shadowRiskOpen.value = !shadowRiskOpen.value),
                onKeydown: _cache[10] || (_cache[10] = withKeys(($event) => shadowRiskOpen.value = false, ["esc"]))
              }, [
              ...
              shadowRiskOpen.value ? (openBlock(), createElementBlock("div", {
                key: 0,
                class: "risk-backdrop",
                onClick: _cache[11] || (_cache[11] = ($event) => shadowRiskOpen.value = false)
              })) : createCommentVNode("", true),
              createVNode(Transition, { name: "pop" }, {
                default: withCtx(() => [
                  shadowRiskOpen.value ? (openBlock(), createElementBlock("div", _hoisted_13, [
                    (openBlock(), createElementBlock(Fragment, null, renderList(shadowRiskOptions, (opt) => {
                      return createBaseVNode("button", {
                        ...
                        createBaseVNode("span", _hoisted_15, toDisplayString(opt.label), 1),
                        shadowRiskFilter.value === opt.value ? (openBlock(), createElementBlock("svg", _hoisted_16, [..._cache[33] || (_cache[33] = [
                          createBaseVNode("polyline", { points: "20 6 9 17 4 12" }, null, -1)
                        ])])) : createCommentVNode("", true)
                      ], 10, _hoisted_14);
                    }), 64))
            ...
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => topicFilter.value = $event),
              class: "compact-select",
              title: "按主题筛选",
              onChange: applyFilters
            }, [
              _cache[34] || (_cache[34] = createBaseVNode("option", { value: "" }, "全部主题", -1)),
            ...
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => statusFilter.value = $event),
              class: "compact-select",
              title: "按处置状态筛选",
              onChange: applyFilters
            }, [
              _cache[35] || (_cache[35] = createBaseVNode("option", { value: "" }, "全部处置状态", -1)),
            ...
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => trendFilter.value = $event),
              class: "compact-select",
              title: "按趋势筛选",
              onChange: applyFilters
            }, [..._cache[36] || (_cache[36] = [
            ...
            createBaseVNode("button", {
              ...
              onClick: _cache[15] || (_cache[15] = ($event) => moreOpen.value = !moreOpen.value)
            }, toDisplayString(moreOpen.value ? "收起更多操作" : "更多操作"), 3),
            moreOpen.value ? (openBlock(), createElementBlock("div", _hoisted_19, [
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => regionFilter.value = $event),
                class: "compact-input",
                type: "number",
                min: "1",
                placeholder: "地区 ID",
              ...
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => heatMin.value = $event),
              ...
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => heatMax.value = $event),
                class: "compact-input heat-input",
                type: "number",
                min: "0",
                max: "100",
              ...
              _cache[41] || (_cache[41] = createBaseVNode("span", { class: "filter-sep" }, null, -1)),
              createBaseVNode("div", _hoisted_20, [
                _cache[37] || (_cache[37] = createBaseVNode("label", { class: "time-range-label" }, "首次发现", -1)),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => firstTimeStart.value = $event),
                  type: "datetime-local",
                ...
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => firstTimeEnd.value = $event),
                  type: "datetime-local",
                  class: "compact-input time-input",
                  title: "首次发现截止时间",
                  onChange: applyFilters
              ...
              createBaseVNode("div", _hoisted_21, [
                _cache[39] || (_cache[39] = createBaseVNode("label", { class: "time-range-label" }, "最后更新", -1)),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => lastTimeStart.value = $event),
                  type: "datetime-local",
                  class: "compact-input time-input",
                  title: "最后更新起始时间",
                  onChange: applyFilters
                ...
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => lastTimeEnd.value = $event),
                  type: "datetime-local",
                  class: "compact-input time-input",
                  title: "最后更新截止时间",
                  onChange: applyFilters
            ...
            }, toDisplayString(aggregating.value ? "聚合中..." : "手动聚合"), 9, _hoisted_22)) : createCommentVNode("", true),
            createBaseVNode("button", {
              class: "btn btn-ghost",
              onClick: loadData
            }, "刷新"),
            lastResult.value ? (openBlock(), createElementBlock("span", _hoisted_23, " 聚合成功：新建 " + toDisplayString(lastResult.value.created) + " · 更新 " + toDisplayString(lastResult.value.updated) + " · 关联 " + toDisplayString(lastResult.value.linked), 1)) : createCommentVNode("", true)
          ]),
          createBaseVNode("div", _hoisted_24, [
            (openBlock(), createElementBlock(Fragment, null, renderList(statusGroups, (g) => {
              ...
              }, toDisplayString(g.label), 11, _hoisted_25);
            }), 64)),
            _cache[42] || (_cache[42] = createBaseVNode("span", { class: "quick-filters-note" }, "（仅过滤当前页）", -1))
          ]),
          createBaseVNode("div", _hoisted_26, [
            createBaseVNode("table", _hoisted_27, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(displayedRows.value, (row, idx) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", null, [
                      createBaseVNode("span", _hoisted_29, toDisplayString(row.title), 1)
                    ]),
                    createBaseVNode("td", _hoisted_30, toDisplayString(topicText(row.topic_category)), 1),
                    createBaseVNode("td", _hoisted_31, [
                      createBaseVNode("span", {
                        class: normalizeClass(["pill", riskPill(row.formal_risk_level || row.risk_level)])
                      }, [
                        _cache[43] || (_cache[43] = createBaseVNode("span", { class: "dot" }, null, -1)),
                      ...
                      _cache[44] || (_cache[44] = createBaseVNode("span", { class: "risk-source" }, "正式快照", -1)),
                      isKeyEvent(row) ? (openBlock(), createElementBlock("span", _hoisted_32, "重点关注")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", _hoisted_33, [
                      row.linked_opinion_current_risk ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                        ...
                        createBaseVNode("small", _hoisted_34, toDisplayString(riskText(row.linked_opinion_current_risk.risk_level)), 1)
                      ], 64)) : (openBlock(), createElementBlock("span", _hoisted_35, "-"))
                    ]),
                    createBaseVNode("td", {
                      ...
                      _cache[45] || (_cache[45] = createBaseVNode("small", { class: "legacy-risk" }, "参考", -1))
                    ], 4),
                    createBaseVNode("td", _hoisted_36, toDisplayString(row.heat_score), 1),
                    createBaseVNode("td", _hoisted_37, [
                      createBaseVNode("span", {
                        class: normalizeClass(["pill", trendPill(row.trend)])
                      }, toDisplayString(trendText(row.trend)), 3)
                    ]),
                    createBaseVNode("td", _hoisted_38, toDisplayString(row.opinion_count), 1),
                    createBaseVNode("td", _hoisted_39, toDisplayString(row.source_count ?? "-"), 1),
                    ...
                    createBaseVNode("td", _hoisted_41, toDisplayString(formatTime(row.first_time)), 1),
                    createBaseVNode("td", _hoisted_42, toDisplayString(formatTime(row.last_time)), 1),
                    createBaseVNode("td", {
                      ...
                      createBaseVNode("div", _hoisted_43, [
                        ...
                        }, "处置", 8, _hoisted_45)) : createCommentVNode("", true),
                        canUpdateEvent.value ? (openBlock(), createElementBlock("button", {
                          key: 1,
                ...
                displayedRows.value.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_47, [..._cache[47] || (_cache[47] = [
                  createBaseVNode("td", {
                    colspan: "14",
                    class: "empty-row"
                  }, "暂无事件数据", -1)
            ...
            total.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_48, [
              createVNode(_component_Pager, {
                total: total.value,
                "current-page": page.value,
                "onUpdate:currentPage": _cache[24] || (_cache[24] = ($event) => page.value = $event),
