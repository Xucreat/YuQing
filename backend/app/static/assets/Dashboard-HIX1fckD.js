...
const _hoisted_31 = { class: "dash-row" };
const _hoisted_32 = { class: "card card-pad-lg" };
const _hoisted_33 = { class: "chart-head" };
const _hoisted_34 = { class: "card card-pad-lg" };
const _hoisted_35 = { class: "dash-row" };
const _hoisted_36 = { class: "card card-pad-lg" };
const _hoisted_37 = { class: "card card-pad-lg" };
const _hoisted_38 = { class: "dash-row" };
const _hoisted_39 = { class: "card card-pad-lg feed-card" };
const _hoisted_40 = { class: "scroll-wrap" };
const _hoisted_41 = { class: "fi-body" };
const _hoisted_42 = { class: "fi-title" };
const _hoisted_43 = { class: "fi-meta" };
const _hoisted_44 = {
  key: 0,
  class: "feed-empty"
};
const _hoisted_45 = { class: "card card-pad-lg feed-card" };
...
const _hoisted_51 = { class: "dash-row" };
const _hoisted_52 = { class: "card card-pad-lg geo-card" };
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(doubledNews.value, (n, i) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_41, [
                      createBaseVNode("div", _hoisted_42, toDisplayString(n.title), 1),
                      createBaseVNode("div", _hoisted_43, toDisplayString(n.source) + " · " + toDisplayString(n.region_name) + " · " + toDisplayString(fmtTime(n.created_at)) + " · 风险 " + toDisplayString(n.risk_score), 1)
                    ])
                  ]);
                }), 128))
              ], 4),
              !recentNews.value.length ? (openBlock(), createElementBlock("div", _hoisted_44, "暂无实时快讯")) : createCommentVNode("", true)
            ])
          ]),
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6daf87e4"]]);
