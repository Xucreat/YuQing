...
const _hoisted_26 = { class: "modal modal-wide" };
...
const _hoisted_32 = { class: "perm-groups compact" };
const _hoisted_33 = { class: "perm-group-title" };
const _hoisted_34 = { class: "perm-grid" };
const _hoisted_35 = ["checked", "onChange"];
const _hoisted_36 = { class: "perm-code" };
const _hoisted_37 = { class: "perm-name" };
const _hoisted_38 = { class: "form-actions" };
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(roles.value, (r) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", _hoisted_9, [
                    ...
                    }, toDisplayString(r.is_enabled ? "停用" : "启用"), 9, _hoisted_11)) : createCommentVNode("", true),
        ...
        editorOpen.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_15, [
            ...
            createBaseVNode("div", _hoisted_24, [
              ...
              }, toDisplayString(saving.value ? "保存中..." : "保存权限"), 9, _hoisted_25)) : createCommentVNode("", true)
            ])
          ])
        ])) : createCommentVNode("", true),
          ...
          createBaseVNode("div", _hoisted_26, [
              ...
              createBaseVNode("div", _hoisted_32, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(groupedPermissions.value, (g) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_33, toDisplayString(g.label), 1),
                    createBaseVNode("div", _hoisted_34, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(g.perms, (p) => {
                        return openBlock(), createElementBlock("label", {
                          ...
                          createBaseVNode("span", _hoisted_36, toDisplayString(p.code), 1),
                          createBaseVNode("span", _hoisted_37, toDisplayString(permNameLabel(p)), 1)
                        ]);
                      }), 128))
                    ])
                  ]);
            ...
            createBaseVNode("div", _hoisted_38, [
              ...
              createBaseVNode("button", {
                ...
                onClick: createRole,
                disabled: saving.value
              }, toDisplayString(saving.value ? "创建中..." : "创建"), 9, _hoisted_39)
            ])
          ])
        ])) : createCommentVNode("", true)
      ])), [
...
const Roles = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-acea7ce0"]]);
