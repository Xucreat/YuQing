import { d as defineComponent, m as watch, p as onMounted, P as onUnmounted, y as createBlock, c as createElementBlock, J as withModifiers, a as createBaseVNode, t as toDisplayString, A as createCommentVNode, w as withDirectives, x as unref, F as Fragment, i as renderList, n as normalizeClass, e as createTextVNode, k as normalizeStyle, B as createVNode, z as withCtx, Q as Teleport, r as ref, j as computed, g as api, E as ElMessage, C as resolveComponent, D as resolveDirective, o as openBlock, _ as _export_sfc } from './index-BmexwUgp.js';
...
const _hoisted_25 = { class: "re-value" };
const _hoisted_26 = {
  key: 2,
  class: "risk-explain-item"
};
const _hoisted_27 = { class: "re-value" };
const _hoisted_28 = {
  key: 3,
  class: "risk-explain-item"
};
...
const _hoisted_30 = { class: "re-value re-muted" };
...
const _hoisted_37 = { class: "card card-pad ai-card" };
const _hoisted_38 = { class: "ai-header" };
const _hoisted_39 = { class: "report-meta" };
const _hoisted_40 = { class: "meta-item" };
const _hoisted_41 = { class: "meta-item" };
const _hoisted_42 = { class: "meta-item" };
const _hoisted_43 = { class: "report-body" };
const _hoisted_44 = {
  key: 0,
  class: "report-p"
};
...
const _hoisted_50 = { class: "ai-actions" };
              ...
              detail.value ? (openBlock(), createElementBlock("div", _hoisted_8, [
                ...
                createBaseVNode("div", _hoisted_15, [
                  createBaseVNode("div", _hoisted_16, [
                    ...
                    hasRiskExplain.value ? (openBlock(), createElementBlock("div", _hoisted_22, [
                      detail.value.risk_category ? (openBlock(), createElementBlock("div", _hoisted_23, [
                        _cache[8] || (_cache[8] = createBaseVNode("span", { class: "re-label" }, "风险分类", -1)),
                      ...
                      detail.value.severity_score != null && detail.value.severity_score > 0 ? (openBlock(), createElementBlock("div", _hoisted_24, [
                        _cache[9] || (_cache[9] = createBaseVNode("span", { class: "re-label" }, "危害严重度", -1)),
                      ...
                      detail.value.event_state ? (openBlock(), createElementBlock("div", _hoisted_26, [
                        _cache[10] || (_cache[10] = createBaseVNode("span", { class: "re-label" }, "事件状态", -1)),
                        createBaseVNode("span", _hoisted_27, toDisplayString(stateText(detail.value.event_state)), 1)
                      ])) : createCommentVNode("", true),
                      factorHits.value.length ? (openBlock(), createElementBlock("div", _hoisted_28, [
                        _cache[11] || (_cache[11] = createBaseVNode("span", { class: "re-label" }, "命中危害词", -1)),
                      ...
                      detail.value.risk_model_version ? (openBlock(), createElementBlock("div", _hoisted_29, [
                        _cache[12] || (_cache[12] = createBaseVNode("span", { class: "re-label" }, "模型版本", -1)),
                        createBaseVNode("span", _hoisted_30, toDisplayString(detail.value.risk_model_version), 1)
                      ])) : createCommentVNode("", true)
                    ])) : createCommentVNode("", true),
                    createBaseVNode("div", _hoisted_31, [
                      detail.value.summary ? (openBlock(), createElementBlock("p", _hoisted_32, toDisplayString(detail.value.summary), 1)) : (openBlock(), createElementBlock("p", _hoisted_33, "暂无系统研判摘要。")),
                      detail.value.analysis_suggestion ? (openBlock(), createElementBlock("p", _hoisted_34, toDisplayString(detail.value.analysis_suggestion), 1)) : createCommentVNode("", true)
                    ]),
                    keywordList.value.length ? (openBlock(), createElementBlock("div", _hoisted_35, [
                      _cache[13] || (_cache[13] = createBaseVNode("span", { class: "kw-label" }, "关键词", -1)),
                    ...
                    detail.value.analysis_time ? (openBlock(), createElementBlock("div", _hoisted_36, " 分析时间：" + toDisplayString(unref(formatTime)(detail.value.analysis_time)), 1)) : createCommentVNode("", true)
                  ]),
                  createBaseVNode("div", _hoisted_37, [
                    createBaseVNode("div", _hoisted_38, [
                      _cache[15] || (_cache[15] = createBaseVNode("span", { class: "section-title" }, "AI 研判报告", -1)),
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("div", _hoisted_39, [
                      ...
                      createBaseVNode("span", _hoisted_41, [
                        _cache[17] || (_cache[17] = createTextVNode("级别 ", -1)),
                      ...
                      createBaseVNode("span", _hoisted_42, [
                        _cache[18] || (_cache[18] = createTextVNode("情感 ", -1)),
                    ...
                    createBaseVNode("div", _hoisted_43, [
                      detail.value.ai_analysis_status === "completed" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                        detail.value.ai_summary ? (openBlock(), createElementBlock("p", _hoisted_44, toDisplayString(detail.value.ai_summary), 1)) : createCommentVNode("", true),
                        detail.value.ai_analysis_suggestion ? (openBlock(), createElementBlock("p", _hoisted_45, toDisplayString(detail.value.ai_analysis_suggestion), 1)) : createCommentVNode("", true)
                      ], 64)) : detail.value.ai_analysis_status === "failed" ? (openBlock(), createElementBlock("p", _hoisted_46, " AI 分析失败（DeepSeek 未配置或余额不足），请稍后重试。 ")) : (openBlock(), createElementBlock("p", _hoisted_47, " 尚未生成 AI 研判报告，点击下方按钮由 DeepSeek 生成。 "))
                    ]),
                    aiKeywordList.value.length ? (openBlock(), createElementBlock("div", _hoisted_48, [
                      _cache[21] || (_cache[21] = createBaseVNode("span", { class: "kw-label" }, "关键词", -1)),
                    ...
                    detail.value.ai_analysis_time ? (openBlock(), createElementBlock("div", _hoisted_49, " 分析时间：" + toDisplayString(unref(formatTime)(detail.value.ai_analysis_time)), 1)) : createCommentVNode("", true),
                    ...
                    createBaseVNode("div", _hoisted_50, [
                      ...
                      }, toDisplayString(analyzing.value ? "分析中..." : detail.value.ai_analysis_status === "completed" ? "重新触发 AI 分析" : "触发 AI 分析"), 9, _hoisted_51)) : (openBlock(), createElementBlock("div", _hoisted_52, [..._cache[22] || (_cache[22] = [
...
const OpinionDetailModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5ac8f8c5"]]);
