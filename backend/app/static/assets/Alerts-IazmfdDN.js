      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
            ...
            createBaseVNode("div", _hoisted_3, [
              ...
              createBaseVNode("div", _hoisted_4, [
                createBaseVNode("button", {
                  ...
                  onClick: _cache[0] || (_cache[0] = ($event) => activeTab.value = "rules")
                }, "预警规则", 2),
                createBaseVNode("button", {
                  class: normalizeClass(["view-tab", { active: activeTab.value === "records" }]),
                  onClick: _cache[1] || (_cache[1] = ($event) => activeTab.value = "records")
                }, "预警记录", 2)
              ])
            ]),
        ...
        activeTab.value === "rules" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          createBaseVNode("div", _hoisted_6, [
            ...
            evalResult.value && scope.value === "domestic" ? (openBlock(), createElementBlock("span", _hoisted_7, "检查 " + toDisplayString(evalResult.value.total_checked) + " 条，生成 " + toDisplayString(evalResult.value.alerts_created) + " 条", 1)) : createCommentVNode("", true)
          ]),
            ...
            default: withCtx(() => [
              ...
              createBaseVNode("div", _hoisted_8, [
                createVNode(_sfc_main$1, {
                  ...
                  "page-size": rulesSize,
                  onCurrentChange: _cache[6] || (_cache[6] = (p) => {
                    rulesPage.value = p;
                    loadDomesticRules();
                  })
