import { d as defineComponent, z as usePermission, r as ref, A as watch, q as createBlock, c as createElementBlock, L as withModifiers, a as createBaseVNode, t as toDisplayString, s as createCommentVNode, w as withDirectives, F as Fragment, n as normalizeClass, e as createTextVNode, H as unref, i as renderList, O as vShow, k as normalizeStyle, T as Teleport, j as computed, g as api, E as ElMessage, y as resolveComponent, B as resolveDirective, o as openBlock, _ as _export_sfc, C as onMounted, G as onBeforeUnmount, J as vModelSelect, b as withKeys, v as vModelText, P as createStaticVNode, m as createVNode, Q as _sfc_main$2, p as withCtx, N as useRoute, f as reactive, M as ElMessageBox, D as nextTick, K as vModelCheckbox, h as useRouter } from './index-BQugYeHy.js';
...
const _hoisted_13$1 = { class: "detail-meta" };
const _hoisted_14$1 = { class: "detail-content" };
const _hoisted_15$1 = {
  key: 0,
  class: "kw-line"
};
...
const _hoisted_20$1 = { class: "detail-right" };
const _hoisted_21$1 = { class: "card card-pad eff-card" };
const _hoisted_22$1 = { class: "ai-header" };
const _hoisted_23$1 = { class: "report-meta" };
const _hoisted_24$1 = { class: "meta-item" };
const _hoisted_25$1 = { class: "meta-item" };
const _hoisted_26$1 = {
  key: 0,
  class: "meta-sep"
};
...
const _hoisted_28$1 = { class: "report-body" };
const _hoisted_29$1 = { class: "report-p report-muted" };
const _hoisted_30$1 = {
  key: 0,
  class: "dual-row"
};
...
const _hoisted_34$1 = { class: "dual-val" };
const _hoisted_35$1 = {
  key: 2,
  class: "dual-row"
};
const _hoisted_36$1 = { class: "dual-val" };
const _hoisted_37$1 = {
  key: 0,
  class: "dual-sub"
};
const _hoisted_38$1 = { class: "card card-pad sys-card" };
const _hoisted_39$1 = { class: "ai-header" };
const _hoisted_40$1 = { class: "report-meta" };
const _hoisted_41$1 = { class: "meta-item" };
const _hoisted_42$1 = { class: "meta-item" };
const _hoisted_43$1 = { class: "meta-item" };
const _hoisted_44$1 = { class: "report-body" };
const _hoisted_45$1 = {
  key: 0,
  class: "report-p"
};
...
const _hoisted_48$1 = { class: "card card-pad ai-card" };
const _hoisted_49$1 = { class: "ai-header" };
const _hoisted_50$1 = { class: "ai-header-tools" };
const _hoisted_51$1 = { class: "report-meta" };
const _hoisted_52$1 = { class: "meta-item" };
const _hoisted_53$1 = { class: "meta-item" };
const _hoisted_54$1 = { class: "meta-item" };
const _hoisted_55$1 = { class: "report-body" };
const _hoisted_56$1 = {
  key: 0,
  class: "report-p"
};
...
const _hoisted_61$1 = ["disabled"];
const _hoisted_62$1 = { class: "modal-card history-modal" };
const _hoisted_63$1 = { class: "modal-header" };
const _hoisted_64$1 = { class: "modal-body" };
const _hoisted_65$1 = {
  key: 0,
  class: "history-list"
};
...
const _hoisted_67$1 = { class: "error-cell" };
const _hoisted_68$1 = { class: "error-cell" };
          ...
          createBaseVNode("div", _hoisted_1$1, [
            createBaseVNode("div", _hoisted_2$1, [
              createBaseVNode("div", _hoisted_3$1, [
                ...
                createBaseVNode("h3", _hoisted_4$1, toDisplayString(showTranslation.value && translatedTitle.value ? translatedTitle.value : detail.value?.title || "加载中…"), 1)
              ]),
                ...
                createBaseVNode("div", _hoisted_9$1, [
                  createBaseVNode("div", _hoisted_10$1, [
                    createBaseVNode("div", _hoisted_11$1, [
                      ...
                      }, toDisplayString(translating.value ? "翻译中…" : showTranslation.value ? "显示原文" : "翻译"), 9, _hoisted_12$1)
                    ]),
                    ...
                    withDirectives(createBaseVNode("div", _hoisted_14$1, [
                      detail.value.matched_keywords && detail.value.matched_keywords.length ? (openBlock(), createElementBlock("p", _hoisted_15$1, [
                      ...
                      detail.value.summary && detail.value.summary !== detail.value.content ? (openBlock(), createElementBlock("p", _hoisted_16$1, toDisplayString(detail.value.summary), 1)) : createCommentVNode("", true),
                      detail.value.content ? (openBlock(), createElementBlock("p", _hoisted_17$1, toDisplayString(detail.value.content), 1)) : !detail.value.content && !detail.value.summary ? (openBlock(), createElementBlock("p", _hoisted_18$1, "暂无摘要与正文（正文抓取已关闭）。")) : createCommentVNode("", true)
                    ], 512), [
                      [vShow, !showTranslation.value]
                    ]),
                    showTranslation.value ? (openBlock(), createElementBlock("div", _hoisted_19$1, [
                  ...
                  createBaseVNode("div", _hoisted_20$1, [
                    createBaseVNode("div", _hoisted_21$1, [
                      ...
                      createBaseVNode("div", _hoisted_23$1, [
                        ...
                        effectiveRiskReason.value ? (openBlock(), createElementBlock("span", _hoisted_26$1, "·")) : createCommentVNode("", true),
                        effectiveRiskReason.value ? (openBlock(), createElementBlock("span", _hoisted_27$1, [
                          _cache[14] || (_cache[14] = createTextVNode("依据 ", -1)),
                          createBaseVNode("b", null, toDisplayString(effectiveRiskReasonText.value), 1)
                        ])) : createCommentVNode("", true)
                      ]),
                      createBaseVNode("div", _hoisted_28$1, [
                        createBaseVNode("p", _hoisted_29$1, toDisplayString(displayRiskDesc.value), 1)
                      ]),
                      detail.value.rule_risk ? (openBlock(), createElementBlock("div", _hoisted_30$1, [
                        ...
                        createBaseVNode("span", _hoisted_31$1, [
                          ...
                          detail.value.rule_risk.risk_category ? (openBlock(), createElementBlock("span", _hoisted_32$1, "· " + toDisplayString(detail.value.rule_risk.risk_category), 1)) : createCommentVNode("", true)
                        ])
                      ])) : createCommentVNode("", true),
                      detail.value.latest_ai_risk ? (openBlock(), createElementBlock("div", _hoisted_33$1, [
                      ...
                      detail.value.alert ? (openBlock(), createElementBlock("div", _hoisted_35$1, [
                        ...
                        createBaseVNode("span", _hoisted_36$1, [
                          ...
                          detail.value.alert.expires_at ? (openBlock(), createElementBlock("span", _hoisted_37$1, " · 有效期至 " + toDisplayString(unref(formatTime)(detail.value.alert.expires_at)), 1)) : createCommentVNode("", true)
                        ])
                      ])) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("div", _hoisted_38$1, [
                      ...
                      createBaseVNode("div", _hoisted_44$1, [
                        detail.value.rule_result?.explanation ? (openBlock(), createElementBlock("p", _hoisted_45$1, toDisplayString(detail.value.rule_result.explanation), 1)) : (openBlock(), createElementBlock("p", _hoisted_46$1, "暂无规则研判解释。"))
                      ]),
                      ruleTermHits.value.length ? (openBlock(), createElementBlock("div", _hoisted_47$1, [
                    ...
                    createBaseVNode("div", _hoisted_48$1, [
                      ...
                      createBaseVNode("div", _hoisted_51$1, [
                        createBaseVNode("span", _hoisted_52$1, [
                        ...
                        createBaseVNode("span", _hoisted_53$1, [
                        ...
                        createBaseVNode("span", _hoisted_54$1, [
                      ...
                      createBaseVNode("div", _hoisted_55$1, [
                        detail.value.ai_result?.status === "completed" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                          detail.value.ai_result.summary ? (openBlock(), createElementBlock("p", _hoisted_56$1, toDisplayString(detail.value.ai_result.summary), 1)) : createCommentVNode("", true),
                          detail.value.ai_result.suggestion ? (openBlock(), createElementBlock("p", _hoisted_57$1, toDisplayString(detail.value.ai_result.suggestion), 1)) : createCommentVNode("", true)
                        ], 64)) : detail.value.ai_result?.status === "failed" ? (openBlock(), createElementBlock("p", _hoisted_58$1, " AI 分析失败：" + toDisplayString(detail.value.ai_result.error_message || "请稍后重试"), 1)) : (openBlock(), createElementBlock("p", _hoisted_59$1, "尚未生成 AI 研判报告，点击下方按钮触发分析。"))
                      ]),
                      canAnalyzeAI.value || detail.value.ai_result?.status === "processing" ? (openBlock(), createElementBlock("div", _hoisted_60$1, [
                        ...
                        }, toDisplayString(analyzing.value ? "分析中..." : detail.value.ai_result?.status === "completed" ? "重新触发 AI 分析" : "触发 AI 分析"), 9, _hoisted_61$1)) : createCommentVNode("", true)
                      ])) : createCommentVNode("", true)
                    ])
                  ])
                ])
        ...
        showHistoryModal.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_62$1, [
            ...
            createBaseVNode("div", _hoisted_64$1, [
              detail.value && detail.value.analysis_runs && detail.value.analysis_runs.length || batchRun.value ? (openBlock(), createElementBlock("div", _hoisted_65$1, [
                batchRun.value ? (openBlock(), createElementBlock("div", _hoisted_66$1, [
                  ...
                  createBaseVNode("span", _hoisted_67$1, " 成功 " + toDisplayString(batchRun.value.success_count || 0) + " · 失败 " + toDisplayString(batchRun.value.failed_count || 0) + " · 跳过 " + toDisplayString(batchRun.value.skipped_count || 0), 1)
                ])) : createCommentVNode("", true),
                (openBlock(true), createElementBlock(Fragment, null, renderList(detail.value?.analysis_runs || [], (run) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("span", _hoisted_68$1, toDisplayString(run.error_message || ""), 1)
                  ]);
                }), 128))
...
const ForeignOpinionDetailModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-c640815f"]]);
...
const _hoisted_65 = { class: "visualization-meta" };
const _hoisted_66 = {
  key: 2,
  class: "state"
};
...
const _hoisted_77 = {
  key: 1,
  class: "ai-batch-details"
};
const _hoisted_78 = { key: 0 };
const _hoisted_79 = { class: "table-wrap tbl-scroll" };
const _hoisted_80 = ["onClick"];
const _hoisted_81 = { class: "title-cell" };
const _hoisted_82 = { class: "dual-cell" };
const _hoisted_83 = { class: "muted" };
const _hoisted_84 = {
  key: 0,
  class: "muted"
};
const _hoisted_85 = { class: "actions" };
...
const _hoisted_90 = { class: "alert-scope-note" };
...
const _hoisted_95 = { class: "subtabs" };
const _hoisted_96 = {
  key: 2,
  class: "table-wrap"
};
const _hoisted_97 = { class: "title-cell" };
const _hoisted_98 = { class: "actions" };
...
const _hoisted_104 = { class: "title-cell" };
const _hoisted_105 = ["disabled", "onClick"];
...
const _hoisted_109 = { class: "event-provenance" };
const _hoisted_110 = { key: 0 };
const _hoisted_111 = { class: "event-detail-head" };
const _hoisted_112 = { class: "actions" };
const _hoisted_113 = ["disabled"];
const _hoisted_114 = ["disabled"];
const _hoisted_115 = ["disabled"];
const _hoisted_116 = { class: "muted" };
const _hoisted_117 = { class: "event-metrics" };
const _hoisted_118 = { class: "muted" };
const _hoisted_119 = ["href"];
const _hoisted_120 = { class: "ai-batch-options" };
const _hoisted_121 = { key: 0 };
const _hoisted_122 = { class: "check-row" };
const _hoisted_123 = { class: "check-row" };
const _hoisted_124 = { class: "check-row" };
const _hoisted_125 = {
  key: 2,
  class: "warning-text"
};
...
const _hoisted_130 = { class: "review-toolbar" };
...
const _hoisted_143 = ["disabled", "onClick"];
...
风险结果`, textAlign: "center", fill: "#1d1d1f", fontSize: 20, fontWeight: 700, lineHeight: 22 } },
    ...
    onMounted(() => {
      ...
      if (runId) pollAIBatch(runId, true);
    });
    onBeforeUnmount(() => {
    ...
    function batchPayload(fullConfirmation = false) {
      const payload = {
        ...
        date_from: aiBatchConfig.date_from || void 0,
        date_to: aiBatchConfig.date_to || void 0,
      ...
      if (!aiBatchConfig.use_current_filters) payload.opinion_ids = void 0;
      return payload;
    }
    ...
    async function startAIBatch() {
      ...
      try {
        ...
        ElMessage.success(`任务已提交（run_id：${data.run_id}，task_id：${data.task_id}），匹配 ${data.matched_count ?? data.total_count} 条，待研判 ${data.pending_analysis_count ?? data.total_count} 条`);
      } catch (err) {
        const status = err?.response?.status;
    ...
    async function rerunFailures() {
      ...
      if (!run) return;
      const failedIds = (run.failures || []).map((f) => f.opinion_id).filter((x) => typeof x === "number");
      if (!failedIds.length) {
        ElMessage.info("没有可重试的失败记录");
        return;
      }
      ...
      try {
        const { data } = await api.post("/foreign/ai-analysis/batch", {
          scope: "count",
          opinion_ids: failedIds,
          recent_n: failedIds.length,
    ...
    async function loadManualReviews() {
      try {
        manualReviews.value = (await api.get("/foreign/ai-analysis/reviews", { params: { size: 100, status: "pending_review" } })).data.items || [];
    ...
    async function batchDecideReviews(decision, confirmAll = false) {
      ...
      if (decision === "reject_change") {
        try {
          await ElMessageBox.confirm("确认批量驳回当前待复核结果？", "批量驳回确认", { type: "warning" });
        } catch {
          return;
        }
      }
      ...
      try {
        await api.post("/foreign/ai-analysis/reviews/batch", { decision, confirm_all: confirmAll, review_ids: confirmAll ? void 0 : selectedReviewIds.value, reason: "Foreign workspace batch review" });
        await loadManualReviews();
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
          ...
          activeTab.value === "dashboard" ? (openBlock(), createElementBlock("section", _hoisted_6, [
            createBaseVNode("div", {
              ...
              _cache[41] || (_cache[41] = createBaseVNode("strong", null, "外网自动采集", -1)),
            ...
            createBaseVNode("div", _hoisted_9, [
              ...
              createBaseVNode("div", _hoisted_10, [
                createBaseVNode("label", _hoisted_11, [
                  _cache[43] || (_cache[43] = createTextVNode("统计窗口 ", -1)),
            ...
            visualizationError.value ? (openBlock(), createElementBlock("div", _hoisted_13, [
              ...
              createBaseVNode("div", _hoisted_15, [
                createBaseVNode("div", _hoisted_16, [
                  _cache[45] || (_cache[45] = createBaseVNode("span", { class: "fw-kpi-label" }, "文章总数", -1)),
                ...
                createBaseVNode("div", _hoisted_18, [
                  _cache[46] || (_cache[46] = createBaseVNode("span", { class: "fw-kpi-label" }, "数据源", -1)),
                ...
                createBaseVNode("div", _hoisted_20, [
                  _cache[47] || (_cache[47] = createBaseVNode("span", { class: "fw-kpi-label" }, "风险已完成", -1)),
                ...
                createBaseVNode("div", _hoisted_22, [
                  _cache[48] || (_cache[48] = createBaseVNode("span", { class: "fw-kpi-label" }, "已确认事件", -1)),
                ...
                createBaseVNode("div", _hoisted_24, [
                  _cache[49] || (_cache[49] = createBaseVNode("span", { class: "fw-kpi-label" }, "外网告警", -1)),
                ...
                createBaseVNode("div", _hoisted_26, [
                  _cache[50] || (_cache[50] = createBaseVNode("span", { class: "fw-kpi-label" }, "外网采集", -1)),
              ...
              createBaseVNode("div", _hoisted_28, [
                createBaseVNode("article", _hoisted_29, [
                  createBaseVNode("header", _hoisted_30, [
                    _cache[51] || (_cache[51] = createBaseVNode("h3", null, "每日趋势", -1)),
                ...
                createBaseVNode("article", _hoisted_34, [
                  createBaseVNode("header", _hoisted_35, [
                    _cache[52] || (_cache[52] = createBaseVNode("h3", null, "外网告警", -1)),
                  ...
                  !alertFeed.value.length ? (openBlock(), createElementBlock("div", _hoisted_37, "该窗口内暂无外网告警")) : (openBlock(), createElementBlock("div", _hoisted_38, [
                    createBaseVNode("div", _hoisted_39, [
                      createBaseVNode("span", _hoisted_40, [
                        _cache[53] || (_cache[53] = createBaseVNode("i", { class: "fw-sum-dot is-amber" }, null, -1)),
                        createTextVNode("待处置 " + toDisplayString(alertPendingCount.value), 1)
                      ]),
                      createBaseVNode("span", _hoisted_41, [
                        _cache[54] || (_cache[54] = createBaseVNode("i", { class: "fw-sum-dot is-teal" }, null, -1)),
                ...
                createBaseVNode("article", _hoisted_53, [
                  createBaseVNode("header", _hoisted_54, [
                    _cache[55] || (_cache[55] = createBaseVNode("h3", null, "数据源分布", -1)),
                ...
                createBaseVNode("article", _hoisted_57, [
                  _cache[56] || (_cache[56] = createBaseVNode("h3", null, "风险分布", -1)),
                  withDirectives(createBaseVNode("div", {
                ...
                createBaseVNode("article", _hoisted_59, [
                  createBaseVNode("header", _hoisted_60, [
                    _cache[57] || (_cache[57] = createBaseVNode("h3", null, "外网热词", -1)),
                ...
                createBaseVNode("article", _hoisted_63, [
                  _cache[58] || (_cache[58] = createBaseVNode("h3", null, "事件状态", -1)),
              ...
              createBaseVNode("div", _hoisted_65, "数据范围：" + toDisplayString(formatTime(dashboardSummary.value.window_start)) + " - " + toDisplayString(formatTime(dashboardSummary.value.window_end)) + " · 更新于：" + toDisplayString(formatTime(dashboardSummary.value.data_as_of)), 1)
            ])) : (openBlock(), createElementBlock("div", _hoisted_66, "加载外网看板中..."))
          ])) : createCommentVNode("", true),
          activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_67, [
            createBaseVNode("div", _hoisted_68, [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="" data-v-f2a68254>全部语言</option><option value="zh" data-v-f2a68254>中文</option><option value="en" data-v-f2a68254>英文</option><option value="mixed" data-v-f2a68254>中英混合</option><option value="unknown" data-v-f2a68254>未知</option>', 5)
              ])], 544), [
                [vModelSelect, riskFilters.language]
              ]),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => riskSource.value = $event),
                class: "input",
                "aria-label": "risk view source",
              ...
              createBaseVNode("span", _hoisted_70, "当前查看口径：" + toDisplayString(displaySourceLabel()), 1),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => riskFilters.risk_level = $event),
                class: "input",
                ...
                createStaticVNode('<option value="" data-v-f2a68254>全部风险等级</option><option value="high" data-v-f2a68254>高</option><option value="medium" data-v-f2a68254>中</option><option value="low" data-v-f2a68254>低</option><option value="unknown" data-v-f2a68254>未知</option>', 5)
              ])], 544), [
                [vModelSelect, riskFilters.risk_level]
              ]),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => riskFilters.analysis_status = $event),
                class: "input",
                onChange: _cache[11] || (_cache[11] = ($event) => {
                  loadOpinions();
                  loadRisk();
                })
              }, [..._cache[63] || (_cache[63] = [
              ...
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => opinionFilters.date_from = $event),
              ...
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => opinionFilters.date_to = $event),
                class: "input date-input",
                type: "date",
                title: "发布时间截止",
                onChange: loadOpinions
              ...
              unref(canAnalyzeAI) ? (openBlock(), createElementBlock("button", {
                ...
                onClick: openAIBatch
              }, "批量 AI 研判", 8, _hoisted_71)) : createCommentVNode("", true),
              unref(canReadAIBatches) ? (openBlock(), createElementBlock("button", {
                key: 1,
                class: "btn btn-secondary",
                disabled: aiBatchLoading.value,
                onClick: openAIBatchHistory
              }, "AI 研判运行记录", 8, _hoisted_72)) : createCommentVNode("", true),
              _cache[64] || (_cache[64] = createBaseVNode("span", { class: "muted" }, "AI 研判结果仅用于辅助分析，不改变系统正式风险和告警", -1))
            ]),
            aiBatchRun.value ? (openBlock(), createElementBlock("div", _hoisted_73, [
              createBaseVNode("strong", null, "AI 批次 " + toDisplayString(zh(aiBatchRun.value.status)), 1),
              createBaseVNode("span", null, "运行号 " + toDisplayString(aiBatchRun.value.run_id), 1),
              createBaseVNode("span", null, "任务号 " + toDisplayString(aiBatchRun.value.task_id || "-"), 1),
              createBaseVNode("span", null, toDisplayString(aiBatchRun.value.processed_count || 0) + "/" + toDisplayString(aiBatchRun.value.total_count || 0) + " (" + toDisplayString(batchProgress.value) + "%)", 1),
              createBaseVNode("span", null, "成功 " + toDisplayString(aiBatchRun.value.success_count || 0) + " / 失败 " + toDisplayString(aiBatchRun.value.failed_count || 0) + " / 跳过 " + toDisplayString(aiBatchRun.value.skipped_count || 0), 1),
              aiBatchRun.value.step ? (openBlock(), createElementBlock("span", _hoisted_74, toDisplayString(aiBatchRun.value.step), 1)) : createCommentVNode("", true),
              aiBatchRun.value.started_at ? (openBlock(), createElementBlock("span", _hoisted_75, "开始：" + toDisplayString(formatTime(aiBatchRun.value.started_at)), 1)) : createCommentVNode("", true),
              aiBatchRun.value.finished_at ? (openBlock(), createElementBlock("span", _hoisted_76, "结束：" + toDisplayString(formatTime(aiBatchRun.value.finished_at)), 1)) : createCommentVNode("", true),
              ...
              (aiBatchRun.value.failures || []).length && ["failed", "partial"].includes(aiBatchRun.value.status) ? (openBlock(), createElementBlock("button", {
                key: 4,
                class: "link-btn",
                onClick: rerunFailures
              }, "重新执行失败记录")) : createCommentVNode("", true),
              createBaseVNode("button", {
                class: "link-btn",
                onClick: _cache[14] || (_cache[14] = ($event) => showAIBatchDetails.value = !showAIBatchDetails.value)
              }, toDisplayString(showAIBatchDetails.value ? "收起详情" : "查看运行详情"), 1)
            ])) : createCommentVNode("", true),
            aiBatchRun.value && showAIBatchDetails.value ? (openBlock(), createElementBlock("div", _hoisted_77, [
              createBaseVNode("span", null, "开始：" + toDisplayString(aiBatchRun.value.started_at || "-"), 1),
              createBaseVNode("span", null, "结束：" + toDisplayString(aiBatchRun.value.finished_at || "-"), 1),
              (aiBatchRun.value.failures || []).length ? (openBlock(), createElementBlock("p", _hoisted_78, "失败明细：" + toDisplayString((aiBatchRun.value.failures || []).map((item) => `#${item.opinion_id || "-"}: ${item.error || item.message || item.code || "未知错误"}`).join("；")), 1)) : createCommentVNode("", true)
            ])) : createCommentVNode("", true),
            createBaseVNode("div", _hoisted_79, [
              createBaseVNode("table", null, [
                _cache[66] || (_cache[66] = createBaseVNode("thead", null, [
                ...
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_81, toDisplayString(row.title || "无标题"), 1),
                      ...
                      createBaseVNode("td", _hoisted_82, [
                        ...
                        createBaseVNode("span", _hoisted_83, toDisplayString(aiHistoryLabel(row)), 1)
                      ]),
                      ...
                      createBaseVNode("td", null, [
                        ...
                        !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_84, "无")) : createCommentVNode("", true)
                      ]),
                      createBaseVNode("td", null, [
                        createBaseVNode("span", {
                      ...
                      createBaseVNode("td", _hoisted_85, [
                        ...
                        }, toDisplayString(ruleOf(row) ? "重新分析" : "分析"), 9, _hoisted_86)
                      ])
                    ], 8, _hoisted_80);
                  }), 128)),
                  !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_87, [..._cache[65] || (_cache[65] = [
                    createBaseVNode("td", {
                      colspan: "16",
                      class: "empty"
                    }, "暂无外网舆情", -1)
            ...
            opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_88, [
          ...
          ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_89, [
            createBaseVNode("div", _hoisted_90, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
            createBaseVNode("div", _hoisted_91, [
              ...
              }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_92),
              _cache[67] || (_cache[67] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
            ]),
            eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_93, [
            ...
            eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_94, [
              _cache[69] || (_cache[69] = createBaseVNode("strong", null, "外网事件运行失败", -1)),
              (openBlock(true), createElementBlock(Fragment, null, renderList(eventRunFailures.value, (run) => {
                return openBlock(), createElementBlock("div", {
                  key: run.id,
                  class: "event-failure-row"
                }, [
                  _cache[68] || (_cache[68] = createBaseVNode("span", { class: "status failed" }, "失败", -1)),
            ...
            createBaseVNode("div", _hoisted_95, [
              ...
              createBaseVNode("button", {
                class: normalizeClass(["tab", { active: eventSection.value === "ai-review" }]),
                onClick: _cache[18] || (_cache[18] = ($event) => {
                  eventSection.value = "ai-review";
                  loadManualReviews();
                })
              }, "AI 人工复核", 2)
            ]),
            eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_96, [
              createBaseVNode("table", null, [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_98, [
                        ...
                        }, "确认", 8, _hoisted_99)) : createCommentVNode("", true),
                        row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                          key: 1,
                          class: "link-btn danger",
                          disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                          onClick: ($event) => rejectCandidate(row)
                        }, "拒绝", 8, _hoisted_100)) : createCommentVNode("", true)
                      ])
                    ]);
                  }), 128)),
                  !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_101, [..._cache[70] || (_cache[70] = [
                    createBaseVNode("td", {
                      colspan: "8",
                      class: "empty"
                    }, "暂无外网事件候选", -1)
            ...
            ])) : eventSection.value === "confirmed" ? (openBlock(), createElementBlock("div", _hoisted_102, [
              createBaseVNode("table", null, [
                ...
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(foreignEvents.value, (row) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_104, toDisplayString(row.title || "无标题"), 1),
                      createBaseVNode("td", null, toDisplayString(zh(row.language)), 1),
                  ...
                  !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_107, [..._cache[72] || (_cache[72] = [
                    createBaseVNode("td", {
                      colspan: "12",
                      class: "empty"
                    }, "暂无已确认外网事件", -1)
            ...
            selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_108, [
              createBaseVNode("div", _hoisted_109, [
                _cache[75] || (_cache[75] = createBaseVNode("strong", null, "事件溯源", -1)),
                ...
                selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_110, [
                  _cache[74] || (_cache[74] = createBaseVNode("summary", null, "聚合证据", -1)),
              ...
              createBaseVNode("div", _hoisted_111, [
                ...
                createBaseVNode("div", _hoisted_112, [
                  createBaseVNode("button", {
                    ...
                    onClick: _cache[19] || (_cache[19] = ($event) => closeEvent(selectedForeignEvent.value))
                  }, "关闭事件", 8, _hoisted_113),
                  createBaseVNode("button", {
                    class: "link-btn",
                    disabled: !unref(canMergeEvents) || Boolean(eventActionKey.value),
                    onClick: _cache[20] || (_cache[20] = ($event) => mergeEvent(selectedForeignEvent.value))
                  }, "合并", 8, _hoisted_114),
                  createBaseVNode("button", {
                    class: "link-btn",
                    disabled: !unref(canSplitEvents) || Boolean(eventActionKey.value),
                    onClick: _cache[21] || (_cache[21] = ($event) => splitEvent(selectedForeignEvent.value))
                  }, "拆分", 8, _hoisted_115),
                  createBaseVNode("button", {
                    class: "link-btn",
                    onClick: _cache[22] || (_cache[22] = ($event) => selectedForeignEvent.value = null)
                  }, "关闭详情")
                ])
              ]),
              createBaseVNode("p", _hoisted_116, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_118, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                  createBaseVNode("a", {
                    href: opinion.url,
                    target: "_blank",
                    rel: "noreferrer",
          ...
          createVNode(ForeignOpinionDetailModal, {
            ...
            "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => detailVisible.value = $event),
          ...
          createVNode(_component_el_dialog, {
            ...
            "onUpdate:modelValue": _cache[39] || (_cache[39] = ($event) => aiBatchDialog.value = $event),
            title: "批量 AI 研判",
            ...
            footer: withCtx(() => [
              createBaseVNode("button", {
                class: "btn btn-secondary",
                onClick: _cache[38] || (_cache[38] = ($event) => aiBatchDialog.value = false)
              }, "取消"),
              createBaseVNode("button", {
                class: "btn btn-primary",
            ...
            default: withCtx(() => [
              createBaseVNode("div", _hoisted_120, [
                createBaseVNode("label", null, [
                  _cache[77] || (_cache[77] = createTextVNode("研判范围 ", -1)),
                  withDirectives(createBaseVNode("select", {
                    "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => aiBatchConfig.scope = $event),
                    class: "input",
                    onChange: refreshAIBatchPreview
                  }, [..._cache[76] || (_cache[76] = [
                    createBaseVNode("option", { value: "count" }, "按数量（最近 N 条）", -1),
                    createBaseVNode("option", { value: "time" }, "按时间范围", -1),
                    createBaseVNode("option", { value: "full" }, "全量 AI 研判", -1)
                  ])], 544), [
                    [vModelSelect, aiBatchConfig.scope]
                  ])
                ]),
                aiBatchConfig.scope === "count" ? (openBlock(), createElementBlock("label", _hoisted_121, [
                  _cache[78] || (_cache[78] = createTextVNode("最近 N 条 ", -1)),
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => aiBatchConfig.recent_n = $event),
                    class: "input",
                    type: "number",
                    min: "1",
                    max: "100000",
                    ...
                    [
                      vModelText,
                      aiBatchConfig.recent_n,
                      void 0,
                      { number: true }
                    ]
                  ])
                ])) : createCommentVNode("", true),
                aiBatchConfig.scope === "time" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                  createBaseVNode("label", null, [
                    _cache[79] || (_cache[79] = createTextVNode("发布时间起始日期", -1)),
                    withDirectives(createBaseVNode("input", {
                      "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => aiBatchConfig.date_from = $event),
                      class: "input",
                      type: "date",
                      onChange: refreshAIBatchPreview
                    }, null, 544), [
                      [vModelText, aiBatchConfig.date_from]
                    ])
                  ]),
                  createBaseVNode("label", null, [
                    _cache[80] || (_cache[80] = createTextVNode("发布时间结束日期", -1)),
                    withDirectives(createBaseVNode("input", {
                      "onUpdate:modelValue": _cache[27] || (_cache[27] = ($event) => aiBatchConfig.date_to = $event),
                      class: "input",
                      type: "date",
                      onChange: refreshAIBatchPreview
                    }, null, 544), [
                      [vModelText, aiBatchConfig.date_to]
                    ])
                  ])
                ], 64)) : createCommentVNode("", true),
                createBaseVNode("label", _hoisted_122, [
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[28] || (_cache[28] = ($event) => aiBatchConfig.use_current_filters = $event),
                    type: "checkbox",
                    onChange: refreshAIBatchPreview
                  }, null, 544), [
                    [vModelCheckbox, aiBatchConfig.use_current_filters]
                  ]),
                  _cache[81] || (_cache[81] = createTextVNode(" 仅选择当前筛选结果", -1))
                ]),
                createBaseVNode("label", _hoisted_123, [
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[29] || (_cache[29] = ($event) => aiBatchConfig.only_unanalyzed = $event),
                    type: "checkbox",
                    onChange: refreshAIBatchPreview
                  }, null, 544), [
                    [vModelCheckbox, aiBatchConfig.only_unanalyzed]
                  ]),
                  _cache[82] || (_cache[82] = createTextVNode(" 仅处理未完成 AI 研判的记录", -1))
                ]),
                createBaseVNode("label", _hoisted_124, [
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[30] || (_cache[30] = ($event) => aiBatchConfig.force = $event),
                    type: "checkbox",
                    onChange: refreshAIBatchPreview
                  }, null, 544), [
                    [vModelCheckbox, aiBatchConfig.force]
                  ]),
                  _cache[83] || (_cache[83] = createTextVNode(" 强制重新研判已有 AI 结果", -1))
                ]),
                aiBatchConfig.scope === "full" ? (openBlock(), createElementBlock("p", _hoisted_125, "全量任务可能消耗大量 Token 并运行较长时间。AI 结果仍须人工复核后才会进入正式事件或预警。")) : createCommentVNode("", true)
              ]),
              aiBatchPreview.value ? (openBlock(), createElementBlock("div", _hoisted_126, [
                createBaseVNode("p", null, [
                  _cache[84] || (_cache[84] = createTextVNode("符合条件舆情：", -1)),
                  createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.matched_count), 1),
                  _cache[85] || (_cache[85] = createTextVNode(" 条", -1))
                ]),
                createBaseVNode("p", null, [
                  _cache[86] || (_cache[86] = createTextVNode("已有 AI 结果：", -1)),
                  createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.existing_ai_result_count), 1),
                  _cache[87] || (_cache[87] = createTextVNode(" 条 · 待分析：", -1)),
                  createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.pending_analysis_count), 1),
                  _cache[88] || (_cache[88] = createTextVNode(" 条", -1))
                ]),
                createBaseVNode("p", null, [
                  _cache[89] || (_cache[89] = createTextVNode("待分析：", -1)),
                  createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.pending_analysis_count), 1),
                  _cache[90] || (_cache[90] = createTextVNode(" 条 · 预计 Token：", -1)),
                ...
                createBaseVNode("p", null, "风险分布：高 " + toDisplayString(aiBatchPreview.value.risk_level_counts?.high || 0) + " · 中 " + toDisplayString(aiBatchPreview.value.risk_level_counts?.medium || 0) + " · 低 " + toDisplayString(aiBatchPreview.value.risk_level_counts?.low || 0), 1),
                createBaseVNode("p", null, "可能影响：事件候选 " + toDisplayString(aiBatchPreview.value.possible_event_count || 0) + " 个 · 预警 " + toDisplayString(aiBatchPreview.value.possible_alert_count || 0) + " 个", 1),
                _cache[91] || (_cache[91] = createBaseVNode("p", { class: "muted" }, "AI 结果必须经过人工复核后，才可用于正式事件或预警变更。", -1)),
                aiBatchPreview.value.preview_warning ? (openBlock(), createElementBlock("p", _hoisted_127, "⚠ " + toDisplayString(aiBatchPreview.value.preview_warning), 1)) : createCommentVNode("", true),
                aiBatchPreview.value.token_budget_exceeded ? (openBlock(), createElementBlock("p", _hoisted_128, "⚠ 预计 Token 超出预算，提交将被拦截，请缩小范围或调高预算。")) : createCommentVNode("", true)
              ])) : createCommentVNode("", true),
              eventSection.value === "ai-review" && canReadReviewSection.value ? (openBlock(), createElementBlock("div", _hoisted_129, [
                createBaseVNode("div", _hoisted_130, [
                  unref(canReviewAI) ? (openBlock(), createElementBlock("button", {
                    key: 0,
                    class: "btn btn-secondary",
                    disabled: !selectedReviewIds.value.length || reviewActionId.value,
                    onClick: _cache[31] || (_cache[31] = ($event) => batchDecideReviews("use_ai_display"))
                  }, "确认选中采用 AI 展示", 8, _hoisted_131)) : createCommentVNode("", true),
                  unref(canConfirmEventReview) ? (openBlock(), createElementBlock("button", {
                    key: 1,
                    class: "btn btn-primary",
                    disabled: !selectedReviewIds.value.length || reviewActionId.value,
                    onClick: _cache[32] || (_cache[32] = ($event) => batchDecideReviews("confirm_event_change"))
                  }, "确认选中事件影响", 8, _hoisted_132)) : createCommentVNode("", true),
                  unref(canConfirmAlertReview) ? (openBlock(), createElementBlock("button", {
                    key: 2,
                    class: "btn btn-primary",
                    disabled: !selectedReviewIds.value.length || reviewActionId.value,
                    onClick: _cache[33] || (_cache[33] = ($event) => batchDecideReviews("confirm_alert_change"))
                  }, "确认选中预警影响", 8, _hoisted_133)) : createCommentVNode("", true),
                  unref(canRejectAIReview) ? (openBlock(), createElementBlock("button", {
                    key: 3,
                    class: "btn btn-danger",
                    disabled: !selectedReviewIds.value.length || reviewActionId.value,
                    onClick: _cache[34] || (_cache[34] = ($event) => batchDecideReviews("reject_change"))
                  }, "驳回选中", 8, _hoisted_134)) : createCommentVNode("", true),
                  unref(canFullConfirmAI) && unref(canConfirmEventReview) ? (openBlock(), createElementBlock("button", {
                    key: 4,
                    class: "btn btn-secondary",
                    disabled: !manualReviews.value.length || reviewActionId.value,
                    onClick: _cache[35] || (_cache[35] = ($event) => batchDecideReviews("confirm_event_change", true))
                  }, "全量确认事件", 8, _hoisted_135)) : createCommentVNode("", true),
                  unref(canFullConfirmAI) && unref(canRejectAIReview) ? (openBlock(), createElementBlock("button", {
                    key: 5,
                    class: "btn btn-danger",
                    disabled: !manualReviews.value.length || reviewActionId.value,
                    onClick: _cache[36] || (_cache[36] = ($event) => batchDecideReviews("reject_change", true))
                  }, "全量驳回", 8, _hoisted_136)) : createCommentVNode("", true)
                ]),
                createBaseVNode("table", null, [
                  createBaseVNode("thead", null, [
                    createBaseVNode("tr", null, [
                      createBaseVNode("th", null, [
                        ...
                        }, null, 40, _hoisted_137)
                      ]),
                      _cache[92] || (_cache[92] = createBaseVNode("th", null, "舆情 ID", -1)),
                      _cache[93] || (_cache[93] = createBaseVNode("th", null, "规则风险", -1)),
                      _cache[94] || (_cache[94] = createBaseVNode("th", null, "AI 风险", -1)),
                      _cache[95] || (_cache[95] = createBaseVNode("th", null, "事件影响", -1)),
                      _cache[96] || (_cache[96] = createBaseVNode("th", null, "预警影响", -1)),
                      _cache[97] || (_cache[97] = createBaseVNode("th", null, "状态", -1)),
                      _cache[98] || (_cache[98] = createBaseVNode("th", null, "操作", -1))
                    ])
                  ]),
                  createBaseVNode("tbody", null, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(manualReviews.value, (review) => {
                      return openBlock(), createElementBlock("tr", {
                        ...
                        createBaseVNode("td", null, [
                          withDirectives(createBaseVNode("input", {
                            "onUpdate:modelValue": _cache[37] || (_cache[37] = ($event) => selectedReviewIds.value = $event),
                            type: "checkbox",
                            value: review.id
                          }, null, 8, _hoisted_138), [
                        ...
                        createBaseVNode("td", null, toDisplayString(review.rule_risk_snapshot?.risk_score ?? "-") + " / " + toDisplayString(zh(review.rule_risk_snapshot?.risk_level)), 1),
                        createBaseVNode("td", null, toDisplayString(review.ai_risk_snapshot?.risk_score ?? "-") + " / " + toDisplayString(zh(review.ai_risk_snapshot?.risk_level)), 1),
                        createBaseVNode("td", null, toDisplayString(review.event_preview?.candidate_count || 0) + " 个候选", 1),
                        createBaseVNode("td", null, toDisplayString(review.alert_preview?.triggered_count || 0) + " 个预警", 1),
                        createBaseVNode("td", null, toDisplayString(zh(review.review_status)), 1),
                        review.review_status === "pending_review" ? (openBlock(), createElementBlock("td", _hoisted_139, [
                          unref(canReviewAI) ? (openBlock(), createElementBlock("button", {
                            key: 0,
                            class: "link-btn",
                            disabled: reviewActionId.value === review.id,
                            onClick: ($event) => decideReview(review, "use_ai_display")
                          }, "采用 AI 展示", 8, _hoisted_140)) : createCommentVNode("", true),
                          unref(canReviewAI) ? (openBlock(), createElementBlock("button", {
                            key: 1,
                            class: "link-btn",
                            disabled: reviewActionId.value === review.id,
                            onClick: ($event) => decideReview(review, "keep_rule")
                          }, "保留规则", 8, _hoisted_141)) : createCommentVNode("", true),
                          unref(canConfirmEventReview) ? (openBlock(), createElementBlock("button", {
                            key: 2,
                            class: "link-btn",
                            disabled: reviewActionId.value === review.id,
                            onClick: ($event) => decideReview(review, "confirm_event_change")
                          }, "确认事件", 8, _hoisted_142)) : createCommentVNode("", true),
                          unref(canConfirmAlertReview) ? (openBlock(), createElementBlock("button", {
                            key: 3,
                            class: "link-btn",
                            disabled: reviewActionId.value === review.id,
                            onClick: ($event) => decideReview(review, "confirm_alert_change")
                          }, "确认预警", 8, _hoisted_143)) : createCommentVNode("", true),
                          unref(canRejectAIReview) ? (openBlock(), createElementBlock("button", {
                            key: 4,
                            class: "link-btn danger",
                            disabled: reviewActionId.value === review.id,
                            onClick: ($event) => decideReview(review, "reject_change")
                          }, "驳回", 8, _hoisted_144)) : createCommentVNode("", true)
                        ])) : (openBlock(), createElementBlock("td", _hoisted_145, toDisplayString(review.review_reason || "-"), 1))
                      ]);
                    }), 128)),
                    !manualReviews.value.length ? (openBlock(), createElementBlock("tr", _hoisted_146, [..._cache[99] || (_cache[99] = [
                      createBaseVNode("td", {
                        colspan: "8",
                        class: "empty"
                      }, "暂无待复核结果", -1)
        ...
        createVNode(_component_el_dialog, {
          ...
          "onUpdate:modelValue": _cache[40] || (_cache[40] = ($event) => aiBatchHistoryDialog.value = $event),
          title: "AI 研判运行记录",
          width: "min(880px, calc(100vw - 24px))"
        }, {
          default: withCtx(() => [
            aiBatchHistoryLoading.value ? (openBlock(), createElementBlock("div", _hoisted_148, "加载中...")) : !aiBatchHistory.value.length ? (openBlock(), createElementBlock("div", _hoisted_149, "暂无批量 AI 研判运行记录")) : (openBlock(), createElementBlock("div", _hoisted_150, [
              createBaseVNode("table", null, [
                _cache[100] || (_cache[100] = createBaseVNode("thead", null, [
                  createBaseVNode("tr", null, [
                    createBaseVNode("th", null, "运行号"),
                    createBaseVNode("th", null, "范围"),
                    createBaseVNode("th", null, "状态"),
                ...
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(aiBatchHistory.value, (r) => {
                    return openBlock(), createElementBlock("tr", {
                      key: r.run_id,
                      class: normalizeClass({ active: aiBatchHistorySel.value && aiBatchHistorySel.value.run_id === r.run_id }),
                      onClick: ($event) => openAIBatchHistoryDetail(r.run_id)
                    }, [
                      createBaseVNode("td", null, toDisplayString(r.run_id.slice(0, 8)), 1),
                      createBaseVNode("td", null, toDisplayString(zh(r.scope)), 1),
                      createBaseVNode("td", null, [
                        createBaseVNode("span", {
                          class: normalizeClass(["status", { on: r.status === "success" || r.status === "partial" }])
                        }, toDisplayString(zh(r.status)), 3)
                      ]),
                      ...
                      createBaseVNode("td", null, toDisplayString(formatTime(r.started_at)), 1),
                      createBaseVNode("td", null, toDisplayString(formatTime(r.finished_at)), 1),
                      createBaseVNode("td", null, [
                        createBaseVNode("button", {
                          class: "link-btn",
            ...
            aiBatchHistorySel.value ? (openBlock(), createElementBlock("div", _hoisted_153, [
              createBaseVNode("h4", null, "运行详情 " + toDisplayString(aiBatchHistorySel.value.run_id), 1),
              createBaseVNode("span", null, "状态：" + toDisplayString(zh(aiBatchHistorySel.value.status)), 1),
              ...
              (aiBatchHistorySel.value.failures || []).length ? (openBlock(), createElementBlock("p", _hoisted_154, "失败明细：" + toDisplayString((aiBatchHistorySel.value.failures || []).map((item) => `#${item.opinion_id}: ${item.error}`).join("；")), 1)) : createCommentVNode("", true),
              aiBatchHistorySel.value.event_preview ? (openBlock(), createElementBlock("p", _hoisted_155, "可能影响事件候选：" + toDisplayString(aiBatchHistorySel.value.event_preview?.candidate_count ?? 0), 1)) : createCommentVNode("", true),
              aiBatchHistorySel.value.alert_preview ? (openBlock(), createElementBlock("p", _hoisted_156, "可能影响预警：" + toDisplayString(aiBatchHistorySel.value.alert_preview?.triggered_count ?? 0), 1)) : createCommentVNode("", true)
            ])) : createCommentVNode("", true)
          ]),
          _: 1
        }, 8, ["modelValue"])
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f2a68254"]]);
