import { d as defineComponent, a0 as useAlertNotifier, z as usePermission, A as watch, C as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, m as createVNode, p as withCtx, r as ref, y as resolveComponent, B as resolveDirective, L as useRoute, g as api, E as ElMessage, X as isPermissionDenied, o as openBlock, e as createTextVNode, q as createBlock, s as createCommentVNode, t as toDisplayString, H as unref, a1 as riskTag, a2 as riskText, R as _sfc_main$1, b as withKeys, F as Fragment, i as renderList, j as computed, f as reactive, Q as ElMessageBox, h as useRouter, _ as _export_sfc } from './index-Bt1_Mwuw.js';
import { O as OpinionDetailModal } from './OpinionDetailModal-DLxy5tvQ.js';
import { F as ForeignOpinionDetailModal } from './ForeignOpinionDetailModal-DwigtgRV.js';
...
const _hoisted_17 = { class: "scope-bar" };
const _hoisted_18 = {
  key: 0,
  class: "scope-hint"
};
...
const _hoisted_20 = { class: "detail-pre" };
const rulesSize = 20;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const FOREIGN_TEXT = { triggered: "待确认", acknowledged: "已确认", resolved: "已解决", suppressed: "已抑制", failed: "失败", critical: "紧急", high: "高", medium: "中", low: "低", pending_review: "待人工复核", confirmed: "已确认", rejected: "已驳回", superseded: "已替代", use_ai_display: "采用 AI 展示", keep_rule: "保留规则", confirm_event_change: "确认事件影响", confirm_alert_change: "确认预警影响", reject_change: "驳回" };
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
                    ...
                    createVNode(_component_el_table, {
                      ...
                      default: withCtx(() => [
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            row.linked_opinion_current_risk ? (openBlock(), createElementBlock("span", _hoisted_8, toDisplayString(row.linked_opinion_current_risk.risk_score ?? "-") + " 分 · " + toDisplayString(unref(riskText)(row.linked_opinion_current_risk.risk_level)), 1)) : (openBlock(), createElementBlock("span", _hoisted_9, "-"))
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            ...
                            }, toDisplayString(row.opinion_title), 9, _hoisted_10)) : (openBlock(), createElementBlock("span", _hoisted_11, toDisplayString(row.opinion_title || "-"), 1))
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                      ...
                      default: withCtx(() => [
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            ...
                            }, toDisplayString(row.opinion_title_snapshot || row.title || "-"), 9, _hoisted_15)) : (openBlock(), createElementBlock("span", _hoisted_16, toDisplayString(row.opinion_title_snapshot || row.title || "-"), 1))
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            createVNode(_component_el_tag, {
                              ...
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(foreignText(row.status)), 1)
                              ]),
                              _: 2
                            }, 1032, ["type"])
                          ]),
                ...
                createVNode(_component_el_card, {
                  ...
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_17, [
                      _cache[61] || (_cache[61] = createBaseVNode("span", { class: "muted" }, "外网人工复核已在统一的「外网舆情工作台」中处理；采用 AI 后进入关联舆情当前风险，正式预警风险保持记录快照。", -1)),
                      createVNode(_component_el_button, {
                        type: "primary",
        ...
        createVNode(_component_el_dialog, {
          ...
          "onUpdate:modelValue": _cache[32] || (_cache[32] = ($event) => foreignDetailDialog.value = $event),
          title: "外网预警详情",
          width: "min(760px, calc(100vw - 24px))"
        }, {
          default: withCtx(() => [
            createBaseVNode("pre", _hoisted_20, toDisplayString(JSON.stringify(foreignDetail.value, null, 2)), 1)
          ]),
          _: 1
        }, 8, ["modelValue"]),
        createVNode(_component_el_dialog, {
          modelValue: foreignHistoryDialog.value,
          "onUpdate:modelValue": _cache[33] || (_cache[33] = ($event) => foreignHistoryDialog.value = $event),
          title: "外网预警处置历史",
        ...
        createVNode(_component_el_dialog, {
          ...
          "onUpdate:modelValue": _cache[37] || (_cache[37] = ($event) => handleDialogVisible.value = $event),
          title: "预警处置",
          width: "min(480px, calc(100vw - 24px))"
        }, {
          footer: withCtx(() => [
            createVNode(_component_el_button, {
              onClick: _cache[36] || (_cache[36] = ($event) => handleDialogVisible.value = false)
            }, {
                ...
                createVNode(_component_el_form_item, { label: "处置状态" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[34] || (_cache[34] = ($event) => handleForm.status = $event)
                    }, {
                      default: withCtx(() => [
                        createVNode(_component_el_option, {
                          label: "待处理",
                ...
                createVNode(_component_el_form_item, { label: "处置备注" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[35] || (_cache[35] = ($event) => handleForm.note = $event),
                      type: "textarea"
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
        ...
        createVNode(OpinionDetailModal, {
          ...
          "onUpdate:modelValue": _cache[38] || (_cache[38] = ($event) => detailVisible.value = $event),
        ...
        createVNode(ForeignOpinionDetailModal, {
          ...
          "onUpdate:modelValue": _cache[39] || (_cache[39] = ($event) => foreignOpinionDetailVisible.value = $event),
...
const Alerts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8e7c96b9"]]);
