import { d as defineComponent, m as onMounted, q as onBeforeUnmount, w as withDirectives, c as createElementBlock, s as createVNode, H as withCtx, r as ref, g as api, E as ElMessage, p as nextTick, C as resolveComponent, x as resolveDirective, o as openBlock, a as createBaseVNode, F as Fragment, i as renderList, J as unref, n as normalizeClass, t as toDisplayString, e as createTextVNode, z as createCommentVNode, A as createBlock, h as useRouter, j as computed, _ as _export_sfc } from './index-CX2gy79j.js';
...
const _hoisted_12 = { class: "source-name" };
const _hoisted_13 = { class: "source-num" };
const _hoisted_14 = {
  key: 0,
  class: "timeline-list"
};
const _hoisted_15 = { class: "tl-content" };
const _hoisted_16 = { class: "tl-time" };
const _hoisted_17 = { class: "tl-title" };
const _hoisted_18 = { class: "tl-source" };
                          ...
                          createVNode(_component_el_col, { span: 12 }, {
                            default: withCtx(() => [
                              createVNode(_component_el_card, {
                                ...
                                default: withCtx(() => [
                                  graphData.value?.source_summary && graphData.value.source_summary.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_11, [
                                    (openBlock(true), createElementBlock(Fragment, null, renderList(graphData.value.source_summary, (s) => {
                                      return openBlock(), createElementBlock("div", {
                                        key: s.source,
                                        class: "source-item"
                                      }, [
                                        createBaseVNode("span", _hoisted_12, toDisplayString(s.source || "未知"), 1),
                                        createVNode(_component_el_progress, {
                                          percentage: Math.round(s.count / graphData.value.total_opinions * 100),
                                          "stroke-width": 8,
                                          "show-text": false
                                        }, null, 8, ["percentage"]),
                                        createBaseVNode("span", _hoisted_13, toDisplayString(s.count), 1)
                                      ]);
                                    }), 128))
                          ...
                          createVNode(_component_el_col, { span: 12 }, {
                            default: withCtx(() => [
                              createVNode(_component_el_card, {
                                ...
                                default: withCtx(() => [
                                  timelineData.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_14, [
                                    (openBlock(true), createElementBlock(Fragment, null, renderList(timelineData.value, (t) => {
                                      return openBlock(), createElementBlock("div", {
                                        key: t.time,
                                        class: "tl-item"
                                      }, [
                                        _cache[6] || (_cache[6] = createBaseVNode("div", { class: "tl-dot" }, null, -1)),
                                        createBaseVNode("div", _hoisted_15, [
                                          createBaseVNode("div", _hoisted_16, toDisplayString(t.time), 1),
                                          createBaseVNode("div", _hoisted_17, toDisplayString(t.title), 1),
                                          createBaseVNode("div", _hoisted_18, toDisplayString(t.source), 1)
                                        ])
                                      ]);
                                    }), 128))
                                  ])) : (openBlock(), createBlock(_component_el_empty, {
...
const Propagation = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-55c24dc1"]]);
