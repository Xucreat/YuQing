              ...
              detail.value ? (openBlock(), createElementBlock("div", _hoisted_8$1, [
                createBaseVNode("div", _hoisted_9$1, [
                  ...
                  createBaseVNode("div", _hoisted_11$1, [
                    ...
                    detail.value.summary ? (openBlock(), createElementBlock("p", _hoisted_13$1, toDisplayString(detail.value.summary), 1)) : createCommentVNode("", true),
                    detail.value.content ? (openBlock(), createElementBlock("p", _hoisted_14$1, toDisplayString(detail.value.content), 1)) : !detail.value.summary ? (openBlock(), createElementBlock("p", _hoisted_15$1, "暂无摘要与正文（正文抓取已关闭）。")) : createCommentVNode("", true)
                  ])
                ]),
...
const ForeignOpinionDetailModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-df736782"]]);
...
const _hoisted_26 = { class: "fw-widget-grid" };
const _hoisted_27 = { class: "fw-card" };
const _hoisted_28 = {
  key: 0,
  class: "empty"
};
const _hoisted_29 = { class: "fw-card" };
const _hoisted_30 = {
  key: 0,
  class: "empty"
};
const _hoisted_31 = { class: "fw-card" };
const _hoisted_32 = {
  key: 0,
  class: "distribution-row"
};
const _hoisted_33 = { class: "distribution-row" };
const _hoisted_34 = {
  key: 1,
  class: "empty"
};
const _hoisted_35 = { class: "fw-card fw-card-wide" };
const _hoisted_36 = { class: "table-wrap" };
const _hoisted_37 = { class: "fw-card fw-card-wide" };
const _hoisted_38 = {
  key: 0,
  class: "fw-hotwords"
};
...
const _hoisted_46 = { class: "table-wrap tbl-scroll" };
const _hoisted_47 = ["onClick"];
const _hoisted_48 = { class: "title-cell" };
const _hoisted_49 = {
  key: 0,
  class: "muted"
};
const _hoisted_50 = { class: "actions" };
...
const _hoisted_57 = { class: "alert-scope-note" };
const _hoisted_58 = { class: "toolbar" };
...
const _hoisted_62 = { class: "subtabs" };
const _hoisted_63 = {
  key: 2,
  class: "table-wrap"
};
...
const _hoisted_71 = { class: "title-cell" };
...
const _hoisted_76 = { class: "event-provenance" };
const _hoisted_77 = { key: 0 };
const _hoisted_78 = { class: "event-detail-head" };
const _hoisted_79 = { class: "actions" };
const _hoisted_80 = ["disabled"];
const _hoisted_81 = ["disabled"];
const _hoisted_82 = ["disabled"];
const _hoisted_83 = { class: "muted" };
const _hoisted_84 = { class: "event-metrics" };
...
const _hoisted_96 = { class: "muted" };
const _hoisted_97 = { class: "actions" };
...
const _hoisted_104 = { class: "table-wrap" };
...
const _hoisted_111 = { class: "detail alert-dialog" };
const _hoisted_112 = { class: "detail-meta" };
const _hoisted_113 = { class: "detail-summary" };
...
const _hoisted_118 = { class: "analysis-block" };
const _hoisted_119 = {
  key: 0,
  class: "analysis-grid"
};
const _hoisted_120 = { class: "analysis-block" };
const _hoisted_121 = {
  key: 0,
  class: "analysis-grid"
};
const _hoisted_122 = { class: "analysis-block" };
const _hoisted_123 = { class: "muted" };
const _hoisted_124 = { class: "analysis-block" };
const _hoisted_125 = {
  key: 0,
...
const _hoisted_129 = { class: "detail history-dialog" };
...
const _hoisted_135 = { class: "detail rule-dialog" };
const _hoisted_136 = { class: "muted" };
const _hoisted_137 = ["disabled"];
const _hoisted_138 = { class: "rule-preview" };
const _hoisted_139 = { class: "actions" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function normalizeTab(value) {
      return value === "dashboard" || value === "events" || value === "alerts" || value === "alertRules" ? value : "opinions";
    }
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          ...
          createBaseVNode("div", _hoisted_3, [
            _cache[34] || (_cache[34] = createBaseVNode("span", { class: "source-scope-label" }, "已批准数据源：57-60", -1)),
            createBaseVNode("button", {
          ...
          createBaseVNode("div", _hoisted_9, [
            ...
            createBaseVNode("div", _hoisted_10, [
              createBaseVNode("label", _hoisted_11, [
                _cache[37] || (_cache[37] = createTextVNode("统计窗口 ", -1)),
          ...
          visualizationError.value ? (openBlock(), createElementBlock("div", _hoisted_13, [
            ...
            createBaseVNode("div", _hoisted_15, [
              createBaseVNode("div", _hoisted_16, [
                _cache[39] || (_cache[39] = createBaseVNode("span", { class: "fw-kpi-label" }, "文章总数", -1)),
              ...
              createBaseVNode("div", _hoisted_18, [
                _cache[40] || (_cache[40] = createBaseVNode("span", { class: "fw-kpi-label" }, "数据源", -1)),
              ...
              createBaseVNode("div", _hoisted_20, [
                _cache[41] || (_cache[41] = createBaseVNode("span", { class: "fw-kpi-label" }, "风险已完成", -1)),
              ...
              createBaseVNode("div", _hoisted_22, [
                _cache[42] || (_cache[42] = createBaseVNode("span", { class: "fw-kpi-label" }, "已确认事件", -1)),
              ...
              createBaseVNode("div", _hoisted_24, [
                _cache[43] || (_cache[43] = createBaseVNode("span", { class: "fw-kpi-label" }, "外网告警", -1)),
            ...
            createBaseVNode("div", _hoisted_26, [
              createBaseVNode("article", _hoisted_27, [
                _cache[44] || (_cache[44] = createBaseVNode("h3", null, "风险分布", -1)),
                ...
                !dashboardRisk.value || !Object.keys(dashboardRisk.value.risk_levels || {}).length ? (openBlock(), createElementBlock("p", _hoisted_28, "暂无已完成风险结果")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_29, [
                _cache[45] || (_cache[45] = createBaseVNode("h3", null, "事件状态", -1)),
                ...
                !dashboardEvents.value || !Object.keys(dashboardEvents.value.formal_events || {}).length ? (openBlock(), createElementBlock("p", _hoisted_30, "暂无外网事件")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_31, [
                _cache[48] || (_cache[48] = createBaseVNode("h3", null, "采集状态", -1)),
                dashboardSummary.value.collection.latest ? (openBlock(), createElementBlock("div", _hoisted_32, [
                  _cache[46] || (_cache[46] = createBaseVNode("span", null, "最近一次", -1)),
                  createBaseVNode("strong", null, toDisplayString(zh(dashboardSummary.value.collection.latest.status)), 1)
                ])) : createCommentVNode("", true),
                createBaseVNode("div", _hoisted_33, [
                  _cache[47] || (_cache[47] = createBaseVNode("span", null, "成功 / 失败", -1)),
                ...
                !dashboardSummary.value.collection.latest ? (openBlock(), createElementBlock("p", _hoisted_34, "暂无外网采集记录")) : createCommentVNode("", true)
              ]),
                  ...
                  createBaseVNode("table", null, [
                    _cache[49] || (_cache[49] = createBaseVNode("thead", null, [
                      createBaseVNode("tr", null, [
                        ...
                        createBaseVNode("th", null, "文章"),
                        createBaseVNode("th", null, "风险完成"),
                        createBaseVNode("th", null, "风险失败"),
                        createBaseVNode("th", null, "事件"),
                        createBaseVNode("th", null, "告警")
                      ])
                    ], -1)),
              ...
              createBaseVNode("article", _hoisted_37, [
                _cache[51] || (_cache[51] = createBaseVNode("h3", null, "外网热词", -1)),
                ...
                ])) : (openBlock(), createElementBlock("p", _hoisted_40, "该窗口内暂无外网热词"))
              ])
            ]),
            createBaseVNode("div", _hoisted_41, "数据范围：" + toDisplayString(formatTime(dashboardSummary.value.window_start)) + " - " + toDisplayString(formatTime(dashboardSummary.value.window_end)) + " · 更新于：" + toDisplayString(formatTime(dashboardSummary.value.data_as_of)), 1)
          ])) : (openBlock(), createElementBlock("div", _hoisted_42, "加载外网看板中..."))
        ])) : createCommentVNode("", true),
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_43, [
          createBaseVNode("div", _hoisted_44, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-4e7bd44f>全部语言</option><option value="zh" data-v-4e7bd44f>中文</option><option value="en" data-v-4e7bd44f>英文</option><option value="mixed" data-v-4e7bd44f>中英混合</option><option value="unknown" data-v-4e7bd44f>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-4e7bd44f>全部风险等级</option><option value="high" data-v-4e7bd44f>高</option><option value="medium" data-v-4e7bd44f>中</option><option value="low" data-v-4e7bd44f>低</option><option value="unknown" data-v-4e7bd44f>未知</option>', 5)
            ])], 544), [
            ...
            _cache[56] || (_cache[56] = createBaseVNode("span", { class: "muted" }, "以舆情为主，右侧为已关联的风险研判（未分析显示 -）", -1))
          ]),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_48, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", null, [
                      ...
                      !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_49, "无")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_50, [
                      ...
                      }, "重新分析", 8, _hoisted_51)) : createCommentVNode("", true)
                    ])
                  ], 8, _hoisted_47);
                }), 128)),
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_52, [..._cache[57] || (_cache[57] = [
                  createBaseVNode("td", {
                    colspan: "14",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          opinionTotal.value > opinionSize ? (openBlock(), createElementBlock("div", _hoisted_53, [
            createBaseVNode("button", {
              class: "btn btn-secondary",
        ...
        ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_56, [
          createBaseVNode("div", _hoisted_57, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
          createBaseVNode("div", _hoisted_58, [
            ...
            }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_59),
            _cache[59] || (_cache[59] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
          ]),
          eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_60, [
          ...
          eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_61, [
            _cache[61] || (_cache[61] = createBaseVNode("strong", null, "外网事件运行失败", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(eventRunFailures.value, (run) => {
              return openBlock(), createElementBlock("div", {
                key: run.id,
                class: "event-failure-row"
              }, [
                _cache[60] || (_cache[60] = createBaseVNode("span", { class: "status failed" }, "失败", -1)),
          ...
          createBaseVNode("div", _hoisted_62, [
            createBaseVNode("button", {
              ...
              onClick: _cache[11] || (_cache[11] = ($event) => eventSection.value = "candidates")
            }, "事件候选", 2),
            createBaseVNode("button", {
              class: normalizeClass(["tab", { active: eventSection.value === "confirmed" }]),
              onClick: _cache[12] || (_cache[12] = ($event) => eventSection.value = "confirmed")
            }, "外网事件", 2)
          ]),
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_63, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_64, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", _hoisted_65, [
                      ...
                      }, "确认", 8, _hoisted_66)) : createCommentVNode("", true),
                      row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn danger",
                        disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                        onClick: ($event) => rejectCandidate(row)
                      }, "拒绝", 8, _hoisted_67)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_68, [..._cache[62] || (_cache[62] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignEvents.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_71, toDisplayString(row.title || "无标题"), 1),
                    createBaseVNode("td", null, toDisplayString(zh(row.language)), 1),
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_74, [..._cache[64] || (_cache[64] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
          ...
          selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_75, [
            createBaseVNode("div", _hoisted_76, [
              _cache[67] || (_cache[67] = createBaseVNode("strong", null, "事件溯源", -1)),
              ...
              selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_77, [
                _cache[66] || (_cache[66] = createBaseVNode("summary", null, "聚合证据", -1)),
            ...
            createBaseVNode("div", _hoisted_78, [
              ...
              createBaseVNode("div", _hoisted_79, [
                createBaseVNode("button", {
                  ...
                  onClick: _cache[13] || (_cache[13] = ($event) => closeEvent(selectedForeignEvent.value))
                }, "关闭事件", 8, _hoisted_80),
                createBaseVNode("button", {
                  class: "link-btn",
                  disabled: !unref(canMergeEvents) || eventActionKey.value,
                  onClick: _cache[14] || (_cache[14] = ($event) => mergeEvent(selectedForeignEvent.value))
                }, "合并", 8, _hoisted_81),
                createBaseVNode("button", {
                  class: "link-btn",
                  disabled: !unref(canSplitEvents) || eventActionKey.value,
                  onClick: _cache[15] || (_cache[15] = ($event) => splitEvent(selectedForeignEvent.value))
                }, "拆分", 8, _hoisted_82),
                createBaseVNode("button", {
                  class: "link-btn",
                  onClick: _cache[16] || (_cache[16] = ($event) => selectedForeignEvent.value = null)
                }, "关闭详情")
              ])
            ]),
            createBaseVNode("p", _hoisted_83, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_85, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                createBaseVNode("a", {
                  href: opinion.url,
                  target: "_blank",
                  rel: "noreferrer",
        ...
        ])) : activeTab.value === "alerts" ? (openBlock(), createElementBlock("section", _hoisted_87, [
          createBaseVNode("div", _hoisted_88, "外网自动告警评估：" + toDisplayString(alertAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(alertAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 外部通知：" + toDisplayString(alertAutoStatus.value?.external_notifications_enabled ? "已启用" : "已停用"), 1),
          createBaseVNode("div", _hoisted_89, [
            ...
            }, toDisplayString(alertEvaluating.value ? "评估中..." : "手动 Dry-Run"), 9, _hoisted_90),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => alertFilters.status = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[68] || (_cache[68] = [
              createStaticVNode('<option value="" data-v-4e7bd44f>全部状态</option><option value="triggered" data-v-4e7bd44f>待处理</option><option value="acknowledged" data-v-4e7bd44f>已确认</option><option value="resolved" data-v-4e7bd44f>已解决</option><option value="suppressed" data-v-4e7bd44f>已抑制</option><option value="failed" data-v-4e7bd44f>失败</option>', 6)
            ])], 544), [
              [vModelSelect, alertFilters.status]
            ]),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => alertFilters.severity = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[69] || (_cache[69] = [
              createStaticVNode('<option value="" data-v-4e7bd44f>全部严重度</option><option value="low" data-v-4e7bd44f>低</option><option value="medium" data-v-4e7bd44f>中</option><option value="high" data-v-4e7bd44f>高</option><option value="critical" data-v-4e7bd44f>紧急</option>', 5)
            ])], 544), [
              [vModelSelect, alertFilters.severity]
            ]),
            _cache[70] || (_cache[70] = createBaseVNode("span", { class: "muted" }, "告警评估默认关闭 · 外部通知默认关闭 · 当前仅保存站内记录", -1))
          ]),
          _cache[75] || (_cache[75] = createBaseVNode("div", { class: "alert-scope-note" }, " 外网告警只读取外网风险和已确认外网事件；不会进入国内告警、Dashboard、地图、热词或事件链路。 ", -1)),
          alertLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_91, [
          ...
          alertRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_92, [
            _cache[72] || (_cache[72] = createBaseVNode("strong", null, "外网告警评估失败", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(alertRunFailures.value, (run) => {
              return openBlock(), createElementBlock("div", {
                key: run.id,
                class: "alert-failure-row"
              }, [
                _cache[71] || (_cache[71] = createBaseVNode("span", { class: "status failed" }, "失败", -1)),
                createBaseVNode("span", null, toDisplayString(formatTime(run.finished_at || run.started_at)), 1),
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignAlerts.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_94, [
                      ...
                      }, toDisplayString(row.title || "无标题告警"), 9, _hoisted_95),
                      createBaseVNode("div", _hoisted_96, toDisplayString(row.message), 1)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_97, [
                      ...
                      }, "解决", 8, _hoisted_100)) : createCommentVNode("", true),
                      row.status === "triggered" || row.status === "acknowledged" ? (openBlock(), createElementBlock("button", {
                        key: 2,
                        class: "link-btn danger",
                      ...
                      }, "抑制", 8, _hoisted_101)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !foreignAlerts.value.length ? (openBlock(), createElementBlock("tr", _hoisted_102, [..._cache[73] || (_cache[73] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无外网告警记录", -1)
        ...
        ])) : activeTab.value === "alertRules" ? (openBlock(), createElementBlock("section", _hoisted_103, [
          createBaseVNode("div", { class: "toolbar" }, [
            ...
            _cache[76] || (_cache[76] = createBaseVNode("span", { class: "muted" }, "外网规则独立管理；新规则保存后默认停用。", -1))
          ]),
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(alertRules.value, (rule) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_105, [
                      ...
                      }, "停用", 8, _hoisted_107)) : (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn",
                      ...
                      }, "删除", 8, _hoisted_109)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !alertRules.value.length ? (openBlock(), createElementBlock("tr", _hoisted_110, [..._cache[77] || (_cache[77] = [
                  createBaseVNode("td", {
                    colspan: "7",
                    class: "empty"
                  }, "暂无外网告警规则", -1)
        ...
        selectedForeignAlert.value ? (openBlock(), createElementBlock("div", {
          key: 5,
          class: "detail-mask",
          onClick: _cache[20] || (_cache[20] = withModifiers(($event) => selectedForeignAlert.value = null, ["self"]))
        }, [
          createBaseVNode("article", _hoisted_111, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭详情",
              onClick: _cache[19] || (_cache[19] = ($event) => selectedForeignAlert.value = null)
            }, "×"),
            createBaseVNode("h3", null, toDisplayString(selectedForeignAlert.value.title || "外网告警详情"), 1),
            createBaseVNode("div", _hoisted_112, "来源：" + toDisplayString(selectedForeignAlert.value.opinion?.source_name_snapshot || selectedForeignAlert.value.event?.opinions?.[0]?.source_name_snapshot || "-") + " · 发布时间：" + toDisplayString(formatTime(selectedForeignAlert.value.opinion?.published_at || selectedForeignAlert.value.event?.last_seen_at)) + " · 当前状态：" + toDisplayString(zh(selectedForeignAlert.value.status)), 1),
            createBaseVNode("p", _hoisted_113, toDisplayString(selectedForeignAlert.value.opinion?.summary || selectedForeignAlert.value.event?.summary || selectedForeignAlert.value.message || "暂无摘要"), 1),
            createBaseVNode("div", {
              class: "detail-text",
              innerHTML: selectedForeignAlert.value.opinion?.content || ""
            }, null, 8, _hoisted_114),
            selectedForeignAlert.value.event?.opinions?.length ? (openBlock(), createElementBlock("div", _hoisted_115, [
            ...
            createBaseVNode("section", _hoisted_118, [
              _cache[79] || (_cache[79] = createBaseVNode("h4", null, "规则研判", -1)),
              createBaseVNode("p", null, toDisplayString(selectedForeignAlert.value.opinion?.rule_result?.explanation || "暂无规则研判结果"), 1),
              selectedForeignAlert.value.opinion?.rule_result ? (openBlock(), createElementBlock("div", _hoisted_119, [
                createBaseVNode("span", null, "分数 " + toDisplayString(selectedForeignAlert.value.opinion.rule_result.risk_score ?? "-"), 1),
                createBaseVNode("span", null, "等级 " + toDisplayString(zh(selectedForeignAlert.value.opinion.rule_result.risk_level)), 1),
            ...
            createBaseVNode("section", _hoisted_120, [
              _cache[80] || (_cache[80] = createBaseVNode("h4", null, "AI 研判", -1)),
              createBaseVNode("p", null, toDisplayString(selectedForeignAlert.value.opinion?.ai_result?.summary || "暂无 AI 研判结果"), 1),
              selectedForeignAlert.value.opinion?.ai_result ? (openBlock(), createElementBlock("div", _hoisted_121, [
                createBaseVNode("span", null, "状态 " + toDisplayString(zh(selectedForeignAlert.value.opinion.ai_result.status)), 1),
            ...
            createBaseVNode("section", _hoisted_122, [
              _cache[81] || (_cache[81] = createBaseVNode("h4", null, "告警规则与评估来源", -1)),
              createBaseVNode("p", null, toDisplayString(selectedForeignAlert.value.rule?.name || selectedForeignAlert.value.rule_snapshot?.name || "规则 #" + (selectedForeignAlert.value.rule_id ?? "-")) + " · " + toDisplayString(zh(selectedForeignAlert.value.evaluation_source || "rule")), 1),
              createBaseVNode("p", _hoisted_123, "告警 #" + toDisplayString(selectedForeignAlert.value.id) + " · 触发 " + toDisplayString(formatTime(selectedForeignAlert.value.triggered_at)), 1)
            ]),
            createBaseVNode("section", _hoisted_124, [
              _cache[82] || (_cache[82] = createBaseVNode("h4", null, "处置历史", -1)),
              selectedForeignAlert.value.actions?.length ? (openBlock(), createElementBlock("div", _hoisted_125, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignAlert.value.actions, (action) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("span", _hoisted_126, "操作人 #" + toDisplayString(action.actor_id ?? "-") + " · " + toDisplayString(formatTime(action.created_at)), 1)
                  ]);
                }), 128))
              ])) : (openBlock(), createElementBlock("p", _hoisted_127, "暂无处置历史"))
            ]),
            selectedForeignAlert.value.opinion?.url ? (openBlock(), createElementBlock("a", {
              ...
              rel: "noreferrer",
              class: "original"
            }, "打开原文", 8, _hoisted_128)) : createCommentVNode("", true)
          ])
        ])) : createCommentVNode("", true),
        historyAlert.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_129, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭处置历史",
              onClick: _cache[21] || (_cache[21] = ($event) => historyAlert.value = null)
            }, "×"),
            _cache[83] || (_cache[83] = createBaseVNode("h3", null, "外网告警处置历史", -1)),
            createBaseVNode("p", _hoisted_130, toDisplayString(historyAlert.value.title || "告警 #" + historyAlert.value.id) + " · 当前状态：" + toDisplayString(zh(historyAlert.value.status)), 1),
            alertActionsLoading.value ? (openBlock(), createElementBlock("div", _hoisted_131, "处置历史加载中...")) : !alertActions.value.length ? (openBlock(), createElementBlock("div", _hoisted_132, "暂无处置历史")) : (openBlock(), createElementBlock("div", _hoisted_133, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(alertActions.value, (action) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", null, toDisplayString(zh(action.previous_status)) + " → " + toDisplayString(zh(action.new_status)), 1),
                  createBaseVNode("span", null, toDisplayString(action.note), 1),
                  createBaseVNode("span", _hoisted_134, "操作人 #" + toDisplayString(action.actor_id ?? "-") + " · " + toDisplayString(formatTime(action.created_at)), 1)
                ]);
              }), 128))
            ]))
          ])
        ...
        alertRuleEditorVisible.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_135, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭规则编辑",
            ...
            createBaseVNode("label", null, [
              _cache[84] || (_cache[84] = createTextVNode("规则名称", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[86] || (_cache[86] = createTextVNode("规则类型", -1)),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => alertRuleDraft.rule_type = $event),
                class: "input"
              }, [..._cache[85] || (_cache[85] = [
                createStaticVNode('<option value="risk_score" data-v-4e7bd44f>风险分</option><option value="risk_level" data-v-4e7bd44f>风险等级</option><option value="risk_category" data-v-4e7bd44f>风险类别</option><option value="confirmed_event" data-v-4e7bd44f>确认事件</option><option value="keyword_combo" data-v-4e7bd44f>关键词组合</option>', 5)
              ])], 512), [
                [vModelSelect, alertRuleDraft.rule_type]
              ])
            ]),
            createBaseVNode("label", null, [
              _cache[87] || (_cache[87] = createTextVNode("风险阈值或条件", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[89] || (_cache[89] = createTextVNode("严重等级", -1)),
              withDirectives(createBaseVNode("select", {
            ...
            createBaseVNode("label", null, [
              _cache[90] || (_cache[90] = createTextVNode("冷却时间", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[91] || (_cache[91] = createTextVNode("规则说明", -1)),
            ...
            createBaseVNode("label", _hoisted_136, [
              ...
              _cache[92] || (_cache[92] = createTextVNode(" 编辑时启用状态（新规则默认停用，启用仍需外网启用权限）", -1))
            ]),
            createBaseVNode("div", _hoisted_138, [
              _cache[93] || (_cache[93] = createBaseVNode("strong", null, "规则预览", -1)),
            ...
            createBaseVNode("div", _hoisted_139, [
              ...
              }, toDisplayString(alertRuleSaving.value ? "保存中..." : "保存规则"), 9, _hoisted_140)
            ])
          ])
        ])) : createCommentVNode("", true),
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4e7bd44f"]]);
