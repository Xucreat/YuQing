import { d as defineComponent, a0 as useAlertNotifier, z as usePermission, A as watch, C as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, m as createVNode, p as withCtx, r as ref, y as resolveComponent, B as resolveDirective, L as useRoute, g as api, E as ElMessage, X as isPermissionDenied, o as openBlock, e as createTextVNode, q as createBlock, s as createCommentVNode, t as toDisplayString, H as unref, a1 as riskTag, a2 as riskText, R as _sfc_main$1, b as withKeys, j as computed, f as reactive, Q as ElMessageBox, h as useRouter, _ as _export_sfc } from './index-yZr-pUsf.js';
...
const _hoisted_8 = { class: "inline-switch" };
...
const _hoisted_18 = { class: "scope-bar" };
const _hoisted_19 = {
  key: 0,
  class: "scope-hint"
};
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const domesticForm = reactive({ name: "", description: "", rule_type: "risk_score", risk_threshold: 70, keywords: "", sources: "", risk_level: "high", enabled: true });
    ...
    const foreignOpinionDetailVisible = ref(false);
    const foreignOpinionDetailId = ref(null);
    const foreignHandleDialogVisible = ref(false);
    const foreignHandling = ref(false);
    const foreignHandlingId = ref(null);
    const foreignHandleForm = reactive({ disposition_status: "pending", note: "" });
    ...
    function openForeignOpinion(id) {
      foreignOpinionDetailId.value = id;
      foreignOpinionDetailVisible.value = true;
    }
    ...
    function goForeignReview() {
      router.push({ path: "/foreign", query: { tab: "opinions", section: "ai-review" } });
    }
    function openDomesticRule(row) {
      domesticEditing.value = !!row;
      domesticId.value = row?.id || null;
      Object.assign(domesticForm, row ? { name: row.name, description: row.description, rule_type: row.rule_type || "risk_score", risk_threshold: row.risk_threshold, keywords: row.keywords, sources: row.sources, risk_level: row.risk_level, enabled: row.enabled } : { name: "", description: "", rule_type: "risk_score", risk_threshold: 70, keywords: "", sources: "", risk_level: "high", enabled: true });
    ...
    function openForeignHandleDialog(row) {
      foreignHandlingId.value = row.id;
      foreignHandleForm.disposition_status = row.disposition_status || "pending";
      foreignHandleForm.note = row.disposition_note || "";
      foreignHandleDialogVisible.value = true;
    }
    async function submitForeignHandle() {
      if (foreignHandlingId.value == null) return;
      foreignHandling.value = true;
      try {
        const { data } = await api.put(`/foreign/alerts/${foreignHandlingId.value}/handle`, { disposition_status: foreignHandleForm.disposition_status, note: foreignHandleForm.note });
        const idx = foreignAlerts.value.findIndex((item) => item.id === foreignHandlingId.value);
        if (idx >= 0) {
          if (foreignHandleForm.disposition_status === "false_positive" && hideForeignFalsePositive.value) foreignAlerts.value.splice(idx, 1);
          else foreignAlerts.value[idx] = data;
        }
        foreignHandleDialogVisible.value = false;
        ElMessage.success("外网预警处置完成");
      } catch (e) {
        if (!isPermissionDenied(e)) ElMessage.error(e?.response?.data?.detail || "外网预警处置失败");
      } finally {
        foreignHandling.value = false;
      }
    }
    ...
    function normalizeRoute() {
      ...
      activeTab.value = tab === "records" ? "records" : "rules";
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
                    ...
                    createVNode(_component_el_table, {
                      ...
                      default: withCtx(() => [
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            createTextVNode(toDisplayString(row.rule_type === "ai_risk_score" ? "AI 风险分" : "规则风险分"), 1)
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                ...
                scope.value === "domestic" ? (openBlock(), createBlock(_component_el_card, {
                  ...
                  default: withCtx(() => [
                    ...
                    createBaseVNode("span", _hoisted_7, [
                      ...
                      _cache[55] || (_cache[55] = createTextVNode("隐藏误报", -1))
                    ]),
                  ...
                  default: withCtx(() => [
                    createBaseVNode("span", _hoisted_8, [
                      createVNode(_component_el_switch, {
                        ...
                        "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => hideForeignFalsePositive.value = $event),
                        onChange: loadForeignRecords
                      }, null, 8, ["modelValue"]),
                      _cache[56] || (_cache[56] = createTextVNode("隐藏误报", -1))
                    ]),
                    createVNode(_component_el_select, {
                    ...
                    createVNode(_component_el_table, {
                      ...
                      default: withCtx(() => [
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            createVNode(_component_el_tag, {
                              type: unref(riskTag)(row.formal_risk_level || row.risk_level),
                              size: "small"
                            }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(row.formal_risk_score ?? "-") + " 分 · " + toDisplayString(unref(riskText)(row.formal_risk_level || row.risk_level)), 1)
                              ]),
                              _: 2
                            }, 1032, ["type"])
                          ]),
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            row.linked_opinion_current_risk ? (openBlock(), createElementBlock("span", _hoisted_9, toDisplayString(row.linked_opinion_current_risk.risk_score ?? "-") + " 分 · " + toDisplayString(unref(riskText)(row.linked_opinion_current_risk.risk_level)), 1)) : (openBlock(), createElementBlock("span", _hoisted_10, "-"))
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            ...
                            }, toDisplayString(row.opinion_title), 9, _hoisted_11)) : (openBlock(), createElementBlock("span", _hoisted_12, toDisplayString(row.opinion_title || "-"), 1))
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            createTextVNode(toDisplayString(row.handle_note || "-"), 1)
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                    ...
                    createVNode(_component_el_table, {
                      ...
                      default: withCtx(() => [
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            createTextVNode(toDisplayString(row.rule_snapshot?.name || "外网预警规则"), 1)
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            createVNode(_component_el_tag, {
                              ...
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(row.formal_risk_score ?? row.risk_score ?? "-") + " 分 · " + toDisplayString(unref(riskText)(row.formal_risk_level || row.risk_level)), 1)
                              ]),
                              _: 2
                            }, 1032, ["type"])
                          ]),
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            row.linked_opinion_current_risk ? (openBlock(), createElementBlock("span", _hoisted_14, toDisplayString(row.linked_opinion_current_risk.risk_score ?? "-") + " 分 · " + toDisplayString(unref(riskText)(row.linked_opinion_current_risk.risk_level)), 1)) : (openBlock(), createElementBlock("span", _hoisted_15, "-"))
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            row.foreign_opinion_id ? (openBlock(), createElementBlock("span", {
                              key: 0,
                              class: "nav-link",
                              onClick: ($event) => openForeignOpinion(row.foreign_opinion_id)
                            }, toDisplayString(row.opinion_title_snapshot || row.title || "-"), 9, _hoisted_16)) : (openBlock(), createElementBlock("span", _hoisted_17, toDisplayString(row.opinion_title_snapshot || row.title || "-"), 1))
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            createTextVNode(toDisplayString(row.message || row.matched_conditions?.reason || row.title || "-"), 1)
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            createVNode(_component_el_tag, {
                              type: statusTag(row.disposition_status),
                              size: "small"
                            }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(statusText(row.disposition_status)), 1)
                              ]),
                              _: 2
                            }, 1032, ["type"])
                          ]),
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            createTextVNode(toDisplayString(row.disposition_note || "-"), 1)
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                ...
                createVNode(_component_el_card, {
                  ...
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_18, [
                      _cache[60] || (_cache[60] = createBaseVNode("span", { class: "muted" }, "外网人工复核已在统一的「外网舆情工作台」中处理；采用 AI 后进入关联舆情当前风险，正式预警风险保持记录快照。", -1)),
                      createVNode(_component_el_button, {
                        type: "primary",
                        onClick: goForeignReview
                      }, {
                        default: withCtx(() => [..._cache[59] || (_cache[59] = [
                          createTextVNode("前往外网人工复核中心", -1)
                        ])]),
                        _: 1
                      })
                    ])
        ...
        createVNode(_component_el_dialog, {
          ...
          "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => domesticRuleDialog.value = $event),
          title: domesticEditing.value ? "编辑规则" : "新增规则",
          width: "min(600px, calc(100vw - 24px))"
        }, {
          footer: withCtx(() => [
            createVNode(_component_el_button, {
              onClick: _cache[22] || (_cache[22] = ($event) => domesticRuleDialog.value = false)
            }, {
          ...
          default: withCtx(() => [
            createVNode(_component_el_form, {
              ...
              default: withCtx(() => [
                createVNode(_component_el_form_item, { label: "规则名称" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => domesticForm.name = $event)
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
                }),
                createVNode(_component_el_form_item, { label: "规则类型" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => domesticForm.rule_type = $event)
                    }, {
                      default: withCtx(() => [
                        createVNode(_component_el_option, {
                          label: "规则风险分",
                ...
                domesticForm.rule_type === "ai_risk_score" ? (openBlock(), createElementBlock("p", _hoisted_19, "AI 风险分规则只生成待人工复核候选，普通预警评估不会直接创建正式预警。")) : createCommentVNode("", true),
                createVNode(_component_el_form_item, { label: "描述" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      modelValue: domesticForm.description,
                      "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => domesticForm.description = $event),
                      type: "textarea"
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
                ...
                createVNode(_component_el_form_item, { label: "风险阈值" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input_number, {
                      ...
                      "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => domesticForm.risk_threshold = $event),
                      min: 0,
                      max: 100
                    }, null, 8, ["modelValue"])
                  ]),
                ...
                createVNode(_component_el_form_item, { label: "关键词匹配" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => domesticForm.keywords = $event)
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
                }),
                createVNode(_component_el_form_item, { label: "来源过滤" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => domesticForm.sources = $event)
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
                }),
                createVNode(_component_el_form_item, { label: "建议等级" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => domesticForm.risk_level = $event)
                    }, {
                      default: withCtx(() => [
                        createVNode(_component_el_option, {
                          label: "严重",
                ...
                createVNode(_component_el_form_item, { label: "启用" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_switch, {
                      ...
                      "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => domesticForm.enabled = $event)
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
                })
        ...
        createVNode(_component_el_dialog, {
          ...
          "onUpdate:modelValue": _cache[31] || (_cache[31] = ($event) => foreignRuleDialog.value = $event),
          title: foreignEditing.value ? "编辑外网告警规则" : "新增外网告警规则",
          width: "min(620px, calc(100vw - 24px))"
        }, {
          footer: withCtx(() => [
            createVNode(_component_el_button, {
              onClick: _cache[30] || (_cache[30] = ($event) => foreignRuleDialog.value = false)
            }, {
          ...
          default: withCtx(() => [
            createVNode(_component_el_form, {
              ...
              default: withCtx(() => [
                createVNode(_component_el_form_item, { label: "规则名称" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => foreignForm.name = $event)
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
                }),
                createVNode(_component_el_form_item, { label: "规则类型" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => foreignForm.rule_type = $event)
                    }, {
                      default: withCtx(() => [
                        createVNode(_component_el_option, {
                          value: "risk_score",
                ...
                foreignForm.rule_type === "ai_risk_score" ? (openBlock(), createElementBlock("p", _hoisted_20, "AI 风险分规则：当某条外网舆情的 AI 研判风险分 ≥ 条件中的 threshold 时，会在「外网人工复核」中生成待确认预警候选，需人工确认后才会进入正式外网预警。")) : createCommentVNode("", true),
                createVNode(_component_el_form_item, { label: "条件 JSON" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      modelValue: foreignForm.conditionsText,
                      "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => foreignForm.conditionsText = $event),
                      type: "textarea",
                      rows: 3
                    }, null, 8, ["modelValue"])
                  ]),
                ...
                createVNode(_component_el_form_item, { label: "严重度" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[27] || (_cache[27] = ($event) => foreignForm.severity = $event)
                    }, {
                      default: withCtx(() => [
                        createVNode(_component_el_option, {
                          value: "low",
                ...
                createVNode(_component_el_form_item, { label: "冷却时间" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input_number, {
                      ...
                      "onUpdate:modelValue": _cache[28] || (_cache[28] = ($event) => foreignForm.cooldown_seconds = $event),
                      min: 0
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
                ...
                createVNode(_component_el_form_item, { label: "说明" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[29] || (_cache[29] = ($event) => foreignForm.description = $event),
                      type: "textarea"
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
        ...
        createVNode(_component_el_dialog, {
          ...
          "onUpdate:modelValue": _cache[35] || (_cache[35] = ($event) => foreignHandleDialogVisible.value = $event),
          title: "外网预警处置",
          width: "min(480px, calc(100vw - 24px))"
        }, {
          footer: withCtx(() => [
            createVNode(_component_el_button, {
              onClick: _cache[34] || (_cache[34] = ($event) => foreignHandleDialogVisible.value = false)
            }, {
                ...
                createVNode(_component_el_form_item, { label: "处置状态" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[32] || (_cache[32] = ($event) => foreignHandleForm.disposition_status = $event)
                    }, {
                      default: withCtx(() => [
                        createVNode(_component_el_option, {
                          label: "待处理",
                ...
                createVNode(_component_el_form_item, { label: "处置备注" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[33] || (_cache[33] = ($event) => foreignHandleForm.note = $event),
                      type: "textarea"
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
        ...
        createVNode(_component_el_dialog, {
          ...
          "onUpdate:modelValue": _cache[39] || (_cache[39] = ($event) => handleDialogVisible.value = $event),
          title: "预警处置",
          width: "min(480px, calc(100vw - 24px))"
        }, {
          footer: withCtx(() => [
            createVNode(_component_el_button, {
              onClick: _cache[38] || (_cache[38] = ($event) => handleDialogVisible.value = false)
            }, {
                ...
                createVNode(_component_el_form_item, { label: "处置状态" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[36] || (_cache[36] = ($event) => handleForm.status = $event)
                    }, {
                      default: withCtx(() => [
                        createVNode(_component_el_option, {
                          label: "待处理",
                ...
                createVNode(_component_el_form_item, { label: "处置备注" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[37] || (_cache[37] = ($event) => handleForm.note = $event),
                      type: "textarea"
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
        ...
        createVNode(OpinionDetailModal, {
          ...
          "onUpdate:modelValue": _cache[40] || (_cache[40] = ($event) => detailVisible.value = $event),
        ...
        createVNode(ForeignOpinionDetailModal, {
          ...
          "onUpdate:modelValue": _cache[41] || (_cache[41] = ($event) => foreignOpinionDetailVisible.value = $event),
...
const Alerts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1f4b83f2"]]);
