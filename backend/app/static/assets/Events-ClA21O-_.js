...
import { d as defineComponent, p as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, n as normalizeClass, b as withKeys, v as vModelText, B as createVNode, z as withCtx, T as Transition, A as createCommentVNode, e as createTextVNode, t as toDisplayString, F as Fragment, i as renderList, G as vModelSelect, x as unref, N as createStaticVNode, r as ref, j as computed, g as api, E as ElMessage, O as pollTask, D as resolveDirective, o as openBlock, J as withModifiers, k as normalizeStyle, P as __vitePreload, _ as _export_sfc } from './index-CVZOEFzU.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      try {
        const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-CVZOEFzU.js').then(n => n.Z);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
