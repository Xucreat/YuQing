...
const _hoisted_74 = { class: "ai-batch-status-head" };
const _hoisted_75 = { class: "ai-batch-count" };
const _hoisted_76 = { class: "ai-batch-step" };
const _hoisted_77 = ["aria-valuenow"];
const _hoisted_78 = { class: "ai-batch-status-meta" };
const _hoisted_79 = {
  key: 0,
  class: "muted"
};
...
const _hoisted_81 = { class: "table-wrap tbl-scroll" };
const _hoisted_82 = ["onClick"];
const _hoisted_83 = { class: "title-cell" };
const _hoisted_84 = { class: "dual-cell" };
const _hoisted_85 = { class: "muted" };
const _hoisted_86 = {
  key: 0,
  class: "muted"
};
const _hoisted_87 = { class: "actions" };
...
const _hoisted_92 = { class: "alert-scope-note" };
...
const _hoisted_97 = { class: "subtabs" };
const _hoisted_98 = {
  key: 2,
  class: "table-wrap"
};
const _hoisted_99 = { class: "title-cell" };
const _hoisted_100 = { class: "actions" };
...
const _hoisted_106 = { class: "title-cell" };
...
const _hoisted_111 = { class: "event-provenance" };
const _hoisted_112 = { key: 0 };
const _hoisted_113 = { class: "event-detail-head" };
const _hoisted_114 = { class: "actions" };
const _hoisted_115 = ["disabled"];
const _hoisted_116 = ["disabled"];
const _hoisted_117 = ["disabled"];
const _hoisted_118 = { class: "muted" };
const _hoisted_119 = { class: "event-metrics" };
const _hoisted_120 = { class: "muted" };
const _hoisted_121 = ["href"];
const _hoisted_122 = { class: "ai-batch-options" };
const _hoisted_123 = { key: 0 };
const _hoisted_124 = { class: "check-row" };
const _hoisted_125 = { class: "check-row" };
const _hoisted_126 = { class: "check-row" };
const _hoisted_127 = {
  key: 2,
  class: "warning-text"
};
...
const _hoisted_132 = { class: "review-toolbar" };
...
const _hoisted_139 = ["checked"];
const _hoisted_140 = ["value"];
const _hoisted_141 = { class: "review-title-cell" };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
          ...
          activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_67, [
            createBaseVNode("div", _hoisted_68, [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="" data-v-b0d38979>全部语言</option><option value="zh" data-v-b0d38979>中文</option><option value="en" data-v-b0d38979>英文</option><option value="mixed" data-v-b0d38979>中英混合</option><option value="unknown" data-v-b0d38979>未知</option>', 5)
              ])], 544), [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="" data-v-b0d38979>全部风险等级</option><option value="high" data-v-b0d38979>高</option><option value="medium" data-v-b0d38979>中</option><option value="low" data-v-b0d38979>低</option><option value="unknown" data-v-b0d38979>未知</option>', 5)
              ])], 544), [
            ...
            aiBatchRun.value && !isAIBatchFinished.value ? (openBlock(), createElementBlock("div", _hoisted_73, [
              createBaseVNode("div", _hoisted_74, [
                createBaseVNode("strong", null, "AI 批量研判 " + toDisplayString(zh(aiBatchRun.value.status)), 1),
                createBaseVNode("span", _hoisted_75, toDisplayString(aiBatchRun.value.processed_count || 0) + " / " + toDisplayString(aiBatchRun.value.total_count || 0), 1),
                createBaseVNode("span", _hoisted_76, toDisplayString(aiBatchRun.value.step || "正在准备任务"), 1),
              ...
              createBaseVNode("div", _hoisted_78, [
                ...
                aiBatchRun.value.started_at ? (openBlock(), createElementBlock("span", _hoisted_79, "开始：" + toDisplayString(formatTime(aiBatchRun.value.started_at)), 1)) : createCommentVNode("", true)
              ]),
              (aiBatchRun.value.failures || []).length ? (openBlock(), createElementBlock("p", _hoisted_80, "失败 " + toDisplayString(aiBatchRun.value.failures.length) + " 条：" + toDisplayString((aiBatchRun.value.failures || []).map((item) => item.error || item.message || item.code || "未知错误").slice(0, 2).join("；")), 1)) : createCommentVNode("", true)
            ])) : createCommentVNode("", true),
                ...
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_83, toDisplayString(row.title || "无标题"), 1),
                      ...
                      createBaseVNode("td", _hoisted_84, [
                        ...
                        createBaseVNode("span", _hoisted_85, toDisplayString(aiHistoryLabel(row)), 1)
                      ]),
                      ...
                      createBaseVNode("td", null, [
                        ...
                        !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_86, "无")) : createCommentVNode("", true)
                      ]),
                      createBaseVNode("td", null, [
                        createBaseVNode("span", {
                      ...
                      createBaseVNode("td", _hoisted_87, [
                        ...
                        }, toDisplayString(ruleOf(row) ? "重新分析" : "分析"), 9, _hoisted_88)
                      ])
                    ], 8, _hoisted_82);
                  }), 128)),
                  !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_89, [..._cache[64] || (_cache[64] = [
                    createBaseVNode("td", {
                      colspan: "16",
                      class: "empty"
                    }, "暂无外网舆情", -1)
            ...
            opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_90, [
          ...
          ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_91, [
            createBaseVNode("div", _hoisted_92, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
            createBaseVNode("div", _hoisted_93, [
              ...
              }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_94),
              _cache[66] || (_cache[66] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
            ]),
            eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_95, [
            ...
            eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_96, [
            ...
            createBaseVNode("div", _hoisted_97, [
              createBaseVNode("button", {
                ...
                onClick: _cache[15] || (_cache[15] = ($event) => eventSection.value = "candidates")
              }, "事件候选", 2),
              createBaseVNode("button", {
                class: normalizeClass(["tab", { active: eventSection.value === "confirmed" }]),
                onClick: _cache[16] || (_cache[16] = ($event) => eventSection.value = "confirmed")
              }, "外网事件", 2),
              createBaseVNode("button", {
            ...
            eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_98, [
              createBaseVNode("table", null, [
                ...
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_99, toDisplayString(row.title || "无标题"), 1),
                      ...
                      createBaseVNode("td", _hoisted_100, [
                        ...
                        }, "确认", 8, _hoisted_101)) : createCommentVNode("", true),
                        row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                          key: 1,
                          class: "link-btn danger",
                          disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                          onClick: ($event) => rejectCandidate(row)
                        }, "拒绝", 8, _hoisted_102)) : createCommentVNode("", true)
                      ])
                    ]);
                  }), 128)),
                  !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_103, [..._cache[69] || (_cache[69] = [
                    createBaseVNode("td", {
                      colspan: "8",
                      class: "empty"
                    }, "暂无外网事件候选", -1)
            ...
            ])) : eventSection.value === "confirmed" ? (openBlock(), createElementBlock("div", _hoisted_104, [
              createBaseVNode("table", null, [
                ...
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(foreignEvents.value, (row) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_106, toDisplayString(row.title || "无标题"), 1),
                      createBaseVNode("td", null, toDisplayString(zh(row.language)), 1),
                  ...
                  !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_109, [..._cache[71] || (_cache[71] = [
                    createBaseVNode("td", {
                      colspan: "12",
                      class: "empty"
                    }, "暂无已确认外网事件", -1)
            ...
            selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_110, [
              createBaseVNode("div", _hoisted_111, [
                ...
                selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_112, [
              ...
              createBaseVNode("p", _hoisted_118, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_120, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                  createBaseVNode("a", {
                    href: opinion.url,
                    target: "_blank",
                    rel: "noreferrer",
          ...
          createVNode(_component_el_dialog, {
            ...
            "onUpdate:modelValue": _cache[38] || (_cache[38] = ($event) => aiBatchDialog.value = $event),
            title: "批量 AI 研判",
            ...
            footer: withCtx(() => [
              createBaseVNode("button", {
                class: "btn btn-secondary",
                onClick: _cache[37] || (_cache[37] = ($event) => aiBatchDialog.value = false)
              }, "取消"),
              createBaseVNode("button", {
                class: "btn btn-primary",
            ...
            default: withCtx(() => [
              createBaseVNode("div", _hoisted_122, [
                createBaseVNode("label", null, [
                  ...
                  withDirectives(createBaseVNode("select", {
                    "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => aiBatchConfig.scope = $event),
                    class: "input",
                ...
                aiBatchConfig.scope === "count" ? (openBlock(), createElementBlock("label", _hoisted_123, [
                  _cache[77] || (_cache[77] = createTextVNode("最近 N 条 ", -1)),
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => aiBatchConfig.recent_n = $event),
                    class: "input",
                    type: "number",
                    min: "1",
                    max: "100000",
                ...
                aiBatchConfig.scope === "time" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                  createBaseVNode("label", null, [
                    ...
                    withDirectives(createBaseVNode("input", {
                      "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => aiBatchConfig.date_from = $event),
                      class: "input",
                      type: "date",
                      onChange: refreshAIBatchPreview
                    }, null, 544), [
                  ...
                  createBaseVNode("label", null, [
                    ...
                    withDirectives(createBaseVNode("input", {
                      "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => aiBatchConfig.date_to = $event),
                      class: "input",
                      type: "date",
                      onChange: refreshAIBatchPreview
                    }, null, 544), [
                ...
                createBaseVNode("label", _hoisted_124, [
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[27] || (_cache[27] = ($event) => aiBatchConfig.use_current_filters = $event),
                    type: "checkbox",
                    onChange: refreshAIBatchPreview
                  }, null, 544), [
                ...
                createBaseVNode("label", _hoisted_125, [
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[28] || (_cache[28] = ($event) => aiBatchConfig.only_unanalyzed = $event),
                    type: "checkbox",
                    onChange: refreshAIBatchPreview
                  }, null, 544), [
                ...
                createBaseVNode("label", _hoisted_126, [
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[29] || (_cache[29] = ($event) => aiBatchConfig.force = $event),
                    type: "checkbox",
                    onChange: refreshAIBatchPreview
                  }, null, 544), [
                ...
                aiBatchConfig.scope === "full" ? (openBlock(), createElementBlock("p", _hoisted_127, "全量任务可能消耗大量 Token 并运行较长时间。AI 结果仍须人工复核后才会进入正式事件或预警。")) : createCommentVNode("", true)
              ]),
              aiBatchPreview.value ? (openBlock(), createElementBlock("div", _hoisted_128, [
                ...
                aiBatchPreview.value.preview_warning ? (openBlock(), createElementBlock("p", _hoisted_129, "⚠ " + toDisplayString(aiBatchPreview.value.preview_warning), 1)) : createCommentVNode("", true),
                aiBatchPreview.value.token_budget_exceeded ? (openBlock(), createElementBlock("p", _hoisted_130, "⚠ 预计 Token 超出预算，提交将被拦截，请缩小范围或调高预算。")) : createCommentVNode("", true)
              ])) : createCommentVNode("", true),
              eventSection.value === "ai-review" && canReadReviewSection.value ? (openBlock(), createElementBlock("div", _hoisted_131, [
                createBaseVNode("div", _hoisted_132, [
                  unref(canReviewAI) ? (openBlock(), createElementBlock("button", {
                    ...
                    onClick: _cache[30] || (_cache[30] = ($event) => batchDecideReviews("use_ai_display"))
                  }, "确认选中采用 AI 展示", 8, _hoisted_133)) : createCommentVNode("", true),
                  unref(canConfirmEventReview) ? (openBlock(), createElementBlock("button", {
                    key: 1,
                    class: "btn btn-primary",
                    disabled: !selectedReviewIds.value.length || reviewActionId.value,
                    onClick: _cache[31] || (_cache[31] = ($event) => batchDecideReviews("confirm_event_change"))
                  }, "确认选中事件影响", 8, _hoisted_134)) : createCommentVNode("", true),
                  unref(canConfirmAlertReview) ? (openBlock(), createElementBlock("button", {
                    key: 2,
                    class: "btn btn-primary",
                    disabled: !selectedReviewIds.value.length || reviewActionId.value,
                    onClick: _cache[32] || (_cache[32] = ($event) => batchDecideReviews("confirm_alert_change"))
                  }, "确认选中预警影响", 8, _hoisted_135)) : createCommentVNode("", true),
                  unref(canRejectAIReview) ? (openBlock(), createElementBlock("button", {
                    key: 3,
                    class: "btn btn-danger",
                    disabled: !selectedReviewIds.value.length || reviewActionId.value,
                    onClick: _cache[33] || (_cache[33] = ($event) => batchDecideReviews("reject_change"))
                  }, "驳回选中", 8, _hoisted_136)) : createCommentVNode("", true),
                  unref(canFullConfirmAI) && unref(canConfirmEventReview) ? (openBlock(), createElementBlock("button", {
                    ...
                    onClick: _cache[34] || (_cache[34] = ($event) => batchDecideReviews("confirm_event_change", true))
                  }, "全量确认事件", 8, _hoisted_137)) : createCommentVNode("", true),
                  unref(canFullConfirmAI) && unref(canRejectAIReview) ? (openBlock(), createElementBlock("button", {
                    key: 5,
                    class: "btn btn-danger",
                    disabled: !manualReviews.value.length || reviewActionId.value,
                    onClick: _cache[35] || (_cache[35] = ($event) => batchDecideReviews("reject_change", true))
                  }, "全量驳回", 8, _hoisted_138)) : createCommentVNode("", true)
                ]),
                createBaseVNode("table", null, [
                  createBaseVNode("thead", null, [
                    createBaseVNode("tr", null, [
                      ...
                      _cache[91] || (_cache[91] = createBaseVNode("th", null, "舆情标题", -1)),
                  ...
                  createBaseVNode("tbody", null, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(manualReviews.value, (review) => {
                      return openBlock(), createElementBlock("tr", {
                        ...
                        createBaseVNode("td", null, [
                          withDirectives(createBaseVNode("input", {
                            "onUpdate:modelValue": _cache[36] || (_cache[36] = ($event) => selectedReviewIds.value = $event),
                            type: "checkbox",
                            value: review.id
                          }, null, 8, _hoisted_140), [
                        ...
                        createBaseVNode("td", _hoisted_141, [
                          ...
                          }, toDisplayString(review.opinion_title || `舆情 #${review.foreign_opinion_id}`), 9, _hoisted_142),
                          createBaseVNode("span", _hoisted_143, toDisplayString(review.opinion_source || "-"), 1)
                        ]),
                        ...
                        review.review_status === "pending_review" ? (openBlock(), createElementBlock("td", _hoisted_144, [
                          unref(canReviewAI) ? (openBlock(), createElementBlock("button", {
                            key: 0,
                            class: "link-btn",
                            disabled: reviewActionId.value === review.id,
                            onClick: ($event) => decideReview(review, "use_ai_display")
                          }, "采用 AI 展示", 8, _hoisted_145)) : createCommentVNode("", true),
                          unref(canReviewAI) ? (openBlock(), createElementBlock("button", {
                            key: 1,
                            class: "link-btn",
                            disabled: reviewActionId.value === review.id,
                            onClick: ($event) => decideReview(review, "keep_rule")
                          }, "保留规则", 8, _hoisted_146)) : createCommentVNode("", true),
                          unref(canConfirmEventReview) ? (openBlock(), createElementBlock("button", {
                            key: 2,
                            class: "link-btn",
                            disabled: reviewActionId.value === review.id,
                            onClick: ($event) => decideReview(review, "confirm_event_change")
                          }, "确认事件", 8, _hoisted_147)) : createCommentVNode("", true),
                          unref(canConfirmAlertReview) ? (openBlock(), createElementBlock("button", {
                            key: 3,
                            class: "link-btn",
                            disabled: reviewActionId.value === review.id,
                            onClick: ($event) => decideReview(review, "confirm_alert_change")
                          }, "确认预警", 8, _hoisted_148)) : createCommentVNode("", true),
                          unref(canRejectAIReview) ? (openBlock(), createElementBlock("button", {
                            key: 4,
                            class: "link-btn danger",
                            disabled: reviewActionId.value === review.id,
                            onClick: ($event) => decideReview(review, "reject_change")
                          }, "驳回", 8, _hoisted_149)) : createCommentVNode("", true)
                        ])) : (openBlock(), createElementBlock("td", _hoisted_150, toDisplayString(review.review_reason || "-"), 1))
                      ]);
                    }), 128)),
                    !manualReviews.value.length ? (openBlock(), createElementBlock("tr", _hoisted_151, [..._cache[99] || (_cache[99] = [
                      createBaseVNode("td", {
                        colspan: "9",
                        class: "empty"
                      }, "暂无待复核结果", -1)
        ...
        createVNode(_component_el_dialog, {
          ...
          "onUpdate:modelValue": _cache[39] || (_cache[39] = ($event) => aiBatchHistoryDialog.value = $event),
          title: "AI 研判运行记录",
          width: "min(880px, calc(100vw - 24px))"
        }, {
          default: withCtx(() => [
            aiBatchHistoryLoading.value ? (openBlock(), createElementBlock("div", _hoisted_153, "加载中...")) : !aiBatchHistory.value.length ? (openBlock(), createElementBlock("div", _hoisted_154, "暂无批量 AI 研判运行记录")) : (openBlock(), createElementBlock("div", _hoisted_155, [
              createBaseVNode("table", null, [
            ...
            aiBatchHistorySel.value ? (openBlock(), createElementBlock("div", _hoisted_158, [
              ...
              (aiBatchHistorySel.value.failures || []).length ? (openBlock(), createElementBlock("p", _hoisted_159, "失败明细：" + toDisplayString((aiBatchHistorySel.value.failures || []).map((item) => `#${item.opinion_id}: ${item.error}`).join("；")), 1)) : createCommentVNode("", true),
              aiBatchHistorySel.value.event_preview ? (openBlock(), createElementBlock("p", _hoisted_160, "可能影响事件候选：" + toDisplayString(aiBatchHistorySel.value.event_preview?.candidate_count ?? 0), 1)) : createCommentVNode("", true),
              aiBatchHistorySel.value.alert_preview ? (openBlock(), createElementBlock("p", _hoisted_161, "可能影响预警：" + toDisplayString(aiBatchHistorySel.value.alert_preview?.triggered_count ?? 0), 1)) : createCommentVNode("", true)
            ])) : createCommentVNode("", true)
          ]),
          _: 1
        }, 8, ["modelValue"])
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b0d38979"]]);
