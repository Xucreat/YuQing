...
const _hoisted_20 = { class: "card table-card" };
const _hoisted_21 = { class: "tbl" };
const _hoisted_22 = ["onClick"];
const _hoisted_23 = { class: "t-title" };
...
const _hoisted_29 = { class: "col-center risk-num" };
const _hoisted_30 = { class: "col-center" };
const _hoisted_31 = { class: "col-center risk-num" };
const _hoisted_32 = { class: "col-center" };
const _hoisted_33 = { class: "nowrap" };
const _hoisted_34 = { class: "nowrap" };
const _hoisted_35 = { class: "row-actions" };
...
const _hoisted_42 = { class: "op-left" };
const _hoisted_43 = { class: "operation-header" };
const _hoisted_44 = { class: "operation-current" };
const _hoisted_45 = {
  key: 0,
...
const _hoisted_49 = { class: "note-submit-row" };
const _hoisted_50 = ["disabled"];
const _hoisted_51 = { class: "op-right" };
const _hoisted_52 = { class: "op-right-title" };
const _hoisted_53 = { class: "op-count" };
const _hoisted_54 = { class: "op-right-scroll" };
const _hoisted_55 = { class: "action-timeline" };
const _hoisted_56 = { class: "timeline-body" };
const _hoisted_57 = { class: "timeline-meta" };
const _hoisted_58 = { class: "timeline-content" };
const _hoisted_59 = {
  key: 0,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      ...
      const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-CsnE4Shm.js').then(n => n.a1);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
      try {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          ...
          withDirectives(createBaseVNode("select", {
            ...
            createStaticVNode('<option value="" data-v-9f054d5c>全部趋势</option><option value="rising" data-v-9f054d5c>↑ 升温</option><option value="stable" data-v-9f054d5c>→ 平稳</option><option value="falling" data-v-9f054d5c>↓ 下降</option><option value="unknown" data-v-9f054d5c>未知</option>', 5)
          ])], 544), [
        ...
        createBaseVNode("div", _hoisted_20, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(rows.value, (row, idx) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", null, [
                    createBaseVNode("span", _hoisted_23, toDisplayString(row.title), 1)
                  ]),
                  createBaseVNode("td", _hoisted_24, toDisplayString(topicText(row.topic_category)), 1),
                  createBaseVNode("td", _hoisted_25, [
                    ...
                    isKeyEvent(row) ? (openBlock(), createElementBlock("span", _hoisted_27, "重点关注")) : createCommentVNode("", true)
                  ]),
                  createBaseVNode("td", {
                    ...
                    }, "现行 " + toDisplayString(row.risk_score), 9, _hoisted_28)
                  ], 4),
                  createBaseVNode("td", _hoisted_29, toDisplayString(row.heat_score), 1),
                  createBaseVNode("td", _hoisted_30, [
                    createBaseVNode("span", {
                      class: normalizeClass(["pill", trendPill(row.trend)])
                    }, toDisplayString(trendText(row.trend)), 3)
                  ]),
                  createBaseVNode("td", _hoisted_31, toDisplayString(row.opinion_count), 1),
                  ...
                  createBaseVNode("td", _hoisted_33, toDisplayString(formatTime(row.first_time)), 1),
                  createBaseVNode("td", _hoisted_34, toDisplayString(formatTime(row.last_time)), 1),
                  createBaseVNode("td", {
                    ...
                    createBaseVNode("div", _hoisted_35, [
                      ...
                      }, "处置", 8, _hoisted_36)) : createCommentVNode("", true),
                      canUpdateEvent.value ? (openBlock(), createElementBlock("button", {
                        key: 1,
                      ...
                      !canUpdateEvent.value ? (openBlock(), createElementBlock("span", _hoisted_38, "—")) : createCommentVNode("", true)
                    ])
                  ])
                ], 8, _hoisted_22);
              }), 128)),
              rows.value.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_39, [..._cache[33] || (_cache[33] = [
                createBaseVNode("td", {
                  colspan: "12",
                  class: "empty-row"
                }, "暂无事件数据", -1)
          ...
          total.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_40, [
        ...
        createVNode(_component_el_dialog, {
          ...
          default: withCtx(() => [
            handleEvent.value ? (openBlock(), createElementBlock("div", _hoisted_41, [
              createBaseVNode("div", _hoisted_42, [
                ...
                canUpdateEvent.value ? (openBlock(), createElementBlock("div", _hoisted_45, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(EVENT_STATUS_OPTIONS), (option) => {
                    ...
                    }, toDisplayString(option.label), 11, _hoisted_46);
                  }), 128))
                ])) : createCommentVNode("", true),
                canUpdateEvent.value ? (openBlock(), createElementBlock("div", _hoisted_47, [
                  ...
                  createBaseVNode("div", _hoisted_49, [
                    ...
                    createBaseVNode("button", {
                      ...
                      onClick: addNote
                    }, toDisplayString(savingNote.value ? "提交中" : "添加备注"), 9, _hoisted_50)
                  ])
                ])) : createCommentVNode("", true)
              ]),
              createBaseVNode("div", _hoisted_51, [
                createBaseVNode("div", _hoisted_52, [
                  ...
                  createBaseVNode("span", _hoisted_53, toDisplayString(handleEvent.value.actions.length), 1)
                ]),
                createBaseVNode("div", _hoisted_54, [
                  createBaseVNode("div", _hoisted_55, [
                    ...
                    handleEvent.value.actions.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_59, "暂无处置记录")) : createCommentVNode("", true)
                  ])
                ])
              ])
            ])) : (openBlock(), createElementBlock("div", _hoisted_60, "加载中…"))
          ]),
          _: 1
        }, 8, ["modelValue"])
      ])), [
...
const Events = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9f054d5c"]]);
