        ...
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_46, [
          createBaseVNode("div", _hoisted_47, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-ab9abead>全部语言</option><option value="zh" data-v-ab9abead>中文</option><option value="en" data-v-ab9abead>英文</option><option value="mixed" data-v-ab9abead>中英混合</option><option value="unknown" data-v-ab9abead>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-ab9abead>全部风险等级</option><option value="high" data-v-ab9abead>高</option><option value="medium" data-v-ab9abead>中</option><option value="low" data-v-ab9abead>低</option><option value="unknown" data-v-ab9abead>未知</option>', 5)
            ])], 544), [
          ...
          createBaseVNode("div", _hoisted_90, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-ab9abead>全部状态</option><option value="triggered" data-v-ab9abead>待处理</option><option value="acknowledged" data-v-ab9abead>已确认</option><option value="resolved" data-v-ab9abead>已解决</option><option value="suppressed" data-v-ab9abead>已抑制</option><option value="failed" data-v-ab9abead>失败</option>', 6)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-ab9abead>全部严重度</option><option value="low" data-v-ab9abead>低</option><option value="medium" data-v-ab9abead>中</option><option value="high" data-v-ab9abead>高</option><option value="critical" data-v-ab9abead>紧急</option>', 5)
            ])], 544), [
          ...
          createBaseVNode("article", _hoisted_122, [
            ...
            createBaseVNode("label", null, [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="risk_score" data-v-ab9abead>风险分</option><option value="risk_level" data-v-ab9abead>风险等级</option><option value="risk_category" data-v-ab9abead>风险类别</option><option value="confirmed_event" data-v-ab9abead>确认事件</option><option value="keyword_combo" data-v-ab9abead>关键词组合</option>', 5)
              ])], 512), [
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ab9abead"]]);
