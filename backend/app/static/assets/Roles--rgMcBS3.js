                  ...
                  createBaseVNode("div", _hoisted_18, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(g.perms, (p) => {
                      return openBlock(), createElementBlock("label", {
                        ...
                        createBaseVNode("span", _hoisted_21, toDisplayString(permNameLabel(p)), 1),
                        createBaseVNode("span", {
                          class: "perm-desc",
                          title: p.description
                    ...
                    createBaseVNode("div", _hoisted_33, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(g.perms, (p) => {
                        return openBlock(), createElementBlock("label", {
                          ...
                          createBaseVNode("span", _hoisted_36, toDisplayString(permNameLabel(p)), 1)
                        ]);
                      }), 128))
                    ])
                  ]);
...
const Roles = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-150c564d"]]);
