import { d as defineComponent, z as usePermission, C as onMounted, o as openBlock, c as createElementBlock, a as createBaseVNode, t as toDisplayString, s as createCommentVNode, F as Fragment, i as renderList, n as normalizeClass, H as unref, e as createTextVNode, P as withModifiers, m as createVNode, r as ref, E as ElMessage, Q as ElMessageBox, g as api, _ as _export_sfc } from './index-CL6LKzp8.js';
import { b as EventDispositionDialog } from './EventDispositionDialog-Co-YGOI4.js';
...
const _hoisted_26 = { class: "event-provenance" };
const _hoisted_27 = { key: 0 };
const _hoisted_28 = { key: 1 };
const _hoisted_29 = { class: "event-detail-head" };
const _hoisted_30 = { class: "actions" };
const _hoisted_31 = ["disabled"];
const _hoisted_32 = ["disabled"];
const _hoisted_33 = ["disabled"];
const _hoisted_34 = { class: "muted" };
const _hoisted_35 = { class: "event-metrics" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("section", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_3, [
          ...
          _cache[7] || (_cache[7] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
        ]),
        ...
        eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_6, [
          _cache[9] || (_cache[9] = createBaseVNode("strong", null, "外网事件运行失败", -1)),
          (openBlock(true), createElementBlock(Fragment, null, renderList(eventRunFailures.value, (run) => {
            return openBlock(), createElementBlock("div", {
              key: run.id,
              class: "event-failure-row"
            }, [
              _cache[8] || (_cache[8] = createBaseVNode("span", { class: "status failed" }, "失败", -1)),
        ...
        eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_8, [
          createBaseVNode("table", null, [
            ...
            createBaseVNode("tbody", null, [
              ...
              !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_13, [..._cache[10] || (_cache[10] = [
                createBaseVNode("td", {
                  colspan: "8",
                  class: "empty"
                }, "暂无外网事件候选", -1)
          ...
          createBaseVNode("table", null, [
            ...
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(foreignEvents.value, (row) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", null, [
                    ...
                    __props.showDispositionActions ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                      createBaseVNode("button", {
                        class: "link-btn",
                        disabled: !unref(canDisposition),
              ...
              !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_24, [..._cache[12] || (_cache[12] = [
                createBaseVNode("td", {
                  colspan: "13",
                  class: "empty"
                }, "暂无已确认外网事件", -1)
        ...
        selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_25, [
          createBaseVNode("div", _hoisted_26, [
            _cache[15] || (_cache[15] = createBaseVNode("strong", null, "事件溯源", -1)),
            ...
            selectedForeignEvent.value.linked_opinion_current_risk ? (openBlock(), createElementBlock("span", _hoisted_27, "关联舆情当前风险：" + toDisplayString(selectedForeignEvent.value.linked_opinion_current_risk.risk_score ?? "-") + " · " + toDisplayString(zh(selectedForeignEvent.value.linked_opinion_current_risk.risk_level)), 1)) : createCommentVNode("", true),
            selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_28, [
              _cache[14] || (_cache[14] = createBaseVNode("summary", null, "聚合证据", -1)),
          ...
          createBaseVNode("p", _hoisted_34, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("span", _hoisted_36, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
              opinion.current_risk ? (openBlock(), createElementBlock("span", _hoisted_37, "当前风险：" + toDisplayString(opinion.current_risk.risk_score ?? "-") + " · " + toDisplayString(zh(opinion.current_risk.risk_level)), 1)) : createCommentVNode("", true),
              createBaseVNode("a", {
                href: opinion.url,
                target: "_blank",
                rel: "noreferrer",
        ...
        createVNode(EventDispositionDialog, {
          ...
          "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => dispositionVisible.value = $event),
...
const ForeignEventsView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0c2ce214"]]);
