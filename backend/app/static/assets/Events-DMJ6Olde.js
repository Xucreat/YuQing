...
const _hoisted_51 = { class: "t-title" };
const _hoisted_52 = { class: "nowrap" };
const _hoisted_53 = { class: "nowrap" };
const _hoisted_54 = { class: "col-center" };
const _hoisted_55 = { class: "col-center" };
...
const _hoisted_59 = { class: "col-center risk-num" };
const _hoisted_60 = { class: "nowrap" };
const _hoisted_61 = { class: "nowrap" };
const _hoisted_62 = { class: "row-actions" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      ...
      const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-pb2TILNy.js').then(n => n.a6);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
      try {
    ...
    async function handleForeignDelete(row) {
    ...
    function openForeignHandle(row) {
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        scope.value === "domestic" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          createBaseVNode("div", _hoisted_3, [
                  ...
                  riskOpen.value ? (openBlock(), createElementBlock("div", _hoisted_6, [
                    (openBlock(), createElementBlock(Fragment, null, renderList(riskOptions, (opt) => {
                      return createBaseVNode("button", {
                        ...
                        riskFilter.value === opt.value ? (openBlock(), createElementBlock("svg", _hoisted_9, [..._cache[32] || (_cache[32] = [
                  ...
                  shadowRiskOpen.value ? (openBlock(), createElementBlock("div", _hoisted_12, [
                    (openBlock(), createElementBlock(Fragment, null, renderList(shadowRiskOptions, (opt) => {
                      return createBaseVNode("button", {
                        ...
                        shadowRiskFilter.value === opt.value ? (openBlock(), createElementBlock("svg", _hoisted_15, [..._cache[34] || (_cache[34] = [
                          createBaseVNode("polyline", { points: "20 6 9 17 4 12" }, null, -1)
                        ])])) : createCommentVNode("", true)
                      ], 10, _hoisted_13);
                    }), 64))
            ...
            withDirectives(createBaseVNode("select", {
              ...
              _cache[35] || (_cache[35] = createBaseVNode("option", { value: "" }, "全部主题", -1)),
            ...
            withDirectives(createBaseVNode("select", {
              ...
              _cache[36] || (_cache[36] = createBaseVNode("option", { value: "" }, "全部处置状态", -1)),
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-651eed8f>全部趋势</option><option value="rising" data-v-651eed8f>↑ 升温</option><option value="stable" data-v-651eed8f>→ 平稳</option><option value="falling" data-v-651eed8f>↓ 下降</option><option value="unknown" data-v-651eed8f>未知</option>', 5)
            ])], 544), [
            ...
            moreOpen.value ? (openBlock(), createElementBlock("div", _hoisted_18, [
              ...
              _cache[42] || (_cache[42] = createBaseVNode("span", { class: "filter-sep" }, null, -1)),
              createBaseVNode("div", _hoisted_19, [
                _cache[38] || (_cache[38] = createBaseVNode("label", { class: "time-range-label" }, "首次发现", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", _hoisted_20, [
                _cache[40] || (_cache[40] = createBaseVNode("label", { class: "time-range-label" }, "最后更新", -1)),
                withDirectives(createBaseVNode("input", {
                ...
                _cache[41] || (_cache[41] = createBaseVNode("span", { class: "time-range-sep" }, "~", -1)),
                withDirectives(createBaseVNode("input", {
          ...
          createBaseVNode("div", _hoisted_23, [
            ...
            _cache[43] || (_cache[43] = createBaseVNode("span", { class: "quick-filters-note" }, "（仅过滤当前页）", -1))
          ]),
          createBaseVNode("div", _hoisted_25, [
            createBaseVNode("table", _hoisted_26, [
              ...
              createBaseVNode("tbody", null, [
                  ...
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_30, [
                      createBaseVNode("span", {
                        ...
                        _cache[44] || (_cache[44] = createBaseVNode("span", { class: "dot" }, null, -1)),
                      ...
                      _cache[45] || (_cache[45] = createBaseVNode("span", { class: "risk-source" }, "正式快照", -1)),
                    ...
                    createBaseVNode("td", {
                      ...
                      _cache[46] || (_cache[46] = createBaseVNode("small", { class: "legacy-risk" }, "参考", -1))
                    ], 4),
                ...
                displayedRows.value.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_46, [..._cache[48] || (_cache[48] = [
                  createBaseVNode("td", {
                    colspan: "14",
                    class: "empty-row"
                  }, "暂无事件数据", -1)
          ...
          _cache[52] || (_cache[52] = createBaseVNode("div", { class: "foreign-events-head" }, [
          ...
          createBaseVNode("table", _hoisted_49, [
            ...
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(foreignRows.value, (row, idx) => {
                return openBlock(), createElementBlock("tr", {
                  key: row.id,
                  onClick: ($event) => _ctx.$router.push("/foreign/event/" + row.id),
                  style: { "cursor": "pointer" }
                }, [
                  createBaseVNode("td", null, toDisplayString(row.id), 1),
                  createBaseVNode("td", null, [
                    createBaseVNode("span", _hoisted_51, toDisplayString(row.title || "无标题"), 1)
                  ]),
                  createBaseVNode("td", _hoisted_52, toDisplayString(langText(row.language)), 1),
                  createBaseVNode("td", _hoisted_53, toDisplayString(srcText(row.confirmation_source || "manual")), 1),
                  ...
                  createBaseVNode("td", _hoisted_56, toDisplayString(row.heat_score ?? "-"), 1),
                  createBaseVNode("td", _hoisted_57, toDisplayString(row.opinion_count ?? "-"), 1),
                  createBaseVNode("td", _hoisted_58, toDisplayString(row.source_count ?? "-"), 1),
                  createBaseVNode("td", _hoisted_59, toDisplayString(Math.round((row.confidence || 0) * 100)) + "%", 1),
                  createBaseVNode("td", _hoisted_60, toDisplayString(formatTime(row.first_seen_at)), 1),
                  createBaseVNode("td", _hoisted_61, toDisplayString(formatTime(row.last_seen_at)), 1),
                  createBaseVNode("td", {
                    class: "col-center operation-col",
                    ...
                    createBaseVNode("div", _hoisted_62, [
                      createBaseVNode("button", {
                        class: "btn-operate",
                        title: "查看外网事件详情",
                        onClick: withModifiers(($event) => _ctx.$router.push("/foreign/event/" + row.id), ["stop"])
                      }, "查看", 8, _hoisted_63),
                      canUpdateForeign.value ? (openBlock(), createElementBlock("button", {
                        key: 0,
                        class: "btn-operate",
                        title: "打开外网事件处置弹窗",
                        onClick: withModifiers(($event) => openForeignHandle(row), ["stop"])
                      }, "处置", 8, _hoisted_64)) : createCommentVNode("", true),
                      canUpdateForeign.value ? (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "btn-icon btn-delete",
                        title: "删除外网事件",
                        onClick: withModifiers(($event) => handleForeignDelete(row), ["stop"])
                      }, "🗑", 8, _hoisted_65)) : createCommentVNode("", true)
                    ])
                  ])
                ], 8, _hoisted_50);
              }), 128)),
              foreignRows.value.length === 0 && !foreignLoading.value ? (openBlock(), createElementBlock("tr", _hoisted_66, [..._cache[50] || (_cache[50] = [
                createBaseVNode("td", {
                  colspan: "13",
                  class: "empty-row"
                }, "暂无外网事件", -1)
          ...
          foreignLoading.value ? (openBlock(), createElementBlock("div", _hoisted_67, "加载外网事件中…")) : createCommentVNode("", true),
          foreignTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_68, [
            createVNode(_component_Pager, {
              total: foreignTotal.value,
              "current-page": foreignPage.value,
              "onUpdate:currentPage": _cache[25] || (_cache[25] = ($event) => foreignPage.value = $event),
        ...
        createVNode(EventDispositionDialog, {
          ...
          "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => handleDialogVisible.value = $event),
...
const Events = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-651eed8f"]]);
