        ...
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_73, [
          createBaseVNode("div", _hoisted_74, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-d5d0f6c3>全部语言</option><option value="zh" data-v-d5d0f6c3>中文</option><option value="en" data-v-d5d0f6c3>英文</option><option value="mixed" data-v-d5d0f6c3>中英混合</option><option value="unknown" data-v-d5d0f6c3>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-d5d0f6c3>全部风险等级</option><option value="high" data-v-d5d0f6c3>高</option><option value="medium" data-v-d5d0f6c3>中</option><option value="low" data-v-d5d0f6c3>低</option><option value="unknown" data-v-d5d0f6c3>未知</option>', 5)
            ])], 544), [
            ...
            _cache[47] || (_cache[47] = createBaseVNode("span", { class: "muted" }, "AI 研判结果仅用于辅助分析，不改变系统正式风险和告警", -1))
          ]),
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d5d0f6c3"]]);
