...
const _hoisted_26 = { class: "fw-card" };
const _hoisted_27 = {
  key: 0,
  class: "empty"
};
const _hoisted_28 = { class: "fw-card" };
const _hoisted_29 = {
  key: 0,
  class: "empty"
};
const _hoisted_30 = { class: "fw-card" };
const _hoisted_31 = {
  key: 0,
  class: "distribution-row"
};
const _hoisted_32 = { class: "distribution-row" };
const _hoisted_33 = {
  key: 1,
  class: "empty"
};
const _hoisted_34 = { class: "fw-card fw-card-wide" };
const _hoisted_35 = { class: "fw-card-head" };
const _hoisted_36 = { class: "fw-legend" };
const _hoisted_37 = ["onClick"];
const _hoisted_38 = {
  key: 0,
  class: "empty"
};
const _hoisted_39 = { class: "fw-card fw-card-wide" };
const _hoisted_40 = { class: "fw-card-head" };
...
const _hoisted_48 = { class: "table-wrap tbl-scroll" };
const _hoisted_49 = ["onClick"];
const _hoisted_50 = { class: "title-cell" };
const _hoisted_51 = {
  key: 0,
  class: "muted"
};
const _hoisted_52 = { class: "actions" };
...
const _hoisted_95 = ["title", "onClick", "onKeydown"];
const _hoisted_96 = {
  key: 1,
  class: "alert-title"
};
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
          ...
          visualizationError.value ? (openBlock(), createElementBlock("div", _hoisted_12, [
            ...
            createBaseVNode("div", _hoisted_25, [
              createBaseVNode("article", _hoisted_26, [
                _cache[40] || (_cache[40] = createBaseVNode("h3", null, "风险分布", -1)),
                ...
                !dashboardRisk.value || !Object.keys(dashboardRisk.value.risk_levels || {}).length ? (openBlock(), createElementBlock("p", _hoisted_27, "暂无已完成风险结果")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_28, [
                _cache[41] || (_cache[41] = createBaseVNode("h3", null, "事件状态", -1)),
                ...
                !dashboardEvents.value || !Object.keys(dashboardEvents.value.formal_events || {}).length ? (openBlock(), createElementBlock("p", _hoisted_29, "暂无外网事件")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_30, [
                _cache[44] || (_cache[44] = createBaseVNode("h3", null, "采集状态", -1)),
                dashboardSummary.value.collection.latest ? (openBlock(), createElementBlock("div", _hoisted_31, [
                  _cache[42] || (_cache[42] = createBaseVNode("span", null, "最近一次", -1)),
                  createBaseVNode("strong", null, toDisplayString(zh(dashboardSummary.value.collection.latest.status)), 1)
                ])) : createCommentVNode("", true),
                createBaseVNode("div", _hoisted_32, [
                  _cache[43] || (_cache[43] = createBaseVNode("span", null, "成功 / 失败", -1)),
                ...
                !dashboardSummary.value.collection.latest ? (openBlock(), createElementBlock("p", _hoisted_33, "暂无外网采集记录")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_34, [
                createBaseVNode("header", _hoisted_35, [
                  _cache[45] || (_cache[45] = createBaseVNode("h3", null, "每日趋势", -1)),
                ...
                !(dashboardTrends.value?.items || []).length ? (openBlock(), createElementBlock("p", _hoisted_38, "该窗口内暂无趋势数据")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_39, [
                createBaseVNode("header", _hoisted_40, [
                  _cache[46] || (_cache[46] = createBaseVNode("h3", null, "外网热词", -1)),
                  createBaseVNode("span", _hoisted_41, "近 " + toDisplayString(visualizationDays.value) + " 天 · 共 " + toDisplayString(hotwordItems.value.length) + " 个热词", 1)
                ]),
                withDirectives(createBaseVNode("div", {
                ...
                !hotwordItems.value.length ? (openBlock(), createElementBlock("p", _hoisted_42, "该窗口内暂无外网热词")) : createCommentVNode("", true)
              ])
            ]),
            createBaseVNode("div", _hoisted_43, "数据范围：" + toDisplayString(formatTime(dashboardSummary.value.window_start)) + " - " + toDisplayString(formatTime(dashboardSummary.value.window_end)) + " · 更新于：" + toDisplayString(formatTime(dashboardSummary.value.data_as_of)), 1)
          ])) : (openBlock(), createElementBlock("div", _hoisted_44, "加载外网看板中..."))
        ])) : createCommentVNode("", true),
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_45, [
          createBaseVNode("div", _hoisted_46, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-96be7d7f>全部语言</option><option value="zh" data-v-96be7d7f>中文</option><option value="en" data-v-96be7d7f>英文</option><option value="mixed" data-v-96be7d7f>中英混合</option><option value="unknown" data-v-96be7d7f>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-96be7d7f>全部风险等级</option><option value="high" data-v-96be7d7f>高</option><option value="medium" data-v-96be7d7f>中</option><option value="low" data-v-96be7d7f>低</option><option value="unknown" data-v-96be7d7f>未知</option>', 5)
            ])], 544), [
            ...
            _cache[51] || (_cache[51] = createBaseVNode("span", { class: "muted" }, "以舆情为主，右侧为已关联的风险研判（未分析显示 -）", -1))
          ]),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_50, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", null, [
                      ...
                      !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_51, "无")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_52, [
                      ...
                      }, "重新分析", 8, _hoisted_53)) : createCommentVNode("", true)
                    ])
                  ], 8, _hoisted_49);
                }), 128)),
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_54, [..._cache[52] || (_cache[52] = [
                  createBaseVNode("td", {
                    colspan: "14",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_55, [
          ...
          createBaseVNode("div", _hoisted_58, [
            ...
            _cache[54] || (_cache[54] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
          ]),
          ...
          eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_61, [
            _cache[56] || (_cache[56] = createBaseVNode("strong", null, "外网事件运行失败", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(eventRunFailures.value, (run) => {
              return openBlock(), createElementBlock("div", {
                key: run.id,
                class: "event-failure-row"
              }, [
                _cache[55] || (_cache[55] = createBaseVNode("span", { class: "status failed" }, "失败", -1)),
          ...
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_63, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                ...
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_68, [..._cache[57] || (_cache[57] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
            ...
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_74, [..._cache[59] || (_cache[59] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
          ...
          selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_75, [
            createBaseVNode("div", _hoisted_76, [
              _cache[62] || (_cache[62] = createBaseVNode("strong", null, "事件溯源", -1)),
              ...
              selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_77, [
                _cache[61] || (_cache[61] = createBaseVNode("summary", null, "聚合证据", -1)),
          ...
          createBaseVNode("div", _hoisted_89, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-96be7d7f>全部状态</option><option value="triggered" data-v-96be7d7f>待处理</option><option value="acknowledged" data-v-96be7d7f>已确认</option><option value="resolved" data-v-96be7d7f>已解决</option><option value="suppressed" data-v-96be7d7f>已抑制</option><option value="failed" data-v-96be7d7f>失败</option>', 6)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-96be7d7f>全部严重度</option><option value="low" data-v-96be7d7f>低</option><option value="medium" data-v-96be7d7f>中</option><option value="high" data-v-96be7d7f>高</option><option value="critical" data-v-96be7d7f>紧急</option>', 5)
            ])], 544), [
              [vModelSelect, alertFilters.severity]
            ]),
            _cache[65] || (_cache[65] = createBaseVNode("span", { class: "muted" }, "告警评估默认关闭 · 外部通知默认关闭 · 当前仅保存站内记录", -1))
          ]),
          _cache[70] || (_cache[70] = createBaseVNode("div", { class: "alert-scope-note" }, " 外网告警只读取外网风险和已确认外网事件；不会进入国内告警、Dashboard、地图、热词或事件链路。 ", -1)),
          ...
          alertRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_92, [
            _cache[67] || (_cache[67] = createBaseVNode("strong", null, "外网告警评估失败", -1)),
          ...
          createBaseVNode("div", _hoisted_93, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignAlerts.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_94, [
                      ...
                      }, toDisplayString(row.title || "无标题告警"), 41, _hoisted_95)) : (openBlock(), createElementBlock("strong", _hoisted_96, toDisplayString(row.title || "无标题告警"), 1)),
                ...
                !foreignAlerts.value.length ? (openBlock(), createElementBlock("tr", _hoisted_106, [..._cache[68] || (_cache[68] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无外网告警记录", -1)
          ...
          createBaseVNode("div", { class: "toolbar" }, [
            ...
            _cache[71] || (_cache[71] = createBaseVNode("span", { class: "muted" }, "外网规则独立管理；新规则保存后默认停用。", -1))
          ]),
          createBaseVNode("div", _hoisted_108, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                ...
                !alertRules.value.length ? (openBlock(), createElementBlock("tr", _hoisted_114, [..._cache[72] || (_cache[72] = [
                  createBaseVNode("td", {
                    colspan: "7",
                    class: "empty"
                  }, "暂无外网告警规则", -1)
        ...
        historyAlert.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_115, [
            ...
            _cache[74] || (_cache[74] = createBaseVNode("h3", null, "外网告警处置历史", -1)),
        ...
        alertRuleEditorVisible.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_121, [
            ...
            createBaseVNode("label", null, [
              _cache[75] || (_cache[75] = createTextVNode("规则名称", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[77] || (_cache[77] = createTextVNode("规则类型", -1)),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => alertRuleDraft.rule_type = $event),
                class: "input"
              }, [..._cache[76] || (_cache[76] = [
                createStaticVNode('<option value="risk_score" data-v-96be7d7f>风险分</option><option value="risk_level" data-v-96be7d7f>风险等级</option><option value="risk_category" data-v-96be7d7f>风险类别</option><option value="confirmed_event" data-v-96be7d7f>确认事件</option><option value="keyword_combo" data-v-96be7d7f>关键词组合</option>', 5)
              ])], 512), [
                [vModelSelect, alertRuleDraft.rule_type]
              ])
            ]),
            createBaseVNode("label", null, [
              _cache[78] || (_cache[78] = createTextVNode("风险阈值或条件", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[80] || (_cache[80] = createTextVNode("严重等级", -1)),
              withDirectives(createBaseVNode("select", {
            ...
            createBaseVNode("label", null, [
              _cache[81] || (_cache[81] = createTextVNode("冷却时间", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[82] || (_cache[82] = createTextVNode("规则说明", -1)),
            ...
            createBaseVNode("label", _hoisted_122, [
              ...
              _cache[83] || (_cache[83] = createTextVNode(" 编辑时启用状态（新规则默认停用，启用仍需外网启用权限）", -1))
            ]),
            createBaseVNode("div", _hoisted_124, [
              _cache[84] || (_cache[84] = createBaseVNode("strong", null, "规则预览", -1)),
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-96be7d7f"]]);
