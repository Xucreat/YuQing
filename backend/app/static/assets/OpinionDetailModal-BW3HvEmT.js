import { d as defineComponent, z as usePermission, A as watch, C as onMounted, I as onUnmounted, q as createBlock, c as createElementBlock, L as withModifiers, a as createBaseVNode, t as toDisplayString, s as createCommentVNode, w as withDirectives, H as unref, F as Fragment, i as renderList, n as normalizeClass, e as createTextVNode, k as normalizeStyle, m as createVNode, p as withCtx, T as Teleport, j as computed, r as ref, g as api, E as ElMessage, X as isPermissionDenied, y as resolveComponent, B as resolveDirective, o as openBlock, _ as _export_sfc } from './index-ZScWDPZM.js';
...
const _hoisted_16 = { class: "card card-pad admission-card" };
const _hoisted_17 = { class: "ai-header" };
const _hoisted_18 = { class: "pill pill-blue" };
const _hoisted_19 = { class: "admission-score" };
const _hoisted_20 = {
  key: 0,
...
const _hoisted_22 = { class: "card card-pad sys-card" };
const _hoisted_23 = { class: "ai-header" };
const _hoisted_24 = { class: "report-meta" };
...
const _hoisted_31 = { class: "re-value" };
const _hoisted_32 = {
  key: 2,
  class: "risk-explain-item"
};
const _hoisted_33 = { class: "re-value" };
const _hoisted_34 = {
  key: 3,
  class: "risk-explain-item"
};
...
const _hoisted_36 = { class: "re-value re-muted" };
const _hoisted_37 = { class: "report-body" };
const _hoisted_38 = {
  key: 0,
  class: "report-p"
};
...
const _hoisted_43 = { class: "card card-pad ai-card" };
const _hoisted_44 = { class: "ai-header" };
const _hoisted_45 = { class: "report-meta" };
const _hoisted_46 = { class: "meta-item" };
const _hoisted_47 = { class: "meta-item" };
const _hoisted_48 = { class: "meta-item" };
const _hoisted_49 = { class: "report-body" };
const _hoisted_50 = {
  key: 0,
  class: "report-p"
};
                ...
                createBaseVNode("div", _hoisted_15, [
                  createBaseVNode("div", _hoisted_16, [
                    createBaseVNode("div", _hoisted_17, [
                      _cache[2] || (_cache[2] = createBaseVNode("span", { class: "section-title" }, "准入分析", -1)),
                      createBaseVNode("span", _hoisted_18, toDisplayString(contentTypeText(detail.value.content_type)), 1)
                    ]),
                    _cache[4] || (_cache[4] = createBaseVNode("div", { class: "detail-divider" }, null, -1)),
                    createBaseVNode("div", _hoisted_19, [
                      _cache[3] || (_cache[3] = createBaseVNode("span", { class: "admission-score-label" }, "相关性", -1)),
                      createBaseVNode("b", {
                    ...
                    admissionItems.value.length ? (openBlock(), createElementBlock("div", _hoisted_20, [
                    ...
                    ])) : (openBlock(), createElementBlock("p", _hoisted_21, toDisplayString(defaultAdmissionText.value), 1))
                  ]),
                  createBaseVNode("div", _hoisted_22, [
                    createBaseVNode("div", _hoisted_23, [
                      _cache[5] || (_cache[5] = createBaseVNode("span", { class: "section-title" }, "系统研判报告", -1)),
                    ...
                    createBaseVNode("div", _hoisted_24, [
                      ...
                      createBaseVNode("span", _hoisted_26, [
                        _cache[7] || (_cache[7] = createTextVNode("级别 ", -1)),
                      ...
                      createBaseVNode("span", _hoisted_27, [
                        _cache[8] || (_cache[8] = createTextVNode("情感 ", -1)),
                        createBaseVNode("b", null, toDisplayString(unref(sentimentText)(detail.value.sentiment)), 1)
                      ])
                    ]),
                    hasRiskExplain.value ? (openBlock(), createElementBlock("div", _hoisted_28, [
                      detail.value.risk_category ? (openBlock(), createElementBlock("div", _hoisted_29, [
                        _cache[11] || (_cache[11] = createBaseVNode("span", { class: "re-label" }, "风险分类", -1)),
                      ...
                      detail.value.severity_score != null && detail.value.severity_score > 0 ? (openBlock(), createElementBlock("div", _hoisted_30, [
                        _cache[12] || (_cache[12] = createBaseVNode("span", { class: "re-label" }, "危害严重度", -1)),
                      ...
                      detail.value.event_state ? (openBlock(), createElementBlock("div", _hoisted_32, [
                        _cache[13] || (_cache[13] = createBaseVNode("span", { class: "re-label" }, "事件状态", -1)),
                        createBaseVNode("span", _hoisted_33, toDisplayString(stateText(detail.value.event_state)), 1)
                      ])) : createCommentVNode("", true),
                      factorHits.value.length ? (openBlock(), createElementBlock("div", _hoisted_34, [
                        _cache[14] || (_cache[14] = createBaseVNode("span", { class: "re-label" }, "命中危害词", -1)),
                      ...
                      detail.value.risk_model_version ? (openBlock(), createElementBlock("div", _hoisted_35, [
                        _cache[15] || (_cache[15] = createBaseVNode("span", { class: "re-label" }, "模型版本", -1)),
                        createBaseVNode("span", _hoisted_36, toDisplayString(detail.value.risk_model_version), 1)
                      ])) : createCommentVNode("", true)
                    ])) : createCommentVNode("", true),
                    createBaseVNode("div", _hoisted_37, [
                      detail.value.summary ? (openBlock(), createElementBlock("p", _hoisted_38, toDisplayString(detail.value.summary), 1)) : (openBlock(), createElementBlock("p", _hoisted_39, "暂无系统研判摘要。")),
                      detail.value.analysis_suggestion ? (openBlock(), createElementBlock("p", _hoisted_40, toDisplayString(detail.value.analysis_suggestion), 1)) : createCommentVNode("", true)
                    ]),
                    keywordList.value.length ? (openBlock(), createElementBlock("div", _hoisted_41, [
                    ...
                    detail.value.analysis_time ? (openBlock(), createElementBlock("div", _hoisted_42, " 分析时间：" + toDisplayString(unref(formatTime)(detail.value.analysis_time)), 1)) : createCommentVNode("", true)
                  ]),
                  createBaseVNode("div", _hoisted_43, [
                    ...
                    createBaseVNode("div", _hoisted_49, [
                      detail.value.ai_analysis_status === "completed" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                        detail.value.ai_summary ? (openBlock(), createElementBlock("p", _hoisted_50, toDisplayString(detail.value.ai_summary), 1)) : createCommentVNode("", true),
                        detail.value.ai_analysis_suggestion ? (openBlock(), createElementBlock("p", _hoisted_51, toDisplayString(detail.value.ai_analysis_suggestion), 1)) : createCommentVNode("", true)
                      ], 64)) : detail.value.ai_analysis_status === "failed" ? (openBlock(), createElementBlock("p", _hoisted_52, " AI 分析失败（DeepSeek 未配置或余额不足），请稍后重试。 ")) : (openBlock(), createElementBlock("p", _hoisted_53, " 尚未生成 AI 研判报告，点击下方按钮由 DeepSeek 生成。 "))
                    ]),
                    aiKeywordList.value.length ? (openBlock(), createElementBlock("div", _hoisted_54, [
                    ...
                    detail.value.ai_analysis_time ? (openBlock(), createElementBlock("div", _hoisted_55, " 分析时间：" + toDisplayString(unref(formatTime)(detail.value.ai_analysis_time)), 1)) : createCommentVNode("", true),
                    _cache[27] || (_cache[27] = createBaseVNode("div", { class: "detail-divider" }, null, -1)),
                    canAnalyze.value || detail.value.ai_analysis_status === "processing" ? (openBlock(), createElementBlock("div", _hoisted_56, [
                      ...
                      }, toDisplayString(analyzing.value ? "分析中..." : detail.value.ai_analysis_status === "completed" ? "重新触发 AI 分析" : "触发 AI 分析"), 9, _hoisted_57)) : (openBlock(), createElementBlock("div", _hoisted_58, [..._cache[25] || (_cache[25] = [
...
const OpinionDetailModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dc61609f"]]);
