        ...
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_66, [
          createBaseVNode("div", _hoisted_67, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-f90d2ab4>全部语言</option><option value="zh" data-v-f90d2ab4>中文</option><option value="en" data-v-f90d2ab4>英文</option><option value="mixed" data-v-f90d2ab4>中英混合</option><option value="unknown" data-v-f90d2ab4>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-f90d2ab4>全部风险等级</option><option value="high" data-v-f90d2ab4>高</option><option value="medium" data-v-f90d2ab4>中</option><option value="low" data-v-f90d2ab4>低</option><option value="unknown" data-v-f90d2ab4>未知</option>', 5)
            ])], 544), [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_73, [
                      ...
                      }, "重新分析", 8, _hoisted_74)) : createCommentVNode("", true)
                    ])
                  ], 8, _hoisted_70);
                }), 128)),
          ...
          createBaseVNode("div", _hoisted_110, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-f90d2ab4>全部状态</option><option value="triggered" data-v-f90d2ab4>待处理</option><option value="acknowledged" data-v-f90d2ab4>已确认</option><option value="resolved" data-v-f90d2ab4>已解决</option><option value="suppressed" data-v-f90d2ab4>已抑制</option><option value="failed" data-v-f90d2ab4>失败</option>', 6)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-f90d2ab4>全部严重度</option><option value="low" data-v-f90d2ab4>低</option><option value="medium" data-v-f90d2ab4>中</option><option value="high" data-v-f90d2ab4>高</option><option value="critical" data-v-f90d2ab4>紧急</option>', 5)
            ])], 544), [
          ...
          createBaseVNode("article", _hoisted_142, [
            ...
            createBaseVNode("label", null, [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="risk_score" data-v-f90d2ab4>风险分</option><option value="risk_level" data-v-f90d2ab4>风险等级</option><option value="risk_category" data-v-f90d2ab4>风险类别</option><option value="confirmed_event" data-v-f90d2ab4>确认事件</option><option value="keyword_combo" data-v-f90d2ab4>关键词组合</option>', 5)
              ])], 512), [
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f90d2ab4"]]);
