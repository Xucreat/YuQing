const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-2h1GiHMQ.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, p as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, t as toDisplayString, A as createCommentVNode, F as Fragment, i as renderList, r as ref, j as computed, g as api, E as ElMessage, D as resolveDirective, o as openBlock, n as normalizeClass, e as createTextVNode, I as withModifiers, J as __vitePreload, _ as _export_sfc } from './index-BPeYYIlC.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      try {
        const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-BPeYYIlC.js').then(n => n.P);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
