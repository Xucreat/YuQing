import { d as defineComponent, z as usePermission, C as onMounted, y as resolveComponent, o as openBlock, c as createElementBlock, a as createBaseVNode, n as normalizeClass, m as createVNode, p as withCtx, H as unref, q as createBlock, e as createTextVNode, s as createCommentVNode, F as Fragment, i as renderList, w as withDirectives, O as vModelCheckbox, t as toDisplayString, S as _sfc_main$3, T as isRef, r as ref, j as computed, g as api, Q as ElMessageBox, E as ElMessage, _ as _export_sfc, f as reactive, P as withModifiers, N as vModelSelect, v as vModelText, L as useRoute, h as useRouter, G as onBeforeUnmount, B as resolveDirective, b as withKeys, U as createStaticVNode, k as normalizeStyle } from './index-GDyWXHX0.js';
import { z as zh, f as formatTime, F as ForeignOpinionDetailModal, u as useForeignDetailState, d as displayOf, r as ruleOf, a as aiHistoryLabel, b as displaySentiment, c as contentTypeText } from './ForeignOpinionDetailModal-D036gI8d.js';
    ...
    return (_ctx, _cache) => {
      ...
      return canReadReviewSection.value ? (openBlock(), createElementBlock("div", _hoisted_1$2, [
        createBaseVNode("div", _hoisted_2$2, [
          ...
          _cache[15] || (_cache[15] = createBaseVNode("span", { class: "muted review-filter-tip" }, "操作后不会丢失：已处理的舆情可在「已确认 / 已驳回 / 全部」中回看与追溯", -1)),
          reviewStatusFilter.value === "pending_review" ? (openBlock(), createElementBlock("div", _hoisted_3$2, [
            ...
            _cache[14] || (_cache[14] = createBaseVNode("span", { class: "muted review-toolbar-hint" }, "先勾选左侧复选框，再从「批量操作」中选择动作", -1))
            ...
            createBaseVNode("table", _hoisted_7$2, [
              createBaseVNode("thead", null, [
                createBaseVNode("tr", null, [
                  ...
                  _cache[16] || (_cache[16] = createBaseVNode("th", null, "舆情标题", -1)),
                  _cache[17] || (_cache[17] = createBaseVNode("th", null, "舆情 ID", -1)),
                  _cache[18] || (_cache[18] = createBaseVNode("th", null, "规则风险", -1)),
                  _cache[19] || (_cache[19] = createBaseVNode("th", null, "AI 风险", -1)),
                  _cache[20] || (_cache[20] = createBaseVNode("th", null, "事件影响", -1)),
                  _cache[21] || (_cache[21] = createBaseVNode("th", null, "预警影响", -1)),
                  _cache[22] || (_cache[22] = createBaseVNode("th", null, "状态", -1)),
                  _cache[23] || (_cache[23] = createBaseVNode("th", null, "决策", -1)),
                  _cache[24] || (_cache[24] = createBaseVNode("th", null, "操作人", -1)),
                  _cache[25] || (_cache[25] = createBaseVNode("th", null, "操作时间", -1)),
                  _cache[26] || (_cache[26] = createBaseVNode("th", null, "操作", -1))
                ])
              ]),
...
const ForeignAIReviewView = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-a3bd7a02"]]);
