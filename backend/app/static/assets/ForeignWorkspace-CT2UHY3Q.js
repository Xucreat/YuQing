...
const _hoisted_66$1 = { class: "error-cell" };
        ...
        showHistoryModal.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_62$1, [
            ...
            createBaseVNode("div", _hoisted_64$1, [
              detail.value && detail.value.analysis_runs && detail.value.analysis_runs.length ? (openBlock(), createElementBlock("div", _hoisted_65$1, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(detail.value.analysis_runs, (run) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("span", _hoisted_66$1, toDisplayString(run.error_message || ""), 1)
                  ]);
                }), 128))
...
const ForeignOpinionDetailModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-65b14b1e"]]);
...
const _hoisted_76 = { class: "table-wrap tbl-scroll" };
const _hoisted_77 = ["onClick"];
const _hoisted_78 = { class: "title-cell" };
const _hoisted_79 = { class: "dual-cell" };
const _hoisted_80 = { class: "muted" };
const _hoisted_81 = {
  key: 0,
  class: "muted"
};
const _hoisted_82 = { class: "actions" };
const _hoisted_83 = ["disabled", "onClick"];
...
const _hoisted_87 = { class: "alert-scope-note" };
const _hoisted_88 = { class: "toolbar" };
...
const _hoisted_92 = { class: "subtabs" };
const _hoisted_93 = {
  key: 2,
  class: "table-wrap"
};
const _hoisted_94 = { class: "title-cell" };
const _hoisted_95 = { class: "actions" };
...
const _hoisted_101 = { class: "title-cell" };
const _hoisted_102 = ["disabled", "onClick"];
...
const _hoisted_106 = { class: "event-provenance" };
const _hoisted_107 = { key: 0 };
const _hoisted_108 = { class: "event-detail-head" };
const _hoisted_109 = { class: "actions" };
const _hoisted_110 = ["disabled"];
const _hoisted_111 = ["disabled"];
const _hoisted_112 = ["disabled"];
const _hoisted_113 = { class: "muted" };
const _hoisted_114 = { class: "event-metrics" };
const _hoisted_115 = { class: "muted" };
const _hoisted_116 = ["href"];
const _hoisted_117 = { class: "ai-batch-options" };
const _hoisted_118 = { key: 0 };
const _hoisted_119 = { class: "check-row" };
...
const _hoisted_125 = { class: "review-toolbar" };
...
const _hoisted_132 = ["checked"];
const _hoisted_133 = ["value"];
const _hoisted_134 = {
  key: 0,
  class: "actions"
};
const _hoisted_135 = ["disabled", "onClick"];
...
风险结果`, textAlign: "center", fill: "#1d1d1f", fontSize: 20, fontWeight: 700, lineHeight: 22 } },
    ...
    async function startAIBatch() {
      ...
      try {
        ...
        ElMessage.success(`任务已提交：${data.run_id}，匹配 ${data.total_count} 条，待研判 ${data.total_count} 条`);
      } catch (err) {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        activeTab.value === "dashboard" ? (openBlock(), createElementBlock("section", _hoisted_6, [
          createBaseVNode("div", {
            ...
            _cache[40] || (_cache[40] = createBaseVNode("strong", null, "外网自动采集", -1)),
          ...
          createBaseVNode("div", _hoisted_9, [
            ...
            createBaseVNode("div", _hoisted_10, [
              createBaseVNode("label", _hoisted_11, [
                _cache[42] || (_cache[42] = createTextVNode("统计窗口 ", -1)),
          ...
          visualizationError.value ? (openBlock(), createElementBlock("div", _hoisted_13, [
            ...
            createBaseVNode("div", _hoisted_15, [
              createBaseVNode("div", _hoisted_16, [
                _cache[44] || (_cache[44] = createBaseVNode("span", { class: "fw-kpi-label" }, "文章总数", -1)),
              ...
              createBaseVNode("div", _hoisted_18, [
                _cache[45] || (_cache[45] = createBaseVNode("span", { class: "fw-kpi-label" }, "数据源", -1)),
              ...
              createBaseVNode("div", _hoisted_20, [
                _cache[46] || (_cache[46] = createBaseVNode("span", { class: "fw-kpi-label" }, "风险已完成", -1)),
              ...
              createBaseVNode("div", _hoisted_22, [
                _cache[47] || (_cache[47] = createBaseVNode("span", { class: "fw-kpi-label" }, "已确认事件", -1)),
              ...
              createBaseVNode("div", _hoisted_24, [
                _cache[48] || (_cache[48] = createBaseVNode("span", { class: "fw-kpi-label" }, "外网告警", -1)),
              ...
              createBaseVNode("div", _hoisted_26, [
                _cache[49] || (_cache[49] = createBaseVNode("span", { class: "fw-kpi-label" }, "外网采集", -1)),
            ...
            createBaseVNode("div", _hoisted_28, [
              createBaseVNode("article", _hoisted_29, [
                createBaseVNode("header", _hoisted_30, [
                  _cache[50] || (_cache[50] = createBaseVNode("h3", null, "每日趋势", -1)),
              ...
              createBaseVNode("article", _hoisted_34, [
                createBaseVNode("header", _hoisted_35, [
                  _cache[51] || (_cache[51] = createBaseVNode("h3", null, "外网告警", -1)),
                ...
                !alertFeed.value.length ? (openBlock(), createElementBlock("div", _hoisted_37, "该窗口内暂无外网告警")) : (openBlock(), createElementBlock("div", _hoisted_38, [
                  createBaseVNode("div", _hoisted_39, [
                    createBaseVNode("span", _hoisted_40, [
                      _cache[52] || (_cache[52] = createBaseVNode("i", { class: "fw-sum-dot is-amber" }, null, -1)),
                      createTextVNode("待处置 " + toDisplayString(alertPendingCount.value), 1)
                    ]),
                    createBaseVNode("span", _hoisted_41, [
                      _cache[53] || (_cache[53] = createBaseVNode("i", { class: "fw-sum-dot is-teal" }, null, -1)),
              ...
              createBaseVNode("article", _hoisted_53, [
                createBaseVNode("header", _hoisted_54, [
                  _cache[54] || (_cache[54] = createBaseVNode("h3", null, "数据源分布", -1)),
              ...
              createBaseVNode("article", _hoisted_57, [
                _cache[55] || (_cache[55] = createBaseVNode("h3", null, "风险分布", -1)),
                withDirectives(createBaseVNode("div", {
              ...
              createBaseVNode("article", _hoisted_59, [
                createBaseVNode("header", _hoisted_60, [
                  _cache[56] || (_cache[56] = createBaseVNode("h3", null, "外网热词", -1)),
              ...
              createBaseVNode("article", _hoisted_63, [
                _cache[57] || (_cache[57] = createBaseVNode("h3", null, "事件状态", -1)),
        ...
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_67, [
          createBaseVNode("div", _hoisted_68, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-742e997d>全部语言</option><option value="zh" data-v-742e997d>中文</option><option value="en" data-v-742e997d>英文</option><option value="mixed" data-v-742e997d>中英混合</option><option value="unknown" data-v-742e997d>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-742e997d>全部风险等级</option><option value="high" data-v-742e997d>高</option><option value="medium" data-v-742e997d>中</option><option value="low" data-v-742e997d>低</option><option value="unknown" data-v-742e997d>未知</option>', 5)
            ])], 544), [
            ...
            _cache[63] || (_cache[63] = createBaseVNode("span", { class: "muted" }, "AI 研判结果仅用于辅助分析，不改变系统正式风险和告警", -1))
          ]),
          aiBatchRun.value ? (openBlock(), createElementBlock("div", _hoisted_72, [
            ...
            aiBatchRun.value.step ? (openBlock(), createElementBlock("span", _hoisted_73, toDisplayString(aiBatchRun.value.step), 1)) : createCommentVNode("", true),
          ...
          aiBatchRun.value && showAIBatchDetails.value ? (openBlock(), createElementBlock("div", _hoisted_74, [
            ...
            (aiBatchRun.value.failures || []).length ? (openBlock(), createElementBlock("p", _hoisted_75, "失败明细：" + toDisplayString((aiBatchRun.value.failures || []).map((item) => `#${item.opinion_id}: ${item.error}`).join("；")), 1)) : createCommentVNode("", true)
          ])) : createCommentVNode("", true),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_78, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", _hoisted_79, [
                      ...
                      createBaseVNode("span", _hoisted_80, toDisplayString(aiHistoryLabel(row)), 1)
                    ]),
                    ...
                    createBaseVNode("td", null, [
                      ...
                      !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_81, "无")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_82, [
                      ...
                      }, toDisplayString(ruleOf(row) ? "重新分析" : "分析"), 9, _hoisted_83)
                    ])
                  ], 8, _hoisted_77);
                }), 128)),
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_84, [..._cache[64] || (_cache[64] = [
                  createBaseVNode("td", {
                    colspan: "16",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_85, [
        ...
        ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_86, [
          createBaseVNode("div", _hoisted_87, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
          createBaseVNode("div", _hoisted_88, [
            ...
            }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_89),
            _cache[66] || (_cache[66] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
          ]),
          eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_90, [
          ...
          eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_91, [
            _cache[68] || (_cache[68] = createBaseVNode("strong", null, "外网事件运行失败", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(eventRunFailures.value, (run) => {
              return openBlock(), createElementBlock("div", {
                key: run.id,
                class: "event-failure-row"
              }, [
                _cache[67] || (_cache[67] = createBaseVNode("span", { class: "status failed" }, "失败", -1)),
          ...
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_93, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_94, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", _hoisted_95, [
                      ...
                      }, "确认", 8, _hoisted_96)) : createCommentVNode("", true),
                      row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn danger",
                        disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                        onClick: ($event) => rejectCandidate(row)
                      }, "拒绝", 8, _hoisted_97)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_98, [..._cache[69] || (_cache[69] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
          ...
          ])) : eventSection.value === "confirmed" ? (openBlock(), createElementBlock("div", _hoisted_99, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignEvents.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_101, toDisplayString(row.title || "无标题"), 1),
                    createBaseVNode("td", null, toDisplayString(zh(row.language)), 1),
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_104, [..._cache[71] || (_cache[71] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
          ...
          selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_105, [
            createBaseVNode("div", _hoisted_106, [
              _cache[74] || (_cache[74] = createBaseVNode("strong", null, "事件溯源", -1)),
              ...
              selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_107, [
                _cache[73] || (_cache[73] = createBaseVNode("summary", null, "聚合证据", -1)),
            ...
            createBaseVNode("p", _hoisted_113, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_115, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                createBaseVNode("a", {
                  href: opinion.url,
                  target: "_blank",
                  rel: "noreferrer",
          ...
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_117, [
              createBaseVNode("label", null, [
                _cache[76] || (_cache[76] = createTextVNode("研判范围 ", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              aiBatchConfig.scope === "count" ? (openBlock(), createElementBlock("label", _hoisted_118, [
                _cache[77] || (_cache[77] = createTextVNode("最近 N 条 ", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              aiBatchConfig.scope === "time" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                createBaseVNode("label", null, [
                  _cache[78] || (_cache[78] = createTextVNode("发布时间起始日期", -1)),
                  withDirectives(createBaseVNode("input", {
                ...
                createBaseVNode("label", null, [
                  _cache[79] || (_cache[79] = createTextVNode("发布时间结束日期", -1)),
                  withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("label", _hoisted_119, [
                ...
                _cache[80] || (_cache[80] = createTextVNode(" 仅选择当前筛选结果", -1))
              ]),
              createBaseVNode("label", _hoisted_120, [
                ...
                _cache[81] || (_cache[81] = createTextVNode(" 仅处理未完成 AI 研判的记录", -1))
              ]),
              createBaseVNode("label", _hoisted_121, [
                ...
                _cache[82] || (_cache[82] = createTextVNode(" 强制重新研判已有 AI 结果", -1))
              ]),
              aiBatchConfig.scope === "full" ? (openBlock(), createElementBlock("p", _hoisted_122, "全量任务可能消耗大量 Token 并运行较长时间。AI 结果仍须人工复核后才会进入正式事件或预警。")) : createCommentVNode("", true)
            ]),
            aiBatchPreview.value ? (openBlock(), createElementBlock("div", _hoisted_123, [
              createBaseVNode("p", null, [
                _cache[83] || (_cache[83] = createTextVNode("符合条件舆情：", -1)),
                createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.matched_count), 1),
                _cache[84] || (_cache[84] = createTextVNode(" 条", -1))
              ]),
              createBaseVNode("p", null, [
                _cache[85] || (_cache[85] = createTextVNode("已有 AI 结果：", -1)),
                createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.existing_ai_result_count), 1),
                _cache[86] || (_cache[86] = createTextVNode(" 条 · 待分析：", -1)),
                createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.pending_analysis_count), 1),
                _cache[87] || (_cache[87] = createTextVNode(" 条", -1))
              ]),
              createBaseVNode("p", null, [
                _cache[88] || (_cache[88] = createTextVNode("待分析：", -1)),
                createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.pending_analysis_count), 1),
                _cache[89] || (_cache[89] = createTextVNode(" 条 · 预计 Token：", -1)),
              ...
              _cache[90] || (_cache[90] = createBaseVNode("p", { class: "muted" }, "AI 结果必须经过人工复核后，才可用于正式事件或预警变更。", -1))
            ])) : createCommentVNode("", true),
            eventSection.value === "ai-review" ? (openBlock(), createElementBlock("div", _hoisted_124, [
              ...
              createBaseVNode("table", null, [
                createBaseVNode("thead", null, [
                  createBaseVNode("tr", null, [
                    ...
                    _cache[91] || (_cache[91] = createBaseVNode("th", null, "舆情 ID", -1)),
                    _cache[92] || (_cache[92] = createBaseVNode("th", null, "规则风险", -1)),
                    _cache[93] || (_cache[93] = createBaseVNode("th", null, "AI 风险", -1)),
                    _cache[94] || (_cache[94] = createBaseVNode("th", null, "事件影响", -1)),
                    _cache[95] || (_cache[95] = createBaseVNode("th", null, "预警影响", -1)),
                    _cache[96] || (_cache[96] = createBaseVNode("th", null, "状态", -1)),
                    _cache[97] || (_cache[97] = createBaseVNode("th", null, "操作", -1))
                  ])
                ]),
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(manualReviews.value, (review) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      review.review_status === "pending_review" ? (openBlock(), createElementBlock("td", _hoisted_134, [
                        createBaseVNode("button", {
                          class: "link-btn",
                          disabled: reviewActionId.value === review.id,
                          onClick: ($event) => decideReview(review, "use_ai_display")
                        }, "采用 AI 展示", 8, _hoisted_135),
                        createBaseVNode("button", {
                          class: "link-btn",
                          disabled: reviewActionId.value === review.id,
                      ...
                      ])) : (openBlock(), createElementBlock("td", _hoisted_140, toDisplayString(review.review_reason || "-"), 1))
                    ]);
                  }), 128)),
                  !manualReviews.value.length ? (openBlock(), createElementBlock("tr", _hoisted_141, [..._cache[98] || (_cache[98] = [
                    createBaseVNode("td", {
                      colspan: "8",
                      class: "empty"
                    }, "暂无待复核结果", -1)
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-742e997d"]]);
