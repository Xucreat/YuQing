const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CMI9WQcC.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, z as usePermission, C as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, n as normalizeClass, b as withKeys, v as vModelText, m as createVNode, p as withCtx, U as Transition, s as createCommentVNode, e as createTextVNode, t as toDisplayString, F as Fragment, i as renderList, J as vModelSelect, H as unref, V as createStaticVNode, r as ref, j as computed, g as api, E as ElMessage, N as pollTask, T as isPermissionDenied, y as resolveComponent, B as resolveDirective, o as openBlock, L as withModifiers, k as normalizeStyle, W as __vitePreload, _ as _export_sfc } from './index-C0Ka1V5k.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      ...
      const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-C0Ka1V5k.js').then(n => n.a2);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
      try {
