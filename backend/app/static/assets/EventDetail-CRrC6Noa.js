import { d as defineComponent, l as usePermission, p as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, t as toDisplayString, n as normalizeClass, e as createTextVNode, A as createCommentVNode, x as unref, k as normalizeStyle, B as createVNode, z as withCtx, F as Fragment, i as renderList, r as ref, j as computed, g as api, E as ElMessage, C as resolveComponent, D as resolveDirective, M as useRoute, o as openBlock, v as vModelText, h as useRouter, _ as _export_sfc } from './index-BITUQ8Oa.js';
import { O as OpinionDetailModal } from './OpinionDetailModal-BkZmGsKI.js';
...
const _hoisted_16 = { class: "op-modal-body" };
const _hoisted_17 = { class: "op-left" };
const _hoisted_18 = { class: "operation-header" };
const _hoisted_19 = { class: "operation-current" };
const _hoisted_20 = {
  key: 0,
...
const _hoisted_24 = { class: "note-submit-row" };
const _hoisted_25 = ["disabled"];
const _hoisted_26 = { class: "op-right" };
const _hoisted_27 = { class: "op-right-title" };
const _hoisted_28 = { class: "op-count" };
const _hoisted_29 = { class: "op-right-scroll" };
const _hoisted_30 = { class: "action-timeline" };
const _hoisted_31 = { class: "timeline-body" };
const _hoisted_32 = { class: "timeline-meta" };
const _hoisted_33 = { class: "timeline-content" };
const _hoisted_34 = {
  key: 0,
  class: "timeline-empty"
};
const _hoisted_35 = { class: "card table-card" };
const _hoisted_36 = { class: "card-header" };
const _hoisted_37 = { class: "section-title" };
const _hoisted_38 = { class: "tbl" };
const _hoisted_39 = ["onClick"];
const _hoisted_40 = { class: "t-title" };
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
            ...
            createBaseVNode("div", _hoisted_16, [
              createBaseVNode("div", _hoisted_17, [
                createBaseVNode("div", _hoisted_18, [
                  createBaseVNode("div", null, [
                    _cache[16] || (_cache[16] = createBaseVNode("h3", { class: "section-title" }, "事件处置", -1)),
                    createBaseVNode("div", _hoisted_19, [
                      _cache[15] || (_cache[15] = createTextVNode(" 当前处置状态 ", -1)),
                      createBaseVNode("span", {
                ...
                canUpdateEvent.value ? (openBlock(), createElementBlock("div", _hoisted_20, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(EVENT_STATUS_OPTIONS), (option) => {
                    ...
                    }, toDisplayString(option.label), 11, _hoisted_21);
                  }), 128))
                ])) : createCommentVNode("", true),
                canUpdateEvent.value ? (openBlock(), createElementBlock("div", _hoisted_22, [
                  ...
                  createBaseVNode("div", _hoisted_24, [
                    ...
                    createBaseVNode("button", {
                      ...
                      onClick: addNote
                    }, toDisplayString(savingNote.value ? "提交中" : "添加备注"), 9, _hoisted_25)
                  ])
                ])) : createCommentVNode("", true)
              ]),
              createBaseVNode("div", _hoisted_26, [
                createBaseVNode("div", _hoisted_27, [
                  ...
                  createBaseVNode("span", _hoisted_28, toDisplayString(event.value.actions.length), 1)
                ]),
                createBaseVNode("div", _hoisted_29, [
                  createBaseVNode("div", _hoisted_30, [
                    ...
                    event.value.actions.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_34, "暂无处置记录")) : createCommentVNode("", true)
                  ])
                ])
              ])
            ])
        ...
        createBaseVNode("div", _hoisted_35, [
          createBaseVNode("div", _hoisted_36, [
            createBaseVNode("h3", _hoisted_37, "关联舆情列表 (" + toDisplayString(event.value.total_opinions) + ")", 1)
          ]),
          createBaseVNode("table", _hoisted_38, [
            ...
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(event.value.opinions, (row) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", null, [
                    createBaseVNode("span", _hoisted_40, toDisplayString(row.title), 1)
                  ]),
              ...
              event.value.opinions.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_43, [..._cache[20] || (_cache[20] = [
                createBaseVNode("td", {
                  colspan: "7",
                  class: "empty-row"
                }, "暂无关联舆情", -1)
...
const EventDetail = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2d0e0c7b"]]);
