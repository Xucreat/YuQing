...
const _hoisted_54 = { class: "fw-card" };
const _hoisted_55 = {
  key: 0,
  class: "empty"
};
const _hoisted_56 = { class: "fw-card" };
const _hoisted_57 = {
  key: 0,
  class: "empty"
};
const _hoisted_58 = { class: "fw-card" };
const _hoisted_59 = {
  key: 0,
  class: "distribution-row"
};
const _hoisted_60 = { class: "distribution-row" };
const _hoisted_61 = {
  key: 1,
  class: "empty"
};
const _hoisted_62 = { class: "visualization-meta" };
const _hoisted_63 = {
  key: 2,
  class: "state"
};
...
const _hoisted_65 = { class: "toolbar" };
const _hoisted_66 = ["value"];
const _hoisted_67 = { class: "table-wrap tbl-scroll" };
const _hoisted_68 = ["onClick"];
const _hoisted_69 = { class: "title-cell" };
const _hoisted_70 = {
  key: 0,
  class: "muted"
};
...
const _hoisted_76 = { class: "alert-scope-note" };
const _hoisted_77 = { class: "toolbar" };
...
const _hoisted_81 = { class: "subtabs" };
const _hoisted_82 = {
  key: 2,
  class: "table-wrap"
};
const _hoisted_83 = { class: "title-cell" };
const _hoisted_84 = { class: "actions" };
...
const _hoisted_95 = { class: "event-provenance" };
const _hoisted_96 = { key: 0 };
const _hoisted_97 = { class: "event-detail-head" };
...
const _hoisted_103 = { class: "event-metrics" };
...
const _hoisted_107 = { class: "alert-scope-note" };
const _hoisted_108 = { class: "toolbar" };
...
const _hoisted_112 = { class: "table-wrap" };
const _hoisted_113 = { class: "title-cell" };
const _hoisted_114 = ["title", "onClick", "onKeydown"];
const _hoisted_115 = {
  key: 1,
  class: "alert-title"
};
const _hoisted_116 = { class: "muted" };
const _hoisted_117 = { class: "linked-cell" };
const _hoisted_118 = ["onClick"];
const _hoisted_119 = {
  key: 1,
  class: "muted"
};
const _hoisted_120 = { class: "actions" };
...
const _hoisted_127 = { class: "table-wrap" };
...
const _hoisted_134 = { class: "detail history-dialog" };
...
const _hoisted_140 = { class: "detail rule-dialog" };
const _hoisted_141 = { class: "muted" };
const _hoisted_142 = ["disabled"];
const _hoisted_143 = { class: "rule-preview" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
            ...
            createBaseVNode("div", _hoisted_25, [
              ...
              createBaseVNode("aside", _hoisted_40, [
                ...
                createBaseVNode("article", _hoisted_56, [
                  ...
                  !dashboardEvents.value || !Object.keys(dashboardEvents.value.formal_events || {}).length ? (openBlock(), createElementBlock("p", _hoisted_57, "暂无外网事件")) : createCommentVNode("", true)
                ]),
                createBaseVNode("article", _hoisted_58, [
                  _cache[50] || (_cache[50] = createBaseVNode("h3", null, "采集状态", -1)),
                  dashboardSummary.value.collection.latest ? (openBlock(), createElementBlock("div", _hoisted_59, [
                  ...
                  !dashboardSummary.value.collection.latest ? (openBlock(), createElementBlock("p", _hoisted_61, "暂无外网采集记录")) : createCommentVNode("", true)
                ])
              ])
            ]),
            createBaseVNode("div", _hoisted_62, "数据范围：" + toDisplayString(formatTime(dashboardSummary.value.window_start)) + " - " + toDisplayString(formatTime(dashboardSummary.value.window_end)) + " · 更新于：" + toDisplayString(formatTime(dashboardSummary.value.data_as_of)), 1)
          ])) : (openBlock(), createElementBlock("div", _hoisted_63, "加载外网看板中..."))
        ])) : createCommentVNode("", true),
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_64, [
          createBaseVNode("div", _hoisted_65, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(opinionSources.value, (source) => {
                return openBlock(), createElementBlock("option", {
                  key: source,
                  value: source
                }, toDisplayString(source), 9, _hoisted_66);
              }), 128))
            ], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-134efb51>全部语言</option><option value="zh" data-v-134efb51>中文</option><option value="en" data-v-134efb51>英文</option><option value="mixed" data-v-134efb51>中英混合</option><option value="unknown" data-v-134efb51>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-134efb51>全部风险等级</option><option value="high" data-v-134efb51>高</option><option value="medium" data-v-134efb51>中</option><option value="low" data-v-134efb51>低</option><option value="unknown" data-v-134efb51>未知</option>', 5)
            ])], 544), [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_69, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", null, [
                      ...
                      !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_70, "无")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_71, [
                      ...
                      }, "重新分析", 8, _hoisted_72)) : createCommentVNode("", true)
                    ])
                  ], 8, _hoisted_68);
                }), 128)),
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_73, [..._cache[56] || (_cache[56] = [
                  createBaseVNode("td", {
                    colspan: "14",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_74, [
        ...
        ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_75, [
          createBaseVNode("div", _hoisted_76, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
          createBaseVNode("div", _hoisted_77, [
            ...
            }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_78),
            _cache[58] || (_cache[58] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
          ]),
          eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_79, [
          ...
          eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_80, [
          ...
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_82, [
            createBaseVNode("table", null, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_84, [
                      ...
                      }, "确认", 8, _hoisted_85)) : createCommentVNode("", true),
                      row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn danger",
                        disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                        onClick: ($event) => rejectCandidate(row)
                      }, "拒绝", 8, _hoisted_86)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_87, [..._cache[61] || (_cache[61] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
            ...
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_93, [..._cache[63] || (_cache[63] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
          ...
          selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_94, [
            createBaseVNode("div", _hoisted_95, [
              ...
              selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_96, [
            ...
            createBaseVNode("p", _hoisted_102, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_104, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                createBaseVNode("a", {
                  href: opinion.url,
                  target: "_blank",
                  rel: "noreferrer",
        ...
        ])) : activeTab.value === "alerts" ? (openBlock(), createElementBlock("section", _hoisted_106, [
          createBaseVNode("div", _hoisted_107, "外网自动告警评估：" + toDisplayString(alertAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(alertAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 外部通知：" + toDisplayString(alertAutoStatus.value?.external_notifications_enabled ? "已启用" : "已停用"), 1),
          createBaseVNode("div", _hoisted_108, [
            ...
            }, toDisplayString(alertEvaluating.value ? "评估中..." : "手动 Dry-Run"), 9, _hoisted_109),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => alertFilters.status = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[67] || (_cache[67] = [
              createStaticVNode('<option value="" data-v-134efb51>全部状态</option><option value="triggered" data-v-134efb51>待处理</option><option value="acknowledged" data-v-134efb51>已确认</option><option value="resolved" data-v-134efb51>已解决</option><option value="suppressed" data-v-134efb51>已抑制</option><option value="failed" data-v-134efb51>失败</option>', 6)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-134efb51>全部严重度</option><option value="low" data-v-134efb51>低</option><option value="medium" data-v-134efb51>中</option><option value="high" data-v-134efb51>高</option><option value="critical" data-v-134efb51>紧急</option>', 5)
            ])], 544), [
          ...
          alertLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_110, [
          ...
          alertRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_111, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignAlerts.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_113, [
                      ...
                      }, toDisplayString(row.title || "无标题告警"), 41, _hoisted_114)) : (openBlock(), createElementBlock("strong", _hoisted_115, toDisplayString(row.title || "无标题告警"), 1)),
                      createBaseVNode("div", _hoisted_116, toDisplayString(row.message), 1)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_117, [
                      ...
                      }, toDisplayString(row.opinion_title_snapshot || "#" + row.foreign_opinion_id), 9, _hoisted_118)) : (openBlock(), createElementBlock("span", _hoisted_119, "-"))
                    ]),
                    ...
                    createBaseVNode("td", _hoisted_120, [
                      ...
                      }, "确认", 8, _hoisted_122)) : createCommentVNode("", true),
                      ...
                      }, "解决", 8, _hoisted_123)) : createCommentVNode("", true),
                      row.status === "triggered" || row.status === "acknowledged" ? (openBlock(), createElementBlock("button", {
                        key: 2,
                        class: "link-btn danger",
                      ...
                      }, "抑制", 8, _hoisted_124)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !foreignAlerts.value.length ? (openBlock(), createElementBlock("tr", _hoisted_125, [..._cache[72] || (_cache[72] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无外网告警记录", -1)
        ...
        ])) : activeTab.value === "alertRules" ? (openBlock(), createElementBlock("section", _hoisted_126, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(alertRules.value, (rule) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_128, [
                      ...
                      }, "停用", 8, _hoisted_130)) : (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn",
                      ...
                      }, "删除", 8, _hoisted_132)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !alertRules.value.length ? (openBlock(), createElementBlock("tr", _hoisted_133, [..._cache[76] || (_cache[76] = [
                  createBaseVNode("td", {
                    colspan: "7",
                    class: "empty"
                  }, "暂无外网告警规则", -1)
        ...
        historyAlert.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_134, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭处置历史",
            ...
            createBaseVNode("p", _hoisted_135, toDisplayString(historyAlert.value.title || "告警 #" + historyAlert.value.id) + " · 当前状态：" + toDisplayString(zh(historyAlert.value.status)), 1),
            alertActionsLoading.value ? (openBlock(), createElementBlock("div", _hoisted_136, "处置历史加载中...")) : !alertActions.value.length ? (openBlock(), createElementBlock("div", _hoisted_137, "暂无处置历史")) : (openBlock(), createElementBlock("div", _hoisted_138, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(alertActions.value, (action) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_139, "操作人 #" + toDisplayString(action.actor_id ?? "-") + " · " + toDisplayString(formatTime(action.created_at)), 1)
                ]);
              }), 128))
            ]))
          ])
          ...
          createBaseVNode("article", _hoisted_140, [
            ...
            createBaseVNode("label", null, [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="risk_score" data-v-134efb51>风险分</option><option value="risk_level" data-v-134efb51>风险等级</option><option value="risk_category" data-v-134efb51>风险类别</option><option value="confirmed_event" data-v-134efb51>确认事件</option><option value="keyword_combo" data-v-134efb51>关键词组合</option>', 5)
              ])], 512), [
            ...
            createBaseVNode("div", _hoisted_144, [
              ...
              }, toDisplayString(alertRuleSaving.value ? "保存中..." : "保存规则"), 9, _hoisted_145)
            ])
          ])
        ])) : createCommentVNode("", true),
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-134efb51"]]);
