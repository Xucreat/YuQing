...
const _hoisted_29 = { class: "op-modal-body" };
const _hoisted_30 = { class: "op-left" };
const _hoisted_31 = { class: "operation-header" };
const _hoisted_32 = { class: "operation-current" };
const _hoisted_33 = {
  key: 0,
...
const _hoisted_37 = { class: "note-submit-row" };
const _hoisted_38 = ["disabled"];
const _hoisted_39 = { class: "op-right" };
const _hoisted_40 = { class: "op-right-title" };
const _hoisted_41 = { class: "op-count" };
const _hoisted_42 = { class: "op-right-scroll" };
const _hoisted_43 = { class: "action-timeline" };
const _hoisted_44 = { class: "timeline-body" };
const _hoisted_45 = { class: "timeline-meta" };
const _hoisted_46 = { class: "timeline-content" };
const _hoisted_47 = {
  key: 0,
  class: "timeline-empty"
};
const _hoisted_48 = { class: "card table-card" };
const _hoisted_49 = { class: "tbl" };
const _hoisted_50 = ["onClick"];
const _hoisted_51 = { class: "t-title" };
const _hoisted_52 = { class: "col-center" };
const _hoisted_53 = { class: "col-center risk-num" };
const _hoisted_54 = { class: "col-center" };
const _hoisted_55 = { key: 0 };
const _hoisted_56 = { class: "tbl" };
const _hoisted_57 = { class: "t-title" };
const _hoisted_58 = { class: "col-center" };
const _hoisted_59 = { class: "col-center" };
const _hoisted_60 = { class: "col-center" };
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("section", _hoisted_3, [
          ...
          createBaseVNode("div", _hoisted_9, [
            ...
            createBaseVNode("div", _hoisted_13, [
              _cache[13] || (_cache[13] = createBaseVNode("span", { class: "situation-label" }, "正式记录风险", -1)),
            ...
            event.value.linked_opinion_current_risk ? (openBlock(), createElementBlock("div", _hoisted_14, [
              _cache[14] || (_cache[14] = createBaseVNode("span", { class: "situation-label" }, "关联舆情当前风险", -1)),
              createBaseVNode("strong", {
            ...
            createBaseVNode("div", _hoisted_15, [
              _cache[15] || (_cache[15] = createBaseVNode("span", { class: "situation-label" }, "当前热度", -1)),
              createBaseVNode("strong", null, toDisplayString(event.value.heat_score) + " 分", 1)
            ]),
            createBaseVNode("div", _hoisted_16, [
              _cache[16] || (_cache[16] = createBaseVNode("span", { class: "situation-label" }, "发展趋势", -1)),
        ...
        event.value.statistics || situation.value ? (openBlock(), createElementBlock("section", _hoisted_17, [
          _cache[25] || (_cache[25] = createBaseVNode("h3", { class: "section-title" }, "研判与统计", -1)),
          createBaseVNode("div", _hoisted_18, [
            event.value.statistics?.source_count != null || situation.value?.source_distribution?.length ? (openBlock(), createElementBlock("div", _hoisted_19, [
              _cache[17] || (_cache[17] = createBaseVNode("span", { class: "stat-label" }, "来源数量", -1)),
            ...
            situation.value?.data_window?.first_time || situation.value?.data_window?.last_time ? (openBlock(), createElementBlock("div", _hoisted_20, [
              _cache[18] || (_cache[18] = createBaseVNode("span", { class: "stat-label" }, "时间范围", -1)),
            ...
            event.value.statistics ? (openBlock(), createElementBlock("div", _hoisted_21, [
              _cache[22] || (_cache[22] = createBaseVNode("span", { class: "stat-label" }, "风险分布", -1)),
            ...
            situation.value?.risk_shadow ? (openBlock(), createElementBlock("div", _hoisted_26, [
              _cache[23] || (_cache[23] = createBaseVNode("span", { class: "stat-label" }, "影子风险", -1)),
            ...
            situation.value?.data_sufficiency ? (openBlock(), createElementBlock("div", _hoisted_27, [
              _cache[24] || (_cache[24] = createBaseVNode("span", { class: "stat-label" }, "数据充分性", -1)),
          ...
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_29, [
              createBaseVNode("div", _hoisted_30, [
                createBaseVNode("div", _hoisted_31, [
                  createBaseVNode("div", null, [
                    createBaseVNode("div", _hoisted_32, [
                      _cache[26] || (_cache[26] = createTextVNode(" 当前处置状态 ", -1)),
                      createBaseVNode("span", {
                ...
                canUpdateEvent.value ? (openBlock(), createElementBlock("div", _hoisted_33, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(EVENT_STATUS_OPTIONS), (option) => {
                    ...
                    }, toDisplayString(option.value === "deprecated" ? "忽略事件" : option.label), 11, _hoisted_34);
                  }), 128))
                ])) : createCommentVNode("", true),
                canUpdateEvent.value ? (openBlock(), createElementBlock("div", _hoisted_35, [
                  ...
                  createBaseVNode("div", _hoisted_37, [
                    ...
                    createBaseVNode("button", {
                      ...
                      onClick: addNote
                    }, toDisplayString(savingNote.value ? "提交中" : "添加备注"), 9, _hoisted_38)
                  ])
                ])) : createCommentVNode("", true)
              ]),
              createBaseVNode("div", _hoisted_39, [
                createBaseVNode("div", _hoisted_40, [
                  _cache[27] || (_cache[27] = createTextVNode(" 处置记录", -1)),
                  createBaseVNode("span", _hoisted_41, toDisplayString(event.value.actions.length), 1)
                ]),
                  ...
                  createBaseVNode("div", _hoisted_43, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(event.value.actions, (action) => {
                      return openBlock(), createElementBlock("div", {
                        ...
                        _cache[28] || (_cache[28] = createBaseVNode("span", { class: "timeline-dot" }, null, -1)),
                    ...
                    event.value.actions.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_47, "暂无处置记录")) : createCommentVNode("", true)
                  ])
                ])
              ])
            ])
                ...
                default: withCtx(() => [
                  createBaseVNode("table", _hoisted_49, [
                    ...
                    createBaseVNode("tbody", null, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(event.value.opinions, (row) => {
                        return openBlock(), createElementBlock("tr", {
                          ...
                          createBaseVNode("td", null, [
                            createBaseVNode("span", _hoisted_51, toDisplayString(row.title), 1)
                          ]),
                          ...
                          createBaseVNode("td", _hoisted_52, [
                            createBaseVNode("span", {
                              ...
                              _cache[29] || (_cache[29] = createBaseVNode("span", { class: "dot" }, null, -1)),
                          ...
                          createBaseVNode("td", _hoisted_53, toDisplayString(row.risk_score ?? "-"), 1),
                      ...
                      event.value.opinions.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_55, [..._cache[30] || (_cache[30] = [
                        createBaseVNode("td", {
                          colspan: "8",
                          class: "empty-row"
                        }, "暂无关联舆情", -1)
                    ...
                    createBaseVNode("tbody", null, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(event.value.alerts || [], (a) => {
                        return openBlock(), createElementBlock("tr", {
                          ...
                          createBaseVNode("td", null, [
                            createBaseVNode("span", _hoisted_57, toDisplayString(a.title), 1)
                          ]),
                          ...
                          createBaseVNode("td", _hoisted_59, toDisplayString(a.linked_opinion_current_risk ? `${a.linked_opinion_current_risk.risk_score ?? "-"} · ${riskText(a.linked_opinion_current_risk.risk_level)}` : "-"), 1),
                          createBaseVNode("td", _hoisted_60, toDisplayString(alertStatusText(a.status)), 1),
                          createBaseVNode("td", null, toDisplayString(formatTime(a.created_at)), 1)
                        ]);
                      }), 128)),
                      (event.value.alerts?.length || 0) === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_61, [..._cache[33] || (_cache[33] = [
                        createBaseVNode("td", {
                          colspan: "5",
                          class: "empty-row"
                        }, "暂无关联预警", -1)
...
const EventDetail = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cb7e199b"]]);
