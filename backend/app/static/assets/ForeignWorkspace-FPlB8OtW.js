...
const _hoisted_5 = { class: "tab-actions" };
...
const _hoisted_26 = { class: "fw-dash-body" };
const _hoisted_27 = { class: "fw-card fw-card-source" };
...
const _hoisted_31 = { class: "fw-card fw-card-hotword" };
...
const _hoisted_35 = { class: "fw-card fw-card-trend" };
...
const _hoisted_40 = { class: "fw-card fw-card-alert fw-alert-card" };
...
const _hoisted_48 = { class: "fw-alert-copy" };
const _hoisted_49 = { class: "fw-alert-list" };
const _hoisted_50 = ["onClick"];
const _hoisted_51 = { class: "fw-alert-main" };
const _hoisted_52 = { class: "fw-alert-title" };
const _hoisted_53 = { class: "fw-alert-meta" };
const _hoisted_54 = {
  key: 0,
  class: "fw-alert-copy"
};
const _hoisted_55 = { class: "fw-alert-list" };
const _hoisted_56 = ["onClick"];
const _hoisted_57 = { class: "fw-alert-main" };
const _hoisted_58 = { class: "fw-alert-title" };
const _hoisted_59 = { class: "fw-alert-meta" };
const _hoisted_60 = { class: "fw-card fw-card-risk" };
const _hoisted_61 = {
  key: 0,
  class: "empty"
};
const _hoisted_62 = { class: "fw-card fw-card-events" };
const _hoisted_63 = {
  key: 0,
  class: "empty"
};
const _hoisted_64 = { class: "fw-card fw-card-collection" };
const _hoisted_65 = {
  key: 0,
  class: "distribution-row"
};
const _hoisted_66 = { class: "distribution-row" };
const _hoisted_67 = {
  key: 1,
  class: "empty"
};
const _hoisted_68 = { class: "visualization-meta" };
const _hoisted_69 = {
  key: 2,
  class: "state"
};
...
const _hoisted_73 = { class: "table-wrap tbl-scroll" };
const _hoisted_74 = ["onClick"];
const _hoisted_75 = { class: "title-cell" };
const _hoisted_76 = {
  key: 0,
  class: "muted"
};
const _hoisted_77 = { class: "actions" };
...
const _hoisted_82 = { class: "alert-scope-note" };
...
const _hoisted_87 = { class: "subtabs" };
const _hoisted_88 = {
  key: 2,
  class: "table-wrap"
};
const _hoisted_89 = { class: "title-cell" };
const _hoisted_90 = { class: "actions" };
...
const _hoisted_96 = { class: "title-cell" };
...
const _hoisted_101 = { class: "event-provenance" };
const _hoisted_102 = { key: 0 };
const _hoisted_103 = { class: "event-detail-head" };
const _hoisted_104 = { class: "actions" };
const _hoisted_105 = ["disabled"];
const _hoisted_106 = ["disabled"];
const _hoisted_107 = ["disabled"];
const _hoisted_108 = { class: "muted" };
const _hoisted_109 = { class: "event-metrics" };
const _hoisted_110 = { class: "muted" };
const _hoisted_111 = ["href"];
const _hoisted_112 = {
  key: 3,
  class: "panel"
};
const _hoisted_113 = { class: "alert-scope-note" };
const _hoisted_114 = { class: "toolbar" };
...
const _hoisted_118 = { class: "table-wrap" };
const _hoisted_119 = { class: "title-cell" };
const _hoisted_120 = ["title", "onClick", "onKeydown"];
const _hoisted_121 = {
  key: 1,
  class: "alert-title"
};
const _hoisted_122 = { class: "muted" };
const _hoisted_123 = { class: "linked-cell" };
const _hoisted_124 = ["onClick"];
const _hoisted_125 = {
  key: 1,
  class: "muted"
};
const _hoisted_126 = { class: "actions" };
const _hoisted_127 = ["onClick"];
const _hoisted_128 = ["disabled", "onClick"];
...
const _hoisted_133 = { class: "table-wrap" };
const _hoisted_134 = { class: "actions" };
...
const _hoisted_140 = { class: "detail history-dialog" };
...
const _hoisted_145 = { class: "muted" };
const _hoisted_146 = { class: "detail rule-dialog" };
const _hoisted_147 = { class: "muted" };
const _hoisted_148 = ["disabled"];
const _hoisted_149 = { class: "rule-preview" };
const _hoisted_150 = { class: "actions" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function renderSourceChart() {
      if (!sourceChart || !dashboardSources.value) return;
      const items = dashboardSources.value.items || [];
      const sorted = [...items].sort((a, b) => (b.opinion_count || 0) - (a.opinion_count || 0)).slice(0, 10);
      const names = sorted.map((i) => i.source_name_snapshot || i.source || i.source_key || "未知");
      const values = sorted.map((i) => i.opinion_count || 0);
      sourceChart.setOption({
        tooltip: { trigger: "axis", axisPointer: { type: "shadow" } },
        grid: { left: 16, right: 24, top: 8, bottom: 8 },
        xAxis: { type: "value", splitLine: { lineStyle: { color: "#f0f0f3" } }, axisLabel: { color: "#86868b" } },
        yAxis: {
          type: "category",
          data: names,
          inverse: true,
          axisLine: { show: false },
          axisTick: { show: false },
          axisLabel: { color: "#1d1d1f", fontSize: 12, width: 110, overflow: "truncate" }
        },
        series: [{
          type: "bar",
          data: values,
          ...
          itemStyle: {
            ...
            color: new LinearGradient(0, 0, 1, 0, [{ offset: 0, color: "#0a84ff" }, { offset: 1, color: "#0071e3" }])
          }
        }]
      }, { notMerge: true });
    }
    ...
    async function loadDashboard() {
      ...
      try {
        ...
        const [summary, trends, risk, events, alerts, sourceStats, hotwords, hotwordTrends, alertFeedData] = await Promise.all([
          ...
          api.get("/foreign/alerts", { params: { size: 30 } }).catch(() => emptyItems)
        ]);
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[88] || (_cache[88] = createBaseVNode("div", { class: "toolbar" }, [
          createBaseVNode("span", { class: "source-scope-label" }, "已批准数据源：57-60")
        ], -1)),
        createBaseVNode("div", _hoisted_2, [
          ...
          createBaseVNode("div", _hoisted_5, [
            createBaseVNode("button", {
              ...
              onClick: collectNow
            }, toDisplayString(collecting.value ? "采集中..." : "采集外网 RSS"), 9, _hoisted_6),
            createBaseVNode("button", {
              class: "btn btn-secondary btn-sm",
              disabled: collecting.value,
              onClick: collectAll
            }, "采集全部数据源", 8, _hoisted_7)
          ])
        ]),
          ...
          createBaseVNode("div", _hoisted_9, [
            ...
            createBaseVNode("div", _hoisted_10, [
              createBaseVNode("label", _hoisted_11, [
                _cache[32] || (_cache[32] = createTextVNode("统计窗口 ", -1)),
          ...
          visualizationError.value ? (openBlock(), createElementBlock("div", _hoisted_13, [
            ...
            createBaseVNode("div", _hoisted_15, [
              createBaseVNode("div", _hoisted_16, [
                _cache[34] || (_cache[34] = createBaseVNode("span", { class: "fw-kpi-label" }, "文章总数", -1)),
              ...
              createBaseVNode("div", _hoisted_18, [
                _cache[35] || (_cache[35] = createBaseVNode("span", { class: "fw-kpi-label" }, "数据源", -1)),
              ...
              createBaseVNode("div", _hoisted_20, [
                _cache[36] || (_cache[36] = createBaseVNode("span", { class: "fw-kpi-label" }, "风险已完成", -1)),
              ...
              createBaseVNode("div", _hoisted_22, [
                _cache[37] || (_cache[37] = createBaseVNode("span", { class: "fw-kpi-label" }, "已确认事件", -1)),
              ...
              createBaseVNode("div", _hoisted_24, [
                _cache[38] || (_cache[38] = createBaseVNode("span", { class: "fw-kpi-label" }, "外网告警", -1)),
            ...
            createBaseVNode("div", _hoisted_26, [
              createBaseVNode("article", _hoisted_27, [
                createBaseVNode("header", _hoisted_28, [
                  _cache[39] || (_cache[39] = createBaseVNode("h3", null, "数据源分布", -1)),
              ...
              createBaseVNode("article", _hoisted_31, [
                createBaseVNode("header", _hoisted_32, [
                  _cache[40] || (_cache[40] = createBaseVNode("h3", null, "外网热词", -1)),
                  createBaseVNode("span", _hoisted_33, "近 " + toDisplayString(visualizationDays.value) + " 天 · 共 " + toDisplayString(hotwordItems.value.length) + " 个热词", 1)
                ]),
                withDirectives(createBaseVNode("div", {
                ...
                !hotwordItems.value.length ? (openBlock(), createElementBlock("p", _hoisted_34, "该窗口内暂无外网热词")) : createCommentVNode("", true)
              ]),
              ...
              createBaseVNode("article", _hoisted_40, [
                createBaseVNode("header", _hoisted_41, [
                  _cache[42] || (_cache[42] = createBaseVNode("h3", null, "外网告警", -1)),
                ...
                !alertFeed.value.length ? (openBlock(), createElementBlock("div", _hoisted_43, "该窗口内暂无外网告警")) : (openBlock(), createElementBlock("div", _hoisted_44, [
                  createBaseVNode("div", _hoisted_45, [
                    createBaseVNode("span", _hoisted_46, [
                      _cache[43] || (_cache[43] = createBaseVNode("i", { class: "fw-sum-dot is-amber" }, null, -1)),
                      createTextVNode("待处置 " + toDisplayString(alertPendingCount.value), 1)
                    ]),
                    createBaseVNode("span", _hoisted_47, [
                      _cache[44] || (_cache[44] = createBaseVNode("i", { class: "fw-sum-dot is-teal" }, null, -1)),
                  ...
                  createBaseVNode("div", {
                    ...
                    createBaseVNode("div", {
                          ...
                          (openBlock(true), createElementBlock(Fragment, null, renderList(alertFeed.value, (a) => {
                            return openBlock(), createElementBlock("li", {
                              ...
                              createBaseVNode("div", _hoisted_51, [
                                createBaseVNode("div", _hoisted_52, toDisplayString(a.title || "未命名告警"), 1),
                                createBaseVNode("div", _hoisted_53, toDisplayString(a.rule_snapshot?.name || a.source_name_snapshot || "外网告警") + " · " + toDisplayString(shortTime(a.triggered_at)), 1)
                              ]),
                              createBaseVNode("span", {
                      ...
                      alertNeedScroll.value ? (openBlock(), createElementBlock("div", _hoisted_54, [
                          ...
                          (openBlock(true), createElementBlock(Fragment, null, renderList(alertFeed.value, (a) => {
                            return openBlock(), createElementBlock("li", {
                              ...
                              createBaseVNode("div", _hoisted_57, [
                                createBaseVNode("div", _hoisted_58, toDisplayString(a.title || "未命名告警"), 1),
                                createBaseVNode("div", _hoisted_59, toDisplayString(a.rule_snapshot?.name || a.source_name_snapshot || "外网告警") + " · " + toDisplayString(shortTime(a.triggered_at)), 1)
                              ]),
                              createBaseVNode("span", {
                                class: normalizeClass(["fw-badge", isHandled(a.status) ? "is-teal" : "is-amber"])
                              }, toDisplayString(zh(a.status)), 3)
              ...
              createBaseVNode("article", _hoisted_60, [
                _cache[45] || (_cache[45] = createBaseVNode("h3", null, "风险分布", -1)),
                ...
                !dashboardRisk.value || !Object.keys(dashboardRisk.value.risk_levels || {}).length ? (openBlock(), createElementBlock("p", _hoisted_61, "暂无已完成风险结果")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_62, [
                _cache[46] || (_cache[46] = createBaseVNode("h3", null, "事件状态", -1)),
                ...
                !dashboardEvents.value || !Object.keys(dashboardEvents.value.formal_events || {}).length ? (openBlock(), createElementBlock("p", _hoisted_63, "暂无外网事件")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_64, [
                _cache[49] || (_cache[49] = createBaseVNode("h3", null, "采集状态", -1)),
                dashboardSummary.value.collection.latest ? (openBlock(), createElementBlock("div", _hoisted_65, [
                  _cache[47] || (_cache[47] = createBaseVNode("span", null, "最近一次", -1)),
                  createBaseVNode("strong", null, toDisplayString(zh(dashboardSummary.value.collection.latest.status)), 1)
                ])) : createCommentVNode("", true),
                createBaseVNode("div", _hoisted_66, [
                  _cache[48] || (_cache[48] = createBaseVNode("span", null, "成功 / 失败", -1)),
                ...
                !dashboardSummary.value.collection.latest ? (openBlock(), createElementBlock("p", _hoisted_67, "暂无外网采集记录")) : createCommentVNode("", true)
              ])
            ]),
            createBaseVNode("div", _hoisted_68, "数据范围：" + toDisplayString(formatTime(dashboardSummary.value.window_start)) + " - " + toDisplayString(formatTime(dashboardSummary.value.window_end)) + " · 更新于：" + toDisplayString(formatTime(dashboardSummary.value.data_as_of)), 1)
          ])) : (openBlock(), createElementBlock("div", _hoisted_69, "加载外网看板中..."))
        ])) : createCommentVNode("", true),
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_70, [
          createBaseVNode("div", _hoisted_71, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-4fb33360>全部语言</option><option value="zh" data-v-4fb33360>中文</option><option value="en" data-v-4fb33360>英文</option><option value="mixed" data-v-4fb33360>中英混合</option><option value="unknown" data-v-4fb33360>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-4fb33360>全部风险等级</option><option value="high" data-v-4fb33360>高</option><option value="medium" data-v-4fb33360>中</option><option value="low" data-v-4fb33360>低</option><option value="unknown" data-v-4fb33360>未知</option>', 5)
            ])], 544), [
            ...
            _cache[54] || (_cache[54] = createBaseVNode("span", { class: "muted" }, "以舆情为主，右侧为已关联的风险研判（未分析显示 -）", -1))
          ]),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_75, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", null, [
                      ...
                      !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_76, "无")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_77, [
                      ...
                      }, "重新分析", 8, _hoisted_78)) : createCommentVNode("", true)
                    ])
                  ], 8, _hoisted_74);
                }), 128)),
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_79, [..._cache[55] || (_cache[55] = [
                  createBaseVNode("td", {
                    colspan: "14",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_80, [
        ...
        ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_81, [
          createBaseVNode("div", _hoisted_82, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
          createBaseVNode("div", _hoisted_83, [
            ...
            }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_84),
            _cache[57] || (_cache[57] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
          ]),
          eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_85, [
          ...
          eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_86, [
            _cache[59] || (_cache[59] = createBaseVNode("strong", null, "外网事件运行失败", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(eventRunFailures.value, (run) => {
              return openBlock(), createElementBlock("div", {
                key: run.id,
                class: "event-failure-row"
              }, [
                _cache[58] || (_cache[58] = createBaseVNode("span", { class: "status failed" }, "失败", -1)),
          ...
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_88, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_89, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", _hoisted_90, [
                      ...
                      }, "确认", 8, _hoisted_91)) : createCommentVNode("", true),
                      row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn danger",
                        disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                        onClick: ($event) => rejectCandidate(row)
                      }, "拒绝", 8, _hoisted_92)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_93, [..._cache[60] || (_cache[60] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignEvents.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_96, toDisplayString(row.title || "无标题"), 1),
                    createBaseVNode("td", null, toDisplayString(zh(row.language)), 1),
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_99, [..._cache[62] || (_cache[62] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
          ...
          selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_100, [
            createBaseVNode("div", _hoisted_101, [
              _cache[65] || (_cache[65] = createBaseVNode("strong", null, "事件溯源", -1)),
              ...
              selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_102, [
                _cache[64] || (_cache[64] = createBaseVNode("summary", null, "聚合证据", -1)),
            ...
            createBaseVNode("p", _hoisted_108, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_110, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                createBaseVNode("a", {
                  href: opinion.url,
                  target: "_blank",
                  rel: "noreferrer",
        ...
        ])) : activeTab.value === "alerts" ? (openBlock(), createElementBlock("section", _hoisted_112, [
          createBaseVNode("div", _hoisted_113, "外网自动告警评估：" + toDisplayString(alertAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(alertAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 外部通知：" + toDisplayString(alertAutoStatus.value?.external_notifications_enabled ? "已启用" : "已停用"), 1),
          createBaseVNode("div", _hoisted_114, [
            ...
            }, toDisplayString(alertEvaluating.value ? "评估中..." : "手动 Dry-Run"), 9, _hoisted_115),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => alertFilters.status = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[66] || (_cache[66] = [
              createStaticVNode('<option value="" data-v-4fb33360>全部状态</option><option value="triggered" data-v-4fb33360>待处理</option><option value="acknowledged" data-v-4fb33360>已确认</option><option value="resolved" data-v-4fb33360>已解决</option><option value="suppressed" data-v-4fb33360>已抑制</option><option value="failed" data-v-4fb33360>失败</option>', 6)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-4fb33360>全部严重度</option><option value="low" data-v-4fb33360>低</option><option value="medium" data-v-4fb33360>中</option><option value="high" data-v-4fb33360>高</option><option value="critical" data-v-4fb33360>紧急</option>', 5)
            ])], 544), [
              [vModelSelect, alertFilters.severity]
            ]),
            _cache[68] || (_cache[68] = createBaseVNode("span", { class: "muted" }, "告警评估默认关闭 · 外部通知默认关闭 · 当前仅保存站内记录", -1))
          ]),
          _cache[73] || (_cache[73] = createBaseVNode("div", { class: "alert-scope-note" }, " 外网告警只读取外网风险和已确认外网事件；不会进入国内告警、Dashboard、地图、热词或事件链路。 ", -1)),
          alertLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_116, [
          ...
          alertRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_117, [
            _cache[70] || (_cache[70] = createBaseVNode("strong", null, "外网告警评估失败", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(alertRunFailures.value, (run) => {
              return openBlock(), createElementBlock("div", {
                key: run.id,
                class: "alert-failure-row"
              }, [
                _cache[69] || (_cache[69] = createBaseVNode("span", { class: "status failed" }, "失败", -1)),
                createBaseVNode("span", null, toDisplayString(formatTime(run.finished_at || run.started_at)), 1),
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignAlerts.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_119, [
                      ...
                      }, toDisplayString(row.title || "无标题告警"), 41, _hoisted_120)) : (openBlock(), createElementBlock("strong", _hoisted_121, toDisplayString(row.title || "无标题告警"), 1)),
                      createBaseVNode("div", _hoisted_122, toDisplayString(row.message), 1)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_123, [
                      ...
                      }, toDisplayString(row.opinion_title_snapshot || "#" + row.foreign_opinion_id), 9, _hoisted_124)) : (openBlock(), createElementBlock("span", _hoisted_125, "-"))
                    ]),
                    ...
                    createBaseVNode("td", _hoisted_126, [
                      ...
                      }, "确认", 8, _hoisted_128)) : createCommentVNode("", true),
                      ...
                      }, "解决", 8, _hoisted_129)) : createCommentVNode("", true),
                      row.status === "triggered" || row.status === "acknowledged" ? (openBlock(), createElementBlock("button", {
                        key: 2,
                        class: "link-btn danger",
                      ...
                      }, "抑制", 8, _hoisted_130)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !foreignAlerts.value.length ? (openBlock(), createElementBlock("tr", _hoisted_131, [..._cache[71] || (_cache[71] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无外网告警记录", -1)
        ...
        ])) : activeTab.value === "alertRules" ? (openBlock(), createElementBlock("section", _hoisted_132, [
          createBaseVNode("div", { class: "toolbar" }, [
            ...
            _cache[74] || (_cache[74] = createBaseVNode("span", { class: "muted" }, "外网规则独立管理；新规则保存后默认停用。", -1))
          ]),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(alertRules.value, (rule) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_134, [
                      createBaseVNode("button", {
                        class: "link-btn",
                      ...
                      }, "停用", 8, _hoisted_136)) : (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn",
                      ...
                      }, "删除", 8, _hoisted_138)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !alertRules.value.length ? (openBlock(), createElementBlock("tr", _hoisted_139, [..._cache[75] || (_cache[75] = [
                  createBaseVNode("td", {
                    colspan: "7",
                    class: "empty"
                  }, "暂无外网告警规则", -1)
        ...
        historyAlert.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_140, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭处置历史",
              onClick: _cache[18] || (_cache[18] = ($event) => historyAlert.value = null)
            }, "×"),
            _cache[77] || (_cache[77] = createBaseVNode("h3", null, "外网告警处置历史", -1)),
            createBaseVNode("p", _hoisted_141, toDisplayString(historyAlert.value.title || "告警 #" + historyAlert.value.id) + " · 当前状态：" + toDisplayString(zh(historyAlert.value.status)), 1),
            alertActionsLoading.value ? (openBlock(), createElementBlock("div", _hoisted_142, "处置历史加载中...")) : !alertActions.value.length ? (openBlock(), createElementBlock("div", _hoisted_143, "暂无处置历史")) : (openBlock(), createElementBlock("div", _hoisted_144, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(alertActions.value, (action) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_145, "操作人 #" + toDisplayString(action.actor_id ?? "-") + " · " + toDisplayString(formatTime(action.created_at)), 1)
                ]);
              }), 128))
            ]))
          ])
        ...
        alertRuleEditorVisible.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_146, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭规则编辑",
            ...
            createBaseVNode("label", null, [
              _cache[78] || (_cache[78] = createTextVNode("规则名称", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[80] || (_cache[80] = createTextVNode("规则类型", -1)),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => alertRuleDraft.rule_type = $event),
                class: "input"
              }, [..._cache[79] || (_cache[79] = [
                createStaticVNode('<option value="risk_score" data-v-4fb33360>风险分</option><option value="risk_level" data-v-4fb33360>风险等级</option><option value="risk_category" data-v-4fb33360>风险类别</option><option value="confirmed_event" data-v-4fb33360>确认事件</option><option value="keyword_combo" data-v-4fb33360>关键词组合</option>', 5)
              ])], 512), [
                [vModelSelect, alertRuleDraft.rule_type]
              ])
            ]),
            createBaseVNode("label", null, [
              _cache[81] || (_cache[81] = createTextVNode("风险阈值或条件", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[83] || (_cache[83] = createTextVNode("严重等级", -1)),
              withDirectives(createBaseVNode("select", {
            ...
            createBaseVNode("label", null, [
              _cache[84] || (_cache[84] = createTextVNode("冷却时间", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[85] || (_cache[85] = createTextVNode("规则说明", -1)),
            ...
            createBaseVNode("label", _hoisted_147, [
              withDirectives(createBaseVNode("input", {
              ...
              _cache[86] || (_cache[86] = createTextVNode(" 编辑时启用状态（新规则默认停用，启用仍需外网启用权限）", -1))
            ]),
            createBaseVNode("div", _hoisted_149, [
              _cache[87] || (_cache[87] = createBaseVNode("strong", null, "规则预览", -1)),
            ...
            createBaseVNode("div", _hoisted_150, [
              ...
              }, toDisplayString(alertRuleSaving.value ? "保存中..." : "保存规则"), 9, _hoisted_151)
            ])
          ])
        ])) : createCommentVNode("", true),
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4fb33360"]]);
