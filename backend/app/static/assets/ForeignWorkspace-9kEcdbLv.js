...
const ForeignOpinionDetailModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a8a0e9ef"]]);
...
const _hoisted_40 = { class: "fw-card fw-card-wide" };
...
const _hoisted_44 = { class: "visualization-meta" };
const _hoisted_45 = {
  key: 2,
  class: "state"
};
...
const _hoisted_49 = { class: "table-wrap tbl-scroll" };
const _hoisted_50 = ["onClick"];
const _hoisted_51 = { class: "title-cell" };
const _hoisted_52 = {
  key: 0,
  class: "muted"
};
const _hoisted_53 = { class: "actions" };
...
const _hoisted_58 = { class: "alert-scope-note" };
const _hoisted_59 = { class: "toolbar" };
...
const _hoisted_63 = { class: "subtabs" };
const _hoisted_64 = {
  key: 2,
  class: "table-wrap"
};
const _hoisted_65 = { class: "title-cell" };
...
const _hoisted_77 = { class: "event-provenance" };
const _hoisted_78 = { key: 0 };
const _hoisted_79 = { class: "event-detail-head" };
...
const _hoisted_85 = { class: "event-metrics" };
...
const _hoisted_89 = { class: "alert-scope-note" };
const _hoisted_90 = { class: "toolbar" };
...
const _hoisted_94 = { class: "table-wrap" };
const _hoisted_95 = { class: "title-cell" };
const _hoisted_96 = { class: "alert-title" };
const _hoisted_97 = { class: "muted" };
const _hoisted_98 = { class: "linked-cell" };
const _hoisted_99 = ["onClick"];
const _hoisted_100 = {
  key: 1,
  class: "muted"
};
const _hoisted_101 = { class: "actions" };
...
const _hoisted_108 = { class: "table-wrap" };
...
const _hoisted_115 = { class: "detail history-dialog" };
...
const _hoisted_121 = { class: "detail rule-dialog" };
const _hoisted_122 = { class: "muted" };
const _hoisted_123 = ["disabled"];
const _hoisted_124 = { class: "rule-preview" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
          ...
          createBaseVNode("div", _hoisted_9, [
            ...
            createBaseVNode("div", _hoisted_10, [
              createBaseVNode("label", _hoisted_11, [
                _cache[34] || (_cache[34] = createTextVNode("统计窗口 ", -1)),
          ...
          visualizationError.value ? (openBlock(), createElementBlock("div", _hoisted_13, [
            ...
            createBaseVNode("div", _hoisted_15, [
              createBaseVNode("div", _hoisted_16, [
                _cache[36] || (_cache[36] = createBaseVNode("span", { class: "fw-kpi-label" }, "文章总数", -1)),
              ...
              createBaseVNode("div", _hoisted_18, [
                _cache[37] || (_cache[37] = createBaseVNode("span", { class: "fw-kpi-label" }, "数据源", -1)),
              ...
              createBaseVNode("div", _hoisted_20, [
                _cache[38] || (_cache[38] = createBaseVNode("span", { class: "fw-kpi-label" }, "风险已完成", -1)),
              ...
              createBaseVNode("div", _hoisted_22, [
                _cache[39] || (_cache[39] = createBaseVNode("span", { class: "fw-kpi-label" }, "已确认事件", -1)),
              ...
              createBaseVNode("div", _hoisted_24, [
                _cache[40] || (_cache[40] = createBaseVNode("span", { class: "fw-kpi-label" }, "外网告警", -1)),
            ...
            createBaseVNode("div", _hoisted_26, [
              ...
              createBaseVNode("article", _hoisted_29, [
                _cache[42] || (_cache[42] = createBaseVNode("h3", null, "事件状态", -1)),
              ...
              createBaseVNode("article", _hoisted_40, [
                createBaseVNode("header", _hoisted_41, [
                  ...
                  createBaseVNode("span", _hoisted_42, "近 " + toDisplayString(visualizationDays.value) + " 天 · 共 " + toDisplayString(hotwordItems.value.length) + " 个热词", 1)
                ]),
                withDirectives(createBaseVNode("div", {
                ...
                !hotwordItems.value.length ? (openBlock(), createElementBlock("p", _hoisted_43, "该窗口内暂无外网热词")) : createCommentVNode("", true)
              ])
            ]),
            createBaseVNode("div", _hoisted_44, "数据范围：" + toDisplayString(formatTime(dashboardSummary.value.window_start)) + " - " + toDisplayString(formatTime(dashboardSummary.value.window_end)) + " · 更新于：" + toDisplayString(formatTime(dashboardSummary.value.data_as_of)), 1)
          ])) : (openBlock(), createElementBlock("div", _hoisted_45, "加载外网看板中..."))
        ])) : createCommentVNode("", true),
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_46, [
          createBaseVNode("div", _hoisted_47, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-8e556d73>全部语言</option><option value="zh" data-v-8e556d73>中文</option><option value="en" data-v-8e556d73>英文</option><option value="mixed" data-v-8e556d73>中英混合</option><option value="unknown" data-v-8e556d73>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-8e556d73>全部风险等级</option><option value="high" data-v-8e556d73>高</option><option value="medium" data-v-8e556d73>中</option><option value="low" data-v-8e556d73>低</option><option value="unknown" data-v-8e556d73>未知</option>', 5)
            ])], 544), [
            ...
            _cache[52] || (_cache[52] = createBaseVNode("span", { class: "muted" }, "以舆情为主，右侧为已关联的风险研判（未分析显示 -）", -1))
          ]),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_51, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", null, [
                      ...
                      !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_52, "无")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_53, [
                      ...
                      }, "重新分析", 8, _hoisted_54)) : createCommentVNode("", true)
                    ])
                  ], 8, _hoisted_50);
                }), 128)),
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_55, [..._cache[53] || (_cache[53] = [
                  createBaseVNode("td", {
                    colspan: "14",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_56, [
        ...
        ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_57, [
          createBaseVNode("div", _hoisted_58, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
          createBaseVNode("div", _hoisted_59, [
            ...
            }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_60),
            _cache[55] || (_cache[55] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
          ]),
          eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_61, [
          ...
          eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_62, [
            _cache[57] || (_cache[57] = createBaseVNode("strong", null, "外网事件运行失败", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(eventRunFailures.value, (run) => {
              return openBlock(), createElementBlock("div", {
                key: run.id,
                class: "event-failure-row"
              }, [
                _cache[56] || (_cache[56] = createBaseVNode("span", { class: "status failed" }, "失败", -1)),
          ...
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_64, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_65, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", _hoisted_66, [
                      ...
                      }, "确认", 8, _hoisted_67)) : createCommentVNode("", true),
                      row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn danger",
                        disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                        onClick: ($event) => rejectCandidate(row)
                      }, "拒绝", 8, _hoisted_68)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_69, [..._cache[58] || (_cache[58] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
            ...
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_75, [..._cache[60] || (_cache[60] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
          ...
          selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_76, [
            createBaseVNode("div", _hoisted_77, [
              _cache[63] || (_cache[63] = createBaseVNode("strong", null, "事件溯源", -1)),
              ...
              selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_78, [
                _cache[62] || (_cache[62] = createBaseVNode("summary", null, "聚合证据", -1)),
            ...
            createBaseVNode("p", _hoisted_84, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_86, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                createBaseVNode("a", {
                  href: opinion.url,
                  target: "_blank",
                  rel: "noreferrer",
        ...
        ])) : activeTab.value === "alerts" ? (openBlock(), createElementBlock("section", _hoisted_88, [
          createBaseVNode("div", _hoisted_89, "外网自动告警评估：" + toDisplayString(alertAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(alertAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 外部通知：" + toDisplayString(alertAutoStatus.value?.external_notifications_enabled ? "已启用" : "已停用"), 1),
          createBaseVNode("div", _hoisted_90, [
            ...
            }, toDisplayString(alertEvaluating.value ? "评估中..." : "手动 Dry-Run"), 9, _hoisted_91),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => alertFilters.status = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[64] || (_cache[64] = [
              createStaticVNode('<option value="" data-v-8e556d73>全部状态</option><option value="triggered" data-v-8e556d73>待处理</option><option value="acknowledged" data-v-8e556d73>已确认</option><option value="resolved" data-v-8e556d73>已解决</option><option value="suppressed" data-v-8e556d73>已抑制</option><option value="failed" data-v-8e556d73>失败</option>', 6)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-8e556d73>全部严重度</option><option value="low" data-v-8e556d73>低</option><option value="medium" data-v-8e556d73>中</option><option value="high" data-v-8e556d73>高</option><option value="critical" data-v-8e556d73>紧急</option>', 5)
            ])], 544), [
              [vModelSelect, alertFilters.severity]
            ]),
            _cache[66] || (_cache[66] = createBaseVNode("span", { class: "muted" }, "告警评估默认关闭 · 外部通知默认关闭 · 当前仅保存站内记录", -1))
          ]),
          _cache[71] || (_cache[71] = createBaseVNode("div", { class: "alert-scope-note" }, " 外网告警只读取外网风险和已确认外网事件；不会进入国内告警、Dashboard、地图、热词或事件链路。 ", -1)),
          alertLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_92, [
          ...
          alertRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_93, [
            _cache[68] || (_cache[68] = createBaseVNode("strong", null, "外网告警评估失败", -1)),
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignAlerts.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_95, [
                      createBaseVNode("strong", _hoisted_96, toDisplayString(row.title || "无标题告警"), 1),
                      createBaseVNode("div", _hoisted_97, toDisplayString(row.message), 1)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_98, [
                      ...
                      }, toDisplayString(row.opinion_title_snapshot || "#" + row.foreign_opinion_id), 9, _hoisted_99)) : (openBlock(), createElementBlock("span", _hoisted_100, "-"))
                    ]),
                    ...
                    createBaseVNode("td", _hoisted_101, [
                      ...
                      }, "确认", 8, _hoisted_103)) : createCommentVNode("", true),
                      ...
                      }, "解决", 8, _hoisted_104)) : createCommentVNode("", true),
                      row.status === "triggered" || row.status === "acknowledged" ? (openBlock(), createElementBlock("button", {
                        key: 2,
                        class: "link-btn danger",
                      ...
                      }, "抑制", 8, _hoisted_105)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !foreignAlerts.value.length ? (openBlock(), createElementBlock("tr", _hoisted_106, [..._cache[69] || (_cache[69] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无外网告警记录", -1)
        ...
        ])) : activeTab.value === "alertRules" ? (openBlock(), createElementBlock("section", _hoisted_107, [
          createBaseVNode("div", { class: "toolbar" }, [
            ...
            _cache[72] || (_cache[72] = createBaseVNode("span", { class: "muted" }, "外网规则独立管理；新规则保存后默认停用。", -1))
          ]),
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(alertRules.value, (rule) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_109, [
                      ...
                      }, "停用", 8, _hoisted_111)) : (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn",
                      ...
                      }, "删除", 8, _hoisted_113)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !alertRules.value.length ? (openBlock(), createElementBlock("tr", _hoisted_114, [..._cache[73] || (_cache[73] = [
                  createBaseVNode("td", {
                    colspan: "7",
                    class: "empty"
                  }, "暂无外网告警规则", -1)
        ...
        historyAlert.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_115, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭处置历史",
              onClick: _cache[18] || (_cache[18] = ($event) => historyAlert.value = null)
            }, "×"),
            _cache[75] || (_cache[75] = createBaseVNode("h3", null, "外网告警处置历史", -1)),
            createBaseVNode("p", _hoisted_116, toDisplayString(historyAlert.value.title || "告警 #" + historyAlert.value.id) + " · 当前状态：" + toDisplayString(zh(historyAlert.value.status)), 1),
            alertActionsLoading.value ? (openBlock(), createElementBlock("div", _hoisted_117, "处置历史加载中...")) : !alertActions.value.length ? (openBlock(), createElementBlock("div", _hoisted_118, "暂无处置历史")) : (openBlock(), createElementBlock("div", _hoisted_119, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(alertActions.value, (action) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_120, "操作人 #" + toDisplayString(action.actor_id ?? "-") + " · " + toDisplayString(formatTime(action.created_at)), 1)
                ]);
              }), 128))
            ]))
          ])
        ...
        alertRuleEditorVisible.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_121, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭规则编辑",
            ...
            createBaseVNode("label", null, [
              _cache[76] || (_cache[76] = createTextVNode("规则名称", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[78] || (_cache[78] = createTextVNode("规则类型", -1)),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => alertRuleDraft.rule_type = $event),
                class: "input"
              }, [..._cache[77] || (_cache[77] = [
                createStaticVNode('<option value="risk_score" data-v-8e556d73>风险分</option><option value="risk_level" data-v-8e556d73>风险等级</option><option value="risk_category" data-v-8e556d73>风险类别</option><option value="confirmed_event" data-v-8e556d73>确认事件</option><option value="keyword_combo" data-v-8e556d73>关键词组合</option>', 5)
              ])], 512), [
                [vModelSelect, alertRuleDraft.rule_type]
              ])
            ]),
            createBaseVNode("label", null, [
              _cache[79] || (_cache[79] = createTextVNode("风险阈值或条件", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[81] || (_cache[81] = createTextVNode("严重等级", -1)),
              withDirectives(createBaseVNode("select", {
            ...
            createBaseVNode("label", null, [
              _cache[82] || (_cache[82] = createTextVNode("冷却时间", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("label", null, [
              _cache[83] || (_cache[83] = createTextVNode("规则说明", -1)),
            ...
            createBaseVNode("label", _hoisted_122, [
              ...
              _cache[84] || (_cache[84] = createTextVNode(" 编辑时启用状态（新规则默认停用，启用仍需外网启用权限）", -1))
            ]),
            createBaseVNode("div", _hoisted_124, [
              _cache[85] || (_cache[85] = createBaseVNode("strong", null, "规则预览", -1)),
            ...
            createBaseVNode("div", _hoisted_125, [
              ...
              }, toDisplayString(alertRuleSaving.value ? "保存中..." : "保存规则"), 9, _hoisted_126)
            ])
          ])
        ])) : createCommentVNode("", true),
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8e556d73"]]);
