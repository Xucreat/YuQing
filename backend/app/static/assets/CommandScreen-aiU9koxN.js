import { d as defineComponent, p as onMounted, s as onBeforeUnmount, c as createElementBlock, a as createBaseVNode, n as normalizeClass, t as toDisplayString, r as ref, j as computed, o as openBlock, _ as _export_sfc, g as api, R as shallowRef, m as watch, F as Fragment, i as renderList, A as createCommentVNode, f as reactive, e as createTextVNode, S as renderSlot, P as onUnmounted, k as normalizeStyle, q as nextTick, B as createVNode, x as unref, z as withCtx, h as useRouter } from './index-DHWATgBi.js';
...
const _hoisted_6$6 = { class: "cs-clock cs-mono" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("header", _hoisted_1$8, [
        ...
        createBaseVNode("div", _hoisted_2$8, [
          ...
          createBaseVNode("div", _hoisted_6$6, toDisplayString(clock.value), 1),
          createBaseVNode("button", {
            class: "cs-fs",
            type: "button",
            title: isFs.value ? "退出全屏 (Esc)" : "进入全屏",
            onClick: toggleFs
          }, toDisplayString(isFs.value ? "⤢ 退出全屏" : "⤢ 全屏"), 9, _hoisted_7$5),
          createBaseVNode("button", {
            class: "cs-exit",
            type: "button",
            title: "返回系统",
...
const ScreenHeader = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-d236cb86"]]);
