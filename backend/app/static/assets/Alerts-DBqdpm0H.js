import { d as defineComponent, p as onMounted, m as watch, w as withDirectives, c as createElementBlock, B as createVNode, z as withCtx, r as ref, g as api, E as ElMessage, C as resolveComponent, D as resolveDirective, o as openBlock, e as createTextVNode, t as toDisplayString, A as createCommentVNode, a as createBaseVNode, y as createBlock, f as reactive, L as ElMessageBox, _ as _export_sfc } from './index-CUdZ_uhW.js';
                    ...
                    createVNode(_component_el_table, {
                      ...
                      default: withCtx(() => [
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            row.opinion_id ? (openBlock(), createBlock(_component_router_link, {
                              key: 0,
                              to: "/opinion/" + row.opinion_id,
                              class: "nav-link"
                            }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(row.opinion_title), 1)
                              ]),
                              _: 2
                            }, 1032, ["to"])) : (openBlock(), createElementBlock("span", _hoisted_4, toDisplayString(row.opinion_title || "-"), 1))
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            row.event_id ? (openBlock(), createBlock(_component_router_link, {
                              ...
                              _: 2
                            }, 1032, ["to"])) : (openBlock(), createElementBlock("span", _hoisted_5, toDisplayString(row.event_title || "-"), 1))
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            !row.handled ? (openBlock(), createBlock(_component_el_button, {
                              ...
                              _: 1
                            }, 8, ["onClick"])) : (openBlock(), createElementBlock("span", _hoisted_6, "已处理"))
                          ]),
                          _: 1
                        })
                      ]),
...
const Alerts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-aaa8b340"]]);
