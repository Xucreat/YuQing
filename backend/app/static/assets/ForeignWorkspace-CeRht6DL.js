...
const _hoisted_58$1 = { class: "ai-header" };
const _hoisted_59$1 = {
  key: 0,
  class: "report-p"
};
...
const _hoisted_65$1 = { class: "history-list" };
                ...
                createBaseVNode("div", _hoisted_16$1, [
                  createBaseVNode("div", _hoisted_17$1, [
                    createBaseVNode("div", _hoisted_18$1, [
                      _cache[5] || (_cache[5] = createBaseVNode("span", { class: "section-title" }, "当前有效风险", -1)),
                    ...
                    createBaseVNode("div", _hoisted_19$1, [
                      ...
                      effectiveRiskReason.value ? (openBlock(), createElementBlock("span", _hoisted_23$1, [
                        _cache[8] || (_cache[8] = createTextVNode("依据 ", -1)),
                    ...
                    detail.value.rule_risk ? (openBlock(), createElementBlock("div", _hoisted_26$1, [
                      _cache[10] || (_cache[10] = createBaseVNode("span", { class: "dual-label" }, "规则基线", -1)),
                    ...
                    detail.value.latest_ai_risk ? (openBlock(), createElementBlock("div", _hoisted_29$1, [
                      _cache[11] || (_cache[11] = createBaseVNode("span", { class: "dual-label" }, "AI 研判", -1)),
                    ...
                    detail.value.alert ? (openBlock(), createElementBlock("div", _hoisted_31$1, [
                      _cache[12] || (_cache[12] = createBaseVNode("span", { class: "dual-label" }, "关联告警", -1)),
                  ...
                  createBaseVNode("div", _hoisted_34$1, [
                    createBaseVNode("div", _hoisted_35$1, [
                      _cache[14] || (_cache[14] = createBaseVNode("span", { class: "section-title" }, "系统规则研判", -1)),
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("div", _hoisted_36$1, [
                      createBaseVNode("span", _hoisted_37$1, [
                        _cache[15] || (_cache[15] = createTextVNode("风险评分 ", -1)),
                        createBaseVNode("b", {
                      ...
                      createBaseVNode("span", _hoisted_38$1, [
                        _cache[16] || (_cache[16] = createTextVNode("等级 ", -1)),
                        createBaseVNode("b", null, toDisplayString(riskLevelZh(detail.value.rule_result?.risk_level)), 1)
                      ]),
                      _cache[19] || (_cache[19] = createBaseVNode("span", { class: "meta-sep" }, "·", -1)),
                      createBaseVNode("span", _hoisted_39$1, [
                        _cache[17] || (_cache[17] = createTextVNode("风险类别 ", -1)),
                    ...
                    ruleTermHits.value.length ? (openBlock(), createElementBlock("div", _hoisted_43$1, [
                      _cache[20] || (_cache[20] = createBaseVNode("span", { class: "kw-label" }, "命中风险词", -1)),
                  ...
                  createBaseVNode("div", _hoisted_44$1, [
                    createBaseVNode("div", _hoisted_45$1, [
                      _cache[22] || (_cache[22] = createBaseVNode("span", { class: "section-title" }, "AI 研判报告", -1)),
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("div", _hoisted_46$1, [
                      createBaseVNode("span", _hoisted_47$1, [
                        _cache[23] || (_cache[23] = createTextVNode("风险评分 ", -1)),
                        createBaseVNode("b", {
                      ...
                      createBaseVNode("span", _hoisted_48$1, [
                        _cache[24] || (_cache[24] = createTextVNode("情感 ", -1)),
                        createBaseVNode("b", null, toDisplayString(unref(sentimentText)(detail.value.ai_result?.sentiment || "unknown")), 1)
                      ]),
                      _cache[27] || (_cache[27] = createBaseVNode("span", { class: "meta-sep" }, "·", -1)),
                      createBaseVNode("span", _hoisted_49$1, [
                        _cache[25] || (_cache[25] = createTextVNode("模型 ", -1)),
                    ...
                    createBaseVNode("div", _hoisted_50$1, [
                      detail.value.ai_result?.status === "completed" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                        detail.value.ai_result.summary ? (openBlock(), createElementBlock("p", _hoisted_51$1, toDisplayString(detail.value.ai_result.summary), 1)) : createCommentVNode("", true),
                        detail.value.ai_result.suggestion ? (openBlock(), createElementBlock("p", _hoisted_52$1, toDisplayString(detail.value.ai_result.suggestion), 1)) : createCommentVNode("", true)
                      ], 64)) : detail.value.ai_result?.status === "failed" ? (openBlock(), createElementBlock("p", _hoisted_53$1, " AI 分析失败：" + toDisplayString(detail.value.ai_result.error_message || "请稍后重试"), 1)) : (openBlock(), createElementBlock("p", _hoisted_54$1, "尚未生成 AI 研判报告，点击下方按钮触发分析。"))
                    ]),
                    canAnalyzeAI.value || detail.value.ai_result?.status === "processing" ? (openBlock(), createElementBlock("div", _hoisted_55$1, [
                      ...
                      }, toDisplayString(analyzing.value ? "分析中..." : detail.value.ai_result?.status === "completed" ? "重新触发 AI 分析" : "触发 AI 分析"), 9, _hoisted_56$1)) : createCommentVNode("", true)
                    ])) : createCommentVNode("", true)
                  ]),
                  detail.value.ai_result?.status === "completed" ? (openBlock(), createElementBlock("div", _hoisted_57$1, [
                    createBaseVNode("div", _hoisted_58$1, [
                      _cache[29] || (_cache[29] = createBaseVNode("span", { class: "section-title" }, "AI 告警准入", -1)),
                      createBaseVNode("span", {
                    ...
                    _cache[31] || (_cache[31] = createBaseVNode("p", { class: "report-p report-muted" }, "决定该外网舆情是否参与 AI 告警评估。", -1)),
                    detail.value.ai_alert_admission?.note ? (openBlock(), createElementBlock("p", _hoisted_59$1, "备注：" + toDisplayString(detail.value.ai_alert_admission.note), 1)) : createCommentVNode("", true),
                    canAdmitAI.value ? (openBlock(), createElementBlock("div", _hoisted_60$1, [
                      createBaseVNode("button", {
                        class: "btn btn-secondary",
                        disabled: admissionSaving.value,
                        onClick: _cache[0] || (_cache[0] = ($event) => setAdmission(true))
                      }, "纳入评估", 8, _hoisted_61$1),
                      createBaseVNode("button", {
                        class: "btn btn-secondary",
                        disabled: admissionSaving.value,
                        onClick: _cache[1] || (_cache[1] = ($event) => setAdmission(false))
                      }, "取消纳入", 8, _hoisted_62$1)
                    ])) : createCommentVNode("", true),
                    detail.value.ai_alert_admission_actions && detail.value.ai_alert_admission_actions.length ? (openBlock(), createElementBlock("div", _hoisted_63$1, [
                  ...
                  detail.value.analysis_runs && detail.value.analysis_runs.length ? (openBlock(), createElementBlock("div", _hoisted_64$1, [
                    _cache[32] || (_cache[32] = createBaseVNode("div", { class: "ai-header" }, [
...
const ForeignOpinionDetailModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6a4133f7"]]);
...
const _hoisted_70 = { class: "table-wrap tbl-scroll" };
const _hoisted_71 = ["onClick"];
const _hoisted_72 = { class: "title-cell" };
const _hoisted_73 = { class: "dual-cell" };
const _hoisted_74 = { class: "muted" };
const _hoisted_75 = {
  key: 0,
  class: "muted"
};
const _hoisted_76 = { class: "actions" };
const _hoisted_77 = ["disabled", "onClick"];
...
const _hoisted_81 = { class: "alert-scope-note" };
...
const _hoisted_86 = { class: "subtabs" };
const _hoisted_87 = {
  key: 2,
  class: "table-wrap"
};
const _hoisted_88 = { class: "title-cell" };
const _hoisted_89 = { class: "actions" };
...
const _hoisted_100 = { class: "event-provenance" };
const _hoisted_101 = { key: 0 };
const _hoisted_102 = { class: "event-detail-head" };
const _hoisted_103 = { class: "actions" };
const _hoisted_104 = ["disabled"];
const _hoisted_105 = ["disabled"];
const _hoisted_106 = ["disabled"];
const _hoisted_107 = { class: "muted" };
const _hoisted_108 = { class: "event-metrics" };
...
const _hoisted_112 = { class: "alert-scope-note" };
const _hoisted_113 = { class: "toolbar" };
...
const _hoisted_117 = { class: "table-wrap" };
const _hoisted_118 = { class: "title-cell" };
const _hoisted_119 = ["title", "onClick", "onKeydown"];
const _hoisted_120 = {
  key: 1,
  class: "alert-title"
};
const _hoisted_121 = { class: "muted" };
const _hoisted_122 = { class: "linked-cell" };
const _hoisted_123 = ["onClick"];
const _hoisted_124 = {
  key: 1,
  class: "muted"
};
const _hoisted_125 = { class: "dual-cell" };
const _hoisted_126 = { key: 0 };
const _hoisted_127 = {
  key: 1,
  class: "muted"
};
const _hoisted_128 = { class: "actions" };
...
const _hoisted_136 = { class: "actions" };
...
const _hoisted_142 = { class: "detail history-dialog" };
...
const _hoisted_147 = { class: "muted" };
const _hoisted_148 = { class: "detail rule-dialog" };
const _hoisted_149 = { class: "muted" };
const _hoisted_150 = ["disabled"];
const _hoisted_151 = { class: "rule-preview" };
const _hoisted_152 = { class: "actions" };
...
风险结果`, textAlign: "center", fill: "#1d1d1f", fontSize: 20, fontWeight: 700, lineHeight: 22 } },
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          ...
          createBaseVNode("div", _hoisted_4, [
            ...
            canCollectSelected.value ? (openBlock(), createElementBlock("button", {
              ...
              disabled: collecting.value || !approvedSourceIds.value.length,
              onClick: collectNow
            }, toDisplayString(collecting.value ? "采集中..." : "采集外网 RSS"), 9, _hoisted_6)) : createCommentVNode("", true),
            canCollectAll.value ? (openBlock(), createElementBlock("button", {
              key: 1,
              class: "btn btn-secondary btn-sm",
              disabled: collecting.value,
              onClick: collectAll
            }, "采集全部数据源", 8, _hoisted_7)) : createCommentVNode("", true)
          ])
        ]),
          ...
          createBaseVNode("div", _hoisted_9, [
            ...
            createBaseVNode("div", _hoisted_10, [
              createBaseVNode("label", _hoisted_11, [
                _cache[35] || (_cache[35] = createTextVNode("统计窗口 ", -1)),
          ...
          visualizationError.value ? (openBlock(), createElementBlock("div", _hoisted_13, [
            ...
            createBaseVNode("div", _hoisted_15, [
              createBaseVNode("div", _hoisted_16, [
                _cache[37] || (_cache[37] = createBaseVNode("span", { class: "fw-kpi-label" }, "文章总数", -1)),
              ...
              createBaseVNode("div", _hoisted_18, [
                _cache[38] || (_cache[38] = createBaseVNode("span", { class: "fw-kpi-label" }, "数据源", -1)),
              ...
              createBaseVNode("div", _hoisted_20, [
                _cache[39] || (_cache[39] = createBaseVNode("span", { class: "fw-kpi-label" }, "风险已完成", -1)),
              ...
              createBaseVNode("div", _hoisted_22, [
                _cache[40] || (_cache[40] = createBaseVNode("span", { class: "fw-kpi-label" }, "已确认事件", -1)),
              ...
              createBaseVNode("div", _hoisted_24, [
                _cache[41] || (_cache[41] = createBaseVNode("span", { class: "fw-kpi-label" }, "外网告警", -1)),
              ...
              createBaseVNode("div", _hoisted_26, [
                _cache[42] || (_cache[42] = createBaseVNode("span", { class: "fw-kpi-label" }, "外网采集", -1)),
            ...
            createBaseVNode("div", _hoisted_28, [
              createBaseVNode("article", _hoisted_29, [
                createBaseVNode("header", _hoisted_30, [
                  _cache[43] || (_cache[43] = createBaseVNode("h3", null, "每日趋势", -1)),
              ...
              createBaseVNode("article", _hoisted_34, [
                createBaseVNode("header", _hoisted_35, [
                  _cache[44] || (_cache[44] = createBaseVNode("h3", null, "外网告警", -1)),
                ...
                !alertFeed.value.length ? (openBlock(), createElementBlock("div", _hoisted_37, "该窗口内暂无外网告警")) : (openBlock(), createElementBlock("div", _hoisted_38, [
                  createBaseVNode("div", _hoisted_39, [
                    createBaseVNode("span", _hoisted_40, [
                      _cache[45] || (_cache[45] = createBaseVNode("i", { class: "fw-sum-dot is-amber" }, null, -1)),
                      createTextVNode("待处置 " + toDisplayString(alertPendingCount.value), 1)
                    ]),
                    createBaseVNode("span", _hoisted_41, [
                      _cache[46] || (_cache[46] = createBaseVNode("i", { class: "fw-sum-dot is-teal" }, null, -1)),
              ...
              createBaseVNode("article", _hoisted_53, [
                createBaseVNode("header", _hoisted_54, [
                  _cache[47] || (_cache[47] = createBaseVNode("h3", null, "数据源分布", -1)),
              ...
              createBaseVNode("article", _hoisted_57, [
                _cache[48] || (_cache[48] = createBaseVNode("h3", null, "风险分布", -1)),
                withDirectives(createBaseVNode("div", {
              ...
              createBaseVNode("article", _hoisted_59, [
                createBaseVNode("header", _hoisted_60, [
                  _cache[49] || (_cache[49] = createBaseVNode("h3", null, "外网热词", -1)),
              ...
              createBaseVNode("article", _hoisted_63, [
                _cache[50] || (_cache[50] = createBaseVNode("h3", null, "事件状态", -1)),
        ...
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_67, [
          createBaseVNode("div", _hoisted_68, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-ffdaddf7>全部语言</option><option value="zh" data-v-ffdaddf7>中文</option><option value="en" data-v-ffdaddf7>英文</option><option value="mixed" data-v-ffdaddf7>中英混合</option><option value="unknown" data-v-ffdaddf7>未知</option>', 5)
            ])], 544), [
              [vModelSelect, riskFilters.language]
            ]),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => riskFilters.risk_level = $event),
              class: "input",
              ...
              createStaticVNode('<option value="" data-v-ffdaddf7>全部风险等级</option><option value="high" data-v-ffdaddf7>高</option><option value="medium" data-v-ffdaddf7>中</option><option value="low" data-v-ffdaddf7>低</option><option value="unknown" data-v-ffdaddf7>未知</option>', 5)
            ])], 544), [
              [vModelSelect, riskFilters.risk_level]
            ]),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => riskFilters.analysis_status = $event),
              class: "input",
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => opinionFilters.date_from = $event),
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => opinionFilters.date_to = $event),
              class: "input date-input",
              type: "date",
              title: "发布时间截止",
              onChange: loadOpinions
            ...
            _cache[55] || (_cache[55] = createBaseVNode("span", { class: "muted" }, "当前风险 = 有效告警期内取 AI 研判，否则回退规则研判；AI 历史始终保留", -1))
          ]),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_72, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", _hoisted_73, [
                      ...
                      createBaseVNode("span", _hoisted_74, toDisplayString(aiHistoryLabel(row)), 1)
                    ]),
                    ...
                    createBaseVNode("td", null, [
                      ...
                      !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_75, "无")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_76, [
                      ...
                      }, toDisplayString(ruleOf(row) ? "重新分析" : "分析"), 9, _hoisted_77)
                    ])
                  ], 8, _hoisted_71);
                }), 128)),
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_78, [..._cache[56] || (_cache[56] = [
                  createBaseVNode("td", {
                    colspan: "16",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_79, [
            createVNode(_sfc_main$2, {
              total: opinionTotal.value,
              "current-page": opinionPage.value,
              "onUpdate:currentPage": _cache[12] || (_cache[12] = ($event) => opinionPage.value = $event),
              "page-size": opinionSize,
              onCurrentChange: loadOpinions
            }, null, 8, ["total", "current-page"])
          ])) : createCommentVNode("", true)
        ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_80, [
          createBaseVNode("div", _hoisted_81, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
          createBaseVNode("div", _hoisted_82, [
            ...
            }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_83),
            _cache[58] || (_cache[58] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
          ]),
          eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_84, [
          ...
          eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_85, [
          ...
          createBaseVNode("div", _hoisted_86, [
            createBaseVNode("button", {
              ...
              onClick: _cache[13] || (_cache[13] = ($event) => eventSection.value = "candidates")
            }, "事件候选", 2),
            createBaseVNode("button", {
              class: normalizeClass(["tab", { active: eventSection.value === "confirmed" }]),
              onClick: _cache[14] || (_cache[14] = ($event) => eventSection.value = "confirmed")
            }, "外网事件", 2)
          ]),
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_87, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_88, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", _hoisted_89, [
                      ...
                      }, "确认", 8, _hoisted_90)) : createCommentVNode("", true),
                      row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn danger",
                        disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                        onClick: ($event) => rejectCandidate(row)
                      }, "拒绝", 8, _hoisted_91)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_92, [..._cache[61] || (_cache[61] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
            ...
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_98, [..._cache[63] || (_cache[63] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
          ...
          selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_99, [
            createBaseVNode("div", _hoisted_100, [
              ...
              selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_101, [
            ...
            createBaseVNode("div", _hoisted_102, [
              ...
              createBaseVNode("div", _hoisted_103, [
                createBaseVNode("button", {
                  ...
                  onClick: _cache[15] || (_cache[15] = ($event) => closeEvent(selectedForeignEvent.value))
                }, "关闭事件", 8, _hoisted_104),
                createBaseVNode("button", {
                  class: "link-btn",
                  disabled: !unref(canMergeEvents) || eventActionKey.value,
                  onClick: _cache[16] || (_cache[16] = ($event) => mergeEvent(selectedForeignEvent.value))
                }, "合并", 8, _hoisted_105),
                createBaseVNode("button", {
                  class: "link-btn",
                  disabled: !unref(canSplitEvents) || eventActionKey.value,
                  onClick: _cache[17] || (_cache[17] = ($event) => splitEvent(selectedForeignEvent.value))
                }, "拆分", 8, _hoisted_106),
                createBaseVNode("button", {
                  class: "link-btn",
                  onClick: _cache[18] || (_cache[18] = ($event) => selectedForeignEvent.value = null)
                }, "关闭详情")
              ])
            ]),
            createBaseVNode("p", _hoisted_107, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_109, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                createBaseVNode("a", {
                  href: opinion.url,
                  target: "_blank",
                  rel: "noreferrer",
        ...
        ])) : activeTab.value === "alerts" ? (openBlock(), createElementBlock("section", _hoisted_111, [
          createBaseVNode("div", _hoisted_112, "外网自动告警评估：" + toDisplayString(alertAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(alertAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 外部通知：" + toDisplayString(alertAutoStatus.value?.external_notifications_enabled ? "已启用" : "已停用"), 1),
          createBaseVNode("div", _hoisted_113, [
            ...
            }, toDisplayString(alertEvaluating.value ? "评估中..." : "手动 Dry-Run"), 9, _hoisted_114),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => alertFilters.status = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[67] || (_cache[67] = [
              createStaticVNode('<option value="" data-v-ffdaddf7>全部状态</option><option value="triggered" data-v-ffdaddf7>待处理</option><option value="acknowledged" data-v-ffdaddf7>已确认</option><option value="resolved" data-v-ffdaddf7>已解决</option><option value="suppressed" data-v-ffdaddf7>已抑制</option><option value="failed" data-v-ffdaddf7>失败</option>', 6)
            ])], 544), [
              [vModelSelect, alertFilters.status]
            ]),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => alertFilters.severity = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[68] || (_cache[68] = [
              createStaticVNode('<option value="" data-v-ffdaddf7>全部严重度</option><option value="low" data-v-ffdaddf7>低</option><option value="medium" data-v-ffdaddf7>中</option><option value="high" data-v-ffdaddf7>高</option><option value="critical" data-v-ffdaddf7>紧急</option>', 5)
            ])], 544), [
              [vModelSelect, alertFilters.severity]
            ]),
            _cache[69] || (_cache[69] = createBaseVNode("span", { class: "muted" }, "告警评估默认关闭 · 外部通知默认关闭 · 当前仅保存站内记录", -1))
          ]),
          _cache[74] || (_cache[74] = createBaseVNode("div", { class: "alert-scope-note" }, " 外网告警只读取外网风险和已确认外网事件；不会进入国内告警、Dashboard、地图、热词或事件链路。 「告警记录值」是触发当时的快照，「当前有效风险」与外网舆情列表使用同一后端判定：告警有效期内取 AI 研判，解除／抑制／过期后回退规则研判。 ", -1)),
          alertLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_115, [
          ...
          alertRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_116, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignAlerts.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_118, [
                      ...
                      }, toDisplayString(row.title || "无标题告警"), 41, _hoisted_119)) : (openBlock(), createElementBlock("strong", _hoisted_120, toDisplayString(row.title || "无标题告警"), 1)),
                      createBaseVNode("div", _hoisted_121, toDisplayString(row.message), 1)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_122, [
                      ...
                      }, toDisplayString(row.opinion_title_snapshot || "#" + row.foreign_opinion_id), 9, _hoisted_123)) : (openBlock(), createElementBlock("span", _hoisted_124, "-"))
                    ]),
                    ...
                    createBaseVNode("td", _hoisted_125, [
                      effOf(row) ? (openBlock(), createElementBlock("span", _hoisted_126, toDisplayString(effOf(row)?.risk_score ?? "-") + " / " + toDisplayString(zh(effOf(row)?.risk_level)), 1)) : (openBlock(), createElementBlock("span", _hoisted_127, "-")),
                    ...
                    createBaseVNode("td", _hoisted_128, [
                      ...
                      }, "确认", 8, _hoisted_130)) : createCommentVNode("", true),
                      ...
                      }, "解决", 8, _hoisted_131)) : createCommentVNode("", true),
                      row.status === "triggered" || row.status === "acknowledged" ? (openBlock(), createElementBlock("button", {
                        key: 2,
                        class: "link-btn danger",
                      ...
                      }, "抑制", 8, _hoisted_132)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !foreignAlerts.value.length ? (openBlock(), createElementBlock("tr", _hoisted_133, [..._cache[72] || (_cache[72] = [
                  createBaseVNode("td", {
                    colspan: "13",
                    class: "empty"
                  }, "暂无外网告警记录", -1)
        ...
        ])) : activeTab.value === "alertRules" ? (openBlock(), createElementBlock("section", _hoisted_134, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(alertRules.value, (rule) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_136, [
                      ...
                      }, "停用", 8, _hoisted_138)) : (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn",
                      ...
                      }, "删除", 8, _hoisted_140)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !alertRules.value.length ? (openBlock(), createElementBlock("tr", _hoisted_141, [..._cache[76] || (_cache[76] = [
                  createBaseVNode("td", {
                    colspan: "7",
                    class: "empty"
                  }, "暂无外网告警规则", -1)
        ...
        historyAlert.value ? (openBlock(), createElementBlock("div", {
          key: 5,
          class: "detail-mask",
          onClick: _cache[22] || (_cache[22] = withModifiers(($event) => historyAlert.value = null, ["self"]))
        }, [
          createBaseVNode("article", _hoisted_142, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭处置历史",
              onClick: _cache[21] || (_cache[21] = ($event) => historyAlert.value = null)
            }, "×"),
            _cache[78] || (_cache[78] = createBaseVNode("h3", null, "外网告警处置历史", -1)),
            createBaseVNode("p", _hoisted_143, toDisplayString(historyAlert.value.title || "告警 #" + historyAlert.value.id) + " · 当前状态：" + toDisplayString(zh(historyAlert.value.status)), 1),
            alertActionsLoading.value ? (openBlock(), createElementBlock("div", _hoisted_144, "处置历史加载中...")) : !alertActions.value.length ? (openBlock(), createElementBlock("div", _hoisted_145, "暂无处置历史")) : (openBlock(), createElementBlock("div", _hoisted_146, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(alertActions.value, (action) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_147, "操作人 #" + toDisplayString(action.actor_id ?? "-") + " · " + toDisplayString(formatTime(action.created_at)), 1)
                ]);
              }), 128))
            ]))
          ])
        ...
        alertRuleEditorVisible.value ? (openBlock(), createElementBlock("div", {
          key: 6,
          class: "detail-mask",
          onClick: _cache[32] || (_cache[32] = withModifiers(($event) => alertRuleEditorVisible.value = false, ["self"]))
        }, [
          createBaseVNode("article", _hoisted_148, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭规则编辑",
              onClick: _cache[23] || (_cache[23] = ($event) => alertRuleEditorVisible.value = false)
            }, "×"),
            ...
            createBaseVNode("label", null, [
              ...
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => alertRuleDraft.name = $event),
                class: "input",
                placeholder: "规则名称"
              }, null, 512), [
            ...
            createBaseVNode("label", null, [
              ...
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => alertRuleDraft.rule_type = $event),
                class: "input"
              }, [..._cache[80] || (_cache[80] = [
                createStaticVNode('<option value="risk_score" data-v-ffdaddf7>风险分</option><option value="risk_level" data-v-ffdaddf7>风险等级</option><option value="risk_category" data-v-ffdaddf7>风险类别</option><option value="confirmed_event" data-v-ffdaddf7>确认事件</option><option value="keyword_combo" data-v-ffdaddf7>关键词组合</option>', 5)
              ])], 512), [
            ...
            createBaseVNode("label", null, [
              ...
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => alertRuleDraft.conditionsText = $event),
                class: "input",
            ...
            createBaseVNode("label", null, [
              ...
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[27] || (_cache[27] = ($event) => alertRuleDraft.severity = $event),
                class: "input"
              }, [..._cache[83] || (_cache[83] = [
            ...
            createBaseVNode("label", null, [
              ...
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[28] || (_cache[28] = ($event) => alertRuleDraft.cooldown_seconds = $event),
            ...
            createBaseVNode("label", null, [
              ...
              withDirectives(createBaseVNode("textarea", {
                "onUpdate:modelValue": _cache[29] || (_cache[29] = ($event) => alertRuleDraft.description = $event),
                class: "input",
                rows: "3",
            ...
            createBaseVNode("label", _hoisted_149, [
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[30] || (_cache[30] = ($event) => alertRuleDraft.is_enabled = $event),
                type: "checkbox",
            ...
            createBaseVNode("div", _hoisted_152, [
              createBaseVNode("button", {
                class: "btn btn-secondary",
                onClick: _cache[31] || (_cache[31] = ($event) => alertRuleEditorVisible.value = false)
              }, "取消"),
              createBaseVNode("button", {
                class: "btn btn-primary",
                disabled: alertRuleSaving.value,
                onClick: createAlertRule
              }, toDisplayString(alertRuleSaving.value ? "保存中..." : "保存规则"), 9, _hoisted_153)
            ])
          ])
        ])) : createCommentVNode("", true),
        createVNode(ForeignOpinionDetailModal, {
          modelValue: detailVisible.value,
          "onUpdate:modelValue": _cache[33] || (_cache[33] = ($event) => detailVisible.value = $event),
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ffdaddf7"]]);
