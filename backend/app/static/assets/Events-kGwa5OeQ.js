...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      ...
      const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-BdgQCfUd.js').then(n => n.a1);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
      try {
