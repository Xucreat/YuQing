import { d as defineComponent, z as usePermission, $ as useAlertNotifier, C as onMounted, A as watch, w as withDirectives, c as createElementBlock, m as createVNode, p as withCtx, r as ref, N as useRoute, g as api, E as ElMessage, y as resolveComponent, B as resolveDirective, o as openBlock, e as createTextVNode, q as createBlock, s as createCommentVNode, t as toDisplayString, H as unref, a0 as riskTag, a1 as riskText, a as createBaseVNode, j as computed, f as reactive, X as isPermissionDenied, M as ElMessageBox, _ as _export_sfc } from './index-Cr-cCcQl.js';
import { O as OpinionDetailModal } from './OpinionDetailModal-DHjNhoOj.js';
...
const _hoisted_6 = { class: "false-positive-filter" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function zh(value) {
      if (!value) return "-";
      return FOREIGN_LEVEL_ZH[value] || value;
    }
    ...
    const canEnableForeignRules = computed(() => hasPermission("foreign:alerts:enable"));
    const canHandleForeign = computed(() => canAcknowledgeForeign.value || canResolveForeign.value || canSuppressForeign.value);
    const rules = ref([]);
    ...
    async function loadForeignAlerts() {
      loading.value = true;
      try {
        const params = { page: 1, size: 100 };
        if (foreignStatus.value) params.status = foreignStatus.value;
    ...
    async function toggleForeignRule(row) {
      ...
      try {
        ...
        ElMessage.success(row.is_enabled ? "外网规则已停用" : "外网规则已启用");
    ...
    watch(activeTab, (tab) => {
      if (tab === "foreign") loadForeignAlerts();
      if (tab === "foreign-rules") loadForeignRules();
      if (tab === "records") {
        loadRecords();
        notifier.markVisited();
      }
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
                ...
                createVNode(_component_el_card, {
                  ...
                  default: withCtx(() => [
                    createVNode(_component_el_select, {
                      modelValue: foreignStatus.value,
                      "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => foreignStatus.value = $event),
                      placeholder: "状态",
                      clearable: "",
                      class: "record-filter-select",
                      onChange: loadForeignAlerts
                    }, {
                      default: withCtx(() => [
                    ...
                    createVNode(_component_el_button, { onClick: loadForeignAlerts }, {
                      default: withCtx(() => [..._cache[21] || (_cache[21] = [
                        createTextVNode("刷新", -1)
                      ])]),
                      _: 1
                    }),
                    canEvaluateForeign.value ? (openBlock(), createBlock(_component_el_button, {
                      key: 0,
                      type: "warning",
                    ...
                    createVNode(_component_el_table, {
                      ...
                      default: withCtx(() => [
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            createTextVNode(toDisplayString(row.risk_score === null || row.risk_score === void 0 ? "-" : row.risk_score) + " / " + toDisplayString(zh(row.risk_level)), 1)
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            row.effective_risk ? (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString(row.effective_risk.risk_score === null || row.effective_risk.risk_score === void 0 ? "-" : row.effective_risk.risk_score) + " / " + toDisplayString(zh(row.effective_risk.risk_level)), 1)) : (openBlock(), createElementBlock("span", _hoisted_3, "-")),
                            row.effective_risk && row.effective_risk.source === "ai" ? (openBlock(), createBlock(_component_el_tag, {
                              key: 2,
                              size: "small",
                              type: "warning",
                              effect: "light"
                              ...
                              _: 1
                            })) : row.effective_risk ? (openBlock(), createBlock(_component_el_tag, {
                              key: 3,
                              size: "small",
                              type: "info",
                              effect: "light"
                        ...
                        canHandleForeign.value ? (openBlock(), createBlock(_component_el_table_column, {
                          key: 0,
                          label: "操作",
                          width: "220"
                        }, {
                          default: withCtx(({ row }) => [
                            canAcknowledgeForeign.value && row.status === "triggered" ? (openBlock(), createBlock(_component_el_button, {
                              key: 0,
                              link: "",
                              type: "primary",
                            ...
                            canResolveForeign.value && row.status !== "resolved" ? (openBlock(), createBlock(_component_el_button, {
                              key: 1,
                              link: "",
                              type: "success",
                            ...
                            canSuppressForeign.value && row.status !== "suppressed" ? (openBlock(), createBlock(_component_el_button, {
                              key: 2,
                              link: "",
                              type: "warning",
            ...
            createVNode(_component_el_tab_pane, {
              ...
              default: withCtx(() => [
                createVNode(_component_el_card, {
                  ...
                  default: withCtx(() => [
                    createVNode(_component_el_button, { onClick: loadForeignRules }, {
                  ...
                  default: withCtx(() => [
                    createVNode(_component_el_table, {
                      ...
                      default: withCtx(() => [
                        ...
                        canEnableForeignRules.value ? (openBlock(), createBlock(_component_el_table_column, {
                          key: 0,
                          label: "操作",
                          width: "160"
                        }, {
            ...
            createVNode(_component_el_tab_pane, {
              ...
              default: withCtx(() => [
                createVNode(_component_el_card, {
                  ...
                  default: withCtx(() => [
                    canWriteAlert.value ? (openBlock(), createBlock(_component_el_button, {
                      key: 0,
                      type: "primary",
                      onClick: _cache[1] || (_cache[1] = ($event) => openRuleDialog(null))
                    }, {
                    ...
                    evalResult.value ? (openBlock(), createElementBlock("span", _hoisted_4, "评估完成：检查 " + toDisplayString(evalResult.value.total_checked) + " 条，生成 " + toDisplayString(evalResult.value.alerts_created) + " 条预警", 1)) : createCommentVNode("", true)
                  ]),
                  _: 1
                }),
                createVNode(_component_el_card, {
                ...
                createVNode(_component_el_card, {
                  ...
                  default: withCtx(() => [
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => recFilterRisk.value = $event),
                      placeholder: "预警等级",
                      clearable: "",
                      class: "record-filter-select",
                    ...
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => recFilterStatus.value = $event),
                      placeholder: "处置状态",
                      clearable: "",
                      class: "record-filter-select",
                      onChange: loadRecords
                    ...
                    createBaseVNode("span", _hoisted_6, [
                      createVNode(_component_el_switch, {
                        ...
                        "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => hideFalsePositive.value = $event),
                        onChange: loadRecords
                      }, null, 8, ["modelValue"]),
                      _cache[34] || (_cache[34] = createBaseVNode("span", null, "隐藏误报", -1))
                    ]),
                    createVNode(_component_el_date_picker, {
                      modelValue: recDateRange.value,
                      "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => recDateRange.value = $event),
                      type: "daterange",
                      "range-separator": "至",
                    ...
                    createVNode(_component_el_button, { onClick: loadRecords }, {
                    ...
                    createVNode(_component_el_table, {
                      ...
                      default: withCtx(() => [
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            row.event_id ? (openBlock(), createBlock(_component_router_link, {
                              ...
                              _: 2
                            }, 1032, ["to"])) : (openBlock(), createElementBlock("span", _hoisted_9, toDisplayString(row.event_title || "-"), 1))
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            createTextVNode(toDisplayString(row.handled_by_name ?? "-"), 1)
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
        ...
        createVNode(_component_el_dialog, {
          ...
          "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => ruleDialogVisible.value = $event),
          title: isEditing.value ? "编辑规则" : "新增规则",
          width: "min(600px, calc(100vw - 24px))"
        }, {
          footer: withCtx(() => [
            createVNode(_component_el_button, {
              onClick: _cache[14] || (_cache[14] = ($event) => ruleDialogVisible.value = false)
            }, {
                ...
                createVNode(_component_el_form_item, { label: "规则名称" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => ruleForm.name = $event),
                      placeholder: "请输入规则名称"
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
                ...
                createVNode(_component_el_form_item, { label: "描述" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => ruleForm.description = $event),
                      type: "textarea",
                      rows: 2,
                ...
                createVNode(_component_el_form_item, { label: "风险阈值" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input_number, {
                      ...
                      "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => ruleForm.risk_threshold = $event),
                      min: 0,
                      max: 100
                    }, null, 8, ["modelValue"])
                  ]),
                ...
                createVNode(_component_el_form_item, { label: "关键词匹配" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => ruleForm.keywords = $event),
                ...
                createVNode(_component_el_form_item, { label: "来源过滤" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => ruleForm.sources = $event),
                ...
                createVNode(_component_el_form_item, { label: "建议等级" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => ruleForm.risk_level = $event),
                      style: { "width": "100%" }
                    }, {
                      default: withCtx(() => [
                        createVNode(_component_el_option, {
                    ...
                    _cache[37] || (_cache[37] = createBaseVNode("div", { class: "form-hint" }, "说明：该等级为规则建议值，不决定实际告警等级（实际等级由舆情风险分派生）。", -1))
                  ]),
                  _: 1
                }),
                createVNode(_component_el_form_item, { label: "启用" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_switch, {
                      ...
                      "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => ruleForm.enabled = $event)
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
                })
        ...
        createVNode(_component_el_dialog, {
          ...
          "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => handleDialogVisible.value = $event),
          title: "预警处置",
          width: "min(480px, calc(100vw - 24px))"
        }, {
          footer: withCtx(() => [
            createVNode(_component_el_button, {
              onClick: _cache[18] || (_cache[18] = ($event) => handleDialogVisible.value = false)
            }, {
                ...
                createVNode(_component_el_form_item, { label: "处置状态" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => handleForm.status = $event),
                      style: { "width": "100%" }
                    }, {
                      default: withCtx(() => [
                        createVNode(_component_el_option, {
                ...
                createVNode(_component_el_form_item, { label: "处置备注" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => handleForm.note = $event),
                      type: "textarea",
                      rows: 3,
...
const Alerts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f4a26c3d"]]);
