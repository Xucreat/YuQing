...
const _hoisted_31 = { class: "report-body" };
const _hoisted_32 = { class: "report-p report-muted" };
const _hoisted_33 = {
  key: 0,
  class: "dual-row"
};
...
const _hoisted_37 = { class: "dual-val" };
const _hoisted_38 = {
  key: 2,
  class: "dual-row"
};
const _hoisted_39 = { class: "dual-val" };
const _hoisted_40 = {
  key: 0,
  class: "dual-sub"
};
const _hoisted_41 = { class: "card card-pad sys-card" };
const _hoisted_42 = { class: "ai-header" };
const _hoisted_43 = { class: "report-meta" };
const _hoisted_44 = { class: "meta-item" };
const _hoisted_45 = { class: "meta-item" };
const _hoisted_46 = { class: "meta-item" };
const _hoisted_47 = { class: "report-body" };
const _hoisted_48 = {
  key: 0,
  class: "report-p"
};
...
const _hoisted_51 = { class: "card card-pad ai-card" };
const _hoisted_52 = { class: "ai-header" };
const _hoisted_53 = { class: "ai-header-tools" };
const _hoisted_54 = { class: "report-meta" };
const _hoisted_55 = { class: "meta-item" };
const _hoisted_56 = { class: "meta-item" };
const _hoisted_57 = { class: "meta-item" };
const _hoisted_58 = { class: "report-body" };
const _hoisted_59 = {
  key: 0,
  class: "report-p"
};
...
const _hoisted_65 = { class: "modal-card history-modal" };
const _hoisted_66 = { class: "modal-header" };
const _hoisted_67 = { class: "modal-body" };
const _hoisted_68 = {
  key: 0,
  class: "history-list"
};
...
const _hoisted_70 = { class: "error-cell" };
const _hoisted_71 = { class: "error-cell" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "ForeignOpinionDetailModal",
  props: {
    modelValue: { type: Boolean },
    opinionId: { default: null },
    riskSource: { default: "current" }
  },
  ...
  setup(__props, { emit: __emit }) {
    ...
    const displayRiskDesc = computed(() => {
      ...
      return displayRiskSource.value === "ai" ? "当前查看口径为 AI 研判；正式预警和事件记录风险仍保持创建时的正式风险快照。" : "当前查看口径为系统规则；正式预警和事件记录风险仍保持创建时的正式风险快照。";
    });
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(Teleport, { to: "body" }, [
          ...
          createBaseVNode("div", _hoisted_1, [
            createBaseVNode("div", _hoisted_2, [
              createBaseVNode("div", _hoisted_3, [
                _cache[6] || (_cache[6] = createBaseVNode("span", { class: "modal-kicker" }, "外网舆情详情与 AI 分析", -1)),
            ...
            withDirectives((openBlock(), createElementBlock("div", _hoisted_7, [
              detail.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                createBaseVNode("div", _hoisted_8, [
                  _cache[7] || (_cache[7] = createBaseVNode("span", { class: "muted" }, "当前查看口径", -1)),
                  createBaseVNode("button", {
                    type: "button",
                    class: normalizeClass(["btn btn-secondary btn-sm", { active: viewSource.value === "current" }]),
                    onClick: _cache[0] || (_cache[0] = ($event) => setViewSource("current"))
                  }, "当前风险", 2),
                  createBaseVNode("button", {
                    type: "button",
                    class: normalizeClass(["btn btn-secondary btn-sm", { active: viewSource.value === "rule" }]),
                    onClick: _cache[1] || (_cache[1] = ($event) => setViewSource("rule"))
                  }, "系统规则", 2),
                  createBaseVNode("button", {
                    type: "button",
                    class: normalizeClass(["btn btn-secondary btn-sm", { active: viewSource.value === "ai" }]),
                    onClick: _cache[2] || (_cache[2] = ($event) => setViewSource("ai"))
                  }, "AI 研判", 2)
                ]),
                createBaseVNode("div", _hoisted_9, [
                  createBaseVNode("div", _hoisted_10, [
                    createBaseVNode("div", _hoisted_11, [
                      _cache[8] || (_cache[8] = createBaseVNode("span", { class: "section-title" }, "原文 / 摘要", -1)),
                      createBaseVNode("button", {
                    ...
                    createBaseVNode("div", _hoisted_13, [
                      ...
                      createBaseVNode("span", null, "类型：" + toDisplayString(unref(contentTypeText)(detail.value.content_type)), 1),
                      createBaseVNode("span", null, "发布时间：" + toDisplayString(unref(formatTime$1)(detail.value.published_at)), 1),
                      createBaseVNode("span", null, "采集时间：" + toDisplayString(unref(formatTime$1)(detail.value.collected_at)), 1)
                    ]),
                    ...
                    withDirectives(createBaseVNode("div", _hoisted_14, [
                      detail.value.matched_keywords && detail.value.matched_keywords.length ? (openBlock(), createElementBlock("p", _hoisted_15, [
                        _cache[9] || (_cache[9] = createBaseVNode("span", { class: "kw-label" }, "命中关键词", -1)),
                  ...
                  createBaseVNode("div", _hoisted_20, [
                    createBaseVNode("div", _hoisted_21, [
                      createBaseVNode("div", _hoisted_22, [
                        _cache[12] || (_cache[12] = createBaseVNode("span", { class: "section-title" }, "当前查看风险", -1)),
                      ...
                      createBaseVNode("div", _hoisted_23, [
                        createBaseVNode("span", _hoisted_24, [
                          _cache[13] || (_cache[13] = createTextVNode("风险评分 ", -1)),
                          createBaseVNode("b", {
                        ...
                        createBaseVNode("span", _hoisted_25, [
                          _cache[14] || (_cache[14] = createTextVNode("等级 ", -1)),
                        ...
                        createBaseVNode("span", _hoisted_26, [
                          ...
                          createBaseVNode("b", null, toDisplayString(unref(sentimentText)(displayRisk.value?.sentiment || "unknown")), 1)
                        ]),
                        _cache[21] || (_cache[21] = createBaseVNode("span", { class: "meta-sep" }, "·", -1)),
                        createBaseVNode("span", _hoisted_27, [
                          _cache[16] || (_cache[16] = createTextVNode("分析时间 ", -1)),
                          createBaseVNode("b", null, toDisplayString(unref(formatTime$1)(displayRisk.value?.evaluated_at)), 1)
                        ]),
                        _cache[22] || (_cache[22] = createBaseVNode("span", { class: "meta-sep" }, "·", -1)),
                        createBaseVNode("span", _hoisted_28, [
                          _cache[17] || (_cache[17] = createTextVNode("版本 ", -1)),
                          createBaseVNode("b", null, toDisplayString(displayRisk.value?.model_version || "-"), 1)
                        ]),
                        effectiveRiskReason.value ? (openBlock(), createElementBlock("span", _hoisted_29, "·")) : createCommentVNode("", true),
                        effectiveRiskReason.value ? (openBlock(), createElementBlock("span", _hoisted_30, [
                          _cache[18] || (_cache[18] = createTextVNode("依据 ", -1)),
                          createBaseVNode("b", null, toDisplayString(effectiveRiskReasonText.value), 1)
                        ])) : createCommentVNode("", true)
                      ]),
                      createBaseVNode("div", _hoisted_31, [
                        createBaseVNode("p", _hoisted_32, toDisplayString(displayRiskDesc.value), 1)
                      ]),
                      detail.value.rule_risk ? (openBlock(), createElementBlock("div", _hoisted_33, [
                        _cache[23] || (_cache[23] = createBaseVNode("span", { class: "dual-label" }, "规则基线", -1)),
                        createBaseVNode("span", _hoisted_34, [
                          ...
                          detail.value.rule_risk.risk_category ? (openBlock(), createElementBlock("span", _hoisted_35, "· " + toDisplayString(detail.value.rule_risk.risk_category), 1)) : createCommentVNode("", true)
                        ])
                      ])) : createCommentVNode("", true),
                      detail.value.latest_ai_risk ? (openBlock(), createElementBlock("div", _hoisted_36, [
                        _cache[25] || (_cache[25] = createBaseVNode("span", { class: "dual-label" }, "AI 研判", -1)),
                        createBaseVNode("span", _hoisted_37, [
                          ...
                          _cache[24] || (_cache[24] = createBaseVNode("span", { class: "dual-flag flag-off" }, "仅历史", -1))
                        ])
                      ])) : createCommentVNode("", true),
                      detail.value.alert ? (openBlock(), createElementBlock("div", _hoisted_38, [
                        _cache[26] || (_cache[26] = createBaseVNode("span", { class: "dual-label" }, "关联告警", -1)),
                        createBaseVNode("span", _hoisted_39, [
                          ...
                          detail.value.alert.expires_at ? (openBlock(), createElementBlock("span", _hoisted_40, " · 有效期至 " + toDisplayString(unref(formatTime$1)(detail.value.alert.expires_at)), 1)) : createCommentVNode("", true)
                        ])
                      ])) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("div", _hoisted_41, [
                      createBaseVNode("div", _hoisted_42, [
                        _cache[28] || (_cache[28] = createBaseVNode("span", { class: "section-title" }, "系统规则研判", -1)),
                        createBaseVNode("span", {
                      ...
                      createBaseVNode("div", _hoisted_43, [
                        createBaseVNode("span", _hoisted_44, [
                          _cache[29] || (_cache[29] = createTextVNode("风险评分 ", -1)),
                          createBaseVNode("b", {
                        ...
                        createBaseVNode("span", _hoisted_45, [
                          _cache[30] || (_cache[30] = createTextVNode("等级 ", -1)),
                        ...
                        createBaseVNode("span", _hoisted_46, [
                          _cache[31] || (_cache[31] = createTextVNode("风险类别 ", -1)),
                          createBaseVNode("b", null, toDisplayString(detail.value.rule_result?.risk_category || "-"), 1)
                        ])
                      ]),
                      createBaseVNode("div", _hoisted_47, [
                        detail.value.rule_result?.explanation ? (openBlock(), createElementBlock("p", _hoisted_48, toDisplayString(detail.value.rule_result.explanation), 1)) : (openBlock(), createElementBlock("p", _hoisted_49, "暂无规则研判解释。"))
                      ]),
                      ruleTermHits.value.length ? (openBlock(), createElementBlock("div", _hoisted_50, [
                        _cache[34] || (_cache[34] = createBaseVNode("span", { class: "kw-label" }, "命中风险词", -1)),
                    ...
                    createBaseVNode("div", _hoisted_51, [
                      createBaseVNode("div", _hoisted_52, [
                        _cache[36] || (_cache[36] = createBaseVNode("span", { class: "section-title" }, "AI 研判记录（历史）", -1)),
                        createBaseVNode("div", _hoisted_53, [
                          ...
                          detail.value.analysis_runs && detail.value.analysis_runs.length ? (openBlock(), createElementBlock("button", {
                            ...
                            onClick: _cache[3] || (_cache[3] = ($event) => showHistoryModal.value = true)
                          }, "查看分析历史")) : createCommentVNode("", true)
                        ])
                      ]),
                      _cache[42] || (_cache[42] = createBaseVNode("div", { class: "detail-divider" }, null, -1)),
                      createBaseVNode("div", _hoisted_54, [
                        createBaseVNode("span", _hoisted_55, [
                          _cache[37] || (_cache[37] = createTextVNode("风险评分 ", -1)),
                          createBaseVNode("b", {
                        ...
                        createBaseVNode("span", _hoisted_56, [
                          _cache[38] || (_cache[38] = createTextVNode("情感 ", -1)),
                        ...
                        createBaseVNode("span", _hoisted_57, [
                          _cache[39] || (_cache[39] = createTextVNode("模型 ", -1)),
                      ...
                      createBaseVNode("div", _hoisted_58, [
                        detail.value.ai_result?.status === "completed" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                          detail.value.ai_result.summary ? (openBlock(), createElementBlock("p", _hoisted_59, toDisplayString(detail.value.ai_result.summary), 1)) : createCommentVNode("", true),
                          detail.value.ai_result.suggestion ? (openBlock(), createElementBlock("p", _hoisted_60, toDisplayString(detail.value.ai_result.suggestion), 1)) : createCommentVNode("", true)
                        ], 64)) : detail.value.ai_result?.status === "failed" ? (openBlock(), createElementBlock("p", _hoisted_61, " AI 分析失败：" + toDisplayString(detail.value.ai_result.error_message || "请稍后重试"), 1)) : (openBlock(), createElementBlock("p", _hoisted_62, "尚未生成 AI 研判报告，点击下方按钮触发分析。"))
                      ]),
                      canAnalyzeAI.value || detail.value.ai_result?.status === "processing" ? (openBlock(), createElementBlock("div", _hoisted_63, [
                        ...
                        }, toDisplayString(analyzing.value ? "分析中..." : detail.value.ai_result?.status === "completed" ? "重新触发 AI 分析" : "触发 AI 分析"), 9, _hoisted_64)) : createCommentVNode("", true)
                      ])) : createCommentVNode("", true)
                    ])
                  ])
                ])
        ...
        showHistoryModal.value ? (openBlock(), createElementBlock("div", {
          key: 1,
          class: "modal-mask",
          onClick: _cache[5] || (_cache[5] = withModifiers(($event) => showHistoryModal.value = false, ["self"]))
        }, [
          createBaseVNode("div", _hoisted_65, [
            createBaseVNode("div", _hoisted_66, [
              _cache[43] || (_cache[43] = createBaseVNode("div", { class: "modal-title-wrap" }, [
              ...
              createBaseVNode("button", {
                class: "modal-close",
                title: "关闭",
                onClick: _cache[4] || (_cache[4] = ($event) => showHistoryModal.value = false)
              }, "✕")
            ]),
            createBaseVNode("div", _hoisted_67, [
              detail.value && detail.value.analysis_runs && detail.value.analysis_runs.length || batchRun.value ? (openBlock(), createElementBlock("div", _hoisted_68, [
                batchRun.value ? (openBlock(), createElementBlock("div", _hoisted_69, [
                  createBaseVNode("span", null, "批量 " + toDisplayString(batchRun.value.run_id.slice(0, 8)), 1),
                  _cache[44] || (_cache[44] = createBaseVNode("span", null, "batch", -1)),
                  ...
                  createBaseVNode("span", _hoisted_70, " 成功 " + toDisplayString(batchRun.value.success_count || 0) + " · 失败 " + toDisplayString(batchRun.value.failed_count || 0) + " · 跳过 " + toDisplayString(batchRun.value.skipped_count || 0), 1)
                ])) : createCommentVNode("", true),
                (openBlock(true), createElementBlock(Fragment, null, renderList(detail.value?.analysis_runs || [], (run) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("span", null, toDisplayString(unref(formatTime$1)(run.finished_at || run.started_at)), 1),
                    createBaseVNode("span", _hoisted_71, toDisplayString(run.error_message || ""), 1)
                  ]);
                }), 128))
