        ...
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_66, [
          createBaseVNode("div", _hoisted_67, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-5f80ff0c>全部语言</option><option value="zh" data-v-5f80ff0c>中文</option><option value="en" data-v-5f80ff0c>英文</option><option value="mixed" data-v-5f80ff0c>中英混合</option><option value="unknown" data-v-5f80ff0c>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-5f80ff0c>全部风险等级</option><option value="high" data-v-5f80ff0c>高</option><option value="medium" data-v-5f80ff0c>中</option><option value="low" data-v-5f80ff0c>低</option><option value="unknown" data-v-5f80ff0c>未知</option>', 5)
            ])], 544), [
          ...
          createBaseVNode("div", _hoisted_110, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-5f80ff0c>全部状态</option><option value="triggered" data-v-5f80ff0c>待处理</option><option value="acknowledged" data-v-5f80ff0c>已确认</option><option value="resolved" data-v-5f80ff0c>已解决</option><option value="suppressed" data-v-5f80ff0c>已抑制</option><option value="failed" data-v-5f80ff0c>失败</option>', 6)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-5f80ff0c>全部严重度</option><option value="low" data-v-5f80ff0c>低</option><option value="medium" data-v-5f80ff0c>中</option><option value="high" data-v-5f80ff0c>高</option><option value="critical" data-v-5f80ff0c>紧急</option>', 5)
            ])], 544), [
          ...
          createBaseVNode("article", _hoisted_142, [
            ...
            createBaseVNode("label", null, [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="risk_score" data-v-5f80ff0c>风险分</option><option value="risk_level" data-v-5f80ff0c>风险等级</option><option value="risk_category" data-v-5f80ff0c>风险类别</option><option value="confirmed_event" data-v-5f80ff0c>确认事件</option><option value="keyword_combo" data-v-5f80ff0c>关键词组合</option>', 5)
              ])], 512), [
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5f80ff0c"]]);
