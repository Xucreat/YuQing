...
import { d as defineComponent, p as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, n as normalizeClass, b as withKeys, v as vModelText, B as createVNode, z as withCtx, T as Transition, A as createCommentVNode, e as createTextVNode, t as toDisplayString, F as Fragment, i as renderList, r as ref, j as computed, g as api, E as ElMessage, I as pollTask, D as resolveDirective, o as openBlock, J as withModifiers, K as __vitePreload, _ as _export_sfc } from './index-YxUSRjrE.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      try {
        const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-YxUSRjrE.js').then(n => n.U);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
