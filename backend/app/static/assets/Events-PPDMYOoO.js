const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-PSMm3Nys.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, p as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, t as toDisplayString, A as createCommentVNode, F as Fragment, i as renderList, r as ref, j as computed, g as api, E as ElMessage, D as resolveDirective, o as openBlock, n as normalizeClass, e as createTextVNode, I as withModifiers, J as __vitePreload, _ as _export_sfc } from './index-B8Jz4k5a.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleAggregate() {
      ...
      try {
        const { data } = await api.post("/events/aggregate", {}, { timeout: 12e4 });
    ...
    async function handleDelete(row) {
      try {
        const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-B8Jz4k5a.js').then(n => n.P);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
        ...
        createBaseVNode("div", _hoisted_5, [
          createBaseVNode("table", _hoisted_6, [
            ...
            createBaseVNode("tbody", null, [
              ...
              rows.value.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_13, [..._cache[5] || (_cache[5] = [
                createBaseVNode("td", {
                  colspan: "8",
                  class: "empty-row"
                }, "暂无事件数据", -1)
...
const Events = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-497d1972"]]);
