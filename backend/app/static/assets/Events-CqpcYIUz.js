const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DOhRNfAz.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, z as usePermission, C as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, n as normalizeClass, b as withKeys, v as vModelText, m as createVNode, p as withCtx, T as Transition, s as createCommentVNode, e as createTextVNode, t as toDisplayString, F as Fragment, i as renderList, J as vModelSelect, H as unref, S as createStaticVNode, r as ref, j as computed, g as api, E as ElMessage, U as pollTask, R as isPermissionDenied, y as resolveComponent, B as resolveDirective, o as openBlock, K as withModifiers, k as normalizeStyle, V as __vitePreload, _ as _export_sfc } from './index-DnAKLHQv.js';
import { E as EVENT_STATUS_OPTIONS, e as eventStatusPill, a as eventStatusLabel } from './event-BQsaDHIJ.js';
...
const _hoisted_20 = { class: "quick-filters" };
const _hoisted_21 = ["onClick"];
const _hoisted_22 = { class: "card table-card" };
const _hoisted_23 = { class: "tbl" };
const _hoisted_24 = ["onClick"];
const _hoisted_25 = { class: "t-title" };
const _hoisted_26 = { class: "nowrap" };
const _hoisted_27 = { class: "col-center" };
...
const _hoisted_31 = { class: "col-center risk-num" };
const _hoisted_32 = { class: "col-center" };
const _hoisted_33 = { class: "col-center risk-num" };
const _hoisted_34 = { class: "col-center risk-num" };
const _hoisted_35 = { class: "col-center" };
const _hoisted_36 = { class: "nowrap" };
const _hoisted_37 = { class: "nowrap" };
const _hoisted_38 = { class: "row-actions" };
...
const _hoisted_45 = { class: "op-left" };
const _hoisted_46 = { class: "operation-header" };
const _hoisted_47 = { class: "operation-current" };
const _hoisted_48 = {
  key: 0,
...
const _hoisted_52 = { class: "note-submit-row" };
const _hoisted_53 = ["disabled"];
const _hoisted_54 = { class: "op-right" };
const _hoisted_55 = { class: "op-right-title" };
const _hoisted_56 = { class: "op-count" };
const _hoisted_57 = { class: "op-right-scroll" };
const _hoisted_58 = { class: "action-timeline" };
const _hoisted_59 = { class: "timeline-body" };
const _hoisted_60 = { class: "timeline-meta" };
const _hoisted_61 = { class: "timeline-content" };
const _hoisted_62 = {
  key: 0,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      ...
      const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-DnAKLHQv.js').then(n => n.a1);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
      try {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
                ...
                riskOpen.value ? (openBlock(), createElementBlock("div", _hoisted_5, [
                  (openBlock(), createElementBlock(Fragment, null, renderList(riskOptions, (opt) => {
                    return createBaseVNode("button", {
                      ...
                      riskFilter.value === opt.value ? (openBlock(), createElementBlock("svg", _hoisted_8, [..._cache[25] || (_cache[25] = [
                ...
                shadowRiskOpen.value ? (openBlock(), createElementBlock("div", _hoisted_11, [
                  (openBlock(), createElementBlock(Fragment, null, renderList(shadowRiskOptions, (opt) => {
                    return createBaseVNode("button", {
                      ...
                      shadowRiskFilter.value === opt.value ? (openBlock(), createElementBlock("svg", _hoisted_14, [..._cache[27] || (_cache[27] = [
                        createBaseVNode("polyline", { points: "20 6 9 17 4 12" }, null, -1)
                      ])])) : createCommentVNode("", true)
                    ], 10, _hoisted_12);
                  }), 64))
          ...
          withDirectives(createBaseVNode("select", {
            ...
            _cache[28] || (_cache[28] = createBaseVNode("option", { value: "" }, "全部主题", -1)),
          ...
          withDirectives(createBaseVNode("select", {
            ...
            _cache[29] || (_cache[29] = createBaseVNode("option", { value: "" }, "全部处置状态", -1)),
          ...
          withDirectives(createBaseVNode("select", {
            ...
            createStaticVNode('<option value="" data-v-05e1dd97>全部趋势</option><option value="rising" data-v-05e1dd97>↑ 升温</option><option value="stable" data-v-05e1dd97>→ 平稳</option><option value="falling" data-v-05e1dd97>↓ 下降</option><option value="unknown" data-v-05e1dd97>未知</option>', 5)
          ])], 544), [
          ...
          }, toDisplayString(aggregating.value ? "聚合中..." : "手动聚合"), 9, _hoisted_18)) : createCommentVNode("", true),
          createBaseVNode("button", {
            class: "btn btn-ghost",
            onClick: loadData
          }, "刷新"),
          lastResult.value ? (openBlock(), createElementBlock("span", _hoisted_19, " 聚合成功：新建 " + toDisplayString(lastResult.value.created) + " · 更新 " + toDisplayString(lastResult.value.updated) + " · 关联 " + toDisplayString(lastResult.value.linked), 1)) : createCommentVNode("", true)
        ]),
        createBaseVNode("div", _hoisted_20, [
          (openBlock(), createElementBlock(Fragment, null, renderList(statusGroups, (g) => {
            ...
            }, toDisplayString(g.label), 11, _hoisted_21);
          }), 64))
        ]),
        createBaseVNode("div", _hoisted_22, [
            ...
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(displayedRows.value, (row, idx) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", _hoisted_26, toDisplayString(topicText(row.topic_category)), 1),
                  createBaseVNode("td", _hoisted_27, [
                    ...
                    isKeyEvent(row) ? (openBlock(), createElementBlock("span", _hoisted_29, "重点关注")) : createCommentVNode("", true)
                  ]),
                  createBaseVNode("td", {
                    ...
                    }, "现行 " + toDisplayString(row.risk_score), 9, _hoisted_30)
                  ], 4),
                  createBaseVNode("td", _hoisted_31, toDisplayString(row.heat_score), 1),
                  createBaseVNode("td", _hoisted_32, [
                    createBaseVNode("span", {
                      class: normalizeClass(["pill", trendPill(row.trend)])
                    }, toDisplayString(trendText(row.trend)), 3)
                  ]),
                  createBaseVNode("td", _hoisted_33, toDisplayString(row.opinion_count), 1),
                  createBaseVNode("td", _hoisted_34, toDisplayString(row.source_count ?? "-"), 1),
                  ...
                  createBaseVNode("td", _hoisted_36, toDisplayString(formatTime(row.first_time)), 1),
                  createBaseVNode("td", _hoisted_37, toDisplayString(formatTime(row.last_time)), 1),
                  createBaseVNode("td", {
                    ...
                    createBaseVNode("div", _hoisted_38, [
                      ...
                      }, "处置", 8, _hoisted_39)) : createCommentVNode("", true),
                      canUpdateEvent.value ? (openBlock(), createElementBlock("button", {
                        key: 1,
                      ...
                      !canUpdateEvent.value ? (openBlock(), createElementBlock("span", _hoisted_41, "—")) : createCommentVNode("", true)
                    ])
                  ])
                ], 8, _hoisted_24);
              }), 128)),
              displayedRows.value.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_42, [..._cache[33] || (_cache[33] = [
                createBaseVNode("td", {
                  colspan: "13",
                  class: "empty-row"
                }, "暂无事件数据", -1)
          ...
          total.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_43, [
            createVNode(_component_Pager, {
              total: total.value,
              "current-page": page.value,
              "onUpdate:currentPage": _cache[18] || (_cache[18] = ($event) => page.value = $event),
        ...
        createVNode(_component_el_dialog, {
          ...
          "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => handleDialogVisible.value = $event),
          title: "事件处置",
          width: "820px",
          top: "6vh",
          ...
          footer: withCtx(() => [
            createBaseVNode("button", {
              class: "btn btn-ghost",
              onClick: _cache[20] || (_cache[20] = ($event) => handleDialogVisible.value = false)
            }, "关闭")
          ]),
          default: withCtx(() => [
            handleEvent.value ? (openBlock(), createElementBlock("div", _hoisted_44, [
              createBaseVNode("div", _hoisted_45, [
                createBaseVNode("div", _hoisted_46, [
                  createBaseVNode("div", null, [
                    createBaseVNode("div", _hoisted_47, [
                      _cache[35] || (_cache[35] = createTextVNode(" 当前处置状态 ", -1)),
                      createBaseVNode("span", {
                ...
                canUpdateEvent.value ? (openBlock(), createElementBlock("div", _hoisted_48, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(EVENT_STATUS_OPTIONS), (option) => {
                    ...
                    }, toDisplayString(option.value === "deprecated" ? "忽略事件" : option.label), 11, _hoisted_49);
                  }), 128))
                ])) : createCommentVNode("", true),
                canUpdateEvent.value ? (openBlock(), createElementBlock("div", _hoisted_50, [
                  withDirectives(createBaseVNode("textarea", {
                    "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => noteContent.value = $event),
                    maxlength: "5000",
                    rows: "3",
                  ...
                  createBaseVNode("div", _hoisted_52, [
                    ...
                    createBaseVNode("button", {
                      ...
                      onClick: addNote
                    }, toDisplayString(savingNote.value ? "提交中" : "添加备注"), 9, _hoisted_53)
                  ])
                ])) : createCommentVNode("", true)
              ]),
              createBaseVNode("div", _hoisted_54, [
                createBaseVNode("div", _hoisted_55, [
                  _cache[36] || (_cache[36] = createTextVNode(" 处置记录", -1)),
                  createBaseVNode("span", _hoisted_56, toDisplayString(handleEvent.value.actions.length), 1)
                ]),
                  ...
                  createBaseVNode("div", _hoisted_58, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(handleEvent.value.actions, (action) => {
                      return openBlock(), createElementBlock("div", {
                        ...
                        _cache[37] || (_cache[37] = createBaseVNode("span", { class: "timeline-dot" }, null, -1)),
                    ...
                    handleEvent.value.actions.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_62, "暂无处置记录")) : createCommentVNode("", true)
                  ])
                ])
              ])
            ])) : (openBlock(), createElementBlock("div", _hoisted_63, "加载中…"))
          ]),
          _: 1
        }, 8, ["modelValue"])
      ])), [
...
const Events = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-05e1dd97"]]);
