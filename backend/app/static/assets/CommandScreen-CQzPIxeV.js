import { d as defineComponent, C as onMounted, G as onBeforeUnmount, c as createElementBlock, n as normalizeClass, a as createBaseVNode, t as toDisplayString, r as ref, j as computed, o as openBlock, _ as _export_sfc, g as api, a4 as shallowRef, A as watch, F as Fragment, i as renderList, s as createCommentVNode, f as reactive, e as createTextVNode, a5 as renderSlot, M as onUnmounted, k as normalizeStyle, D as nextTick, m as createVNode, H as unref, p as withCtx, h as useRouter } from './index-CL6LKzp8.js';
import { o as registerMap, i as init } from './index-F2TANFn2.js';

const _hoisted_1$8 = { class: "cs-header-right" };
const _hoisted_2$8 = ["title"];
const _hoisted_3$7 = { class: "cs-status-code cs-mono" };
const _hoisted_4$7 = { class: "cs-status-text" };
const _hoisted_5$6 = { class: "cs-clock cs-mono" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("header", {
        class: normalizeClass(["cs-header", { "is-fs": isFs.value }])
      }, [
        createBaseVNode("div", { class: "cs-header-left" }, [
          ...
          _cache[1] || (_cache[1] = createBaseVNode("div", { class: "cs-titles" }, [
            createBaseVNode("h1", { class: "cs-title" }, "公安互联网舆情监测研判 · 指挥大屏"),
            createBaseVNode("p", { class: "cs-subtitle" }, "全域舆情态势 · 实时监测")
          ], -1))
        ]),
        createBaseVNode("div", _hoisted_1$8, [
          createBaseVNode("div", {
            ...
            createBaseVNode("span", _hoisted_3$7, toDisplayString(statusInfo.value.code), 1),
            createBaseVNode("span", _hoisted_4$7, toDisplayString(statusInfo.value.text) + " · " + toDisplayString(statusInfo.value.desc), 1)
          ], 10, _hoisted_2$8),
          createBaseVNode("div", _hoisted_5$6, toDisplayString(clock.value), 1),
          createBaseVNode("button", {
            class: "cs-fs",
            type: "button",
            title: isFs.value ? "退出全屏 (Esc)" : "进入全屏",
            onClick: toggleFs
          }, toDisplayString(isFs.value ? "⤢ 退出全屏" : "⤢ 全屏"), 9, _hoisted_6$6),
          createBaseVNode("button", {
            class: "cs-exit",
            type: "button",
            title: "返回系统",
...
const ScreenHeader = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-ad52eb3a"]]);
...
const _hoisted_6$5 = { class: "cs-kpi-foot" };
const _hoisted_7$4 = { class: "cs-kpi-note" };
const _hoisted_8$4 = ["viewBox"];
const _hoisted_9$3 = ["id"];
const _hoisted_10$3 = ["stop-color"];
const _hoisted_11$3 = ["stop-color"];
const _hoisted_12$3 = ["d", "fill"];
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(items.value, (item) => {
          return openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", _hoisted_6$5, [
              ...
              createBaseVNode("span", _hoisted_7$4, toDisplayString(item.foot), 1)
            ]),
...
const _hoisted_7$3 = { class: "cs-tour-head" };
const _hoisted_8$3 = { class: "cs-tour-ctrl" };
const _hoisted_9$2 = { class: "cs-tour-list" };
const _hoisted_10$2 = ["onClick"];
const _hoisted_11$2 = ["value"];
const _hoisted_12$2 = {
  key: 0,
  class: "cs-tour-status cs-mono"
};
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const allProvinceNames = ref([]);
    const tourPanelOpen = ref(false);
    const tourActive = ref(false);
    const tourPaused = ref(false);
    const tourProvinces = ref([]);
    const currentTourProvince = ref(null);
    let tourToken = 0;
    ...
    function initTourProvinces() {
      ...
      const dataProvinces = (props.regions ?? []).filter((r) => (r.count ?? 0) > 0).map((r) => r.region_name);
    ...
    async function prefetchTourGeo(list) {
      await Promise.all(
        list.map(async (name) => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          class: normalizeClass(["cs-tour", { open: tourPanelOpen.value }])
        }, [
          !tourPanelOpen.value ? (openBlock(), createElementBlock("button", {
            key: 0,
            class: "cs-tour-fab",
            type: "button",
            title: "自动轮播下钻",
            onClick: _cache[0] || (_cache[0] = ($event) => tourPanelOpen.value = true)
          }, [..._cache[2] || (_cache[2] = [
            createBaseVNode("span", { class: "cs-tour-fab-icon" }, "▶", -1)
          ])])) : (openBlock(), createElementBlock("div", _hoisted_6$4, [
            createBaseVNode("div", _hoisted_7$3, [
              _cache[3] || (_cache[3] = createBaseVNode("span", null, "自动轮播下钻", -1)),
              createBaseVNode("button", {
                class: "cs-tour-x",
                type: "button",
                title: "收起",
                onClick: _cache[1] || (_cache[1] = ($event) => tourPanelOpen.value = false)
              }, "×")
            ]),
            createBaseVNode("div", _hoisted_8$3, [
              !tourActive.value ? (openBlock(), createElementBlock("button", {
                key: 0,
                class: "cs-tour-btn play",
                type: "button",
                onClick: startTour
              }, "▶ 开始")) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                createBaseVNode("button", {
                  class: "cs-tour-btn",
                  type: "button",
                  onClick: togglePause
                }, toDisplayString(tourPaused.value ? "▶ 继续" : "⏸ 暂停"), 1),
                createBaseVNode("button", {
                  class: "cs-tour-btn stop",
                  type: "button",
                  onClick: stopTour
                }, "■ 停止")
              ], 64))
            ...
            createBaseVNode("div", _hoisted_9$2, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(tourProvinces.value, (p) => {
                return openBlock(), createElementBlock("span", {
                  key: p,
                  class: normalizeClass(["cs-tour-chip", { active: currentTourProvince.value === p }])
                }, [
                  createTextVNode(toDisplayString(p) + " ", 1),
                  createBaseVNode("button", {
                    class: "cs-tour-chip-x",
                    type: "button",
                    title: "移出轮播",
                    onClick: ($event) => removeProvince(p)
                  }, "×", 8, _hoisted_10$2)
                ], 2);
              }), 128)),
              candidateProvinces.value.length ? (openBlock(), createElementBlock("select", {
                key: 0,
                class: "cs-tour-add",
                value: "",
                onChange: onAddProvince
              }, [
                _cache[4] || (_cache[4] = createBaseVNode("option", { value: "" }, "+ 添加省份", -1)),
                (openBlock(true), createElementBlock(Fragment, null, renderList(candidateProvinces.value, (p) => {
                  return openBlock(), createElementBlock("option", {
                    key: p,
                    value: p
                  }, toDisplayString(p), 9, _hoisted_11$2);
                }), 128))
              ], 32)) : createCommentVNode("", true)
            ]),
            tourActive.value ? (openBlock(), createElementBlock("div", _hoisted_12$2, toDisplayString(tourPaused.value ? "已暂停" : currentTourProvince.value ? "轮播中 · " + currentTourProvince.value : "轮播中"), 1)) : createCommentVNode("", true)
          ]))
        ], 2)
      ], 2);
    };
...
const ChinaMap = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-1cb2ba92"]]);
...
const CommandScreen = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-36f18dbf"]]);
