...
const _hoisted_38 = { class: "perm-groups compact" };
const _hoisted_39 = { class: "perm-group-title" };
const _hoisted_40 = { class: "perm-grid" };
const _hoisted_41 = ["checked", "onChange"];
const _hoisted_42 = { class: "perm-code" };
const _hoisted_43 = { class: "perm-name" };
const _hoisted_44 = { class: "form-actions" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const legacyPermissionGroups = computed(() => groupedPermissions.value.filter((group) => group.group !== "Foreign combined"));
    const visiblePermissionGroups = computed(() => showLegacyPermissions.value ? groupedPermissions.value : groupedPermissions.value.filter((group) => group.group === "Foreign combined"));
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          _cache[8] || (_cache[8] = createBaseVNode("h3", { class: "section-title" }, "角色权限", -1)),
        ...
        createBaseVNode("div", _hoisted_3, [
          createBaseVNode("table", _hoisted_4, [
            ...
            createBaseVNode("tbody", null, [
              ...
              !roles.value.length ? (openBlock(), createElementBlock("tr", _hoisted_14, [..._cache[9] || (_cache[9] = [
                createBaseVNode("td", {
                  colspan: "7",
                  class: "empty-row"
                }, "暂无角色", -1)
        ...
        editorOpen.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_15, [
            ...
            isAdminRole.value ? (openBlock(), createElementBlock("p", _hoisted_16, [..._cache[11] || (_cache[11] = [
            ...
            createBaseVNode("div", _hoisted_17, [
              _cache[12] || (_cache[12] = createBaseVNode("div", null, [
                ...
                createBaseVNode("span", null, "默认展示四类外网组合权限；旧细粒度权限保留在兼容区。")
              ], -1)),
              createBaseVNode("button", {
                type: "button",
            ...
            createBaseVNode("div", _hoisted_19, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(visiblePermissionGroups.value, (g) => {
                return openBlock(), createElementBlock("div", {
                  key: g.group,
                  class: normalizeClass(["perm-group", { "foreign-combined-group": g.group === "Foreign combined", "legacy-permission-group": g.group !== "Foreign combined" }])
                }, [
        ...
        createOpen.value ? (openBlock(), createElementBlock("div", {
          key: 1,
          class: "modal-overlay",
          onClick: _cache[7] || (_cache[7] = withModifiers(($event) => createOpen.value = false, ["self"]))
        }, [
          createBaseVNode("div", _hoisted_32, [
            _cache[18] || (_cache[18] = createBaseVNode("h3", null, "新建角色", -1)),
            createBaseVNode("div", _hoisted_33, [
              _cache[13] || (_cache[13] = createBaseVNode("label", null, "角色代码（code，英文唯一）", -1)),
            ...
            createBaseVNode("div", _hoisted_34, [
              _cache[14] || (_cache[14] = createBaseVNode("label", null, "角色名（name，唯一）", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("div", _hoisted_35, [
              _cache[15] || (_cache[15] = createBaseVNode("label", null, "显示名", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("div", _hoisted_36, [
              _cache[16] || (_cache[16] = createBaseVNode("label", null, "描述", -1)),
              withDirectives(createBaseVNode("input", {
            ...
            createBaseVNode("div", _hoisted_37, [
              _cache[17] || (_cache[17] = createBaseVNode("label", null, "初始权限", -1)),
              createBaseVNode("div", _hoisted_38, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(groupedPermissions.value, (g) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_39, toDisplayString(g.label), 1),
                    createBaseVNode("div", _hoisted_40, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(g.perms, (p) => {
                        return openBlock(), createElementBlock("label", {
                          ...
                          createBaseVNode("span", _hoisted_42, toDisplayString(p.code), 1),
                          createBaseVNode("span", _hoisted_43, toDisplayString(permNameLabel(p)), 1)
                        ]);
                      }), 128))
                    ])
                  ]);
            ...
            createBaseVNode("div", _hoisted_44, [
              createBaseVNode("button", {
                class: "btn",
                onClick: _cache[6] || (_cache[6] = ($event) => createOpen.value = false)
              }, "取消"),
              createBaseVNode("button", {
                class: "btn btn-primary",
                onClick: createRole,
                disabled: saving.value
              }, toDisplayString(saving.value ? "创建中..." : "创建"), 9, _hoisted_45)
            ])
          ])
        ])) : createCommentVNode("", true)
      ])), [
...
const Roles = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fad30a8c"]]);
