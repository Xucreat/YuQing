...
const _hoisted_15 = { class: "card card-pad sys-card" };
...
const _hoisted_27 = { class: "card card-pad ai-card" };
const _hoisted_28 = { class: "ai-header" };
const _hoisted_29 = { class: "report-meta" };
const _hoisted_30 = { class: "meta-item" };
const _hoisted_31 = { class: "meta-item" };
const _hoisted_32 = { class: "meta-item" };
const _hoisted_33 = { class: "report-body" };
const _hoisted_34 = {
  key: 0,
  class: "report-p"
};
...
const _hoisted_40 = { class: "ai-actions" };
              ...
              detail.value ? (openBlock(), createElementBlock("div", _hoisted_8, [
                ...
                createBaseVNode("div", _hoisted_15, [
                  ...
                  createBaseVNode("div", _hoisted_21, [
                    detail.value.summary ? (openBlock(), createElementBlock("p", _hoisted_22, toDisplayString(detail.value.summary), 1)) : (openBlock(), createElementBlock("p", _hoisted_23, "暂无系统研判摘要。")),
                ...
                createBaseVNode("div", _hoisted_27, [
                  ...
                  createBaseVNode("div", _hoisted_33, [
                    detail.value.ai_analysis_status === "completed" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                      detail.value.ai_summary ? (openBlock(), createElementBlock("p", _hoisted_34, toDisplayString(detail.value.ai_summary), 1)) : createCommentVNode("", true),
                      detail.value.ai_analysis_suggestion ? (openBlock(), createElementBlock("p", _hoisted_35, toDisplayString(detail.value.ai_analysis_suggestion), 1)) : createCommentVNode("", true)
                    ], 64)) : detail.value.ai_analysis_status === "failed" ? (openBlock(), createElementBlock("p", _hoisted_36, " AI 分析失败（DeepSeek 未配置或余额不足），请稍后重试。 ")) : (openBlock(), createElementBlock("p", _hoisted_37, " 尚未生成 AI 研判报告，点击下方按钮由 DeepSeek 生成。 "))
                  ]),
                  aiKeywordList.value.length ? (openBlock(), createElementBlock("div", _hoisted_38, [
                  ...
                  detail.value.ai_analysis_time ? (openBlock(), createElementBlock("div", _hoisted_39, " 分析时间：" + toDisplayString(unref(formatTime)(detail.value.ai_analysis_time)), 1)) : createCommentVNode("", true),
                  ...
                  createBaseVNode("div", _hoisted_40, [
                    ...
                    }, toDisplayString(analyzing.value ? "分析中..." : detail.value.ai_analysis_status === "completed" ? "重新触发 AI 分析" : "触发 AI 分析"), 9, _hoisted_41)) : (openBlock(), createElementBlock("div", _hoisted_42, [..._cache[17] || (_cache[17] = [
...
const OpinionDetailModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a74469a4"]]);
