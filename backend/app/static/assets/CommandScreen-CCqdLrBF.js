    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        level.value === "province" ? (openBlock(), createElementBlock("div", _hoisted_3$4, [
          ...
          children.value ? (openBlock(), createElementBlock("div", _hoisted_4$4, " 已下钻 · " + toDisplayString(children.value.province) + " · 共 " + toDisplayString(children.value.total) + " 条 ", 1)) : loadingChildren.value ? (openBlock(), createElementBlock("div", _hoisted_5$4, "加载细分数据…")) : createCommentVNode("", true)
        ])) : createCommentVNode("", true)
      ], 2);
    };
  }
...
const ChinaMap = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-5e7d2540"]]);
