import { d as defineComponent, p as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, t as toDisplayString, n as normalizeClass, e as createTextVNode, A as createCommentVNode, k as normalizeStyle, F as Fragment, i as renderList, B as createVNode, r as ref, j as computed, g as api, E as ElMessage, D as resolveDirective, M as useRoute, o as openBlock, h as useRouter, _ as _export_sfc } from './index-DB9eapVy.js';
import { O as OpinionDetailModal } from './OpinionDetailModal-B8Gt3xzd.js';
...
const _hoisted_16 = { class: "card table-card" };
const _hoisted_17 = { class: "card-header" };
const _hoisted_18 = { class: "section-title" };
const _hoisted_19 = { class: "tbl" };
const _hoisted_20 = ["onClick"];
const _hoisted_21 = { class: "t-title" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function statusText(value) {
      return { active: "关注中", verifying: "核查中", processing: "处理中", resolved: "已解决", closed: "已关闭" }[value] || value || "未知";
    }
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_9, [
          createBaseVNode("div", _hoisted_10, [
            _cache[5] || (_cache[5] = createBaseVNode("span", { class: "situation-label" }, "影响区域", -1)),
          ...
          createBaseVNode("div", _hoisted_11, [
            _cache[6] || (_cache[6] = createBaseVNode("span", { class: "situation-label" }, "事件主题", -1)),
            createBaseVNode("strong", null, toDisplayString(topicText(event.value.topic_category)), 1)
          ]),
          createBaseVNode("div", _hoisted_12, [
            _cache[7] || (_cache[7] = createBaseVNode("span", { class: "situation-label" }, "事件状态", -1)),
            createBaseVNode("strong", null, toDisplayString(statusText(event.value.status)), 1)
          ]),
          createBaseVNode("div", _hoisted_13, [
            _cache[8] || (_cache[8] = createBaseVNode("span", { class: "situation-label" }, "当前风险", -1)),
          ...
          createBaseVNode("div", _hoisted_14, [
            _cache[9] || (_cache[9] = createBaseVNode("span", { class: "situation-label" }, "当前热度", -1)),
            createBaseVNode("strong", null, toDisplayString(event.value.heat_score) + " 分", 1)
          ]),
          createBaseVNode("div", _hoisted_15, [
            _cache[10] || (_cache[10] = createBaseVNode("span", { class: "situation-label" }, "发展趋势", -1)),
            createBaseVNode("strong", null, toDisplayString(trendText(event.value.trend)), 1)
          ])
        ]),
        createBaseVNode("div", _hoisted_16, [
          createBaseVNode("div", _hoisted_17, [
            createBaseVNode("h3", _hoisted_18, "关联舆情列表 (" + toDisplayString(event.value.total_opinions) + ")", 1)
          ]),
          createBaseVNode("table", _hoisted_19, [
            ...
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(event.value.opinions, (row) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", null, [
                    createBaseVNode("span", _hoisted_21, toDisplayString(row.title), 1)
                  ]),
                  ...
                  createBaseVNode("td", _hoisted_22, [
                    createBaseVNode("span", {
                      ...
                      _cache[11] || (_cache[11] = createBaseVNode("span", { class: "dot" }, null, -1)),
              ...
              event.value.opinions.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_24, [..._cache[12] || (_cache[12] = [
                createBaseVNode("td", {
                  colspan: "7",
                  class: "empty-row"
                }, "暂无关联舆情", -1)
...
const EventDetail = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dce227cc"]]);
