import { d as defineComponent, z as usePermission, C as onMounted, E as ElMessage, w as withDirectives, c as createElementBlock, a as createBaseVNode, H as unref, s as createCommentVNode, F as Fragment, i as renderList, L as withModifiers, t as toDisplayString, e as createTextVNode, v as vModelText, r as ref, j as computed, g as api, B as resolveDirective, o as openBlock, n as normalizeClass, m as createVNode, p as withCtx, M as ElMessageBox, y as resolveComponent, _ as _export_sfc } from './index-DVsoRI-e.js';
...
const _hoisted_17 = { class: "perm-groups" };
const _hoisted_18 = { class: "perm-group-title" };
const _hoisted_19 = {
  key: 0,
  class: "perm-group-note"
};
const _hoisted_20 = { class: "perm-grid" };
const _hoisted_21 = ["checked", "disabled", "onChange"];
const _hoisted_22 = { class: "perm-copy" };
const _hoisted_23 = { class: "perm-line" };
const _hoisted_24 = { class: "perm-code" };
const _hoisted_25 = { class: "perm-name" };
const _hoisted_26 = {
  key: 0,
  class: "perm-desc"
};
...
const _hoisted_30 = { class: "modal modal-wide" };
...
const _hoisted_36 = { class: "perm-groups compact" };
const _hoisted_37 = { class: "perm-group-title" };
const _hoisted_38 = { class: "perm-grid" };
const _hoisted_39 = ["checked", "onChange"];
const _hoisted_40 = { class: "perm-code" };
const _hoisted_41 = { class: "perm-name" };
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          _cache[7] || (_cache[7] = createBaseVNode("h3", { class: "section-title" }, "角色权限", -1)),
        ...
        createBaseVNode("div", _hoisted_3, [
          createBaseVNode("table", _hoisted_4, [
            ...
            createBaseVNode("tbody", null, [
              ...
              !roles.value.length ? (openBlock(), createElementBlock("tr", _hoisted_14, [..._cache[8] || (_cache[8] = [
                createBaseVNode("td", {
                  colspan: "7",
                  class: "empty-row"
                }, "暂无角色", -1)
        ...
        editorOpen.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_15, [
            ...
            isAdminRole.value ? (openBlock(), createElementBlock("p", _hoisted_16, [..._cache[10] || (_cache[10] = [
            ...
            createBaseVNode("div", _hoisted_17, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(groupedPermissions.value, (g) => {
                return openBlock(), createElementBlock("div", {
                  key: g.group,
                  class: normalizeClass(["perm-group", { "foreign-combined-group": g.group === "Foreign combined" }])
                }, [
                  createBaseVNode("div", _hoisted_18, toDisplayString(g.label), 1),
                  g.group === "Foreign combined" ? (openBlock(), createElementBlock("div", _hoisted_19, " 四类组合权限按业务场景归类；保存后由后端自动展开为兼容的细粒度权限。 ")) : createCommentVNode("", true),
                      ...
                      return openBlock(), createElementBlock("label", {
                        ...
                        createBaseVNode("span", _hoisted_22, [
                          createBaseVNode("span", _hoisted_23, [
                            createBaseVNode("span", _hoisted_24, toDisplayString(p.code), 1),
                            createBaseVNode("span", _hoisted_25, toDisplayString(permNameLabel(p)), 1)
                          ]),
                          g.group !== "Foreign combined" ? (openBlock(), createElementBlock("span", _hoisted_26, toDisplayString(p.description), 1)) : createCommentVNode("", true)
                        ]),
            ...
            createBaseVNode("div", _hoisted_28, [
              ...
              }, toDisplayString(saving.value ? "保存中..." : "保存权限"), 9, _hoisted_29)) : createCommentVNode("", true)
            ])
          ])
        ])) : createCommentVNode("", true),
        createOpen.value ? (openBlock(), createElementBlock("div", {
          key: 1,
          class: "modal-overlay",
          onClick: _cache[6] || (_cache[6] = withModifiers(($event) => createOpen.value = false, ["self"]))
        }, [
          createBaseVNode("div", _hoisted_30, [
            _cache[16] || (_cache[16] = createBaseVNode("h3", null, "新建角色", -1)),
            createBaseVNode("div", _hoisted_31, [
              _cache[11] || (_cache[11] = createBaseVNode("label", null, "角色代码（code，英文唯一）", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => createForm.value.code = $event),
                class: "input",
            ...
            createBaseVNode("div", _hoisted_32, [
              _cache[12] || (_cache[12] = createBaseVNode("label", null, "角色名（name，唯一）", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => createForm.value.name = $event),
                class: "input",
                placeholder: "如 custom_analyst"
              }, null, 512), [
            ...
            createBaseVNode("div", _hoisted_33, [
              ...
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => createForm.value.display_name = $event),
                class: "input",
            ...
            createBaseVNode("div", _hoisted_34, [
              _cache[14] || (_cache[14] = createBaseVNode("label", null, "描述", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => createForm.value.description = $event),
                class: "input",
                placeholder: "可选"
              }, null, 512), [
            ...
            createBaseVNode("div", _hoisted_35, [
              _cache[15] || (_cache[15] = createBaseVNode("label", null, "初始权限", -1)),
              createBaseVNode("div", _hoisted_36, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(groupedPermissions.value, (g) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_37, toDisplayString(g.label), 1),
                    createBaseVNode("div", _hoisted_38, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(g.perms, (p) => {
                        return openBlock(), createElementBlock("label", {
                          ...
                          createBaseVNode("span", _hoisted_40, toDisplayString(p.code), 1),
                          createBaseVNode("span", _hoisted_41, toDisplayString(permNameLabel(p)), 1)
                        ]);
                      }), 128))
                    ])
                  ]);
            ...
            createBaseVNode("div", _hoisted_42, [
              createBaseVNode("button", {
                class: "btn",
                onClick: _cache[5] || (_cache[5] = ($event) => createOpen.value = false)
              }, "取消"),
              createBaseVNode("button", {
                class: "btn btn-primary",
                onClick: createRole,
                disabled: saving.value
              }, toDisplayString(saving.value ? "创建中..." : "创建"), 9, _hoisted_43)
            ])
          ])
        ])) : createCommentVNode("", true)
      ])), [
...
const Roles = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-23b4f3a3"]]);
