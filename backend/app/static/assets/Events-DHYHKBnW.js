...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      ...
      const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-BAp8qvqC.js').then(n => n.a1);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
      try {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          ...
          withDirectives(createBaseVNode("select", {
            ...
            createStaticVNode('<option value="" data-v-2466e751>全部趋势</option><option value="rising" data-v-2466e751>↑ 升温</option><option value="stable" data-v-2466e751>→ 平稳</option><option value="falling" data-v-2466e751>↓ 下降</option><option value="unknown" data-v-2466e751>未知</option>', 5)
          ])], 544), [
...
const Events = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2466e751"]]);
