    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_3, [
          createBaseVNode("table", _hoisted_4, [
            ...
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(filteredUsers.value, (user) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", _hoisted_5, [
                    ...
                    }, toDisplayString(userToggleId.value === user.id ? "处理中…" : user.is_active ? "停用" : "启用"), 11, _hoisted_7)) : createCommentVNode("", true),
                    createBaseVNode("button", {
              ...
              !filteredUsers.value.length ? (openBlock(), createElementBlock("tr", _hoisted_9, [..._cache[10] || (_cache[10] = [
                createBaseVNode("td", {
                  colspan: "6",
                  class: "empty-row"
                }, "暂无用户", -1)
        ...
        showForm.value ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: "modal-overlay",
          onClick: _cache[6] || (_cache[6] = withModifiers(($event) => showForm.value = false, ["self"]))
        }, [
          createBaseVNode("div", _hoisted_10, [
            ...
            !editingId.value ? (openBlock(), createElementBlock("div", _hoisted_13, [
            ...
            createBaseVNode("div", _hoisted_14, [
              ...
              editingId.value && selectedUser.value?.role === "admin" ? (openBlock(), createElementBlock("small", _hoisted_16, "管理员角色固定，仅可修改密码。")) : createCommentVNode("", true)
            ]),
            editingId.value && selectedUser.value ? (openBlock(), createElementBlock("div", _hoisted_17, [
              _cache[16] || (_cache[16] = createBaseVNode("span", null, "密码管理", -1)),
              createBaseVNode("button", {
                class: "btn btn-mini",
                onClick: _cache[4] || (_cache[4] = ($event) => openPasswordDialog(selectedUser.value))
              }, "修改此用户密码")
            ])) : createCommentVNode("", true),
            createBaseVNode("div", _hoisted_18, [
              createBaseVNode("button", {
                class: "btn",
                onClick: _cache[5] || (_cache[5] = ($event) => showForm.value = false)
              }, "关闭"),
              ...
              }, toDisplayString(saving.value ? "保存中..." : "保存"), 9, _hoisted_19)) : createCommentVNode("", true)
            ])
          ])
        ])) : createCommentVNode("", true),
        showPassword.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_20, [
            ...
            passwordMode.value === "self" ? (openBlock(), createElementBlock("div", _hoisted_21, [
              _cache[17] || (_cache[17] = createBaseVNode("label", null, "旧密码", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => passwordForm.value.old_password = $event),
                type: "password",
                class: "input",
            ...
            createBaseVNode("div", _hoisted_22, [
              ...
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => passwordForm.value.new_password = $event),
                type: "password",
                class: "input",
                autocomplete: "new-password"
              }, null, 512), [
            ...
            createBaseVNode("div", _hoisted_23, [
              ...
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => passwordForm.value.confirm_password = $event),
                type: "password",
                class: "input",
                autocomplete: "new-password"
              }, null, 512), [
            ...
            createBaseVNode("div", _hoisted_24, [
              ...
              }, toDisplayString(passwordSaving.value ? "提交中..." : "保存密码"), 9, _hoisted_25)
            ])
          ])
        ])) : createCommentVNode("", true)
      ])), [
...
const Users = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e6796f70"]]);
