...
const _hoisted_5$3 = { class: "section-head" };
          ...
          createBaseVNode("div", _hoisted_4$3, [
            createBaseVNode("div", _hoisted_5$3, [
              createBaseVNode("div", null, [
                ...
                unref(activeSession) ? (openBlock(), createElementBlock("p", _hoisted_6$3, "本次检索返回 " + toDisplayString(unref(results).length) + " 条结果", 1)) : (openBlock(), createElementBlock("p", _hoisted_7$2, "输入关键词后开始一次主动检索"))
              ]),
...
const _hoisted_6$2 = { class: "section-head" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        ...
        withDirectives((openBlock(), createElementBlock("section", _hoisted_3$2, [
          createBaseVNode("div", _hoisted_4$2, [
            answer.value || unref(session) ? (openBlock(), createElementBlock("section", _hoisted_5$2, [
          ...
          createBaseVNode("div", _hoisted_4$1, [
            createBaseVNode("div", _hoisted_5$1, [
              createBaseVNode("div", null, [
                ...
                unref(activeSession) ? (openBlock(), createElementBlock("p", _hoisted_6$1, "本次搜索返回 " + toDisplayString(unref(results).length) + " 条结果", 1)) : (openBlock(), createElementBlock("p", _hoisted_7, "输入关键词后开始一次 Anspire 网页搜索"))
              ]),
          ...
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("div", _hoisted_3, [
              ...
              createBaseVNode("div", _hoisted_4, [
                createBaseVNode("button", {
                  class: normalizeClass(["view-tab", { active: !isAiSearch.value && !isAnspireSearch.value }]),
                  type: "button",
                  disabled: !isAiSearch.value && !isAnspireSearch.value && navigating.value,
                  onClick: _cache[0] || (_cache[0] = ($event) => go("/ai-search/web"))
                }, " Bocha 网页搜索 ", 10, _hoisted_5),
                createBaseVNode("button", {
                  class: normalizeClass(["view-tab", { active: isAiSearch.value }]),
                  type: "button",
                  disabled: isAiSearch.value && navigating.value,
                  onClick: _cache[1] || (_cache[1] = ($event) => go("/ai-search/ai"))
                }, " AI 搜索（Bocha） ", 10, _hoisted_6),
                createBaseVNode("button", {
                  class: normalizeClass(["view-tab", { active: isAnspireSearch.value }]),
                  type: "button",
