import { d as defineComponent, l as usePermission, p as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, t as toDisplayString, n as normalizeClass, e as createTextVNode, A as createCommentVNode, x as unref, k as normalizeStyle, F as Fragment, i as renderList, B as createVNode, z as withCtx, r as ref, j as computed, g as api, E as ElMessage, C as resolveComponent, D as resolveDirective, M as useRoute, o as openBlock, v as vModelText, h as useRouter, _ as _export_sfc } from './index-6hQVgtzz.js';
import { O as OpinionDetailModal } from './OpinionDetailModal-lcxAECRF.js';
...
const _hoisted_17 = { class: "situation-panel-head" };
const _hoisted_18 = { class: "pill pill-gray" };
const _hoisted_19 = { class: "situation-facts" };
const _hoisted_20 = { class: "risk-factor-list" };
const _hoisted_21 = { class: "op-modal-body" };
const _hoisted_22 = { class: "op-left" };
const _hoisted_23 = { class: "operation-header" };
const _hoisted_24 = { class: "operation-current" };
const _hoisted_25 = {
  key: 0,
...
const _hoisted_29 = { class: "note-submit-row" };
const _hoisted_30 = ["disabled"];
const _hoisted_31 = { class: "op-right" };
const _hoisted_32 = { class: "op-right-title" };
const _hoisted_33 = { class: "op-count" };
const _hoisted_34 = { class: "op-right-scroll" };
const _hoisted_35 = { class: "action-timeline" };
const _hoisted_36 = { class: "timeline-body" };
const _hoisted_37 = { class: "timeline-meta" };
const _hoisted_38 = { class: "timeline-content" };
const _hoisted_39 = {
  key: 0,
  class: "timeline-empty"
};
const _hoisted_40 = { class: "card table-card" };
const _hoisted_41 = { class: "card-header" };
const _hoisted_42 = { class: "section-title" };
const _hoisted_43 = { class: "tbl" };
const _hoisted_44 = ["onClick"];
const _hoisted_45 = { class: "t-title" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        situation.value ? (openBlock(), createElementBlock("section", _hoisted_16, [
          createBaseVNode("div", _hoisted_17, [
            _cache[15] || (_cache[15] = createBaseVNode("h3", { class: "section-title" }, "事件态势（只读研判）", -1)),
            createBaseVNode("span", _hoisted_18, "数据充分性：" + toDisplayString(sufficiencyText(situation.value.data_sufficiency?.level)), 1)
          ]),
              ...
              createBaseVNode("div", _hoisted_22, [
                createBaseVNode("div", _hoisted_23, [
                  createBaseVNode("div", null, [
                    _cache[17] || (_cache[17] = createBaseVNode("h3", { class: "section-title" }, "事件处置", -1)),
                    createBaseVNode("div", _hoisted_24, [
                      _cache[16] || (_cache[16] = createTextVNode(" 当前处置状态 ", -1)),
                      createBaseVNode("span", {
                ...
                canUpdateEvent.value ? (openBlock(), createElementBlock("div", _hoisted_25, [
                ...
                canUpdateEvent.value ? (openBlock(), createElementBlock("div", _hoisted_27, [
                  ...
                  createBaseVNode("div", _hoisted_29, [
                    ...
                    createBaseVNode("button", {
                      ...
                      onClick: addNote
                    }, toDisplayString(savingNote.value ? "提交中" : "添加备注"), 9, _hoisted_30)
                  ])
                ])) : createCommentVNode("", true)
              ]),
              createBaseVNode("div", _hoisted_31, [
                createBaseVNode("div", _hoisted_32, [
                  _cache[18] || (_cache[18] = createTextVNode(" 处置记录", -1)),
                  createBaseVNode("span", _hoisted_33, toDisplayString(event.value.actions.length), 1)
                ]),
                  ...
                  createBaseVNode("div", _hoisted_35, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(event.value.actions, (action) => {
                      return openBlock(), createElementBlock("div", {
                        ...
                        _cache[19] || (_cache[19] = createBaseVNode("span", { class: "timeline-dot" }, null, -1)),
                    ...
                    event.value.actions.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_39, "暂无处置记录")) : createCommentVNode("", true)
                  ])
                ])
              ])
            ])
        ...
        createBaseVNode("div", _hoisted_40, [
          createBaseVNode("div", _hoisted_41, [
            createBaseVNode("h3", _hoisted_42, "关联舆情列表 (" + toDisplayString(event.value.total_opinions) + ")", 1)
          ]),
          createBaseVNode("table", _hoisted_43, [
            ...
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(event.value.opinions, (row) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", null, [
                    createBaseVNode("span", _hoisted_45, toDisplayString(row.title), 1)
                  ]),
              ...
              event.value.opinions.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_48, [..._cache[21] || (_cache[21] = [
                createBaseVNode("td", {
                  colspan: "7",
                  class: "empty-row"
                }, "暂无关联舆情", -1)
...
const EventDetail = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-94526bb9"]]);
