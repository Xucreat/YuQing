  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("header", _hoisted_1$7, [
        _cache[0] || (_cache[0] = createStaticVNode('<div class="cs-header-left" data-v-a25ed9c4><div class="cs-logo" data-v-a25ed9c4>YQ</div><div class="cs-titles" data-v-a25ed9c4><h1 class="cs-title" data-v-a25ed9c4>大厂县公安互联网舆情监测研判 · 指挥大屏</h1><p class="cs-subtitle" data-v-a25ed9c4>全域舆情态势 · 实时监测</p></div></div>', 1)),
        createBaseVNode("div", _hoisted_2$7, [
          createBaseVNode("div", {
            ...
            createBaseVNode("span", _hoisted_4$5, toDisplayString(statusInfo.value.code), 1),
            createBaseVNode("span", _hoisted_5$4, toDisplayString(statusInfo.value.text) + " · " + toDisplayString(statusInfo.value.desc), 1)
          ], 10, _hoisted_3$6),
          createBaseVNode("div", _hoisted_6$3, toDisplayString(clock.value), 1)
        ])
      ]);
    };
  }
...
const ScreenHeader = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-a25ed9c4"]]);

const _hoisted_1$6 = { class: "cs-kpi-bar" };
const _hoisted_2$6 = { class: "cs-kpi-label" };
const _hoisted_3$5 = { class: "cs-kpi-value cs-mono" };
const _hoisted_4$4 = { key: 0 };
const _hoisted_5$3 = {
  key: 1,
  class: "cs-kpi-skeleton"
};
const _hoisted_6$2 = { class: "cs-kpi-foot" };
const _hoisted_7$1 = { class: "cs-kpi-note" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$6, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(items.value, (item) => {
          return openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", _hoisted_2$6, toDisplayString(item.label), 1),
            createBaseVNode("div", _hoisted_3$5, [
              hasData.value ? (openBlock(), createElementBlock("span", _hoisted_4$4, toDisplayString(displayed[item.key]), 1)) : (openBlock(), createElementBlock("span", _hoisted_5$3, "—"))
            ]),
            createBaseVNode("div", _hoisted_6$2, [
              createBaseVNode("span", {
                class: normalizeClass(["cs-kpi-caliber", "cal-" + item.tone])
              }, toDisplayString(item.caliber), 3),
              createBaseVNode("span", _hoisted_7$1, toDisplayString(item.foot), 1)
            ])
          ], 2);
        }), 128))
      ]);
...
const KpiBar = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-cc5b844e"]]);

const _hoisted_1$5 = { class: "cs-panel" };
const _hoisted_2$5 = {
  key: 0,
...
const _hoisted_4$3 = { class: "cs-panel-body" };
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("section", _hoisted_1$5, [
        __props.title ? (openBlock(), createElementBlock("h3", _hoisted_2$5, [
          createTextVNode(toDisplayString(__props.title) + " ", 1),
          __props.badge ? (openBlock(), createElementBlock("span", _hoisted_3$4, toDisplayString(__props.badge), 1)) : createCommentVNode("", true)
...
const BaseChart = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-f3ec95da"]]);

const _hoisted_1$4 = { class: "cs-map-wrap" };
const _hoisted_2$4 = {
  key: 0,
  class: "cs-map-msg"
};
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$4, [
        ...
        mapError.value ? (openBlock(), createElementBlock("div", _hoisted_2$4, "地图资源加载失败，仅影响地图展示")) : !mapReady.value ? (openBlock(), createElementBlock("div", _hoisted_3$3, "地图加载中…")) : createCommentVNode("", true)
      ]);
    };
  }
});

const ChinaMap = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-273f3d43"]]);
...
const _hoisted_6$1 = { class: "cs-hot-count cs-mono" };
        ...
        !__props.items || __props.items.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_2$3, "暂无热门关键词")) : (openBlock(), createElementBlock("ul", _hoisted_3$2, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.items, (k, i) => {
            return openBlock(), createElementBlock("li", {
              ...
              createBaseVNode("span", _hoisted_6$1, toDisplayString(k.count), 1),
              createBaseVNode("span", {
...
const _hoisted_6 = { class: "cs-feed-meta cs-muted" };
const _hoisted_7 = { class: "cs-mono" };
const _hoisted_8 = {
  key: 0,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        __props.kind === "recent" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              ...
              return openBlock(), createElementBlock("li", {
                ...
                createBaseVNode("div", _hoisted_4$1, [
                  ...
                  createBaseVNode("div", _hoisted_6, [
                    ...
                    createBaseVNode("span", _hoisted_7, toDisplayString(shortTime(o.created_at)), 1)
                  ])
                ]),
                createBaseVNode("span", {
          ...
          __props.alerts && __props.alerts.length ? (openBlock(), createElementBlock("div", _hoisted_8, [
...
const _hoisted_5 = { class: "cs-col cs-col-right" };
const days = 7;
...
const CommandScreen = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-474b347f"]]);
