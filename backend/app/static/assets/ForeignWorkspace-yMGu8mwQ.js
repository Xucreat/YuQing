...
const _hoisted_77 = { class: "dual-cell" };
const _hoisted_78 = { class: "muted" };
const _hoisted_79 = {
  key: 0,
  class: "muted"
};
const _hoisted_80 = { class: "actions" };
const _hoisted_81 = ["disabled", "onClick"];
...
const _hoisted_85 = { class: "alert-scope-note" };
const _hoisted_86 = { class: "toolbar" };
...
const _hoisted_90 = { class: "subtabs" };
const _hoisted_91 = {
  key: 2,
  class: "table-wrap"
};
const _hoisted_92 = { class: "title-cell" };
const _hoisted_93 = { class: "actions" };
...
const _hoisted_104 = { class: "event-provenance" };
const _hoisted_105 = { key: 0 };
const _hoisted_106 = { class: "event-detail-head" };
const _hoisted_107 = { class: "actions" };
const _hoisted_108 = ["disabled"];
const _hoisted_109 = ["disabled"];
const _hoisted_110 = ["disabled"];
const _hoisted_111 = { class: "muted" };
const _hoisted_112 = { class: "event-metrics" };
const _hoisted_113 = { class: "muted" };
const _hoisted_114 = ["href"];
const _hoisted_115 = { class: "ai-batch-options" };
const _hoisted_116 = { key: 0 };
const _hoisted_117 = { class: "check-row" };
const _hoisted_118 = { class: "check-row" };
...
const _hoisted_123 = { class: "review-toolbar" };
...
风险结果`, textAlign: "center", fill: "#1d1d1f", fontSize: 20, fontWeight: 700, lineHeight: 22 } },
    ...
    async function batchDecideReviews(decision) {
      if (!manualReviews.value.length || reviewActionId.value) return;
      ...
      try {
        await api.post("/foreign/ai-analysis/reviews/batch", { decision, confirm_all: true, reason: "Foreign workspace batch review" });
        await loadManualReviews();
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_67, [
          createBaseVNode("div", _hoisted_68, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              _cache[54] || (_cache[54] = createBaseVNode("option", { value: "" }, "全部来源", -1)),
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-da7c3434>全部语言</option><option value="zh" data-v-da7c3434>中文</option><option value="en" data-v-da7c3434>英文</option><option value="mixed" data-v-da7c3434>中英混合</option><option value="unknown" data-v-da7c3434>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-da7c3434>全部风险等级</option><option value="high" data-v-da7c3434>高</option><option value="medium" data-v-da7c3434>中</option><option value="low" data-v-da7c3434>低</option><option value="unknown" data-v-da7c3434>未知</option>', 5)
            ])], 544), [
            ...
            _cache[59] || (_cache[59] = createBaseVNode("span", { class: "muted" }, "AI 研判结果仅用于辅助分析，不改变系统正式风险和告警", -1))
          ]),
          aiBatchRun.value ? (openBlock(), createElementBlock("div", _hoisted_72, [
            ...
            aiBatchRun.value.status === "running" || aiBatchRun.value.status === "pending" ? (openBlock(), createElementBlock("span", _hoisted_73, toDisplayString(aiBatchRun.value.progress || 0) + "%", 1)) : createCommentVNode("", true),
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_77, [
                      ...
                      createBaseVNode("span", _hoisted_78, toDisplayString(aiHistoryLabel(row)), 1)
                    ]),
                    ...
                    createBaseVNode("td", null, [
                      ...
                      !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_79, "无")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_80, [
                      ...
                      }, toDisplayString(ruleOf(row) ? "重新分析" : "分析"), 9, _hoisted_81)
                    ])
                  ], 8, _hoisted_75);
                }), 128)),
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_82, [..._cache[60] || (_cache[60] = [
                  createBaseVNode("td", {
                    colspan: "16",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_83, [
        ...
        ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_84, [
          createBaseVNode("div", _hoisted_85, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
          createBaseVNode("div", _hoisted_86, [
            ...
            }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_87),
            _cache[62] || (_cache[62] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
          ]),
          eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_88, [
          ...
          eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_89, [
            _cache[64] || (_cache[64] = createBaseVNode("strong", null, "外网事件运行失败", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(eventRunFailures.value, (run) => {
              return openBlock(), createElementBlock("div", {
                key: run.id,
                class: "event-failure-row"
              }, [
                _cache[63] || (_cache[63] = createBaseVNode("span", { class: "status failed" }, "失败", -1)),
          ...
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_91, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_92, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", _hoisted_93, [
                      ...
                      }, "确认", 8, _hoisted_94)) : createCommentVNode("", true),
                      row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn danger",
                        disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                        onClick: ($event) => rejectCandidate(row)
                      }, "拒绝", 8, _hoisted_95)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_96, [..._cache[65] || (_cache[65] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
          ...
          ])) : eventSection.value === "confirmed" ? (openBlock(), createElementBlock("div", _hoisted_97, [
            createBaseVNode("table", null, [
              _cache[68] || (_cache[68] = createBaseVNode("thead", null, [
                createBaseVNode("tr", null, [
                  createBaseVNode("th", null, "标题"),
                  createBaseVNode("th", null, "语言"),
              ...
              createBaseVNode("tbody", null, [
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_102, [..._cache[67] || (_cache[67] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
          ...
          selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_103, [
            createBaseVNode("div", _hoisted_104, [
              _cache[70] || (_cache[70] = createBaseVNode("strong", null, "事件溯源", -1)),
              ...
              selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_105, [
                _cache[69] || (_cache[69] = createBaseVNode("summary", null, "聚合证据", -1)),
            ...
            createBaseVNode("p", _hoisted_111, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_113, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                createBaseVNode("a", {
                  href: opinion.url,
                  target: "_blank",
                  rel: "noreferrer",
        ...
        createVNode(_component_el_dialog, {
          ...
          "onUpdate:modelValue": _cache[35] || (_cache[35] = ($event) => aiBatchDialog.value = $event),
          title: "批量 AI 研判",
          ...
          footer: withCtx(() => [
            createBaseVNode("button", {
              class: "btn btn-secondary",
              onClick: _cache[34] || (_cache[34] = ($event) => aiBatchDialog.value = false)
            }, "取消"),
            createBaseVNode("button", {
              class: "btn btn-primary",
          ...
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_115, [
              createBaseVNode("label", null, [
                _cache[72] || (_cache[72] = createTextVNode("研判范围 ", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              aiBatchConfig.scope === "count" ? (openBlock(), createElementBlock("label", _hoisted_116, [
                _cache[73] || (_cache[73] = createTextVNode("最近 N 条 ", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              aiBatchConfig.scope === "time" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                createBaseVNode("label", null, [
                  _cache[74] || (_cache[74] = createTextVNode("发布时间起始日期", -1)),
                  withDirectives(createBaseVNode("input", {
                ...
                createBaseVNode("label", null, [
                  _cache[75] || (_cache[75] = createTextVNode("发布时间结束日期", -1)),
                  withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("label", _hoisted_117, [
                withDirectives(createBaseVNode("input", {
                ...
                _cache[76] || (_cache[76] = createTextVNode(" 仅选择当前筛选结果", -1))
              ]),
              createBaseVNode("label", _hoisted_118, [
                withDirectives(createBaseVNode("input", {
                ...
                _cache[77] || (_cache[77] = createTextVNode(" 仅处理未完成 AI 研判的记录", -1))
              ]),
              createBaseVNode("label", _hoisted_119, [
                ...
                _cache[78] || (_cache[78] = createTextVNode(" 强制重新研判已有 AI 结果", -1))
              ]),
              aiBatchConfig.scope === "full" ? (openBlock(), createElementBlock("p", _hoisted_120, "全量任务可能消耗大量 Token 并运行较长时间。AI 结果仍须人工复核后才会进入正式事件或预警。")) : createCommentVNode("", true)
            ]),
            aiBatchPreview.value ? (openBlock(), createElementBlock("div", _hoisted_121, [
              createBaseVNode("p", null, [
                _cache[79] || (_cache[79] = createTextVNode("符合条件舆情：", -1)),
                createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.matched_count), 1),
                _cache[80] || (_cache[80] = createTextVNode(" 条", -1))
              ]),
              createBaseVNode("p", null, [
                _cache[81] || (_cache[81] = createTextVNode("已有 AI 结果：", -1)),
                createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.existing_ai_result_count), 1),
                _cache[82] || (_cache[82] = createTextVNode(" 条 · 待分析：", -1)),
                createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.pending_analysis_count), 1),
                _cache[83] || (_cache[83] = createTextVNode(" 条", -1))
              ]),
              createBaseVNode("p", null, [
                _cache[84] || (_cache[84] = createTextVNode("待分析：", -1)),
                createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.pending_analysis_count), 1),
                _cache[85] || (_cache[85] = createTextVNode(" 条 · 预计 Token：", -1)),
              ...
              _cache[86] || (_cache[86] = createBaseVNode("p", { class: "muted" }, "AI 结果必须经过人工复核后，才可用于正式事件或预警变更。", -1))
            ])) : createCommentVNode("", true),
            eventSection.value === "ai-review" ? (openBlock(), createElementBlock("div", _hoisted_122, [
              ...
              createBaseVNode("table", null, [
                _cache[88] || (_cache[88] = createBaseVNode("thead", null, [
                  createBaseVNode("tr", null, [
                    createBaseVNode("th", null, "舆情 ID"),
                    createBaseVNode("th", null, "规则风险"),
                    createBaseVNode("th", null, "AI 风险"),
                    createBaseVNode("th", null, "事件影响"),
                    createBaseVNode("th", null, "预警影响"),
                    createBaseVNode("th", null, "状态"),
                    createBaseVNode("th", null, "操作")
                  ])
                ], -1)),
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(manualReviews.value, (review) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      review.review_status === "pending_review" ? (openBlock(), createElementBlock("td", _hoisted_128, [
                        createBaseVNode("button", {
                          class: "link-btn",
                          disabled: reviewActionId.value === review.id,
                          onClick: ($event) => decideReview(review, "use_ai_display")
                        }, "采用 AI 展示", 8, _hoisted_129),
                        createBaseVNode("button", {
                          class: "link-btn",
                          disabled: reviewActionId.value === review.id,
                      ...
                      ])) : (openBlock(), createElementBlock("td", _hoisted_134, toDisplayString(review.review_reason || "-"), 1))
                    ]);
                  }), 128)),
                  !manualReviews.value.length ? (openBlock(), createElementBlock("tr", _hoisted_135, [..._cache[87] || (_cache[87] = [
                    createBaseVNode("td", {
                      colspan: "7",
                      class: "empty"
                    }, "暂无待复核结果", -1)
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-da7c3434"]]);
