...
风险结果`, textAlign: "center", fill: "#1d1d1f", fontSize: 20, fontWeight: 700, lineHeight: 22 } },
    ...
    async function startAIBatch() {
      ...
      try {
        ...
        ElMessage.success(`任务已提交（run_id：${data.run_id}，task_id：${data.task_id}），匹配 ${data.total_count} 条，待研判 ${data.total_count} 条`);
      } catch (err) {
        const status = err?.response?.status;
        ...
        withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
          ...
          activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_67, [
            createBaseVNode("div", _hoisted_68, [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="" data-v-2b21d70c>全部语言</option><option value="zh" data-v-2b21d70c>中文</option><option value="en" data-v-2b21d70c>英文</option><option value="mixed" data-v-2b21d70c>中英混合</option><option value="unknown" data-v-2b21d70c>未知</option>', 5)
              ])], 544), [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="" data-v-2b21d70c>全部风险等级</option><option value="high" data-v-2b21d70c>高</option><option value="medium" data-v-2b21d70c>中</option><option value="low" data-v-2b21d70c>低</option><option value="unknown" data-v-2b21d70c>未知</option>', 5)
              ])], 544), [
          ...
          createVNode(_component_el_dialog, {
            ...
            default: withCtx(() => [
              ...
              eventSection.value === "ai-review" ? (openBlock(), createElementBlock("div", _hoisted_129, [
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2b21d70c"]]);
