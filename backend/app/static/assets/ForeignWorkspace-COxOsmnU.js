...
const _hoisted_9 = { class: "toolbar" };
...
const _hoisted_14 = { class: "metric-grid" };
...
const _hoisted_19 = { class: "metric-card" };
const _hoisted_20 = { class: "visualization-columns" };
...
const _hoisted_25 = { class: "data-section" };
const _hoisted_26 = {
  key: 0,
  class: "distribution-row"
};
const _hoisted_27 = { class: "distribution-row" };
const _hoisted_28 = {
  key: 1,
  class: "empty"
};
const _hoisted_29 = { class: "data-section" };
const _hoisted_30 = { class: "table-wrap" };
const _hoisted_31 = { class: "visualization-meta" };
const _hoisted_32 = {
  key: 2,
  class: "state"
};
...
const _hoisted_39 = { class: "table-wrap" };
const _hoisted_40 = { class: "title-cell" };
const _hoisted_41 = { class: "data-section" };
const _hoisted_42 = { class: "table-wrap" };
const _hoisted_43 = { class: "visualization-meta" };
const _hoisted_44 = {
  key: 2,
  class: "state"
};
...
const _hoisted_46 = { class: "toolbar" };
const _hoisted_47 = {
  key: 0,
  class: "stale-badge"
};
...
const _hoisted_50 = { class: "visualization-columns" };
const _hoisted_51 = { class: "data-section" };
const _hoisted_52 = { class: "data-section" };
const _hoisted_53 = {
  key: 0,
  class: "empty"
};
const _hoisted_54 = { class: "table-wrap" };
const _hoisted_55 = { class: "muted" };
const _hoisted_56 = { class: "visualization-meta" };
const _hoisted_57 = {
  key: 2,
  class: "state"
};
const _hoisted_58 = { class: "toolbar source-editor-toolbar" };
const _hoisted_59 = {
  key: 3,
  class: "source-editor"
};
...
const _hoisted_66 = { class: "table-wrap" };
...
const _hoisted_80 = { class: "error-cell" };
const _hoisted_81 = {
  key: 0,
  class: "muted"
};
...
const _hoisted_83 = { class: "toolbar" };
const _hoisted_84 = ["value"];
const _hoisted_85 = { class: "table-wrap" };
const _hoisted_86 = ["onClick"];
const _hoisted_87 = { class: "title-cell" };
...
const _hoisted_93 = { class: "toolbar" };
const _hoisted_94 = ["value"];
const _hoisted_95 = { class: "table-wrap" };
...
const _hoisted_105 = { class: "alert-scope-note" };
const _hoisted_106 = { class: "toolbar" };
...
const _hoisted_110 = { class: "subtabs" };
const _hoisted_111 = {
  key: 2,
  class: "table-wrap"
};
const _hoisted_112 = { class: "title-cell" };
const _hoisted_113 = { class: "actions" };
const _hoisted_114 = ["disabled", "onClick"];
const _hoisted_115 = ["disabled", "onClick"];
...
const _hoisted_119 = { class: "title-cell" };
const _hoisted_120 = ["disabled", "onClick"];
...
const _hoisted_124 = { class: "event-provenance" };
const _hoisted_125 = { key: 0 };
const _hoisted_126 = { class: "event-detail-head" };
...
const _hoisted_132 = { class: "event-metrics" };
...
const _hoisted_136 = { class: "alert-scope-note" };
const _hoisted_137 = { class: "toolbar" };
...
const _hoisted_141 = { class: "table-wrap" };
const _hoisted_142 = { class: "title-cell" };
const _hoisted_143 = ["onClick"];
const _hoisted_144 = { class: "muted" };
const _hoisted_145 = { class: "actions" };
const _hoisted_146 = ["onClick"];
const _hoisted_147 = ["disabled", "onClick"];
...
const _hoisted_152 = { class: "table-wrap" };
const _hoisted_153 = { class: "actions" };
const _hoisted_154 = ["onClick"];
const _hoisted_155 = ["disabled", "onClick"];
...
const _hoisted_175 = { class: "table-wrap" };
const _hoisted_176 = { class: "error-cell" };
const _hoisted_177 = { key: 0 };
const _hoisted_178 = { class: "detail alert-dialog" };
const _hoisted_179 = { class: "detail-meta" };
const _hoisted_180 = { class: "detail-summary" };
const _hoisted_181 = ["innerHTML"];
const _hoisted_182 = {
  key: 0,
  class: "event-opinion-list"
};
const _hoisted_183 = { class: "muted" };
...
const _hoisted_187 = { class: "analysis-block" };
const _hoisted_188 = {
  key: 0,
  class: "analysis-grid"
};
const _hoisted_189 = { class: "analysis-block" };
const _hoisted_190 = { class: "muted" };
const _hoisted_191 = { class: "analysis-block" };
const _hoisted_192 = {
  key: 0,
  class: "alert-action-history"
};
const _hoisted_193 = { class: "muted" };
const _hoisted_194 = {
  key: 1,
  class: "muted"
};
const _hoisted_195 = ["href"];
const _hoisted_196 = { class: "detail history-dialog" };
const _hoisted_197 = { class: "muted" };
const _hoisted_198 = {
  key: 0,
  class: "muted"
};
...
const _hoisted_201 = { class: "muted" };
const _hoisted_202 = { class: "detail rule-dialog" };
const _hoisted_203 = { class: "muted" };
const _hoisted_204 = ["disabled"];
const _hoisted_205 = { class: "rule-preview" };
const _hoisted_206 = { class: "actions" };
const _hoisted_207 = ["disabled"];
const _hoisted_208 = { class: "detail" };
const _hoisted_209 = {
  key: 0,
  class: "ai-admission"
};
...
const _hoisted_213 = { class: "detail-meta" };
const _hoisted_214 = { class: "detail-summary" };
const _hoisted_215 = { class: "detail-text" };
const _hoisted_216 = ["href"];
const _hoisted_217 = { class: "analysis-block" };
const _hoisted_218 = {
  key: 0,
  class: "analysis-grid"
};
const _hoisted_219 = { key: 1 };
const _hoisted_220 = { key: 2 };
const _hoisted_221 = {
  key: 3,
  class: "muted"
};
const _hoisted_222 = { class: "analysis-block" };
const _hoisted_223 = { class: "analysis-heading" };
const _hoisted_224 = ["disabled"];
const _hoisted_225 = {
  key: 0,
  class: "analysis-grid"
};
const _hoisted_226 = { key: 1 };
const _hoisted_227 = { key: 2 };
const _hoisted_228 = {
  key: 3,
  class: "error-cell"
};
...
const _hoisted_230 = { class: "analysis-block" };
const _hoisted_231 = {
  key: 0,
  class: "muted"
};
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function normalizeTab(value) {
      return value === "dashboard" || value === "risk" || value === "events" || value === "alerts" || value === "alertRules" || value === "hotwords" || value === "keywords" || value === "sources" || value === "runs" ? value : "opinions";
    }
    ...
    const sourceDraft = reactive({ name: "", key: "", feedsText: "", language: "unknown", proxyEnv: "FOREIGN_HTTP_PROXY", timeout: 15, maxRetries: 2, maxItems: 100, requestInterval: 0.5, scheduleInterval: 60, maxContentLength: 2e5, respectRobots: true });
    ...
    async function openAlertDetail(row) {
      try {
        selectedForeignAlert.value = (await api.get(`/foreign/alerts/${row.id}`)).data;
      } catch (err) {
        ElMessage.error(err?.response?.data?.detail || "外网告警详情加载失败");
      }
    }
    ...
    async function setAIAdmission(included) {
      if (!canAdmitAI || !selectedOpinion.value?.id) return;
      try {
        const prompt = await ElMessageBox.prompt(
          included ? "请填写纳入 AI 告警评估的备注" : "请填写取消纳入的备注",
          "AI 告警准入",
          { inputType: "textarea", inputValidator: (value) => value.trim() ? true : "备注不能为空" }
        );
        await api.post(`/foreign/opinions/${selectedOpinion.value.id}/ai-alert-admission`, {
          included,
          note: prompt.value.trim()
        });
        selectedOpinion.value = (await api.get(`/foreign/opinions/${selectedOpinion.value.id}/detail`)).data;
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          _cache[76] || (_cache[76] = createBaseVNode("div", null, [
            createBaseVNode("h2", null, "外网舆情"),
            createBaseVNode("p", null, "独立采集、去重和展示链路；不会进入国内舆情、风险、事件或告警。")
          ], -1)),
          createBaseVNode("div", _hoisted_3, [
            _cache[75] || (_cache[75] = createBaseVNode("span", { class: "source-scope-label" }, "Approved sources: 57-60", -1)),
            createBaseVNode("button", {
              class: "btn btn-primary",
              disabled: collecting.value,
              onClick: collectNow
            }, toDisplayString(collecting.value ? "采集中..." : "采集外网 RSS"), 9, _hoisted_4),
            createBaseVNode("button", {
              class: "btn btn-secondary",
              disabled: collecting.value,
              onClick: collectAll
            }, "Collect all sources", 8, _hoisted_5)
          ])
        ]),
        ...
        activeTab.value === "dashboard" ? (openBlock(), createElementBlock("section", _hoisted_8, [
          createBaseVNode("div", _hoisted_9, [
            ...
            createBaseVNode("label", _hoisted_10, [
              _cache[78] || (_cache[78] = createTextVNode("Window ", -1)),
            ...
            _cache[79] || (_cache[79] = createBaseVNode("span", { class: "scope-badge" }, "Foreign data only · UTC", -1)),
            visualizationStale.value ? (openBlock(), createElementBlock("span", _hoisted_11, "Stale data")) : createCommentVNode("", true)
          ]),
          visualizationError.value ? (openBlock(), createElementBlock("div", _hoisted_12, [
            ...
            createBaseVNode("div", _hoisted_14, [
              createBaseVNode("div", _hoisted_15, [
                _cache[80] || (_cache[80] = createBaseVNode("span", null, "Articles total", -1)),
              ...
              createBaseVNode("div", _hoisted_16, [
                _cache[81] || (_cache[81] = createBaseVNode("span", null, "Sources", -1)),
              ...
              createBaseVNode("div", _hoisted_17, [
                _cache[82] || (_cache[82] = createBaseVNode("span", null, "Risk completed", -1)),
              ...
              createBaseVNode("div", _hoisted_18, [
                _cache[83] || (_cache[83] = createBaseVNode("span", null, "Confirmed events", -1)),
              ...
              createBaseVNode("div", _hoisted_19, [
                _cache[84] || (_cache[84] = createBaseVNode("span", null, "Foreign alerts", -1)),
            ...
            createBaseVNode("div", _hoisted_20, [
              createBaseVNode("article", _hoisted_21, [
                _cache[85] || (_cache[85] = createBaseVNode("h3", null, "Risk distribution", -1)),
                ...
                !dashboardRisk.value || !Object.keys(dashboardRisk.value.risk_levels || {}).length ? (openBlock(), createElementBlock("p", _hoisted_22, "No completed risk results")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_23, [
                _cache[86] || (_cache[86] = createBaseVNode("h3", null, "Event states", -1)),
                ...
                !dashboardEvents.value || !Object.keys(dashboardEvents.value.formal_events || {}).length ? (openBlock(), createElementBlock("p", _hoisted_24, "No foreign events")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_25, [
                _cache[89] || (_cache[89] = createBaseVNode("h3", null, "Collection status", -1)),
                dashboardSummary.value.collection.latest ? (openBlock(), createElementBlock("div", _hoisted_26, [
                  _cache[87] || (_cache[87] = createBaseVNode("span", null, "Latest", -1)),
                  createBaseVNode("strong", null, toDisplayString(dashboardSummary.value.collection.latest.status), 1)
                ])) : createCommentVNode("", true),
                createBaseVNode("div", _hoisted_27, [
                  _cache[88] || (_cache[88] = createBaseVNode("span", null, "Success / failed", -1)),
                ...
                !dashboardSummary.value.collection.latest ? (openBlock(), createElementBlock("p", _hoisted_28, "No foreign collection runs")) : createCommentVNode("", true)
              ])
            ]),
            createBaseVNode("div", _hoisted_29, [
              _cache[91] || (_cache[91] = createBaseVNode("h3", null, "Daily trend", -1)),
            ...
            createBaseVNode("div", _hoisted_31, "Data range: " + toDisplayString(formatTime(dashboardSummary.value.window_start)) + " - " + toDisplayString(formatTime(dashboardSummary.value.window_end)) + " · Updated: " + toDisplayString(formatTime(dashboardSummary.value.data_as_of)), 1)
          ])) : (openBlock(), createElementBlock("div", _hoisted_32, "Loading foreign dashboard..."))
        ])) : activeTab.value === "hotwords" ? (openBlock(), createElementBlock("section", _hoisted_33, [
          createBaseVNode("div", _hoisted_34, [
            ...
            createBaseVNode("label", _hoisted_35, [
              _cache[93] || (_cache[93] = createTextVNode("Window ", -1)),
              withDirectives(createBaseVNode("select", {
            ...
            _cache[95] || (_cache[95] = createBaseVNode("span", { class: "scope-badge" }, "Foreign text only · China/Chinese/中国 excluded", -1)),
            visualizationStale.value ? (openBlock(), createElementBlock("span", _hoisted_36, "Stale data")) : createCommentVNode("", true)
          ]),
          visualizationError.value ? (openBlock(), createElementBlock("div", _hoisted_37, [
            createTextVNode(toDisplayString(visualizationError.value) + " ", 1),
            createBaseVNode("button", {
              class: "btn btn-secondary",
              onClick: loadHotwords
            }, "Retry")
          ])) : hotwordItems.value.length ? (openBlock(), createElementBlock("div", _hoisted_38, [
                ...
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(hotwordItems.value, (item) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_40, toDisplayString(item.word), 1),
            ...
            createBaseVNode("div", _hoisted_41, [
              _cache[98] || (_cache[98] = createBaseVNode("h3", null, "Hotword trend", -1)),
            ...
            createBaseVNode("div", _hoisted_43, "Data range: " + toDisplayString(formatTime(hotwordMeta.value.window_start)) + " - " + toDisplayString(formatTime(hotwordMeta.value.window_end)) + " · Updated: " + toDisplayString(formatTime(hotwordMeta.value.data_as_of)), 1)
          ])) : (openBlock(), createElementBlock("div", _hoisted_44, "No foreign hotwords in this window."))
        ])) : activeTab.value === "sources" ? (openBlock(), createElementBlock("section", _hoisted_45, [
          createBaseVNode("div", _hoisted_46, [
            ...
            _cache[99] || (_cache[99] = createBaseVNode("span", { class: "scope-badge" }, "Source and language distribution · no map", -1)),
            visualizationStale.value ? (openBlock(), createElementBlock("span", _hoisted_47, "Stale data")) : createCommentVNode("", true)
          ]),
          visualizationError.value ? (openBlock(), createElementBlock("div", _hoisted_48, [
            createTextVNode(toDisplayString(visualizationError.value) + " ", 1),
            createBaseVNode("button", {
              class: "btn btn-secondary",
              onClick: loadSourcesView
            }, "Retry")
          ])) : sourceDistribution.value ? (openBlock(), createElementBlock("div", _hoisted_49, [
            createBaseVNode("div", _hoisted_50, [
              createBaseVNode("article", _hoisted_51, [
                _cache[100] || (_cache[100] = createBaseVNode("h3", null, "Language distribution", -1)),
              ...
              createBaseVNode("article", _hoisted_52, [
                _cache[101] || (_cache[101] = createBaseVNode("h3", null, "Foreign sources", -1)),
                ...
                !sourceDistribution.value.items.length ? (openBlock(), createElementBlock("p", _hoisted_53, "No foreign source data")) : createCommentVNode("", true)
              ])
            ]),
            createBaseVNode("div", _hoisted_54, [
              createBaseVNode("table", null, [
                _cache[102] || (_cache[102] = createBaseVNode("thead", null, [
                  createBaseVNode("tr", null, [
                ...
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(sourceDistribution.value.items, (item) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", null, [
                        createTextVNode(toDisplayString(item.source), 1),
                        createBaseVNode("div", _hoisted_55, toDisplayString(item.source_key), 1)
                      ]),
            ...
            createBaseVNode("div", _hoisted_56, "Data range: " + toDisplayString(formatTime(sourceDistribution.value.window_start)) + " - " + toDisplayString(formatTime(sourceDistribution.value.window_end)) + " · Updated: " + toDisplayString(formatTime(sourceDistribution.value.data_as_of)), 1)
          ])) : (openBlock(), createElementBlock("div", _hoisted_57, "Loading foreign source distribution...")),
          _cache[108] || (_cache[108] = createBaseVNode("div", { class: "source-management-note" }, "Source management remains below. Visualization data never changes source status.", -1)),
          _cache[109] || (_cache[109] = createBaseVNode("div", { class: "source-note" }, "First-party foreign sources are disabled by default. Proxy configuration is not displayed.", -1)),
          ...
          sourceEditorVisible.value ? (openBlock(), createElementBlock("div", _hoisted_59, [
            withDirectives(createBaseVNode("input", {
            ...
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => sourceDraft.language = $event),
              class: "input"
            }, [..._cache[103] || (_cache[103] = [
              createBaseVNode("option", { value: "unknown" }, "语言：未知", -1),
              createBaseVNode("option", { value: "en" }, "语言：英文", -1),
              createBaseVNode("option", { value: "zh" }, "语言：中文", -1),
              createBaseVNode("option", { value: "mixed" }, "语言：中英混合", -1)
            ])], 512), [
              [vModelSelect, sourceDraft.language]
            ]),
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => sourceDraft.feedsText = $event),
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => sourceDraft.proxyEnv = $event),
              class: "input",
              placeholder: "代理环境变量名"
            }, null, 512), [
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => sourceDraft.timeout = $event),
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => sourceDraft.maxRetries = $event),
              class: "input number-input",
              type: "number",
              min: "0",
              max: "5",
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => sourceDraft.maxItems = $event),
              class: "input number-input",
              type: "number",
              min: "1",
              max: "500",
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => sourceDraft.requestInterval = $event),
              class: "input number-input",
              type: "number",
              min: "0",
              max: "60",
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => sourceDraft.scheduleInterval = $event),
              class: "input number-input",
              type: "number",
              min: "5",
              max: "10080",
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => sourceDraft.maxContentLength = $event),
              class: "input number-input",
              type: "number",
              min: "100",
              max: "1000000",
            ...
            createBaseVNode("label", _hoisted_61, [
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => sourceDraft.respectRobots = $event),
                type: "checkbox"
              }, null, 512), [
                [vModelCheckbox, sourceDraft.respectRobots]
              ]),
              _cache[104] || (_cache[104] = createTextVNode(" robots 检查", -1))
            ]),
            _cache[105] || (_cache[105] = createBaseVNode("label", { class: "muted" }, [
            ...
            }, toDisplayString(sourceTesting.value ? "测试中..." : "连通性测试"), 9, _hoisted_62),
            createBaseVNode("button", {
              class: "btn btn-primary",
              disabled: sourceSaving.value || !sourceDraftTested.value,
              onClick: saveSource
            }, toDisplayString(sourceSaving.value ? "保存中..." : "保存"), 9, _hoisted_63),
            !sourceDraftTested.value ? (openBlock(), createElementBlock("span", _hoisted_64, "保存前必须完成当前配置的 RSS 测试")) : createCommentVNode("", true)
          ])) : createCommentVNode("", true),
          sourceTestResult.value ? (openBlock(), createElementBlock("div", _hoisted_65, [
          ...
          createBaseVNode("div", _hoisted_66, [
            createBaseVNode("table", null, [
              _cache[107] || (_cache[107] = createBaseVNode("thead", null, [
                createBaseVNode("tr", null, [
                  createBaseVNode("th", null, "Source"),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(sources.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", null, [
                      ...
                      createBaseVNode("div", _hoisted_67, toDisplayString(row.key), 1)
                    ]),
                    createBaseVNode("td", null, [
                    ...
                    createBaseVNode("td", null, [
                      createBaseVNode("div", _hoisted_68, toDisplayString(row.class_path || "foreign_rss"), 1)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("button", {
                      ...
                      }, toDisplayString(row.enabled ? "Enabled" : "Disabled"), 11, _hoisted_69)
                    ]),
                    ...
                    createBaseVNode("td", null, [
                      ...
                      row.proxy_configured ? (openBlock(), createElementBlock("span", _hoisted_70, "configured")) : createCommentVNode("", true)
                    ]),
                ...
                !sources.value.length ? (openBlock(), createElementBlock("tr", _hoisted_75, [..._cache[106] || (_cache[106] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
          ...
          sourceTotal.value > sourceSize ? (openBlock(), createElementBlock("div", _hoisted_76, [
            createBaseVNode("button", {
              class: "btn btn-secondary",
          ...
          selectedSourceRuns.value ? (openBlock(), createElementBlock("div", _hoisted_79, [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectedSourceRuns.value.items, (run) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_80, toDisplayString(run.error_msg || ""), 1)
              ]);
            }), 128)),
            !selectedSourceRuns.value.items.length ? (openBlock(), createElementBlock("p", _hoisted_81, "暂无采集历史")) : createCommentVNode("", true)
          ])) : createCommentVNode("", true)
        ])) : createCommentVNode("", true),
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_82, [
          createBaseVNode("div", _hoisted_83, [
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => opinionFilters.q = $event),
              class: "input",
            ...
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => opinionFilters.source = $event),
              class: "input",
              onChange: loadOpinions
            }, [
              _cache[110] || (_cache[110] = createBaseVNode("option", { value: "" }, "全部来源", -1)),
              (openBlock(true), createElementBlock(Fragment, null, renderList(opinionSources.value, (source) => {
                return openBlock(), createElementBlock("option", {
                  key: source,
                  value: source
                }, toDisplayString(source), 9, _hoisted_84);
              }), 128))
            ], 544), [
              [vModelSelect, opinionFilters.source]
            ]),
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => opinionFilters.keyword = $event),
              class: "input",
              placeholder: "命中关键词",
              onKeyup: withKeys(loadOpinions, ["enter"])
            }, null, 544), [
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => opinionFilters.date_from = $event),
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => opinionFilters.date_to = $event),
              class: "input date-input",
              type: "date",
              title: "发布时间截止",
              onChange: loadOpinions
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_87, toDisplayString(row.title || "无标题"), 1),
                ...
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_88, [..._cache[111] || (_cache[111] = [
                  createBaseVNode("td", {
                    colspan: "5",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          opinionTotal.value > opinionSize ? (openBlock(), createElementBlock("div", _hoisted_89, [
            createBaseVNode("button", {
              class: "btn btn-secondary",
        ...
        ])) : activeTab.value === "risk" ? (openBlock(), createElementBlock("section", _hoisted_92, [
          createBaseVNode("div", _hoisted_93, [
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[27] || (_cache[27] = ($event) => riskFilters.q = $event),
              class: "input",
              placeholder: "搜索标题、摘要、正文",
            ...
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[28] || (_cache[28] = ($event) => riskFilters.source = $event),
              class: "input",
              onChange: loadRisk
            }, [
              _cache[113] || (_cache[113] = createBaseVNode("option", { value: "" }, "全部来源", -1)),
              (openBlock(true), createElementBlock(Fragment, null, renderList(opinionSources.value, (source) => {
                return openBlock(), createElementBlock("option", {
                  key: source,
                  value: source
                }, toDisplayString(source), 9, _hoisted_94);
              }), 128))
            ], 544), [
              [vModelSelect, riskFilters.source]
            ]),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[29] || (_cache[29] = ($event) => riskFilters.language = $event),
              class: "input",
              onChange: loadRisk
            }, [..._cache[114] || (_cache[114] = [
              createStaticVNode('<option value="" data-v-fdb23cbd>全部语言</option><option value="zh" data-v-fdb23cbd>中文</option><option value="en" data-v-fdb23cbd>英文</option><option value="mixed" data-v-fdb23cbd>中英混合</option><option value="unknown" data-v-fdb23cbd>未知</option>', 5)
            ])], 544), [
              [vModelSelect, riskFilters.language]
            ]),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[30] || (_cache[30] = ($event) => riskFilters.risk_level = $event),
              class: "input",
              onChange: loadRisk
            }, [..._cache[115] || (_cache[115] = [
              createStaticVNode('<option value="" data-v-fdb23cbd>全部风险等级</option><option value="high" data-v-fdb23cbd>高</option><option value="medium" data-v-fdb23cbd>中</option><option value="low" data-v-fdb23cbd>低</option><option value="unknown" data-v-fdb23cbd>未知</option>', 5)
            ])], 544), [
              [vModelSelect, riskFilters.risk_level]
            ]),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[31] || (_cache[31] = ($event) => riskFilters.analysis_status = $event),
              class: "input",
              onChange: loadRisk
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[32] || (_cache[32] = ($event) => riskFilters.date_from = $event),
              class: "input date-input",
              type: "date",
              title: "发布时间起始",
              onChange: loadRisk
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[33] || (_cache[33] = ($event) => riskFilters.date_to = $event),
              class: "input date-input",
              type: "date",
              title: "发布时间截止",
              onChange: loadRisk
            ...
            _cache[117] || (_cache[117] = createBaseVNode("span", { class: "muted" }, "规则优先；AI 人工复核当前未启用", -1))
          ]),
          createBaseVNode("div", _hoisted_95, [
            createBaseVNode("table", null, [
              _cache[119] || (_cache[119] = createBaseVNode("thead", null, [
                createBaseVNode("tr", null, [
                  createBaseVNode("th", null, "标题"),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(risks.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_97, toDisplayString(row.opinion.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", null, [
                      ...
                      !row.matched_terms.length ? (openBlock(), createElementBlock("span", _hoisted_98, "无")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                ...
                !risks.value.length ? (openBlock(), createElementBlock("tr", _hoisted_100, [..._cache[118] || (_cache[118] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
          ...
          riskTotal.value > riskSize ? (openBlock(), createElementBlock("div", _hoisted_101, [
            createBaseVNode("button", {
              class: "btn btn-secondary",
        ...
        ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_104, [
          createBaseVNode("div", _hoisted_105, "Foreign auto-aggregation: " + toDisplayString(eventAutoStatus.value?.enabled ? "enabled" : "disabled") + " · Scheduler registered: " + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "yes" : "no") + " · threshold " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · window " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + "h", 1),
          createBaseVNode("div", _hoisted_106, [
            ...
            }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_107),
            _cache[120] || (_cache[120] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
          ]),
          eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_108, [
          ...
          eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_109, [
            _cache[122] || (_cache[122] = createBaseVNode("strong", null, "外网事件运行失败", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(eventRunFailures.value, (run) => {
              return openBlock(), createElementBlock("div", {
                key: run.id,
                class: "event-failure-row"
              }, [
                _cache[121] || (_cache[121] = createBaseVNode("span", { class: "status failed" }, "failed", -1)),
          ...
          createBaseVNode("div", _hoisted_110, [
            createBaseVNode("button", {
              ...
              onClick: _cache[36] || (_cache[36] = ($event) => eventSection.value = "candidates")
            }, "事件候选", 2),
            createBaseVNode("button", {
              class: normalizeClass(["tab", { active: eventSection.value === "confirmed" }]),
              onClick: _cache[37] || (_cache[37] = ($event) => eventSection.value = "confirmed")
            }, "外网事件", 2)
          ]),
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_111, [
            createBaseVNode("table", null, [
              _cache[124] || (_cache[124] = createBaseVNode("thead", null, [
                createBaseVNode("tr", null, [
                  createBaseVNode("th", null, "标题"),
                  createBaseVNode("th", null, "语言"),
                  createBaseVNode("th", null, "Review source"),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_112, toDisplayString(row.title || "无标题"), 1),
                    createBaseVNode("td", null, toDisplayString(row.language), 1),
                    createBaseVNode("td", null, toDisplayString(row.review_source || "manual"), 1),
                    ...
                    createBaseVNode("td", _hoisted_113, [
                      ...
                      }, "确认", 8, _hoisted_114)) : createCommentVNode("", true),
                      row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn danger",
                        disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                        onClick: ($event) => rejectCandidate(row)
                      }, "拒绝", 8, _hoisted_115)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_116, [..._cache[123] || (_cache[123] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
            ...
            createBaseVNode("table", null, [
              _cache[126] || (_cache[126] = createBaseVNode("thead", null, [
                createBaseVNode("tr", null, [
                  createBaseVNode("th", null, "标题"),
                  createBaseVNode("th", null, "语言"),
                  createBaseVNode("th", null, "Confirmation source"),
                  createBaseVNode("th", null, "状态"),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignEvents.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_119, toDisplayString(row.title || "无标题"), 1),
                    createBaseVNode("td", null, toDisplayString(row.language), 1),
                    createBaseVNode("td", null, toDisplayString(row.confirmation_source || "manual"), 1),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_122, [..._cache[125] || (_cache[125] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
          ...
          selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_123, [
            createBaseVNode("div", _hoisted_124, [
              _cache[128] || (_cache[128] = createBaseVNode("strong", null, "Event provenance", -1)),
              createBaseVNode("span", null, "confirmation=" + toDisplayString(selectedForeignEvent.value.confirmation_source || "manual"), 1),
              createBaseVNode("span", null, "review=" + toDisplayString(selectedForeignEvent.value.auto_aggregation?.review_source || "-"), 1),
              createBaseVNode("span", null, "confidence=" + toDisplayString(Math.round((selectedForeignEvent.value.confidence || 0) * 100)) + "%", 1),
              createBaseVNode("span", null, "articles=" + toDisplayString(selectedForeignEvent.value.opinion_count) + " sources=" + toDisplayString(selectedForeignEvent.value.source_count), 1),
              selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_125, [
                _cache[127] || (_cache[127] = createBaseVNode("summary", null, "Aggregation evidence", -1)),
            ...
            createBaseVNode("div", _hoisted_126, [
              ...
              createBaseVNode("div", _hoisted_127, [
                createBaseVNode("button", {
                  ...
                  onClick: _cache[38] || (_cache[38] = ($event) => closeEvent(selectedForeignEvent.value))
                }, "关闭事件", 8, _hoisted_128),
                createBaseVNode("button", {
                  class: "link-btn",
                  disabled: !unref(canMergeEvents) || eventActionKey.value,
                  onClick: _cache[39] || (_cache[39] = ($event) => mergeEvent(selectedForeignEvent.value))
                }, "合并", 8, _hoisted_129),
                createBaseVNode("button", {
                  class: "link-btn",
                  disabled: !unref(canSplitEvents) || eventActionKey.value,
                  onClick: _cache[40] || (_cache[40] = ($event) => splitEvent(selectedForeignEvent.value))
                }, "拆分", 8, _hoisted_130),
                createBaseVNode("button", {
                  class: "link-btn",
                  onClick: _cache[41] || (_cache[41] = ($event) => selectedForeignEvent.value = null)
                }, "关闭详情")
              ])
            ]),
            createBaseVNode("p", _hoisted_131, toDisplayString(selectedForeignEvent.value.language) + " · " + toDisplayString(selectedForeignEvent.value.event_status) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_133, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                createBaseVNode("a", {
                  href: opinion.url,
                  target: "_blank",
                  rel: "noreferrer",
        ...
        ])) : activeTab.value === "alerts" ? (openBlock(), createElementBlock("section", _hoisted_135, [
          createBaseVNode("div", _hoisted_136, "Foreign automatic alert evaluation: " + toDisplayString(alertAutoStatus.value?.enabled ? "enabled" : "disabled") + " · Scheduler registered: " + toDisplayString(alertAutoStatus.value?.scheduler_registered ? "yes" : "no") + " · External notifications: " + toDisplayString(alertAutoStatus.value?.external_notifications_enabled ? "enabled" : "disabled"), 1),
          createBaseVNode("div", _hoisted_137, [
            ...
            }, toDisplayString(alertEvaluating.value ? "评估中..." : "手动 Dry-Run"), 9, _hoisted_138),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[42] || (_cache[42] = ($event) => alertFilters.status = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[129] || (_cache[129] = [
              createStaticVNode('<option value="" data-v-fdb23cbd>全部状态</option><option value="triggered" data-v-fdb23cbd>待处理</option><option value="acknowledged" data-v-fdb23cbd>已确认</option><option value="resolved" data-v-fdb23cbd>已解决</option><option value="suppressed" data-v-fdb23cbd>已抑制</option><option value="failed" data-v-fdb23cbd>失败</option>', 6)
            ])], 544), [
              [vModelSelect, alertFilters.status]
            ]),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[43] || (_cache[43] = ($event) => alertFilters.severity = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[130] || (_cache[130] = [
              createStaticVNode('<option value="" data-v-fdb23cbd>全部严重度</option><option value="low" data-v-fdb23cbd>低</option><option value="medium" data-v-fdb23cbd>中</option><option value="high" data-v-fdb23cbd>高</option><option value="critical" data-v-fdb23cbd>紧急</option>', 5)
            ])], 544), [
              [vModelSelect, alertFilters.severity]
            ]),
            _cache[131] || (_cache[131] = createBaseVNode("span", { class: "muted" }, "告警评估默认关闭 · 外部通知默认关闭 · 当前仅保存站内记录", -1))
          ]),
          _cache[136] || (_cache[136] = createBaseVNode("div", { class: "alert-scope-note" }, " 外网告警只读取外网风险和 confirmed 外网事件；不会进入国内告警、Dashboard、地图、热词或事件链路。 ", -1)),
          alertLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_139, [
          ...
          alertRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_140, [
            _cache[133] || (_cache[133] = createBaseVNode("strong", null, "外网告警评估失败", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(alertRunFailures.value, (run) => {
              return openBlock(), createElementBlock("div", {
                key: run.id,
                class: "alert-failure-row"
              }, [
                _cache[132] || (_cache[132] = createBaseVNode("span", { class: "status failed" }, "failed", -1)),
                createBaseVNode("span", null, toDisplayString(formatTime(run.finished_at || run.started_at)), 1),
          ...
          createBaseVNode("div", _hoisted_141, [
            createBaseVNode("table", null, [
              _cache[135] || (_cache[135] = createBaseVNode("thead", null, [
                createBaseVNode("tr", null, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignAlerts.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_142, [
                      createBaseVNode("button", {
                        class: "link-btn title-link",
                        onClick: withModifiers(($event) => openAlertDetail(row), ["stop"])
                      }, toDisplayString(row.title || "无标题告警"), 9, _hoisted_143),
                      createBaseVNode("div", _hoisted_144, toDisplayString(row.message), 1)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_145, [
                      createBaseVNode("button", {
                        class: "link-btn",
                      ...
                      }, "确认", 8, _hoisted_147)) : createCommentVNode("", true),
                      ...
                      }, "解决", 8, _hoisted_148)) : createCommentVNode("", true),
                      row.status === "triggered" || row.status === "acknowledged" ? (openBlock(), createElementBlock("button", {
                        key: 2,
                        class: "link-btn danger",
                      ...
                      }, "抑制", 8, _hoisted_149)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !foreignAlerts.value.length ? (openBlock(), createElementBlock("tr", _hoisted_150, [..._cache[134] || (_cache[134] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无外网告警记录", -1)
        ...
        ])) : activeTab.value === "alertRules" ? (openBlock(), createElementBlock("section", _hoisted_151, [
          createBaseVNode("div", { class: "toolbar" }, [
            ...
            _cache[137] || (_cache[137] = createBaseVNode("span", { class: "muted" }, "外网规则独立管理；新规则保存后默认停用。", -1))
          ]),
          createBaseVNode("div", _hoisted_152, [
            createBaseVNode("table", null, [
              _cache[139] || (_cache[139] = createBaseVNode("thead", null, [
                createBaseVNode("tr", null, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(alertRules.value, (rule) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_153, [
                      ...
                      }, "停用", 8, _hoisted_155)) : (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn",
                      ...
                      }, "删除", 8, _hoisted_157)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !alertRules.value.length ? (openBlock(), createElementBlock("tr", _hoisted_158, [..._cache[138] || (_cache[138] = [
                  createBaseVNode("td", {
                    colspan: "7",
                    class: "empty"
                  }, "暂无外网告警规则", -1)
        ...
        ])) : activeTab.value === "keywords" ? (openBlock(), createElementBlock("section", _hoisted_159, [
          createBaseVNode("div", _hoisted_160, [
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[44] || (_cache[44] = ($event) => keywordFilters.q = $event),
              class: "input",
            ...
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[45] || (_cache[45] = ($event) => keywordFilters.category = $event),
              class: "input",
              onChange: loadKeywords
            }, [
              _cache[140] || (_cache[140] = createBaseVNode("option", { value: "" }, "All topics", -1)),
              (openBlock(true), createElementBlock(Fragment, null, renderList(keywordCategories.value, (item) => {
                return openBlock(), createElementBlock("option", {
                  key: item,
                  value: item
                }, toDisplayString(item), 9, _hoisted_161);
              }), 128))
            ], 544), [
              [vModelSelect, keywordFilters.category]
            ]),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[46] || (_cache[46] = ($event) => keywordFilters.type = $event),
              class: "input",
              onChange: loadKeywords
            ...
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[47] || (_cache[47] = ($event) => keywordFilters.enabled = $event),
              class: "input",
              onChange: loadKeywords
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[48] || (_cache[48] = ($event) => keywordDraft.category = $event),
              class: "input",
              placeholder: "Topic"
            }, null, 512), [
            ...
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[49] || (_cache[49] = ($event) => keywordDraft.type = $event),
              class: "input"
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[50] || (_cache[50] = ($event) => keywordDraft.weight = $event),
              class: "input number-input",
              type: "number",
              min: "0",
              max: "100",
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[51] || (_cache[51] = ($event) => keywordDraft.word = $event),
              class: "input",
              placeholder: "新增外网关键词",
          ...
          createBaseVNode("div", _hoisted_162, [
            createBaseVNode("table", null, [
              _cache[145] || (_cache[145] = createBaseVNode("thead", null, [
                createBaseVNode("tr", null, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(keywords.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_163, [
                      ...
                      }, toDisplayString(row.is_enabled ? "停用" : "启用"), 9, _hoisted_164),
                      createBaseVNode("button", {
                        class: "link-btn",
                ...
                !keywords.value.length ? (openBlock(), createElementBlock("tr", _hoisted_167, [..._cache[144] || (_cache[144] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网关键词", -1)
          ...
          createBaseVNode("div", _hoisted_168, [
            createBaseVNode("button", {
              class: "btn btn-secondary",
              disabled: keywordSaving.value,
              onClick: _cache[52] || (_cache[52] = ($event) => bulkToggleKeywords(true))
            }, "批量启用全部当前结果", 8, _hoisted_169),
            createBaseVNode("button", {
              class: "btn btn-secondary",
              disabled: keywordSaving.value,
              onClick: _cache[53] || (_cache[53] = ($event) => bulkToggleKeywords(false))
            }, "批量停用全部当前结果", 8, _hoisted_170)
          ]),
          keywordTotal.value > keywordSize ? (openBlock(), createElementBlock("div", _hoisted_171, [
            createBaseVNode("button", {
              class: "btn btn-secondary",
              disabled: keywordPage.value <= 1,
              onClick: _cache[54] || (_cache[54] = ($event) => {
                keywordPage.value--;
                loadKeywords();
              })
            }, "上一页", 8, _hoisted_172),
            ...
            createBaseVNode("button", {
              ...
              onClick: _cache[55] || (_cache[55] = ($event) => {
                keywordPage.value++;
                loadKeywords();
              })
            }, "下一页", 8, _hoisted_173)
          ])) : createCommentVNode("", true)
        ])) : activeTab.value === "runs" ? (openBlock(), createElementBlock("section", _hoisted_174, [
          createBaseVNode("div", { class: "toolbar" }, [
            createBaseVNode("button", {
              class: "btn btn-secondary",
              onClick: loadRuns
            }, "刷新日志"),
            _cache[146] || (_cache[146] = createBaseVNode("span", { class: "muted" }, "仅显示 scope=foreign 的采集记录", -1))
          ]),
          createBaseVNode("div", _hoisted_175, [
            createBaseVNode("table", null, [
              _cache[148] || (_cache[148] = createBaseVNode("thead", null, [
                createBaseVNode("tr", null, [
                  createBaseVNode("th", null, "来源"),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(runs.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_176, toDisplayString(row.error_msg || "-"), 1)
                  ]);
                }), 128)),
                !runs.value.length ? (openBlock(), createElementBlock("tr", _hoisted_177, [..._cache[147] || (_cache[147] = [
                  createBaseVNode("td", {
                    colspan: "10",
                    class: "empty"
                  }, "暂无外网采集日志", -1)
        ...
        selectedForeignAlert.value ? (openBlock(), createElementBlock("div", {
          key: 10,
          class: "detail-mask",
          onClick: _cache[57] || (_cache[57] = withModifiers(($event) => selectedForeignAlert.value = null, ["self"]))
        }, [
          createBaseVNode("article", _hoisted_178, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭详情",
              onClick: _cache[56] || (_cache[56] = ($event) => selectedForeignAlert.value = null)
            }, "×"),
            createBaseVNode("h3", null, toDisplayString(selectedForeignAlert.value.title || "外网告警详情"), 1),
            createBaseVNode("div", _hoisted_179, "来源：" + toDisplayString(selectedForeignAlert.value.opinion?.source_name_snapshot || selectedForeignAlert.value.event?.opinions?.[0]?.source_name_snapshot || "-") + " · 发布时间：" + toDisplayString(formatTime(selectedForeignAlert.value.opinion?.published_at || selectedForeignAlert.value.event?.last_seen_at)) + " · 当前状态：" + toDisplayString(selectedForeignAlert.value.status), 1),
            createBaseVNode("p", _hoisted_180, toDisplayString(selectedForeignAlert.value.opinion?.summary || selectedForeignAlert.value.event?.summary || selectedForeignAlert.value.message || "暂无摘要"), 1),
            createBaseVNode("div", {
              class: "detail-text",
              innerHTML: selectedForeignAlert.value.opinion?.content || ""
            }, null, 8, _hoisted_181),
            selectedForeignAlert.value.event?.opinions?.length ? (openBlock(), createElementBlock("div", _hoisted_182, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignAlert.value.event.opinions, (opinion) => {
                return openBlock(), createElementBlock("div", {
                  key: opinion.id,
                  class: "event-opinion"
                }, [
                  createBaseVNode("strong", null, toDisplayString(opinion.title), 1),
                  createBaseVNode("span", _hoisted_183, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                  createBaseVNode("div", {
                    class: "detail-text",
                    innerHTML: opinion.content || opinion.summary || ""
                  }, null, 8, _hoisted_184)
                ]);
              }), 128))
            ])) : createCommentVNode("", true),
            createBaseVNode("section", _hoisted_185, [
              _cache[149] || (_cache[149] = createBaseVNode("h4", null, "规则研判", -1)),
              createBaseVNode("p", null, toDisplayString(selectedForeignAlert.value.opinion?.rule_result?.explanation || "暂无规则研判结果"), 1),
              selectedForeignAlert.value.opinion?.rule_result ? (openBlock(), createElementBlock("div", _hoisted_186, [
                createBaseVNode("span", null, "分数 " + toDisplayString(selectedForeignAlert.value.opinion.rule_result.risk_score ?? "-"), 1),
                createBaseVNode("span", null, "等级 " + toDisplayString(selectedForeignAlert.value.opinion.rule_result.risk_level), 1),
                createBaseVNode("span", null, "类别 " + toDisplayString(selectedForeignAlert.value.opinion.rule_result.risk_category), 1)
              ])) : createCommentVNode("", true)
            ]),
            createBaseVNode("section", _hoisted_187, [
              _cache[150] || (_cache[150] = createBaseVNode("h4", null, "AI 研判", -1)),
              createBaseVNode("p", null, toDisplayString(selectedForeignAlert.value.opinion?.ai_result?.summary || "暂无 AI 研判结果"), 1),
              selectedForeignAlert.value.opinion?.ai_result ? (openBlock(), createElementBlock("div", _hoisted_188, [
                createBaseVNode("span", null, "状态 " + toDisplayString(selectedForeignAlert.value.opinion.ai_result.status), 1),
                createBaseVNode("span", null, "风险 " + toDisplayString(selectedForeignAlert.value.opinion.ai_result.risk_score ?? "-"), 1)
              ])) : createCommentVNode("", true)
            ]),
            createBaseVNode("section", _hoisted_189, [
              _cache[151] || (_cache[151] = createBaseVNode("h4", null, "告警规则与评估来源", -1)),
              createBaseVNode("p", null, toDisplayString(selectedForeignAlert.value.rule?.name || selectedForeignAlert.value.rule_snapshot?.name || "规则 #" + (selectedForeignAlert.value.rule_id ?? "-")) + " · " + toDisplayString(selectedForeignAlert.value.evaluation_source || "rule"), 1),
              createBaseVNode("p", _hoisted_190, "告警 #" + toDisplayString(selectedForeignAlert.value.id) + " · 触发 " + toDisplayString(formatTime(selectedForeignAlert.value.triggered_at)), 1)
            ]),
            createBaseVNode("section", _hoisted_191, [
              _cache[152] || (_cache[152] = createBaseVNode("h4", null, "处置历史", -1)),
              selectedForeignAlert.value.actions?.length ? (openBlock(), createElementBlock("div", _hoisted_192, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignAlert.value.actions, (action) => {
                  return openBlock(), createElementBlock("div", {
                    key: action.id,
                    ...
                    createBaseVNode("span", _hoisted_193, "操作人 #" + toDisplayString(action.actor_id ?? "-") + " · " + toDisplayString(formatTime(action.created_at)), 1)
                  ]);
                }), 128))
              ])) : (openBlock(), createElementBlock("p", _hoisted_194, "暂无处置历史"))
            ]),
            selectedForeignAlert.value.opinion?.url ? (openBlock(), createElementBlock("a", {
              key: 1,
              href: selectedForeignAlert.value.opinion.url,
              target: "_blank",
              rel: "noreferrer",
              class: "original"
            }, "打开原文", 8, _hoisted_195)) : createCommentVNode("", true)
          ])
        ])) : createCommentVNode("", true),
        historyAlert.value ? (openBlock(), createElementBlock("div", {
          key: 11,
          class: "detail-mask",
          onClick: _cache[59] || (_cache[59] = withModifiers(($event) => historyAlert.value = null, ["self"]))
        }, [
          createBaseVNode("article", _hoisted_196, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭处置历史",
              onClick: _cache[58] || (_cache[58] = ($event) => historyAlert.value = null)
            }, "×"),
            _cache[153] || (_cache[153] = createBaseVNode("h3", null, "外网告警处置历史", -1)),
            createBaseVNode("p", _hoisted_197, toDisplayString(historyAlert.value.title || "告警 #" + historyAlert.value.id) + " · 当前状态：" + toDisplayString(historyAlert.value.status), 1),
            alertActionsLoading.value ? (openBlock(), createElementBlock("div", _hoisted_198, "处置历史加载中...")) : !alertActions.value.length ? (openBlock(), createElementBlock("div", _hoisted_199, "暂无处置历史")) : (openBlock(), createElementBlock("div", _hoisted_200, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(alertActions.value, (action) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", null, toDisplayString(action.previous_status) + " → " + toDisplayString(action.new_status), 1),
                  createBaseVNode("span", null, toDisplayString(action.note), 1),
                  createBaseVNode("span", _hoisted_201, "操作人 #" + toDisplayString(action.actor_id ?? "-") + " · " + toDisplayString(formatTime(action.created_at)), 1)
                ]);
              }), 128))
            ]))
          ])
        ...
        alertRuleEditorVisible.value ? (openBlock(), createElementBlock("div", {
          key: 12,
          class: "detail-mask",
          onClick: _cache[69] || (_cache[69] = withModifiers(($event) => alertRuleEditorVisible.value = false, ["self"]))
        }, [
          createBaseVNode("article", _hoisted_202, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭规则编辑",
              onClick: _cache[60] || (_cache[60] = ($event) => alertRuleEditorVisible.value = false)
            }, "×"),
            createBaseVNode("h3", null, toDisplayString(alertRuleEditingId.value ? "编辑外网告警规则" : "新增外网告警规则"), 1),
            createBaseVNode("label", null, [
              _cache[154] || (_cache[154] = createTextVNode("规则名称", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[61] || (_cache[61] = ($event) => alertRuleDraft.name = $event),
                class: "input",
                placeholder: "规则名称"
              }, null, 512), [
            ...
            createBaseVNode("label", null, [
              _cache[156] || (_cache[156] = createTextVNode("规则类型", -1)),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[62] || (_cache[62] = ($event) => alertRuleDraft.rule_type = $event),
                class: "input"
              }, [..._cache[155] || (_cache[155] = [
                createStaticVNode('<option value="risk_score" data-v-fdb23cbd>风险分</option><option value="risk_level" data-v-fdb23cbd>风险等级</option><option value="risk_category" data-v-fdb23cbd>风险类别</option><option value="confirmed_event" data-v-fdb23cbd>确认事件</option><option value="keyword_combo" data-v-fdb23cbd>关键词组合</option>', 5)
              ])], 512), [
                [vModelSelect, alertRuleDraft.rule_type]
              ])
            ]),
            createBaseVNode("label", null, [
              _cache[157] || (_cache[157] = createTextVNode("风险阈值或条件", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[63] || (_cache[63] = ($event) => alertRuleDraft.conditionsText = $event),
                class: "input",
            ...
            createBaseVNode("label", null, [
              _cache[159] || (_cache[159] = createTextVNode("严重等级", -1)),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[64] || (_cache[64] = ($event) => alertRuleDraft.severity = $event),
                class: "input"
            ...
            createBaseVNode("label", null, [
              _cache[160] || (_cache[160] = createTextVNode("冷却时间", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[65] || (_cache[65] = ($event) => alertRuleDraft.cooldown_seconds = $event),
                class: "input number-input",
                type: "number",
                min: "0"
              }, null, 512), [
            ...
            createBaseVNode("label", null, [
              _cache[161] || (_cache[161] = createTextVNode("规则说明", -1)),
              withDirectives(createBaseVNode("textarea", {
                "onUpdate:modelValue": _cache[66] || (_cache[66] = ($event) => alertRuleDraft.description = $event),
                class: "input",
                rows: "3",
            ...
            createBaseVNode("label", _hoisted_203, [
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[67] || (_cache[67] = ($event) => alertRuleDraft.is_enabled = $event),
                type: "checkbox",
                disabled: !alertRuleEditingId.value || !unref(canEnableAlertRules)
              }, null, 8, _hoisted_204), [
                [vModelCheckbox, alertRuleDraft.is_enabled]
              ]),
              _cache[162] || (_cache[162] = createTextVNode(" 编辑时启用状态（新规则默认停用，启用仍需外网启用权限）", -1))
            ]),
            createBaseVNode("div", _hoisted_205, [
              _cache[163] || (_cache[163] = createBaseVNode("strong", null, "规则预览", -1)),
              createBaseVNode("pre", null, toDisplayString(rulePreview.value), 1)
            ]),
            createBaseVNode("div", _hoisted_206, [
              createBaseVNode("button", {
                class: "btn btn-secondary",
                onClick: _cache[68] || (_cache[68] = ($event) => alertRuleEditorVisible.value = false)
              }, "取消"),
              createBaseVNode("button", {
                class: "btn btn-primary",
                disabled: alertRuleSaving.value,
                onClick: createAlertRule
              }, toDisplayString(alertRuleSaving.value ? "保存中..." : "保存规则"), 9, _hoisted_207)
            ])
          ])
        ])) : createCommentVNode("", true),
        selectedOpinion.value ? (openBlock(), createElementBlock("div", {
          key: 13,
          class: "detail-mask",
          onClick: _cache[74] || (_cache[74] = withModifiers(($event) => selectedOpinion.value = null, ["self"]))
        }, [
          createBaseVNode("article", _hoisted_208, [
            selectedOpinion.value.ai_result?.status === "completed" ? (openBlock(), createElementBlock("div", _hoisted_209, [
              createBaseVNode("strong", null, "AI alert admission: " + toDisplayString(selectedOpinion.value.ai_alert_admission?.status || "excluded"), 1),
              createBaseVNode("button", {
                class: "btn btn-secondary",
                disabled: !unref(canAdmitAI),
                onClick: _cache[70] || (_cache[70] = ($event) => setAIAdmission(true))
              }, "Include in AI alert evaluation", 8, _hoisted_210),
              createBaseVNode("button", {
                class: "btn btn-secondary",
                disabled: !unref(canAdmitAI),
                onClick: _cache[71] || (_cache[71] = ($event) => setAIAdmission(false))
              }, "Exclude from AI alert evaluation", 8, _hoisted_211),
              (openBlock(true), createElementBlock(Fragment, null, renderList(selectedOpinion.value.ai_alert_admission_actions || [], (action) => {
                return openBlock(), createElementBlock("div", {
                  key: `admission-${action.id}`,
                  class: "history-row"
                }, [
                  createBaseVNode("span", null, toDisplayString(action.previous_status) + " -> " + toDisplayString(action.new_status), 1),
                  createBaseVNode("span", null, toDisplayString(action.note), 1),
                  createBaseVNode("span", null, "AI #" + toDisplayString(action.foreign_ai_result_id ?? "-") + " actor #" + toDisplayString(action.actor_id ?? "-"), 1),
                  createBaseVNode("span", null, toDisplayString(formatTime(action.created_at)), 1)
                ]);
              }), 128))
            ])) : createCommentVNode("", true),
            createBaseVNode("button", {
              class: "close",
              title: "关闭详情",
              onClick: _cache[72] || (_cache[72] = ($event) => selectedOpinion.value = null)
            }, "×"),
            opinionLoading.value ? (openBlock(), createElementBlock("div", _hoisted_212, "正在加载外网详情...")) : createCommentVNode("", true),
            createBaseVNode("h3", null, toDisplayString(selectedOpinion.value.title), 1),
            createBaseVNode("div", _hoisted_213, toDisplayString(selectedOpinion.value.source_name_snapshot) + " · " + toDisplayString(formatTime(selectedOpinion.value.published_at)) + " · 命中 " + toDisplayString(selectedOpinion.value.matched_keywords.join("、") || "-"), 1),
            createBaseVNode("p", _hoisted_214, toDisplayString(selectedOpinion.value.summary || "暂无摘要"), 1),
            createBaseVNode("p", _hoisted_215, toDisplayString(selectedOpinion.value.content || "暂无正文（正文抓取已关闭）"), 1),
            selectedOpinion.value.url ? (openBlock(), createElementBlock("a", {
              ...
              rel: "noreferrer",
              class: "original"
            }, "打开原文", 8, _hoisted_216)) : createCommentVNode("", true),
            createBaseVNode("section", _hoisted_217, [
              _cache[164] || (_cache[164] = createBaseVNode("h4", null, "系统规则研判", -1)),
              selectedOpinion.value.rule_result ? (openBlock(), createElementBlock("div", _hoisted_218, [
              ...
              selectedOpinion.value.rule_result?.matched_terms?.length ? (openBlock(), createElementBlock("p", _hoisted_219, "命中风险词：" + toDisplayString(selectedOpinion.value.rule_result.matched_terms.map((item) => item.word).join("、")), 1)) : createCommentVNode("", true),
              selectedOpinion.value.rule_result ? (openBlock(), createElementBlock("p", _hoisted_220, toDisplayString(selectedOpinion.value.rule_result.explanation || "暂无规则解释"), 1)) : (openBlock(), createElementBlock("p", _hoisted_221, "暂无规则研判结果"))
            ]),
            createBaseVNode("section", _hoisted_222, [
              createBaseVNode("div", _hoisted_223, [
                _cache[165] || (_cache[165] = createBaseVNode("h4", null, "AI 研判报告", -1)),
                createBaseVNode("button", {
                  class: "btn btn-secondary",
                  disabled: aiAnalyzing.value || !unref(canAnalyzeAI),
                  onClick: _cache[73] || (_cache[73] = ($event) => analyzeAI(selectedOpinion.value.id))
                }, toDisplayString(aiAnalyzing.value ? "分析中..." : "人工触发 AI"), 9, _hoisted_224)
              ]),
              selectedOpinion.value.ai_result ? (openBlock(), createElementBlock("div", _hoisted_225, [
              ...
              selectedOpinion.value.ai_result?.status === "completed" ? (openBlock(), createElementBlock("p", _hoisted_226, toDisplayString(selectedOpinion.value.ai_result.summary || "暂无 AI 摘要"), 1)) : createCommentVNode("", true),
              selectedOpinion.value.ai_result?.status === "completed" ? (openBlock(), createElementBlock("p", _hoisted_227, "建议：" + toDisplayString(selectedOpinion.value.ai_result.suggestion || "暂无建议"), 1)) : createCommentVNode("", true),
              selectedOpinion.value.ai_result?.status === "failed" ? (openBlock(), createElementBlock("p", _hoisted_228, toDisplayString(selectedOpinion.value.ai_result.error_message || "AI 分析失败"), 1)) : createCommentVNode("", true),
              !selectedOpinion.value.ai_result ? (openBlock(), createElementBlock("p", _hoisted_229, "尚未执行 AI 研判")) : createCommentVNode("", true)
            ]),
            createBaseVNode("section", _hoisted_230, [
              _cache[166] || (_cache[166] = createBaseVNode("h4", null, "分析运行历史", -1)),
              ...
              !selectedOpinion.value.analysis_runs?.length ? (openBlock(), createElementBlock("p", _hoisted_231, "暂无运行记录")) : createCommentVNode("", true)
            ])
          ])
        ])) : createCommentVNode("", true)
      ])), [
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fdb23cbd"]]);
