import { d as defineComponent, u as useAuthStore, z as usePermission, C as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, F as Fragment, i as renderList, s as createCommentVNode, L as withModifiers, t as toDisplayString, v as vModelText, J as vModelSelect, r as ref, g as api, E as ElMessage, B as resolveDirective, j as computed, o as openBlock, n as normalizeClass, H as unref, M as ElMessageBox, _ as _export_sfc } from './index-CNIg4H9D.js';
                ...
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", _hoisted_4, [
                    ...
                    unref(canActivate) ? (openBlock(), createElementBlock("button", {
                      key: 0,
                      class: normalizeClass(["btn btn-mini", { "is-disabled-action": user.username === currentUsername.value }]),
                      disabled: user.username === currentUsername.value || userToggleId.value === user.id,
                      title: user.username === currentUsername.value ? "当前登录用户不可停用" : void 0,
...
const Users = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-17b17891"]]);
