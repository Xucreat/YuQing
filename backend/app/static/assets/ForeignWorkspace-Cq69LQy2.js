...
const _hoisted_77 = { class: "table-wrap tbl-scroll" };
const _hoisted_78 = ["onClick"];
const _hoisted_79 = { class: "title-cell" };
const _hoisted_80 = { class: "dual-cell" };
const _hoisted_81 = { class: "muted" };
const _hoisted_82 = {
  key: 0,
  class: "muted"
};
const _hoisted_83 = { class: "actions" };
const _hoisted_84 = ["disabled", "onClick"];
...
const _hoisted_88 = { class: "alert-scope-note" };
const _hoisted_89 = { class: "toolbar" };
...
const _hoisted_93 = { class: "subtabs" };
const _hoisted_94 = {
  key: 2,
  class: "table-wrap"
};
const _hoisted_95 = { class: "title-cell" };
const _hoisted_96 = { class: "actions" };
...
const _hoisted_102 = { class: "title-cell" };
const _hoisted_103 = ["disabled", "onClick"];
const _hoisted_104 = ["disabled", "onClick"];
const _hoisted_105 = { key: 0 };
const _hoisted_106 = {
  key: 4,
  class: "event-detail"
};
const _hoisted_107 = { class: "event-provenance" };
const _hoisted_108 = { key: 0 };
const _hoisted_109 = { class: "event-detail-head" };
const _hoisted_110 = { class: "actions" };
const _hoisted_111 = ["disabled"];
const _hoisted_112 = ["disabled"];
const _hoisted_113 = ["disabled"];
const _hoisted_114 = { class: "muted" };
const _hoisted_115 = { class: "event-metrics" };
const _hoisted_116 = { class: "muted" };
const _hoisted_117 = ["href"];
const _hoisted_118 = { class: "ai-batch-options" };
const _hoisted_119 = { key: 0 };
const _hoisted_120 = { class: "check-row" };
const _hoisted_121 = { class: "check-row" };
...
const _hoisted_128 = { class: "review-toolbar" };
...
风险结果`, textAlign: "center", fill: "#1d1d1f", fontSize: 20, fontWeight: 700, lineHeight: 22 } },
    ...
    function batchPayload(fullConfirmation = false) {
      const payload = {
        ...
        current_filters: { ...opinionFilters, language: riskFilters.language, risk_level: riskFilters.risk_level, analysis_status: riskFilters.analysis_status, risk_source: riskSource.value },
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
          ...
          activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_67, [
            createBaseVNode("div", _hoisted_68, [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="" data-v-72831ff5>全部语言</option><option value="zh" data-v-72831ff5>中文</option><option value="en" data-v-72831ff5>英文</option><option value="mixed" data-v-72831ff5>中英混合</option><option value="unknown" data-v-72831ff5>未知</option>', 5)
              ])], 544), [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="" data-v-72831ff5>全部风险等级</option><option value="high" data-v-72831ff5>高</option><option value="medium" data-v-72831ff5>中</option><option value="low" data-v-72831ff5>低</option><option value="unknown" data-v-72831ff5>未知</option>', 5)
              ])], 544), [
            ...
            aiBatchRun.value ? (openBlock(), createElementBlock("div", _hoisted_73, [
              ...
              (aiBatchRun.value.failures || []).length && aiBatchRun.value.status === "failed" ? (openBlock(), createElementBlock("button", {
                key: 2,
                class: "link-btn",
            ...
            aiBatchRun.value && showAIBatchDetails.value ? (openBlock(), createElementBlock("div", _hoisted_75, [
              ...
              (aiBatchRun.value.failures || []).length ? (openBlock(), createElementBlock("p", _hoisted_76, "失败明细：" + toDisplayString((aiBatchRun.value.failures || []).map((item) => `#${item.opinion_id}: ${item.error}`).join("；")), 1)) : createCommentVNode("", true)
            ])) : createCommentVNode("", true),
                ...
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_79, toDisplayString(row.title || "无标题"), 1),
                      ...
                      createBaseVNode("td", _hoisted_80, [
                        ...
                        createBaseVNode("span", _hoisted_81, toDisplayString(aiHistoryLabel(row)), 1)
                      ]),
                      ...
                      createBaseVNode("td", null, [
                        ...
                        !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_82, "无")) : createCommentVNode("", true)
                      ]),
                      createBaseVNode("td", null, [
                        createBaseVNode("span", {
                      ...
                      createBaseVNode("td", _hoisted_83, [
                        ...
                        }, toDisplayString(ruleOf(row) ? "重新分析" : "分析"), 9, _hoisted_84)
                      ])
                    ], 8, _hoisted_78);
                  }), 128)),
                  !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_85, [..._cache[65] || (_cache[65] = [
                    createBaseVNode("td", {
                      colspan: "16",
                      class: "empty"
                    }, "暂无外网舆情", -1)
            ...
            opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_86, [
          ...
          ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_87, [
            createBaseVNode("div", _hoisted_88, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
            createBaseVNode("div", _hoisted_89, [
              ...
              }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_90),
              _cache[67] || (_cache[67] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
            ]),
            eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_91, [
            ...
            eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_92, [
            ...
            eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_94, [
              createBaseVNode("table", null, [
                ...
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_95, toDisplayString(row.title || "无标题"), 1),
                      ...
                      createBaseVNode("td", _hoisted_96, [
                        ...
                        }, "确认", 8, _hoisted_97)) : createCommentVNode("", true),
                        row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                          key: 1,
                          class: "link-btn danger",
                          disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                          onClick: ($event) => rejectCandidate(row)
                        }, "拒绝", 8, _hoisted_98)) : createCommentVNode("", true)
                      ])
                    ]);
                  }), 128)),
                  !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_99, [..._cache[70] || (_cache[70] = [
                    createBaseVNode("td", {
                      colspan: "8",
                      class: "empty"
                    }, "暂无外网事件候选", -1)
            ...
            ])) : eventSection.value === "confirmed" ? (openBlock(), createElementBlock("div", _hoisted_100, [
              createBaseVNode("table", null, [
                ...
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(foreignEvents.value, (row) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_102, toDisplayString(row.title || "无标题"), 1),
                      createBaseVNode("td", null, toDisplayString(zh(row.language)), 1),
                  ...
                  !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_105, [..._cache[72] || (_cache[72] = [
                    createBaseVNode("td", {
                      colspan: "12",
                      class: "empty"
                    }, "暂无已确认外网事件", -1)
            ...
            selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_106, [
              createBaseVNode("div", _hoisted_107, [
                ...
                selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_108, [
              ...
              createBaseVNode("p", _hoisted_114, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_116, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                  createBaseVNode("a", {
                    href: opinion.url,
                    target: "_blank",
                    rel: "noreferrer",
          ...
          createVNode(_component_el_dialog, {
            ...
            default: withCtx(() => [
              createBaseVNode("div", _hoisted_118, [
                ...
                aiBatchConfig.scope === "count" ? (openBlock(), createElementBlock("label", _hoisted_119, [
                ...
                aiBatchConfig.scope === "full" ? (openBlock(), createElementBlock("p", _hoisted_123, "全量任务可能消耗大量 Token 并运行较长时间。AI 结果仍须人工复核后才会进入正式事件或预警。")) : createCommentVNode("", true)
              ]),
              aiBatchPreview.value ? (openBlock(), createElementBlock("div", _hoisted_124, [
                ...
                aiBatchPreview.value.preview_warning ? (openBlock(), createElementBlock("p", _hoisted_125, "⚠ " + toDisplayString(aiBatchPreview.value.preview_warning), 1)) : createCommentVNode("", true),
                aiBatchPreview.value.token_budget_exceeded ? (openBlock(), createElementBlock("p", _hoisted_126, "⚠ 预计 Token 超出预算，提交将被拦截，请缩小范围或调高预算。")) : createCommentVNode("", true)
              ])) : createCommentVNode("", true),
              eventSection.value === "ai-review" ? (openBlock(), createElementBlock("div", _hoisted_127, [
                  ...
                  createBaseVNode("tbody", null, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(manualReviews.value, (review) => {
                      return openBlock(), createElementBlock("tr", {
                        ...
                        review.review_status === "pending_review" ? (openBlock(), createElementBlock("td", _hoisted_137, [
                          createBaseVNode("button", {
                            class: "link-btn",
                            disabled: reviewActionId.value === review.id,
                            onClick: ($event) => decideReview(review, "use_ai_display")
                          }, "采用 AI 展示", 8, _hoisted_138),
                          createBaseVNode("button", {
                            class: "link-btn",
                            disabled: reviewActionId.value === review.id,
                        ...
                        ])) : (openBlock(), createElementBlock("td", _hoisted_143, toDisplayString(review.review_reason || "-"), 1))
                      ]);
                    }), 128)),
                    !manualReviews.value.length ? (openBlock(), createElementBlock("tr", _hoisted_144, [..._cache[99] || (_cache[99] = [
                      createBaseVNode("td", {
                        colspan: "8",
                        class: "empty"
                      }, "暂无待复核结果", -1)
        ...
        createVNode(_component_el_dialog, {
          ...
          default: withCtx(() => [
            aiBatchHistoryLoading.value ? (openBlock(), createElementBlock("div", _hoisted_146, "加载中...")) : !aiBatchHistory.value.length ? (openBlock(), createElementBlock("div", _hoisted_147, "暂无批量 AI 研判运行记录")) : (openBlock(), createElementBlock("div", _hoisted_148, [
              createBaseVNode("table", null, [
            ...
            aiBatchHistorySel.value ? (openBlock(), createElementBlock("div", _hoisted_151, [
              ...
              (aiBatchHistorySel.value.failures || []).length ? (openBlock(), createElementBlock("p", _hoisted_152, "失败明细：" + toDisplayString((aiBatchHistorySel.value.failures || []).map((item) => `#${item.opinion_id}: ${item.error}`).join("；")), 1)) : createCommentVNode("", true),
              aiBatchHistorySel.value.event_preview ? (openBlock(), createElementBlock("p", _hoisted_153, "可能影响事件候选：" + toDisplayString(aiBatchHistorySel.value.event_preview?.candidate_count ?? 0), 1)) : createCommentVNode("", true),
              aiBatchHistorySel.value.alert_preview ? (openBlock(), createElementBlock("p", _hoisted_154, "可能影响预警：" + toDisplayString(aiBatchHistorySel.value.alert_preview?.triggered_count ?? 0), 1)) : createCommentVNode("", true)
            ])) : createCommentVNode("", true)
          ]),
          _: 1
        }, 8, ["modelValue"])
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-72831ff5"]]);
