...
const _hoisted_19 = { class: "perm-grid" };
const _hoisted_20 = ["checked", "disabled", "onChange"];
const _hoisted_21 = { class: "perm-code" };
const _hoisted_22 = { class: "perm-name" };
...
const _hoisted_27 = { class: "modal modal-wide" };
...
const _hoisted_33 = { class: "perm-groups compact" };
const _hoisted_34 = { class: "perm-group-title" };
const _hoisted_35 = { class: "perm-grid" };
const _hoisted_36 = ["checked", "onChange"];
const _hoisted_37 = { class: "perm-code" };
const _hoisted_38 = { class: "perm-name" };
const _hoisted_39 = { class: "form-actions" };
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_3, [
          createBaseVNode("table", _hoisted_4, [
            ...
            createBaseVNode("tbody", null, [
              ...
              !roles.value.length ? (openBlock(), createElementBlock("tr", _hoisted_14, [..._cache[7] || (_cache[7] = [
                createBaseVNode("td", {
                  colspan: "7",
                  class: "empty-row"
                }, "暂无角色", -1)
        ...
        editorOpen.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_15, [
            ...
            isAdminRole.value ? (openBlock(), createElementBlock("p", _hoisted_16, [..._cache[9] || (_cache[9] = [
                  ...
                  createBaseVNode("div", _hoisted_19, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(g.perms, (p) => {
                      return openBlock(), createElementBlock("label", {
                        ...
                        createBaseVNode("span", _hoisted_21, toDisplayString(p.code), 1),
                        createBaseVNode("span", _hoisted_22, toDisplayString(permNameLabel(p)), 1),
                        createBaseVNode("span", {
                          class: "perm-desc",
                          title: p.description
                        }, toDisplayString(p.description), 9, _hoisted_23),
                        g.group === "Foreign combined" ? (openBlock(), createElementBlock("span", _hoisted_24, "组合权限 · 后端自动展开为兼容细粒度权限")) : createCommentVNode("", true)
                      ], 2);
                    }), 128))
                  ])
                ], 2);
            ...
            createBaseVNode("div", _hoisted_25, [
              ...
              }, toDisplayString(saving.value ? "保存中..." : "保存权限"), 9, _hoisted_26)) : createCommentVNode("", true)
            ])
          ])
        ])) : createCommentVNode("", true),
          ...
          createBaseVNode("div", _hoisted_27, [
              ...
              createBaseVNode("div", _hoisted_33, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(groupedPermissions.value, (g) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_34, toDisplayString(g.label), 1),
                    createBaseVNode("div", _hoisted_35, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(g.perms, (p) => {
                        return openBlock(), createElementBlock("label", {
                          ...
                          createBaseVNode("span", _hoisted_37, toDisplayString(p.code), 1),
                          createBaseVNode("span", _hoisted_38, toDisplayString(permNameLabel(p)), 1)
                        ]);
                      }), 128))
                    ])
                  ]);
            ...
            createBaseVNode("div", _hoisted_39, [
              ...
              createBaseVNode("button", {
                ...
                onClick: createRole,
                disabled: saving.value
              }, toDisplayString(saving.value ? "创建中..." : "创建"), 9, _hoisted_40)
            ])
          ])
        ])) : createCommentVNode("", true)
      ])), [
...
const Roles = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-66366533"]]);
