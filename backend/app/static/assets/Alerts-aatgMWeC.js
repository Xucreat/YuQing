import { d as defineComponent, Z as useAlertNotifier, z as usePermission, C as onMounted, A as watch, w as withDirectives, c as createElementBlock, a as createBaseVNode, m as createVNode, p as withCtx, r as ref, g as api, y as resolveComponent, B as resolveDirective, N as useRoute, E as ElMessage, V as isPermissionDenied, o as openBlock, e as createTextVNode, q as createBlock, s as createCommentVNode, t as toDisplayString, H as unref, $ as riskTag, a0 as riskText, Q as _sfc_main$1, b as withKeys, F as Fragment, i as renderList, j as computed, f as reactive, M as ElMessageBox, _ as _export_sfc } from './index-BTTTKmk0.js';
import { O as OpinionDetailModal } from './OpinionDetailModal-BYRFEtHB.js';
...
const _hoisted_17 = { class: "detail-pre" };
const rulesSize = 20;
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
            ...
            scope.value === "foreign" ? (openBlock(), createBlock(_component_el_tab_pane, {
              ...
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_13, [
                  ...
                  _cache[64] || (_cache[64] = createBaseVNode("span", { class: "muted" }, "AI 结果仅在人工确认后进入正式业务流程", -1))
                ]),
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            row.foreign_opinion_id ? (openBlock(), createElementBlock("span", {
                              ...
                              class: "nav-link",
                              onClick: ($event) => openForeignOpinion(row.foreign_opinion_id)
                            }, toDisplayString(row.opinion_title || `舆情 #${row.foreign_opinion_id}`), 9, _hoisted_14)) : (openBlock(), createElementBlock("span", _hoisted_15, "-"))
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            createVNode(_component_el_tag, { size: "small" }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(foreignText(row.review_status)), 1)
                              ]),
                              _: 2
                            }, 1024)
                          ]),
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            ...
                            row.review_status === "pending_review" && canForeignReviewReject.value ? (openBlock(), createBlock(_component_el_button, {
                              ...
                              _: 1
                            }, 8, ["onClick"])) : (openBlock(), createElementBlock("span", _hoisted_16, toDisplayString(row.review_reason || "-"), 1))
                          ]),
                          _: 1
                        })
                      ]),
        ...
        createVNode(_component_el_dialog, {
          ...
          default: withCtx(() => [
            createBaseVNode("pre", _hoisted_17, toDisplayString(JSON.stringify(foreignDetail.value, null, 2)), 1)
          ]),
          _: 1
        }, 8, ["modelValue"]),
        createVNode(_component_el_dialog, {
        ...
        createVNode(ForeignOpinionDetailModal, {
          ...
          "onUpdate:modelValue": _cache[40] || (_cache[40] = ($event) => foreignOpinionDetailVisible.value = $event),
...
const Alerts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-857e4944"]]);
