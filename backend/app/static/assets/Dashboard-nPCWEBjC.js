...
const _hoisted_39 = { class: "fi-body" };
const _hoisted_40 = { class: "fi-title" };
const _hoisted_41 = { class: "fi-meta" };
const _hoisted_42 = {
  key: 0,
  class: "feed-empty"
};
const _hoisted_43 = { class: "card card-pad-lg feed-card area-alert" };
const _hoisted_44 = { class: "scroll-wrap" };
const _hoisted_45 = { class: "ai-body" };
const _hoisted_46 = { class: "ai-title" };
const _hoisted_47 = { class: "ai-meta" };
const _hoisted_48 = {
  key: 0,
  class: "feed-empty"
};
const _hoisted_49 = { class: "card card-pad-lg area-geo" };
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            _cache[1] || (_cache[1] = createBaseVNode("div", { class: "s-ico" }, "≡", -1)),
            _cache[2] || (_cache[2] = createBaseVNode("div", { class: "s-label" }, "总舆情数", -1)),
            createBaseVNode("div", _hoisted_4, toDisplayString(stats.total.toLocaleString()), 1),
            _cache[3] || (_cache[3] = createBaseVNode("div", { class: "s-foot-row" }, [
              createBaseVNode("span", { class: "s-foot" }, "累计监测数据")
            ], -1))
          ]),
          createBaseVNode("div", _hoisted_5, [
            _cache[4] || (_cache[4] = createBaseVNode("div", { class: "s-ico" }, "↗", -1)),
            _cache[5] || (_cache[5] = createBaseVNode("div", { class: "s-label" }, "今日新增", -1)),
            createBaseVNode("div", _hoisted_6, toDisplayString(stats.today.toLocaleString()), 1),
            _cache[6] || (_cache[6] = createBaseVNode("div", { class: "s-foot-row" }, [
              createBaseVNode("span", { class: "s-foot" }, "当日采集")
            ], -1))
          ]),
          createBaseVNode("div", _hoisted_7, [
            _cache[7] || (_cache[7] = createBaseVNode("div", { class: "s-ico" }, "!", -1)),
            _cache[8] || (_cache[8] = createBaseVNode("div", { class: "s-label" }, "高风险", -1)),
            createBaseVNode("div", _hoisted_8, toDisplayString(stats.high_risk.toLocaleString()), 1),
            _cache[9] || (_cache[9] = createBaseVNode("div", { class: "s-foot-row" }, [
              createBaseVNode("span", { class: "s-foot" }, "需关注处理")
            ], -1))
          ]),
          createBaseVNode("div", _hoisted_9, [
            _cache[10] || (_cache[10] = createBaseVNode("div", { class: "s-ico" }, "◎", -1)),
            _cache[11] || (_cache[11] = createBaseVNode("div", { class: "s-label" }, "事件数", -1)),
            createBaseVNode("div", _hoisted_10, toDisplayString((stats.event_count || 0).toLocaleString()), 1),
            _cache[12] || (_cache[12] = createBaseVNode("div", { class: "s-foot-row" }, [
              createBaseVNode("span", { class: "s-foot" }, "聚合事件")
            ], -1))
          ]),
          createBaseVNode("div", _hoisted_11, [
            _cache[13] || (_cache[13] = createBaseVNode("div", { class: "s-ico" }, "↻", -1)),
            _cache[14] || (_cache[14] = createBaseVNode("div", { class: "s-label" }, "采集状态", -1)),
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_16, [
            createBaseVNode("div", _hoisted_17, [
              _cache[15] || (_cache[15] = createBaseVNode("span", { class: "lvl-dot" }, null, -1)),
        ...
        createBaseVNode("div", _hoisted_31, [
          createBaseVNode("div", _hoisted_32, [
            createBaseVNode("div", _hoisted_33, [
              _cache[22] || (_cache[22] = createBaseVNode("h3", { class: "section-title" }, "舆情趋势", -1)),
          ...
          createBaseVNode("div", _hoisted_34, [
            _cache[23] || (_cache[23] = createBaseVNode("div", { class: "chart-head" }, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(doubledNews.value, (n, i) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_39, [
                      createBaseVNode("div", _hoisted_40, toDisplayString(n.title), 1),
                      createBaseVNode("div", _hoisted_41, toDisplayString(n.source) + " · " + toDisplayString(n.region_name) + " · " + toDisplayString(fmtTime(n.created_at)) + " · 风险 " + toDisplayString(n.risk_score), 1)
                    ])
                  ]);
                }), 128))
              ], 4),
              !recentNews.value.length ? (openBlock(), createElementBlock("div", _hoisted_42, "暂无实时快讯")) : createCommentVNode("", true)
            ])
          ]),
            ...
            createBaseVNode("div", _hoisted_44, [
              createBaseVNode("div", {
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(doubledAlerts.value, (a, i) => {
                  return openBlock(), createElementBlock("div", {
                    key: "a" + i,
                    class: normalizeClass(["alert-item", { handled: a.handled }])
                  }, [
                    createBaseVNode("span", {
                      class: normalizeClass(["ai-tag", riskClass(a.risk_level)])
                    }, toDisplayString(riskText(a.risk_level)), 3),
                    createBaseVNode("div", _hoisted_45, [
                      createBaseVNode("div", _hoisted_46, toDisplayString(a.opinion_title || a.rule_name), 1),
                      createBaseVNode("div", _hoisted_47, toDisplayString(a.rule_name) + " · " + toDisplayString(fmtTime(a.created_at)) + toDisplayString(a.handled ? " · 已处置" : ""), 1)
                    ])
                  ], 2);
                }), 128))
              ], 4),
              !alerts.value.length ? (openBlock(), createElementBlock("div", _hoisted_48, "暂无预警")) : createCommentVNode("", true)
            ])
          ]),
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ac96b01c"]]);
