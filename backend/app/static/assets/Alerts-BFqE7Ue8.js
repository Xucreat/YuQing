import { d as defineComponent, $ as useAlertNotifier, z as usePermission, C as onMounted, A as watch, w as withDirectives, c as createElementBlock, m as createVNode, p as withCtx, r as ref, y as resolveComponent, B as resolveDirective, N as useRoute, g as api, E as ElMessage, X as isPermissionDenied, o as openBlock, a as createBaseVNode, e as createTextVNode, q as createBlock, s as createCommentVNode, t as toDisplayString, H as unref, a0 as riskTag, a1 as riskText, Q as _sfc_main$1, b as withKeys, F as Fragment, i as renderList, j as computed, f as reactive, M as ElMessageBox, _ as _export_sfc } from './index-St-GUZhB.js';
import { O as OpinionDetailModal } from './OpinionDetailModal-6L3TY-lQ.js';
import './admission-DpEuIHXC.js';
import './opinion-Cag9WtuS.js';

const _hoisted_1 = { class: "alerts" };
const _hoisted_2 = { class: "scope-bar" };
const _hoisted_3 = {
  key: 3,
  class: "eval-result"
};
const _hoisted_4 = { class: "pagination" };
const _hoisted_5 = { class: "scope-bar" };
const _hoisted_6 = { class: "inline-switch" };
const _hoisted_7 = ["onClick"];
const _hoisted_8 = { key: 1 };
const _hoisted_9 = { class: "pagination" };
const _hoisted_10 = { key: 0 };
const _hoisted_11 = { key: 1 };
const _hoisted_12 = { class: "detail-pre" };
const rulesSize = 20;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const rulesScope = ref("domestic");
    const recordsScope = ref("domestic");
    ...
    function loadRulesScope() {
      rulesScope.value === "foreign" ? loadForeignRules() : loadDomesticRules();
    }
    function loadRecordsScope() {
      recordsScope.value === "foreign" ? loadForeignRecords() : loadDomesticRecords();
    }
    ...
    async function handleEvaluate() {
      ...
      try {
        ...
        if (recordsScope.value === "domestic") await loadDomesticRecords();
      } catch (e) {
    ...
    function normalizeRoute() {
      ...
      if (tab === "foreign" || tab === "foreign-rules") {
        activeTab.value = tab === "foreign-rules" ? "rules" : "records";
        if (tab === "foreign-rules") rulesScope.value = "foreign";
        else recordsScope.value = "foreign";
        return;
      }
      activeTab.value = tab === "records" ? "records" : "rules";
      if (scope === "foreign") activeTab.value === "rules" ? rulesScope.value = "foreign" : recordsScope.value = "foreign";
    }
    onMounted(() => {
      normalizeRoute();
      loadRulesScope();
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
              ...
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_2, [
                  createVNode(_component_el_radio_group, {
                    modelValue: rulesScope.value,
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => rulesScope.value = $event),
                    onChange: loadRulesScope
                  }, {
                    default: withCtx(() => [
                  ...
                  createVNode(_component_el_button, { onClick: loadRulesScope }, {
                    default: withCtx(() => [..._cache[41] || (_cache[41] = [
                      createTextVNode("刷新", -1)
                    ])]),
                    _: 1
                  }),
                  rulesScope.value === "domestic" && canWriteAlert.value ? (openBlock(), createBlock(_component_el_button, {
                    key: 0,
                    type: "primary",
                  ...
                  rulesScope.value === "foreign" && canForeignRuleWrite.value ? (openBlock(), createBlock(_component_el_button, {
                    key: 2,
                    type: "primary",
                  ...
                  evalResult.value && rulesScope.value === "domestic" ? (openBlock(), createElementBlock("span", _hoisted_3, "检查 " + toDisplayString(evalResult.value.total_checked) + " 条，生成 " + toDisplayString(evalResult.value.alerts_created) + " 条", 1)) : createCommentVNode("", true)
                ]),
                rulesScope.value === "domestic" ? (openBlock(), createBlock(_component_el_card, {
                  key: 0,
                  shadow: "never",
                  class: "table-card"
                }, {
            ...
            createVNode(_component_el_tab_pane, {
              ...
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_5, [
                  createVNode(_component_el_radio_group, {
                    modelValue: recordsScope.value,
                    "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => recordsScope.value = $event),
                    onChange: loadRecordsScope
                  }, {
                    default: withCtx(() => [
                      createVNode(_component_el_radio_button, { label: "domestic" }, {
                  ...
                  createVNode(_component_el_button, { onClick: loadRecordsScope }, {
                    default: withCtx(() => [..._cache[51] || (_cache[51] = [
                      createTextVNode("刷新", -1)
                    ])]),
                    _: 1
                  }),
                  recordsScope.value === "domestic" && canWriteAlert.value ? (openBlock(), createBlock(_component_el_button, {
                    key: 0,
                    type: "warning",
                    loading: evaluating.value,
                    onClick: handleEvaluate
                  ...
                  recordsScope.value === "foreign" && canEvaluateForeign.value ? (openBlock(), createBlock(_component_el_button, {
                    key: 1,
                    type: "warning",
                ...
                recordsScope.value === "domestic" ? (openBlock(), createBlock(_component_el_card, {
                  key: 0,
                  shadow: "never",
                  class: "filter-card"
                }, {
                  default: withCtx(() => [
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => recFilterRisk.value = $event),
                      placeholder: "预警等级",
                      clearable: "",
                      class: "filter-select",
                    ...
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => recFilterStatus.value = $event),
                      placeholder: "处置状态",
                      clearable: "",
                      class: "filter-select",
                      onChange: loadDomesticRecords
                    ...
                    createBaseVNode("span", _hoisted_6, [
                      createVNode(_component_el_switch, {
                        ...
                        "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => hideFalsePositive.value = $event),
                        onChange: loadDomesticRecords
                      }, null, 8, ["modelValue"]),
                      _cache[54] || (_cache[54] = createTextVNode("隐藏误报", -1))
                    ]),
                    createVNode(_component_el_date_picker, {
                      modelValue: recDateRange.value,
                      "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => recDateRange.value = $event),
                      type: "daterange",
                      "range-separator": "至",
                  ...
                  default: withCtx(() => [
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => foreignFilters.status = $event),
                      placeholder: "状态",
                      clearable: "",
                      class: "filter-select",
                    ...
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => foreignFilters.severity = $event),
                      placeholder: "严重度",
                      clearable: "",
                      class: "filter-select",
                      onChange: loadForeignRecords
                    ...
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => foreignFilters.source = $event),
                      placeholder: "来源",
                      clearable: "",
                      class: "filter-select",
                    ...
                    createVNode(_component_el_date_picker, {
                      ...
                      "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => foreignDateRange.value = $event),
                      type: "daterange",
                      "range-separator": "至",
                      "start-placeholder": "开始日期",
                      "end-placeholder": "结束日期",
                  ...
                  default: withCtx(() => [
                      ...
                      default: withCtx(() => [
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            ...
                            }, toDisplayString(row.opinion_title), 9, _hoisted_7)) : (openBlock(), createElementBlock("span", _hoisted_8, toDisplayString(row.opinion_title || "-"), 1))
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                    ...
                    createBaseVNode("div", _hoisted_9, [
                      createVNode(_sfc_main$1, {
                        ...
                        onCurrentChange: _cache[13] || (_cache[13] = (p) => {
                          recordsPage.value = p;
                          loadDomesticRecords();
                        })
                      }, null, 8, ["total", "current-page"])
                    ...
                    createVNode(_component_el_table, {
                      ...
                      default: withCtx(() => [
                        ...
                        createVNode(_component_el_table_column, {
                          ...
                          default: withCtx(({ row }) => [
                            row.effective_risk ? (openBlock(), createElementBlock("span", _hoisted_10, toDisplayString(row.effective_risk.risk_score ?? "-") + " / " + toDisplayString(foreignText(row.effective_risk.risk_level)), 1)) : (openBlock(), createElementBlock("span", _hoisted_11, "-"))
                          ]),
                          _: 1
                        }),
                        createVNode(_component_el_table_column, {
                ...
                createVNode(_component_el_form_item, { label: "规则名称" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      ...
                      "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => domesticForm.name = $event)
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
                }),
        ...
        createVNode(_component_el_dialog, {
          ...
          default: withCtx(() => [
            createBaseVNode("pre", _hoisted_12, toDisplayString(JSON.stringify(foreignDetail.value, null, 2)), 1)
          ]),
          _: 1
        }, 8, ["modelValue"]),
        createVNode(_component_el_dialog, {
...
const Alerts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-88b9076c"]]);
