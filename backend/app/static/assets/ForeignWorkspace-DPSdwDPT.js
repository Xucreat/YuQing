...
const _hoisted_27 = { class: "fw-col-left" };
const _hoisted_28 = { class: "fw-card fw-card-source fw-card-wide" };
...
const _hoisted_32 = { class: "fw-card fw-card-trend" };
const _hoisted_33 = { class: "fw-card-head" };
const _hoisted_34 = { class: "fw-legend" };
const _hoisted_35 = ["onClick"];
const _hoisted_36 = {
  key: 0,
  class: "empty"
};
const _hoisted_37 = { class: "fw-card fw-card-hotword" };
const _hoisted_38 = { class: "fw-card-head" };
const _hoisted_39 = { class: "muted" };
const _hoisted_40 = {
  key: 0,
  class: "empty"
};
const _hoisted_41 = { class: "fw-col-right" };
const _hoisted_42 = { class: "fw-card fw-card-alert fw-alert-card" };
const _hoisted_43 = { class: "fw-card-head" };
...
const _hoisted_47 = { class: "fw-alert-summary" };
const _hoisted_48 = { class: "fw-alert-sum" };
const _hoisted_49 = { class: "fw-alert-sum" };
const _hoisted_50 = { class: "fw-alert-copy" };
const _hoisted_51 = { class: "fw-alert-list" };
const _hoisted_52 = ["onClick"];
const _hoisted_53 = { class: "fw-alert-main" };
const _hoisted_54 = { class: "fw-alert-title" };
const _hoisted_55 = { class: "fw-alert-meta" };
const _hoisted_56 = {
  key: 0,
  class: "fw-alert-copy"
};
const _hoisted_57 = { class: "fw-alert-list" };
const _hoisted_58 = ["onClick"];
const _hoisted_59 = { class: "fw-alert-main" };
const _hoisted_60 = { class: "fw-alert-title" };
const _hoisted_61 = { class: "fw-alert-meta" };
const _hoisted_62 = { class: "fw-card fw-card-risk" };
const _hoisted_63 = {
  key: 0,
  class: "empty"
};
const _hoisted_64 = { class: "fw-card fw-card-events" };
const _hoisted_65 = {
  key: 0,
  class: "empty"
};
const _hoisted_66 = { class: "fw-card fw-card-collection" };
const _hoisted_67 = {
  key: 0,
  class: "distribution-row"
};
const _hoisted_68 = { class: "distribution-row" };
const _hoisted_69 = {
  key: 1,
  class: "empty"
};
const _hoisted_70 = { class: "visualization-meta" };
const _hoisted_71 = {
  key: 2,
  class: "state"
};
...
const _hoisted_73 = { class: "toolbar" };
const _hoisted_74 = ["value"];
const _hoisted_75 = { class: "table-wrap tbl-scroll" };
const _hoisted_76 = ["onClick"];
const _hoisted_77 = { class: "title-cell" };
const _hoisted_78 = {
  key: 0,
  class: "muted"
};
...
const _hoisted_84 = { class: "alert-scope-note" };
const _hoisted_85 = { class: "toolbar" };
...
const _hoisted_89 = { class: "subtabs" };
const _hoisted_90 = {
  key: 2,
  class: "table-wrap"
};
const _hoisted_91 = { class: "title-cell" };
const _hoisted_92 = { class: "actions" };
...
const _hoisted_103 = { class: "event-provenance" };
const _hoisted_104 = { key: 0 };
const _hoisted_105 = { class: "event-detail-head" };
const _hoisted_106 = { class: "actions" };
const _hoisted_107 = ["disabled"];
const _hoisted_108 = ["disabled"];
const _hoisted_109 = ["disabled"];
const _hoisted_110 = { class: "muted" };
const _hoisted_111 = { class: "event-metrics" };
const _hoisted_112 = { class: "muted" };
const _hoisted_113 = ["href"];
const _hoisted_114 = {
  key: 3,
  class: "panel"
};
const _hoisted_115 = { class: "alert-scope-note" };
const _hoisted_116 = { class: "toolbar" };
...
const _hoisted_120 = { class: "table-wrap" };
const _hoisted_121 = { class: "title-cell" };
const _hoisted_122 = ["title", "onClick", "onKeydown"];
const _hoisted_123 = {
  key: 1,
  class: "alert-title"
};
const _hoisted_124 = { class: "muted" };
const _hoisted_125 = { class: "linked-cell" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
              ...
              createBaseVNode("div", _hoisted_27, [
                createBaseVNode("article", _hoisted_28, [
                  createBaseVNode("header", _hoisted_29, [
                    ...
                    createBaseVNode("span", _hoisted_30, "近 " + toDisplayString(visualizationDays.value) + " 天 · 各来源文章量", 1)
                  ]),
                  ...
                  !(dashboardSources.value?.items || []).length ? (openBlock(), createElementBlock("p", _hoisted_31, "该窗口内暂无数据源分布")) : createCommentVNode("", true)
                ]),
                createBaseVNode("article", _hoisted_32, [
                  ...
                  !(dashboardTrends.value?.items || []).length ? (openBlock(), createElementBlock("p", _hoisted_36, "该窗口内暂无趋势数据")) : createCommentVNode("", true)
                ]),
                createBaseVNode("article", _hoisted_37, [
                  createBaseVNode("header", _hoisted_38, [
                    _cache[42] || (_cache[42] = createBaseVNode("h3", null, "外网热词", -1)),
                    createBaseVNode("span", _hoisted_39, "近 " + toDisplayString(visualizationDays.value) + " 天 · 共 " + toDisplayString(hotwordItems.value.length) + " 个热词", 1)
                  ]),
                  withDirectives(createBaseVNode("div", {
                  ...
                  !hotwordItems.value.length ? (openBlock(), createElementBlock("p", _hoisted_40, "该窗口内暂无外网热词")) : createCommentVNode("", true)
                ])
              ]),
              createBaseVNode("div", _hoisted_41, [
                createBaseVNode("article", _hoisted_42, [
                  createBaseVNode("header", _hoisted_43, [
                    _cache[43] || (_cache[43] = createBaseVNode("h3", null, "外网告警", -1)),
                    createBaseVNode("span", _hoisted_44, "滚动播报 · 共 " + toDisplayString(alertFeed.value.length) + " 条", 1)
                  ]),
                  !alertFeed.value.length ? (openBlock(), createElementBlock("div", _hoisted_45, "该窗口内暂无外网告警")) : (openBlock(), createElementBlock("div", _hoisted_46, [
                    ...
                    createBaseVNode("div", {
                      ...
                      createBaseVNode("div", {
                            ...
                            (openBlock(true), createElementBlock(Fragment, null, renderList(alertFeed.value, (a) => {
                              return openBlock(), createElementBlock("li", {
                                ...
                                createBaseVNode("div", _hoisted_53, [
                                  createBaseVNode("div", _hoisted_54, toDisplayString(a.title || "未命名告警"), 1),
                                  createBaseVNode("div", _hoisted_55, toDisplayString(a.rule_snapshot?.name || a.source_name_snapshot || "外网告警") + " · " + toDisplayString(shortTime(a.triggered_at)), 1)
                                ]),
                                createBaseVNode("span", {
                        ...
                        alertNeedScroll.value ? (openBlock(), createElementBlock("div", _hoisted_56, [
                            ...
                            (openBlock(true), createElementBlock(Fragment, null, renderList(alertFeed.value, (a) => {
                              return openBlock(), createElementBlock("li", {
                                ...
                                createBaseVNode("div", _hoisted_59, [
                                  createBaseVNode("div", _hoisted_60, toDisplayString(a.title || "未命名告警"), 1),
                                  createBaseVNode("div", _hoisted_61, toDisplayString(a.rule_snapshot?.name || a.source_name_snapshot || "外网告警") + " · " + toDisplayString(shortTime(a.triggered_at)), 1)
                                ]),
                                createBaseVNode("span", {
                                  class: normalizeClass(["fw-badge", isHandled(a.status) ? "is-teal" : "is-amber"])
                                }, toDisplayString(zh(a.status)), 3)
                ...
                createBaseVNode("article", _hoisted_62, [
                  _cache[46] || (_cache[46] = createBaseVNode("header", { class: "fw-card-head" }, [
                    createBaseVNode("h3", null, "风险分布")
                  ], -1)),
                  ...
                  !dashboardRisk.value || !Object.keys(dashboardRisk.value.risk_levels || {}).length ? (openBlock(), createElementBlock("p", _hoisted_63, "暂无已完成风险结果")) : createCommentVNode("", true)
                ]),
                createBaseVNode("article", _hoisted_64, [
                  _cache[47] || (_cache[47] = createBaseVNode("header", { class: "fw-card-head" }, [
                    createBaseVNode("h3", null, "事件状态")
                  ], -1)),
                ...
                createBaseVNode("article", _hoisted_66, [
                  _cache[50] || (_cache[50] = createBaseVNode("header", { class: "fw-card-head" }, [
                    createBaseVNode("h3", null, "采集状态")
                  ], -1)),
                  dashboardSummary.value.collection.latest ? (openBlock(), createElementBlock("div", _hoisted_67, [
                  ...
                  !dashboardSummary.value.collection.latest ? (openBlock(), createElementBlock("p", _hoisted_69, "暂无外网采集记录")) : createCommentVNode("", true)
                ])
              ])
            ]),
            createBaseVNode("div", _hoisted_70, "数据范围：" + toDisplayString(formatTime(dashboardSummary.value.window_start)) + " - " + toDisplayString(formatTime(dashboardSummary.value.window_end)) + " · 更新于：" + toDisplayString(formatTime(dashboardSummary.value.data_as_of)), 1)
          ])) : (openBlock(), createElementBlock("div", _hoisted_71, "加载外网看板中..."))
        ])) : createCommentVNode("", true),
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_72, [
          createBaseVNode("div", _hoisted_73, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(opinionSources.value, (source) => {
                return openBlock(), createElementBlock("option", {
                  key: source,
                  value: source
                }, toDisplayString(source), 9, _hoisted_74);
              }), 128))
            ], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-a95e0f60>全部语言</option><option value="zh" data-v-a95e0f60>中文</option><option value="en" data-v-a95e0f60>英文</option><option value="mixed" data-v-a95e0f60>中英混合</option><option value="unknown" data-v-a95e0f60>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-a95e0f60>全部风险等级</option><option value="high" data-v-a95e0f60>高</option><option value="medium" data-v-a95e0f60>中</option><option value="low" data-v-a95e0f60>低</option><option value="unknown" data-v-a95e0f60>未知</option>', 5)
            ])], 544), [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_77, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", null, [
                      ...
                      !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_78, "无")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_79, [
                      ...
                      }, "重新分析", 8, _hoisted_80)) : createCommentVNode("", true)
                    ])
                  ], 8, _hoisted_76);
                }), 128)),
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_81, [..._cache[56] || (_cache[56] = [
                  createBaseVNode("td", {
                    colspan: "14",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_82, [
        ...
        ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_83, [
          createBaseVNode("div", _hoisted_84, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
          createBaseVNode("div", _hoisted_85, [
            ...
            }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_86),
            _cache[58] || (_cache[58] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
          ]),
          eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_87, [
          ...
          eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_88, [
          ...
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_90, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_91, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", _hoisted_92, [
                      ...
                      }, "确认", 8, _hoisted_93)) : createCommentVNode("", true),
                      row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn danger",
                        disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                        onClick: ($event) => rejectCandidate(row)
                      }, "拒绝", 8, _hoisted_94)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_95, [..._cache[61] || (_cache[61] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
            ...
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_101, [..._cache[63] || (_cache[63] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
          ...
          selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_102, [
            createBaseVNode("div", _hoisted_103, [
              ...
              selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_104, [
            ...
            createBaseVNode("p", _hoisted_110, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_112, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                createBaseVNode("a", {
                  href: opinion.url,
                  target: "_blank",
                  rel: "noreferrer",
        ...
        ])) : activeTab.value === "alerts" ? (openBlock(), createElementBlock("section", _hoisted_114, [
          createBaseVNode("div", _hoisted_115, "外网自动告警评估：" + toDisplayString(alertAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(alertAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 外部通知：" + toDisplayString(alertAutoStatus.value?.external_notifications_enabled ? "已启用" : "已停用"), 1),
          createBaseVNode("div", _hoisted_116, [
            ...
            }, toDisplayString(alertEvaluating.value ? "评估中..." : "手动 Dry-Run"), 9, _hoisted_117),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => alertFilters.status = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[67] || (_cache[67] = [
              createStaticVNode('<option value="" data-v-a95e0f60>全部状态</option><option value="triggered" data-v-a95e0f60>待处理</option><option value="acknowledged" data-v-a95e0f60>已确认</option><option value="resolved" data-v-a95e0f60>已解决</option><option value="suppressed" data-v-a95e0f60>已抑制</option><option value="failed" data-v-a95e0f60>失败</option>', 6)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-a95e0f60>全部严重度</option><option value="low" data-v-a95e0f60>低</option><option value="medium" data-v-a95e0f60>中</option><option value="high" data-v-a95e0f60>高</option><option value="critical" data-v-a95e0f60>紧急</option>', 5)
            ])], 544), [
          ...
          alertLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_118, [
          ...
          alertRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_119, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignAlerts.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_121, [
                      ...
                      }, toDisplayString(row.title || "无标题告警"), 41, _hoisted_122)) : (openBlock(), createElementBlock("strong", _hoisted_123, toDisplayString(row.title || "无标题告警"), 1)),
                      createBaseVNode("div", _hoisted_124, toDisplayString(row.message), 1)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_125, [
                      ...
                      }, toDisplayString(row.opinion_title_snapshot || "#" + row.foreign_opinion_id), 9, _hoisted_126)) : (openBlock(), createElementBlock("span", _hoisted_127, "-"))
                    ]),
          ...
          createBaseVNode("article", _hoisted_148, [
            ...
            createBaseVNode("label", null, [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="risk_score" data-v-a95e0f60>风险分</option><option value="risk_level" data-v-a95e0f60>风险等级</option><option value="risk_category" data-v-a95e0f60>风险类别</option><option value="confirmed_event" data-v-a95e0f60>确认事件</option><option value="keyword_combo" data-v-a95e0f60>关键词组合</option>', 5)
              ])], 512), [
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a95e0f60"]]);
