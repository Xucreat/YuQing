      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        activeTab.value === "dashboard" ? (openBlock(), createElementBlock("section", _hoisted_6, [
          createBaseVNode("div", {
            ...
            _cache[32] || (_cache[32] = createBaseVNode("strong", null, "外网自动采集", -1)),
          ...
          visualizationError.value ? (openBlock(), createElementBlock("div", _hoisted_13, [
            ...
            createBaseVNode("div", _hoisted_15, [
              ...
              createBaseVNode("div", _hoisted_26, [
                _cache[41] || (_cache[41] = createBaseVNode("span", { class: "fw-kpi-label" }, "外网采集", -1)),
            ...
            createBaseVNode("div", _hoisted_28, [
              createBaseVNode("article", _hoisted_29, [
                createBaseVNode("header", _hoisted_30, [
                  _cache[42] || (_cache[42] = createBaseVNode("h3", null, "每日趋势", -1)),
              ...
              createBaseVNode("article", _hoisted_53, [
                createBaseVNode("header", _hoisted_54, [
                  _cache[46] || (_cache[46] = createBaseVNode("h3", null, "数据源分布", -1)),
              ...
              createBaseVNode("article", _hoisted_57, [
                _cache[47] || (_cache[47] = createBaseVNode("h3", null, "风险分布", -1)),
                withDirectives(createBaseVNode("div", {
              ...
              createBaseVNode("article", _hoisted_59, [
                createBaseVNode("header", _hoisted_60, [
                  _cache[48] || (_cache[48] = createBaseVNode("h3", null, "外网热词", -1)),
              ...
              createBaseVNode("article", _hoisted_63, [
                _cache[49] || (_cache[49] = createBaseVNode("h3", null, "事件状态", -1)),
        ...
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_67, [
          createBaseVNode("div", _hoisted_68, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-8470e420>全部语言</option><option value="zh" data-v-8470e420>中文</option><option value="en" data-v-8470e420>英文</option><option value="mixed" data-v-8470e420>中英混合</option><option value="unknown" data-v-8470e420>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-8470e420>全部风险等级</option><option value="high" data-v-8470e420>高</option><option value="medium" data-v-8470e420>中</option><option value="low" data-v-8470e420>低</option><option value="unknown" data-v-8470e420>未知</option>', 5)
            ])], 544), [
            ...
            _cache[55] || (_cache[55] = createBaseVNode("span", { class: "muted" }, "AI 研判结果仅用于辅助分析，不改变系统正式风险和告警", -1))
          ]),
          ...
          createBaseVNode("div", _hoisted_74, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                ...
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_82, [..._cache[56] || (_cache[56] = [
                  createBaseVNode("td", {
                    colspan: "16",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_91, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                ...
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_96, [..._cache[61] || (_cache[61] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
            ...
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_102, [..._cache[63] || (_cache[63] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
        ...
        createVNode(_component_el_dialog, {
          ...
          "onUpdate:modelValue": _cache[31] || (_cache[31] = ($event) => aiBatchDialog.value = $event),
          title: "批量 AI 研判",
          ...
          footer: withCtx(() => [
            createBaseVNode("button", {
              class: "btn btn-secondary",
              onClick: _cache[30] || (_cache[30] = ($event) => aiBatchDialog.value = false)
            }, "取消"),
            createBaseVNode("button", {
              class: "btn btn-primary",
          ...
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_115, [
              createBaseVNode("label", null, [
                _cache[68] || (_cache[68] = createTextVNode("研判范围 ", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              aiBatchConfig.scope === "count" ? (openBlock(), createElementBlock("label", _hoisted_116, [
                _cache[69] || (_cache[69] = createTextVNode("最近 N 条 ", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              aiBatchConfig.scope === "time" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                createBaseVNode("label", null, [
                  _cache[70] || (_cache[70] = createTextVNode("发布时间起始日期", -1)),
                  withDirectives(createBaseVNode("input", {
                ...
                createBaseVNode("label", null, [
                  _cache[71] || (_cache[71] = createTextVNode("发布时间结束日期", -1)),
                  withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("label", _hoisted_117, [
                ...
                _cache[72] || (_cache[72] = createTextVNode(" 仅选择当前筛选结果", -1))
              ]),
              createBaseVNode("label", _hoisted_118, [
                ...
                _cache[73] || (_cache[73] = createTextVNode(" 仅处理未完成 AI 研判的记录", -1))
              ]),
              createBaseVNode("label", _hoisted_119, [
                ...
                _cache[74] || (_cache[74] = createTextVNode(" 强制重新研判已有 AI 结果", -1))
              ]),
            ...
            aiBatchPreview.value ? (openBlock(), createElementBlock("div", _hoisted_121, [
              createBaseVNode("p", null, [
                _cache[75] || (_cache[75] = createTextVNode("符合条件舆情：", -1)),
                createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.matched_count), 1),
                _cache[76] || (_cache[76] = createTextVNode(" 条", -1))
              ]),
              createBaseVNode("p", null, [
                _cache[77] || (_cache[77] = createTextVNode("已有 AI 结果：", -1)),
                createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.existing_ai_result_count), 1),
                _cache[78] || (_cache[78] = createTextVNode(" 条 · 待分析：", -1)),
                createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.pending_analysis_count), 1),
                _cache[79] || (_cache[79] = createTextVNode(" 条", -1))
              ]),
              createBaseVNode("p", null, [
                _cache[80] || (_cache[80] = createTextVNode("待分析：", -1)),
                createBaseVNode("strong", null, toDisplayString(aiBatchPreview.value.pending_analysis_count), 1),
                _cache[81] || (_cache[81] = createTextVNode(" 条 · 预计 Token：", -1)),
              ...
              _cache[82] || (_cache[82] = createBaseVNode("p", { class: "muted" }, "AI 结果必须经过人工复核后，才可用于正式事件或预警变更。", -1))
            ])) : createCommentVNode("", true),
                ...
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(manualReviews.value, (review) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      review.review_status === "pending_review" ? (openBlock(), createElementBlock("td", _hoisted_123, [
                        createBaseVNode("button", {
                          class: "link-btn",
                          disabled: reviewActionId.value === review.id,
                          onClick: ($event) => decideReview(review, "use_ai_display")
                        }, "采用 AI 展示", 8, _hoisted_124),
                        createBaseVNode("button", {
                          class: "link-btn",
                          disabled: reviewActionId.value === review.id,
                      ...
                      ])) : (openBlock(), createElementBlock("td", _hoisted_127, toDisplayString(review.review_reason || "-"), 1))
                    ]);
                  }), 128)),
                  !manualReviews.value.length ? (openBlock(), createElementBlock("tr", _hoisted_128, [..._cache[83] || (_cache[83] = [
                    createBaseVNode("td", {
                      colspan: "5",
                      class: "empty"
                    }, "暂无待复核结果", -1)
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8470e420"]]);
