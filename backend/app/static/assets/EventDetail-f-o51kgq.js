...
const _hoisted_27 = { class: "situation-panel-head" };
const _hoisted_28 = { class: "pill pill-gray" };
const _hoisted_29 = { class: "situation-facts" };
const _hoisted_30 = { class: "risk-factor-list" };
const _hoisted_31 = { class: "op-modal-body" };
const _hoisted_32 = { class: "op-left" };
const _hoisted_33 = { class: "operation-header" };
const _hoisted_34 = { class: "operation-current" };
const _hoisted_35 = {
  key: 0,
...
const _hoisted_39 = { class: "note-submit-row" };
const _hoisted_40 = ["disabled"];
const _hoisted_41 = { class: "op-right" };
const _hoisted_42 = { class: "op-right-title" };
const _hoisted_43 = { class: "op-count" };
const _hoisted_44 = { class: "op-right-scroll" };
const _hoisted_45 = { class: "action-timeline" };
const _hoisted_46 = { class: "timeline-body" };
const _hoisted_47 = { class: "timeline-meta" };
const _hoisted_48 = { class: "timeline-content" };
const _hoisted_49 = {
  key: 0,
  class: "timeline-empty"
};
const _hoisted_50 = { class: "card table-card" };
const _hoisted_51 = { class: "card-header" };
const _hoisted_52 = { class: "section-title" };
const _hoisted_53 = { class: "tbl" };
...
const _hoisted_59 = { class: "card table-card" };
const _hoisted_60 = { class: "card-header" };
const _hoisted_61 = { class: "section-title" };
const _hoisted_62 = { class: "tbl" };
const _hoisted_63 = { class: "t-title" };
const _hoisted_64 = { class: "col-center" };
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_3, [
          ...
          createBaseVNode("div", _hoisted_7, [
            createBaseVNode("span", null, [
              _cache[7] || (_cache[7] = createTextVNode("关联舆情：", -1)),
              createBaseVNode("b", null, toDisplayString(event.value.total_opinions), 1),
              _cache[8] || (_cache[8] = createTextVNode(" 条", -1))
            ]),
        ...
        createBaseVNode("div", _hoisted_9, [
          ...
          createBaseVNode("div", _hoisted_11, [
            _cache[10] || (_cache[10] = createBaseVNode("span", { class: "situation-label" }, "事件主题", -1)),
            createBaseVNode("strong", null, toDisplayString(topicText(event.value.topic_category)), 1)
          ]),
          createBaseVNode("div", _hoisted_12, [
            _cache[11] || (_cache[11] = createBaseVNode("span", { class: "situation-label" }, "处置状态", -1)),
            createBaseVNode("strong", null, toDisplayString(unref(eventStatusLabel)(event.value.status)), 1)
          ]),
          createBaseVNode("div", _hoisted_13, [
            _cache[12] || (_cache[12] = createBaseVNode("span", { class: "situation-label" }, "当前风险", -1)),
        ...
        event.value.statistics ? (openBlock(), createElementBlock("section", _hoisted_16, [
          _cache[22] || (_cache[22] = createBaseVNode("h3", { class: "section-title" }, "运营统计", -1)),
          createBaseVNode("div", _hoisted_17, [
            createBaseVNode("div", _hoisted_18, [
              _cache[15] || (_cache[15] = createBaseVNode("span", { class: "stat-label" }, "关联舆情", -1)),
              createBaseVNode("strong", null, toDisplayString(event.value.statistics.opinion_count) + " 条", 1)
            ]),
            createBaseVNode("div", _hoisted_19, [
              _cache[16] || (_cache[16] = createBaseVNode("span", { class: "stat-label" }, "来源数量", -1)),
              createBaseVNode("strong", null, toDisplayString(event.value.statistics.source_count) + " 个", 1)
            ]),
            createBaseVNode("div", _hoisted_20, [
              _cache[17] || (_cache[17] = createBaseVNode("span", { class: "stat-label" }, "最新时间", -1)),
              createBaseVNode("strong", null, toDisplayString(formatTime(event.value.statistics.latest_time)), 1)
            ]),
        ...
        situation.value ? (openBlock(), createElementBlock("section", _hoisted_26, [
          createBaseVNode("div", _hoisted_27, [
            _cache[23] || (_cache[23] = createBaseVNode("h3", { class: "section-title" }, "事件态势（只读研判）", -1)),
            createBaseVNode("span", _hoisted_28, "数据充分性：" + toDisplayString(sufficiencyText(situation.value.data_sufficiency?.level)), 1)
          ]),
          createBaseVNode("div", _hoisted_29, [
            createBaseVNode("span", null, "来源 " + toDisplayString(situation.value.source_distribution?.length || 0) + " 个", 1),
            createBaseVNode("span", null, "时间范围 " + toDisplayString(formatTime(situation.value.data_window?.first_time)) + " - " + toDisplayString(formatTime(situation.value.data_window?.last_time)), 1),
            createBaseVNode("span", null, "影子风险 " + toDisplayString(situation.value.risk_shadow?.score ?? "-") + " 分", 1)
          ]),
          ...
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_31, [
              createBaseVNode("div", _hoisted_32, [
                createBaseVNode("div", _hoisted_33, [
                  createBaseVNode("div", null, [
                    createBaseVNode("div", _hoisted_34, [
                      _cache[24] || (_cache[24] = createTextVNode(" 当前处置状态 ", -1)),
                      createBaseVNode("span", {
                ...
                canUpdateEvent.value ? (openBlock(), createElementBlock("div", _hoisted_35, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(EVENT_STATUS_OPTIONS), (option) => {
                    ...
                    }, toDisplayString(option.value === "deprecated" ? "忽略事件" : option.label), 11, _hoisted_36);
                  }), 128))
                ])) : createCommentVNode("", true),
                canUpdateEvent.value ? (openBlock(), createElementBlock("div", _hoisted_37, [
                  ...
                  createBaseVNode("div", _hoisted_39, [
                    ...
                    createBaseVNode("button", {
                      ...
                      onClick: addNote
                    }, toDisplayString(savingNote.value ? "提交中" : "添加备注"), 9, _hoisted_40)
                  ])
                ])) : createCommentVNode("", true)
              ]),
              createBaseVNode("div", _hoisted_41, [
                createBaseVNode("div", _hoisted_42, [
                  _cache[25] || (_cache[25] = createTextVNode(" 处置记录", -1)),
                  createBaseVNode("span", _hoisted_43, toDisplayString(event.value.actions.length), 1)
                ]),
                  ...
                  createBaseVNode("div", _hoisted_45, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(event.value.actions, (action) => {
                      return openBlock(), createElementBlock("div", {
                        ...
                        _cache[26] || (_cache[26] = createBaseVNode("span", { class: "timeline-dot" }, null, -1)),
                    ...
                    event.value.actions.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_49, "暂无处置记录")) : createCommentVNode("", true)
                  ])
                ])
              ])
            ])
        ...
        createBaseVNode("div", _hoisted_50, [
          createBaseVNode("div", _hoisted_51, [
            createBaseVNode("h3", _hoisted_52, "关联舆情列表 (" + toDisplayString(event.value.total_opinions) + ")", 1)
          ]),
          createBaseVNode("table", _hoisted_53, [
            ...
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(event.value.opinions, (row) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", null, [
                    createBaseVNode("span", _hoisted_55, toDisplayString(row.title), 1)
                  ]),
              ...
              event.value.opinions.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_58, [..._cache[28] || (_cache[28] = [
                createBaseVNode("td", {
                  colspan: "7",
                  class: "empty-row"
                }, "暂无关联舆情", -1)
        ...
        createBaseVNode("div", _hoisted_59, [
          createBaseVNode("div", _hoisted_60, [
            createBaseVNode("h3", _hoisted_61, "关联预警 (" + toDisplayString(event.value.alerts?.length || 0) + ")", 1)
          ]),
            ...
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(event.value.alerts || [], (a) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", null, [
                    createBaseVNode("span", _hoisted_63, toDisplayString(a.title), 1)
                  ]),
                  createBaseVNode("td", _hoisted_64, [
                    createBaseVNode("span", {
                      class: normalizeClass(["pill", riskPill(a.risk_level)])
                    }, [
                      _cache[30] || (_cache[30] = createBaseVNode("span", { class: "dot" }, null, -1)),
                      createTextVNode(toDisplayString(riskText(a.risk_level)), 1)
                    ], 2)
                  ]),
                  createBaseVNode("td", _hoisted_65, toDisplayString(alertStatusText(a.status)), 1),
                  createBaseVNode("td", null, toDisplayString(formatTime(a.created_at)), 1)
                ]);
              }), 128)),
              (event.value.alerts?.length || 0) === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_66, [..._cache[31] || (_cache[31] = [
                createBaseVNode("td", {
                  colspan: "4",
                  class: "empty-row"
                }, "暂无关联预警", -1)
...
const EventDetail = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a769ca82"]]);
