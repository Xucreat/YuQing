const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Dnhy_dOC.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, m as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, t as toDisplayString, z as createCommentVNode, F as Fragment, i as renderList, r as ref, j as computed, g as api, E as ElMessage, x as resolveDirective, o as openBlock, n as normalizeClass, e as createTextVNode, D as withModifiers, G as __vitePreload, _ as _export_sfc } from './index-CX2gy79j.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      try {
        const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-CX2gy79j.js').then(n => n.K);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
