import { d as defineComponent, l as usePermission, p as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, t as toDisplayString, n as normalizeClass, e as createTextVNode, A as createCommentVNode, x as unref, k as normalizeStyle, F as Fragment, i as renderList, v as vModelText, B as createVNode, r as ref, j as computed, g as api, E as ElMessage, D as resolveDirective, M as useRoute, o as openBlock, h as useRouter, _ as _export_sfc } from './index-CpSMA9H0.js';
import { O as OpinionDetailModal } from './OpinionDetailModal-C45p-24V.js';
...
const _hoisted_29 = { class: "action-timeline" };
const _hoisted_30 = { class: "timeline-body" };
const _hoisted_31 = { class: "timeline-meta" };
const _hoisted_32 = { class: "timeline-content" };
const _hoisted_33 = {
  key: 0,
  class: "timeline-empty"
};
const _hoisted_34 = { class: "card table-card" };
const _hoisted_35 = { class: "card-header" };
const _hoisted_36 = { class: "section-title" };
const _hoisted_37 = { class: "tbl" };
const _hoisted_38 = ["onClick"];
const _hoisted_39 = { class: "t-title" };
        ...
        createBaseVNode("section", _hoisted_16, [
          ...
          createBaseVNode("div", _hoisted_26, [
            ...
            createBaseVNode("div", _hoisted_29, [
              ...
              event.value.actions.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_33, "暂无处置记录")) : createCommentVNode("", true)
            ])
          ])
        ]),
        createBaseVNode("div", _hoisted_34, [
          createBaseVNode("div", _hoisted_35, [
            createBaseVNode("h3", _hoisted_36, "关联舆情列表 (" + toDisplayString(event.value.total_opinions) + ")", 1)
          ]),
          createBaseVNode("table", _hoisted_37, [
            ...
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(event.value.opinions, (row) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", null, [
                    createBaseVNode("span", _hoisted_39, toDisplayString(row.title), 1)
                  ]),
              ...
              event.value.opinions.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_42, [..._cache[17] || (_cache[17] = [
                createBaseVNode("td", {
                  colspan: "7",
                  class: "empty-row"
                }, "暂无关联舆情", -1)
...
const EventDetail = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5b47613c"]]);
