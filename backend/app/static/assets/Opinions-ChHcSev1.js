import { d as defineComponent, r as ref, A as watch, z as usePermission, C as onMounted, M as onUnmounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, F as Fragment, n as normalizeClass, s as createCommentVNode, m as createVNode, p as withCtx, i as renderList, N as vModelSelect, v as vModelText, b as withKeys, H as unref, O as vModelCheckbox, e as createTextVNode, t as toDisplayString, k as normalizeStyle, P as withModifiers, q as createBlock, f as reactive, j as computed, Q as ElMessageBox, g as api, E as ElMessage, y as resolveComponent, B as resolveDirective, L as useRoute, h as useRouter, o as openBlock, _ as _export_sfc } from './index-YAaNtFRE.js';
import { O as OpinionDetailModal } from './OpinionDetailModal-CtXmL0e8.js';
import { B as BatchAIModal, F as ForeignOpinionListView, a as ForeignAIReviewView } from './ForeignOpinionListView-BzLAX8x6.js';
...
import './ForeignOpinionDetailModal-S7s5FXXr.js';
...
const _hoisted_9 = { class: "risk-view-switch" };
const _hoisted_10 = { class: "date-range" };
const _hoisted_11 = { class: "search-wrap" };
const _hoisted_12 = {
  key: 2,
...
const _hoisted_14 = { class: "batch-count" };
const _hoisted_15 = ["disabled"];
const _hoisted_16 = { class: "sent-pop" };
const _hoisted_17 = ["onClick"];
const _hoisted_18 = {
  key: 1,
  class: "run-progress"
};
const _hoisted_19 = { class: "run-progress-head" };
const _hoisted_20 = { class: "progress-track" };
const _hoisted_21 = { class: "run-progress-meta" };
const _hoisted_22 = {
  key: 2,
  class: "run-progress run-failed"
};
const _hoisted_23 = { class: "run-progress-meta" };
const _hoisted_24 = { class: "card table-card" };
const _hoisted_25 = { class: "tbl-scroll" };
...
const _hoisted_28 = ["checked", "indeterminate"];
const _hoisted_29 = {
  style: { "width": "110px" },
  class: "col-center"
};
...
const _hoisted_33 = ["checked", "onClick"];
const _hoisted_34 = { class: "leading-id" };
const _hoisted_35 = { class: "leading-title" };
const _hoisted_36 = { class: "t-title" };
const _hoisted_37 = { class: "col-center" };
const _hoisted_38 = { class: "pill pill-blue" };
const _hoisted_39 = { class: "col-center" };
const _hoisted_40 = { class: "admission-summary" };
const _hoisted_41 = { class: "col-center" };
const _hoisted_42 = ["onClick"];
const _hoisted_43 = { class: "sent-pop" };
...
const _hoisted_48 = { class: "col-center" };
const _hoisted_49 = {
  key: 1,
  class: "col-center"
};
...
const _hoisted_55 = { class: "review-filter" };
const _hoisted_56 = {
  key: 0,
  class: "review-batch"
};
...
const _hoisted_60 = { class: "tbl-scroll" };
const _hoisted_61 = { class: "tbl review-table" };
const _hoisted_62 = { style: { "width": "44px" } };
const _hoisted_63 = ["checked"];
const _hoisted_64 = ["checked", "onClick"];
const _hoisted_65 = { class: "review-title-cell" };
const _hoisted_66 = ["onClick"];
const _hoisted_67 = { class: "risk-num" };
...
const _hoisted_71 = { class: "col-center" };
const _hoisted_72 = {
  key: 0,
  class: "pill pill-green"
};
const _hoisted_73 = { key: 1 };
const _hoisted_74 = { class: "review-op-cell" };
...
const _hoisted_79 = { class: "modal-card compact-modal" };
const _hoisted_80 = { class: "modal-header" };
const _hoisted_81 = { class: "modal-body" };
const _hoisted_82 = {
  key: 0,
  class: "review-empty"
};
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        scope.value === "domestic" && activeView.value === "opinions" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          createBaseVNode("div", _hoisted_5, [
            createBaseVNode("div", _hoisted_6, [
              withDirectives(createBaseVNode("select", {
                ...
                _cache[28] || (_cache[28] = createBaseVNode("option", { value: "" }, "来源（全部）", -1)),
              ...
              withDirectives(createBaseVNode("select", {
                ...
                _cache[29] || (_cache[29] = createBaseVNode("option", { value: "" }, "类型（全部）", -1)),
              ...
              createBaseVNode("div", _hoisted_9, [
                _cache[34] || (_cache[34] = createBaseVNode("span", { class: "risk-view-label" }, "展示口径", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => riskView.value = $event),
                  class: "select",
                  onChange: handleSearch
                }, [..._cache[33] || (_cache[33] = [
              ...
              createBaseVNode("div", _hoisted_10, [
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => filters.date_from = $event),
                ...
                _cache[35] || (_cache[35] = createBaseVNode("span", { class: "date-sep" }, "至", -1)),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => filters.date_to = $event),
                  class: "select date-input",
                  type: "date",
                  title: "发布结束日期",
                  onChange: handleSearch
              ...
              createBaseVNode("div", _hoisted_11, [
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => filters.keyword = $event),
                  class: "search",
                  type: "text",
              ...
              canAnalyze.value ? (openBlock(), createElementBlock("button", {
                ...
                onClick: _cache[14] || (_cache[14] = ($event) => batchDialog.value = true)
              ...
              unref(isSuperuser) ? (openBlock(), createElementBlock("label", _hoisted_12, [
                withDirectives(createBaseVNode("input", {
                  type: "checkbox",
                  "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => includeLowValue.value = $event),
                  onChange: handleSearch
                }, null, 544), [
                  [vModelCheckbox, includeLowValue.value]
                ]),
                _cache[36] || (_cache[36] = createTextVNode(" 显示低价值内容 ", -1))
              ])) : createCommentVNode("", true)
            ])
          ]),
          selectedIds.value.size > 0 ? (openBlock(), createElementBlock("div", _hoisted_13, [
            createBaseVNode("span", _hoisted_14, [
              _cache[37] || (_cache[37] = createTextVNode("已选择 ", -1)),
              createBaseVNode("b", null, toDisplayString(selectedIds.value.size), 1),
              _cache[38] || (_cache[38] = createTextVNode(" 条", -1))
            ]),
              ...
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_16, [
                  (openBlock(), createElementBlock(Fragment, null, renderList(sentimentOptions, (opt) => {
                    ...
                    }, toDisplayString(opt.label), 11, _hoisted_17);
                  }), 64))
                ])
              ]),
              _: 1
          ...
          activeRun.value && !["succeeded", "partial_failed", "failed", "cancelled"].includes(activeRun.value.status) ? (openBlock(), createElementBlock("div", _hoisted_18, [
            createBaseVNode("div", _hoisted_19, [
              _cache[39] || (_cache[39] = createBaseVNode("b", null, "国内 AI 研判进行中", -1)),
          ...
          activeRun.value && activeRun.value.status === "partial_failed" && activeRun.value.failed_count ? (openBlock(), createElementBlock("div", _hoisted_22, [
            createBaseVNode("div", { class: "run-progress-head" }, [
              _cache[40] || (_cache[40] = createBaseVNode("b", null, "批量研判存在失败记录", -1)),
              createBaseVNode("button", {
                class: "link-btn",
              ...
              createBaseVNode("table", _hoisted_26, [
                createBaseVNode("thead", null, [
                  createBaseVNode("tr", null, [
                    canEditOpinion.value || canDelete.value ? (openBlock(), createElementBlock("th", _hoisted_27, [
                    ...
                    _cache[43] || (_cache[43] = createBaseVNode("th", { style: { "width": "150px" } }, "来源", -1)),
                    ...
                    _cache[46] || (_cache[46] = createBaseVNode("th", { style: { "width": "200px" } }, "准入原因", -1)),
                    ...
                    createBaseVNode("th", _hoisted_29, "风险评分" + toDisplayString(riskView.value === "ai" ? "(AI)" : ""), 1),
                    _cache[49] || (_cache[49] = createBaseVNode("th", {
                      style: { "width": "110px" },
                      class: "col-center"
                    }, "分析状态", -1)),
                    _cache[50] || (_cache[50] = createBaseVNode("th", { style: { "width": "170px" } }, "发布时间", -1)),
                    canDelete.value ? (openBlock(), createElementBlock("th", _hoisted_30, "操作")) : createCommentVNode("", true)
                  ])
                ]),
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(rows.value, (row, idx) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      canEditOpinion.value || canDelete.value ? (openBlock(), createElementBlock("td", _hoisted_32, [
                        createBaseVNode("input", {
                          type: "checkbox",
                          class: "row-check",
                      ...
                      createBaseVNode("td", _hoisted_34, toDisplayString((page.value - 1) * size.value + idx + 1), 1),
                      createBaseVNode("td", _hoisted_35, [
                        createBaseVNode("span", _hoisted_36, toDisplayString(row.title), 1)
                      ]),
                      createBaseVNode("td", null, toDisplayString(row.source), 1),
                      createBaseVNode("td", _hoisted_37, [
                        createBaseVNode("span", _hoisted_38, toDisplayString(contentTypeText(row.content_type)), 1)
                      ]),
                      ...
                      createBaseVNode("td", null, [
                        createBaseVNode("span", _hoisted_40, toDisplayString(admissionSummary(row.admission_reason)), 1)
                      ]),
                        ...
                        canEditOpinion.value ? (openBlock(), createBlock(_component_el_popover, {
                          ...
                          reference: withCtx(() => [
                            createBaseVNode("span", {
                              ...
                              _cache[51] || (_cache[51] = createBaseVNode("span", { class: "dot" }, null, -1)),
                          ...
                          default: withCtx(() => [
                            createBaseVNode("div", _hoisted_43, [
                              (openBlock(), createElementBlock(Fragment, null, renderList(sentimentOptions, (opt) => {
                                ...
                                }, toDisplayString(opt.label), 11, _hoisted_44);
                              }), 64))
                            ])
                          ]),
                          _: 2
                      ...
                      createBaseVNode("td", _hoisted_46, [
                        ...
                        showAIBadge(row) ? (openBlock(), createElementBlock("span", _hoisted_47, "AI")) : createCommentVNode("", true)
                      ]),
                      ...
                      canDelete.value ? (openBlock(), createElementBlock("td", _hoisted_49, [
                        createBaseVNode("button", {
                          class: "op-del",
                  ...
                  rows.value.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_51, [
                    createBaseVNode("td", {
                      colspan: colCount.value,
                      class: "empty-row"
                    }, "暂无舆情数据", 8, _hoisted_52)
                  ])) : createCommentVNode("", true)
                ])
              ])
            ]),
            total.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_53, [
              createVNode(_component_Pager, {
                total: total.value,
                "current-page": page.value,
                "onUpdate:currentPage": _cache[16] || (_cache[16] = ($event) => page.value = $event),
                "page-size": size.value,
                onCurrentChange: onPageChange
              }, null, 8, ["total", "current-page", "page-size"])
            ])) : createCommentVNode("", true)
          ])
        ], 64)) : scope.value === "domestic" ? (openBlock(), createElementBlock("section", _hoisted_54, [
          _cache[78] || (_cache[78] = createBaseVNode("div", { class: "review-head" }, [
          ...
          createBaseVNode("div", _hoisted_55, [
            ...
            _cache[61] || (_cache[61] = createBaseVNode("span", { class: "muted review-filter-tip" }, "操作后不会丢失：已处理的舆情可在「已确认 / 已驳回 / 全部」中回看与追溯", -1)),
            reviewStatusFilter.value === "pending_review" ? (openBlock(), createElementBlock("div", _hoisted_56, [
              ...
              _cache[60] || (_cache[60] = createBaseVNode("span", { class: "muted review-toolbar-hint" }, "先勾选左侧复选框，再从「批量操作」中选择动作", -1))
            ])) : createCommentVNode("", true)
          ]),
          reviewsLoading.value ? (openBlock(), createElementBlock("div", _hoisted_58, "加载复核记录中…")) : (openBlock(), createElementBlock("div", _hoisted_59, [
            createBaseVNode("div", _hoisted_60, [
              createBaseVNode("table", _hoisted_61, [
                createBaseVNode("thead", null, [
                  createBaseVNode("tr", null, [
                    createBaseVNode("th", _hoisted_62, [
                      createBaseVNode("input", {
                        type: "checkbox",
                        class: "row-check",
                    ...
                    _cache[62] || (_cache[62] = createBaseVNode("th", null, "舆情标题", -1)),
                    _cache[63] || (_cache[63] = createBaseVNode("th", null, "来源", -1)),
                    _cache[64] || (_cache[64] = createBaseVNode("th", null, "发布时间", -1)),
                    _cache[65] || (_cache[65] = createBaseVNode("th", null, "规则风险", -1)),
                    _cache[66] || (_cache[66] = createBaseVNode("th", null, "AI 风险", -1)),
                    _cache[67] || (_cache[67] = createBaseVNode("th", null, "展示口径", -1)),
                    _cache[68] || (_cache[68] = createBaseVNode("th", null, "事件候选", -1)),
                    _cache[69] || (_cache[69] = createBaseVNode("th", null, "预警候选", -1)),
                    _cache[70] || (_cache[70] = createBaseVNode("th", null, "状态", -1)),
                    _cache[71] || (_cache[71] = createBaseVNode("th", { class: "review-op-th" }, "操作", -1))
                  ])
                ]),
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(reviews.value, (review) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_65, [
                        ...
                        }, toDisplayString(review.opinion_title || `舆情 #${review.opinion_id}`), 9, _hoisted_66)
                      ]),
                      ...
                      createBaseVNode("td", null, [
                        createBaseVNode("span", _hoisted_67, toDisplayString(review.rule_risk_snapshot?.risk_score ?? "-"), 1)
                      ]),
                      createBaseVNode("td", null, [
                        createBaseVNode("span", {
                          class: "risk-num",
                      ...
                      createBaseVNode("td", _hoisted_68, [
                        review.event_review_status === "confirmed" ? (openBlock(), createElementBlock("span", _hoisted_69, "已确认")) : (openBlock(), createElementBlock("span", _hoisted_70, toDisplayString(review.event_candidate_count), 1))
                      ]),
                      createBaseVNode("td", _hoisted_71, [
                        review.alert_review_status === "confirmed" ? (openBlock(), createElementBlock("span", _hoisted_72, "已确认")) : (openBlock(), createElementBlock("span", _hoisted_73, toDisplayString(review.alert_candidate_count), 1))
                      ]),
                      createBaseVNode("td", null, [
                        createBaseVNode("span", {
                  ...
                  !reviews.value.length ? (openBlock(), createElementBlock("tr", _hoisted_77, [..._cache[77] || (_cache[77] = [
                    createBaseVNode("td", {
                      colspan: "11",
                      class: "empty-row"
                    }, "暂无待复核记录", -1)
          ...
          reviewsTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_78, [
            createVNode(_component_Pager, {
              total: reviewsTotal.value,
              "current-page": reviewsPage.value,
              "onUpdate:currentPage": _cache[21] || (_cache[21] = ($event) => reviewsPage.value = $event),
        ...
        scope.value === "domestic" ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
          createVNode(BatchAIModal, {
            ...
            "onUpdate:visible": _cache[22] || (_cache[22] = ($event) => batchDialog.value = $event),
          ...
          batchHistoryDialog.value ? (openBlock(), createElementBlock("div", {
            key: 0,
            class: "modal-mask",
            onClick: _cache[24] || (_cache[24] = withModifiers(($event) => batchHistoryDialog.value = false, ["self"]))
          }, [
            createBaseVNode("div", _hoisted_79, [
              createBaseVNode("div", _hoisted_80, [
                _cache[79] || (_cache[79] = createBaseVNode("div", { class: "modal-title-wrap" }, [
                  createBaseVNode("span", { class: "modal-kicker" }, "AI 研判运行记录"),
                  createBaseVNode("h3", { class: "modal-title" }, "历史批次")
                ], -1)),
                createBaseVNode("button", {
                  class: "modal-close",
                  onClick: _cache[23] || (_cache[23] = ($event) => batchHistoryDialog.value = false)
                }, "✕")
              ]),
              createBaseVNode("div", _hoisted_81, [
                ...
                !batchRuns.value.length ? (openBlock(), createElementBlock("p", _hoisted_82, "暂无运行记录")) : createCommentVNode("", true)
              ])
            ])
          ])) : createCommentVNode("", true)
        ...
        createVNode(OpinionDetailModal, {
          ...
          "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => detailVisible.value = $event),
...
const Opinions = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b1479936"]]);
