...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      ...
      const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-BNJql6Jy.js').then(n => n.a6);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
      try {
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        scope.value === "domestic" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          createBaseVNode("div", _hoisted_3, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-f6b08c84>全部趋势</option><option value="rising" data-v-f6b08c84>↑ 升温</option><option value="stable" data-v-f6b08c84>→ 平稳</option><option value="falling" data-v-f6b08c84>↓ 下降</option><option value="unknown" data-v-f6b08c84>未知</option>', 5)
            ])], 544), [
        ...
        scope.value === "foreign" ? (openBlock(), createBlock(ForeignEventsView, { key: 1 })) : createCommentVNode("", true),
...
const Events = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f6b08c84"]]);
