...
const _hoisted_25 = { class: "fw-dash-grid" };
const _hoisted_26 = { class: "fw-card fw-card-trend fw-col-1" };
const _hoisted_27 = { class: "fw-card-head" };
const _hoisted_28 = { class: "fw-legend" };
const _hoisted_29 = ["onClick"];
const _hoisted_30 = {
  key: 0,
  class: "empty"
};
const _hoisted_31 = { class: "fw-card fw-card-alert fw-col-2" };
...
const _hoisted_36 = { class: "fw-alert-summary" };
const _hoisted_37 = { class: "fw-alert-sum" };
const _hoisted_38 = { class: "fw-alert-sum" };
const _hoisted_39 = { class: "fw-alert-list" };
const _hoisted_40 = ["onClick"];
const _hoisted_41 = { class: "fw-alert-main" };
const _hoisted_42 = { class: "fw-alert-title" };
const _hoisted_43 = { class: "fw-alert-meta" };
const _hoisted_44 = {
  key: 0,
  class: "fw-alert-copy"
};
const _hoisted_45 = { class: "fw-alert-list" };
const _hoisted_46 = ["onClick"];
const _hoisted_47 = { class: "fw-alert-main" };
const _hoisted_48 = { class: "fw-alert-title" };
const _hoisted_49 = { class: "fw-alert-meta" };
const _hoisted_50 = { class: "fw-card fw-card-source fw-col-1" };
const _hoisted_51 = { class: "fw-card-head" };
const _hoisted_52 = { class: "muted" };
const _hoisted_53 = {
  key: 0,
  class: "empty"
};
const _hoisted_54 = { class: "fw-card fw-col-2" };
const _hoisted_55 = {
  key: 0,
  class: "empty"
};
const _hoisted_56 = { class: "fw-card fw-card-hotword fw-col-1" };
...
const _hoisted_60 = { class: "fw-card fw-col-2" };
const _hoisted_61 = {
  key: 0,
  class: "empty"
};
...
const _hoisted_64 = { class: "distribution-row" };
const _hoisted_65 = {
  key: 1,
  class: "empty"
};
...
const _hoisted_71 = { class: "table-wrap tbl-scroll" };
const _hoisted_72 = ["onClick"];
const _hoisted_73 = { class: "title-cell" };
const _hoisted_74 = {
  key: 0,
  class: "muted"
};
const _hoisted_75 = { class: "actions" };
const _hoisted_76 = ["disabled", "onClick"];
...
const _hoisted_80 = { class: "alert-scope-note" };
...
const _hoisted_85 = { class: "subtabs" };
const _hoisted_86 = {
  key: 2,
  class: "table-wrap"
};
...
const _hoisted_99 = { class: "event-provenance" };
const _hoisted_100 = { key: 0 };
const _hoisted_101 = { class: "event-detail-head" };
...
const _hoisted_107 = { class: "event-metrics" };
...
const _hoisted_116 = { class: "table-wrap" };
const _hoisted_117 = { class: "title-cell" };
const _hoisted_118 = ["title", "onClick", "onKeydown"];
const _hoisted_119 = {
  key: 1,
  class: "alert-title"
};
const _hoisted_120 = { class: "muted" };
const _hoisted_121 = { class: "linked-cell" };
const _hoisted_122 = ["onClick"];
const _hoisted_123 = {
  key: 1,
  class: "muted"
};
const _hoisted_124 = { class: "actions" };
...
const _hoisted_131 = { class: "table-wrap" };
const _hoisted_132 = { class: "actions" };
...
const _hoisted_138 = { class: "detail history-dialog" };
...
const _hoisted_144 = { class: "detail rule-dialog" };
const _hoisted_145 = { class: "muted" };
const _hoisted_146 = ["disabled"];
const _hoisted_147 = { class: "rule-preview" };
const _hoisted_148 = { class: "actions" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
            ...
            createBaseVNode("div", _hoisted_25, [
              createBaseVNode("article", _hoisted_26, [
                createBaseVNode("header", _hoisted_27, [
                  _cache[40] || (_cache[40] = createBaseVNode("h3", null, "每日趋势", -1)),
                ...
                !(dashboardTrends.value?.items || []).length ? (openBlock(), createElementBlock("p", _hoisted_30, "该窗口内暂无趋势数据")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_31, [
                createBaseVNode("header", _hoisted_32, [
                  _cache[41] || (_cache[41] = createBaseVNode("h3", null, "外网告警", -1)),
                  createBaseVNode("span", _hoisted_33, "滚动播报 · 共 " + toDisplayString(alertFeed.value.length) + " 条", 1)
                ]),
                !alertFeed.value.length ? (openBlock(), createElementBlock("div", _hoisted_34, "该窗口内暂无外网告警")) : (openBlock(), createElementBlock("div", _hoisted_35, [
                  createBaseVNode("div", _hoisted_36, [
                    createBaseVNode("span", _hoisted_37, [
                      _cache[42] || (_cache[42] = createBaseVNode("i", { class: "fw-sum-dot is-amber" }, null, -1)),
                      createTextVNode("待处置 " + toDisplayString(alertPendingCount.value), 1)
                    ]),
                    createBaseVNode("span", _hoisted_38, [
                      _cache[43] || (_cache[43] = createBaseVNode("i", { class: "fw-sum-dot is-teal" }, null, -1)),
                  ...
                  createBaseVNode("div", {
                    ...
                    createBaseVNode("div", {
                        ...
                        (openBlock(true), createElementBlock(Fragment, null, renderList(alertFeed.value, (a) => {
                          return openBlock(), createElementBlock("li", {
                            ...
                            createBaseVNode("div", _hoisted_41, [
                              createBaseVNode("div", _hoisted_42, toDisplayString(a.title || "未命名告警"), 1),
                              createBaseVNode("div", _hoisted_43, toDisplayString(a.rule_snapshot?.name || a.source_name_snapshot || "外网告警") + " · " + toDisplayString(shortTime(a.triggered_at)), 1)
                            ]),
                            createBaseVNode("span", {
                      ...
                      alertNeedScroll.value ? (openBlock(), createElementBlock("div", _hoisted_44, [
                          ...
                          (openBlock(true), createElementBlock(Fragment, null, renderList(alertFeed.value, (a) => {
                            return openBlock(), createElementBlock("li", {
                              ...
                              createBaseVNode("div", _hoisted_47, [
                                createBaseVNode("div", _hoisted_48, toDisplayString(a.title || "未命名告警"), 1),
                                createBaseVNode("div", _hoisted_49, toDisplayString(a.rule_snapshot?.name || a.source_name_snapshot || "外网告警") + " · " + toDisplayString(shortTime(a.triggered_at)), 1)
                              ]),
                              createBaseVNode("span", {
                                class: normalizeClass(["fw-badge", isHandled(a.status) ? "is-teal" : "is-amber"])
                              }, toDisplayString(zh(a.status)), 3)
              ...
              createBaseVNode("article", _hoisted_50, [
                createBaseVNode("header", _hoisted_51, [
                  _cache[44] || (_cache[44] = createBaseVNode("h3", null, "数据源分布", -1)),
                  createBaseVNode("span", _hoisted_52, "近 " + toDisplayString(visualizationDays.value) + " 天 · 各来源文章量", 1)
                ]),
                withDirectives(createBaseVNode("div", {
                ...
                !(dashboardSources.value?.items || []).length ? (openBlock(), createElementBlock("p", _hoisted_53, "该窗口内暂无数据源分布")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_54, [
                ...
                !dashboardRisk.value || !Object.keys(dashboardRisk.value.risk_levels || {}).length ? (openBlock(), createElementBlock("p", _hoisted_55, "暂无已完成风险结果")) : createCommentVNode("", true)
              ]),
              ...
              createBaseVNode("article", _hoisted_60, [
                ...
                !dashboardEvents.value || !Object.keys(dashboardEvents.value.formal_events || {}).length ? (openBlock(), createElementBlock("p", _hoisted_61, "暂无外网事件")) : createCommentVNode("", true)
              ]),
              createBaseVNode("article", _hoisted_62, [
                _cache[50] || (_cache[50] = createBaseVNode("h3", null, "采集状态", -1)),
                dashboardSummary.value.collection.latest ? (openBlock(), createElementBlock("div", _hoisted_63, [
                ...
                !dashboardSummary.value.collection.latest ? (openBlock(), createElementBlock("p", _hoisted_65, "暂无外网采集记录")) : createCommentVNode("", true)
              ])
            ]),
        ...
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_68, [
          createBaseVNode("div", _hoisted_69, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-f1752ae1>全部语言</option><option value="zh" data-v-f1752ae1>中文</option><option value="en" data-v-f1752ae1>英文</option><option value="mixed" data-v-f1752ae1>中英混合</option><option value="unknown" data-v-f1752ae1>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-f1752ae1>全部风险等级</option><option value="high" data-v-f1752ae1>高</option><option value="medium" data-v-f1752ae1>中</option><option value="low" data-v-f1752ae1>低</option><option value="unknown" data-v-f1752ae1>未知</option>', 5)
            ])], 544), [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_73, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", null, [
                      ...
                      !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_74, "无")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_75, [
                      ...
                      }, "重新分析", 8, _hoisted_76)) : createCommentVNode("", true)
                    ])
                  ], 8, _hoisted_72);
                }), 128)),
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_77, [..._cache[56] || (_cache[56] = [
                  createBaseVNode("td", {
                    colspan: "14",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_78, [
        ...
        ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_79, [
          createBaseVNode("div", _hoisted_80, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
          createBaseVNode("div", _hoisted_81, [
            ...
            }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_82),
            _cache[58] || (_cache[58] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
          ]),
          eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_83, [
          ...
          eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_84, [
          ...
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_86, [
            createBaseVNode("table", null, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_88, [
                      ...
                      }, "确认", 8, _hoisted_89)) : createCommentVNode("", true),
                      row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn danger",
                        disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                        onClick: ($event) => rejectCandidate(row)
                      }, "拒绝", 8, _hoisted_90)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_91, [..._cache[61] || (_cache[61] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
            ...
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_97, [..._cache[63] || (_cache[63] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
          ...
          selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_98, [
            createBaseVNode("div", _hoisted_99, [
              ...
              selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_100, [
            ...
            createBaseVNode("p", _hoisted_106, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_108, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                createBaseVNode("a", {
                  href: opinion.url,
                  target: "_blank",
                  rel: "noreferrer",
        ...
        ])) : activeTab.value === "alerts" ? (openBlock(), createElementBlock("section", _hoisted_110, [
          createBaseVNode("div", _hoisted_111, "外网自动告警评估：" + toDisplayString(alertAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(alertAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 外部通知：" + toDisplayString(alertAutoStatus.value?.external_notifications_enabled ? "已启用" : "已停用"), 1),
          createBaseVNode("div", _hoisted_112, [
            ...
            }, toDisplayString(alertEvaluating.value ? "评估中..." : "手动 Dry-Run"), 9, _hoisted_113),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => alertFilters.status = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[67] || (_cache[67] = [
              createStaticVNode('<option value="" data-v-f1752ae1>全部状态</option><option value="triggered" data-v-f1752ae1>待处理</option><option value="acknowledged" data-v-f1752ae1>已确认</option><option value="resolved" data-v-f1752ae1>已解决</option><option value="suppressed" data-v-f1752ae1>已抑制</option><option value="failed" data-v-f1752ae1>失败</option>', 6)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-f1752ae1>全部严重度</option><option value="low" data-v-f1752ae1>低</option><option value="medium" data-v-f1752ae1>中</option><option value="high" data-v-f1752ae1>高</option><option value="critical" data-v-f1752ae1>紧急</option>', 5)
            ])], 544), [
          ...
          alertLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_114, [
          ...
          alertRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_115, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignAlerts.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_117, [
                      ...
                      }, toDisplayString(row.title || "无标题告警"), 41, _hoisted_118)) : (openBlock(), createElementBlock("strong", _hoisted_119, toDisplayString(row.title || "无标题告警"), 1)),
                      createBaseVNode("div", _hoisted_120, toDisplayString(row.message), 1)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_121, [
                      ...
                      }, toDisplayString(row.opinion_title_snapshot || "#" + row.foreign_opinion_id), 9, _hoisted_122)) : (openBlock(), createElementBlock("span", _hoisted_123, "-"))
                    ]),
                    ...
                    createBaseVNode("td", _hoisted_124, [
                      ...
                      }, "确认", 8, _hoisted_126)) : createCommentVNode("", true),
                      ...
                      }, "解决", 8, _hoisted_127)) : createCommentVNode("", true),
                      row.status === "triggered" || row.status === "acknowledged" ? (openBlock(), createElementBlock("button", {
                        key: 2,
                        class: "link-btn danger",
                      ...
                      }, "抑制", 8, _hoisted_128)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !foreignAlerts.value.length ? (openBlock(), createElementBlock("tr", _hoisted_129, [..._cache[72] || (_cache[72] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无外网告警记录", -1)
        ...
        ])) : activeTab.value === "alertRules" ? (openBlock(), createElementBlock("section", _hoisted_130, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(alertRules.value, (rule) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_132, [
                      createBaseVNode("button", {
                        class: "link-btn",
                      ...
                      }, "停用", 8, _hoisted_134)) : (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn",
                      ...
                      }, "删除", 8, _hoisted_136)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !alertRules.value.length ? (openBlock(), createElementBlock("tr", _hoisted_137, [..._cache[76] || (_cache[76] = [
                  createBaseVNode("td", {
                    colspan: "7",
                    class: "empty"
                  }, "暂无外网告警规则", -1)
        ...
        historyAlert.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_138, [
            ...
            createBaseVNode("p", _hoisted_139, toDisplayString(historyAlert.value.title || "告警 #" + historyAlert.value.id) + " · 当前状态：" + toDisplayString(zh(historyAlert.value.status)), 1),
            alertActionsLoading.value ? (openBlock(), createElementBlock("div", _hoisted_140, "处置历史加载中...")) : !alertActions.value.length ? (openBlock(), createElementBlock("div", _hoisted_141, "暂无处置历史")) : (openBlock(), createElementBlock("div", _hoisted_142, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(alertActions.value, (action) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_143, "操作人 #" + toDisplayString(action.actor_id ?? "-") + " · " + toDisplayString(formatTime(action.created_at)), 1)
                ]);
              }), 128))
            ]))
          ])
        ...
        alertRuleEditorVisible.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_144, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭规则编辑",
            ...
            createBaseVNode("label", null, [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="risk_score" data-v-f1752ae1>风险分</option><option value="risk_level" data-v-f1752ae1>风险等级</option><option value="risk_category" data-v-f1752ae1>风险类别</option><option value="confirmed_event" data-v-f1752ae1>确认事件</option><option value="keyword_combo" data-v-f1752ae1>关键词组合</option>', 5)
              ])], 512), [
            ...
            createBaseVNode("div", _hoisted_148, [
              ...
              }, toDisplayString(alertRuleSaving.value ? "保存中..." : "保存规则"), 9, _hoisted_149)
            ])
          ])
        ])) : createCommentVNode("", true),
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f1752ae1"]]);
