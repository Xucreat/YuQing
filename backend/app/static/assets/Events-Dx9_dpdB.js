const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C7B-CLbO.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, p as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, n as normalizeClass, b as withKeys, v as vModelText, B as createVNode, z as withCtx, T as Transition, A as createCommentVNode, e as createTextVNode, t as toDisplayString, F as Fragment, i as renderList, G as vModelSelect, N as createStaticVNode, r as ref, j as computed, g as api, E as ElMessage, O as pollTask, D as resolveDirective, o as openBlock, J as withModifiers, k as normalizeStyle, P as __vitePreload, _ as _export_sfc } from './index-MuSPuFCc.js';
...
const _hoisted_13 = { class: "tbl" };
const _hoisted_14 = ["onClick"];
const _hoisted_15 = { class: "t-title" };
const _hoisted_16 = { class: "col-center" };
const _hoisted_17 = {
  key: 0,
  class: "focus-mark"
};
const _hoisted_18 = { class: "col-center risk-num" };
...
const _hoisted_25 = { class: "p-info" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function trendText(value) {
      return { rising: "↑ 升温", stable: "→ 稳定", falling: "↓ 降温", unknown: "- 不足" }[value] || value;
    }
    function trendPill(value) {
      return { rising: "pill-red", stable: "pill-gray", falling: "pill-green", unknown: "pill-gray" }[value] || "pill-gray";
    }
    function statusText(s) {
      return { active: "关注中", verifying: "核查中", processing: "处理中", resolved: "已解决", closed: "已关闭" }[s] || s;
    }
    function statusPill(s) {
      return { active: "pill-green", verifying: "pill-orange", processing: "pill-orange", resolved: "pill-gray", closed: "pill-gray" }[s] || "pill-gray";
    }
    ...
    async function handleDelete(row) {
      try {
        const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-MuSPuFCc.js').then(n => n.Z);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          ...
          withDirectives(createBaseVNode("select", {
            ...
            createStaticVNode('<option value="" data-v-74c50425>全部状态</option><option value="active" data-v-74c50425>关注中</option><option value="verifying" data-v-74c50425>核查中</option><option value="processing" data-v-74c50425>处理中</option><option value="resolved" data-v-74c50425>已解决</option><option value="closed" data-v-74c50425>已关闭</option>', 6)
          ])], 544), [
          ...
          withDirectives(createBaseVNode("select", {
            ...
            createStaticVNode('<option value="" data-v-74c50425>全部趋势</option><option value="rising" data-v-74c50425>↑ 升温</option><option value="stable" data-v-74c50425>→ 平稳</option><option value="falling" data-v-74c50425>↓ 下降</option><option value="unknown" data-v-74c50425>未知</option>', 5)
          ])], 544), [
          ...
          }, toDisplayString(aggregating.value ? "聚合中..." : "手动聚合"), 9, _hoisted_10),
          createBaseVNode("button", {
            class: "btn btn-ghost",
            onClick: loadData
          }, "刷新"),
          lastResult.value ? (openBlock(), createElementBlock("span", _hoisted_11, " 聚合成功：新建 " + toDisplayString(lastResult.value.created) + " · 更新 " + toDisplayString(lastResult.value.updated) + " · 关联 " + toDisplayString(lastResult.value.linked), 1)) : createCommentVNode("", true)
        ]),
        createBaseVNode("div", _hoisted_12, [
          createBaseVNode("table", _hoisted_13, [
            _cache[26] || (_cache[26] = createBaseVNode("thead", null, [
              createBaseVNode("tr", null, [
                ...
                createBaseVNode("th", { style: { "width": "120px" } }, "地区"),
                createBaseVNode("th", { style: { "width": "120px" } }, "主题"),
                createBaseVNode("th", {
                  style: { "width": "120px" },
                  class: "col-center"
                }, "风险等级"),
            ...
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(rows.value, (row, idx) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", null, [
                    createBaseVNode("span", _hoisted_15, toDisplayString(row.title), 1)
                  ]),
                  createBaseVNode("td", null, toDisplayString(row.region_name || (row.region_id ? `地区 ${row.region_id}` : "-")), 1),
                  createBaseVNode("td", null, toDisplayString(topicText(row.topic_category)), 1),
              ...
              rows.value.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_23, [..._cache[25] || (_cache[25] = [
                createBaseVNode("td", {
                  colspan: "13",
                  class: "empty-row"
                }, "暂无事件数据", -1)
          ...
          total.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_24, [
            createBaseVNode("span", _hoisted_25, "共 " + toDisplayString(total.value) + " 条", 1),
            createBaseVNode("button", {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(pages.value, (p) => {
              ...
              }, toDisplayString(p), 11, _hoisted_27);
            }), 128)),
            createBaseVNode("button", {
...
const Events = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-74c50425"]]);
