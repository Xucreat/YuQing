...
const _hoisted_96 = ["title", "onClick", "onKeydown"];
const _hoisted_97 = {
  key: 1,
  class: "alert-title"
};
const _hoisted_98 = { class: "muted" };
const _hoisted_99 = { class: "linked-cell" };
const _hoisted_100 = ["onClick"];
const _hoisted_101 = {
  key: 1,
  class: "muted"
};
const _hoisted_102 = { class: "actions" };
...
const _hoisted_109 = { class: "table-wrap" };
...
const _hoisted_116 = { class: "detail history-dialog" };
...
const _hoisted_122 = { class: "detail rule-dialog" };
const _hoisted_123 = { class: "muted" };
const _hoisted_124 = ["disabled"];
const _hoisted_125 = { class: "rule-preview" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_46, [
          createBaseVNode("div", _hoisted_47, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-40072466>全部语言</option><option value="zh" data-v-40072466>中文</option><option value="en" data-v-40072466>英文</option><option value="mixed" data-v-40072466>中英混合</option><option value="unknown" data-v-40072466>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-40072466>全部风险等级</option><option value="high" data-v-40072466>高</option><option value="medium" data-v-40072466>中</option><option value="low" data-v-40072466>低</option><option value="unknown" data-v-40072466>未知</option>', 5)
            ])], 544), [
          ...
          createBaseVNode("div", _hoisted_90, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-40072466>全部状态</option><option value="triggered" data-v-40072466>待处理</option><option value="acknowledged" data-v-40072466>已确认</option><option value="resolved" data-v-40072466>已解决</option><option value="suppressed" data-v-40072466>已抑制</option><option value="failed" data-v-40072466>失败</option>', 6)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-40072466>全部严重度</option><option value="low" data-v-40072466>低</option><option value="medium" data-v-40072466>中</option><option value="high" data-v-40072466>高</option><option value="critical" data-v-40072466>紧急</option>', 5)
            ])], 544), [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignAlerts.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_95, [
                      ...
                      }, toDisplayString(row.title || "无标题告警"), 41, _hoisted_96)) : (openBlock(), createElementBlock("strong", _hoisted_97, toDisplayString(row.title || "无标题告警"), 1)),
                      createBaseVNode("div", _hoisted_98, toDisplayString(row.message), 1)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_99, [
                      ...
                      }, toDisplayString(row.opinion_title_snapshot || "#" + row.foreign_opinion_id), 9, _hoisted_100)) : (openBlock(), createElementBlock("span", _hoisted_101, "-"))
                    ]),
                    ...
                    createBaseVNode("td", _hoisted_102, [
                      ...
                      }, "确认", 8, _hoisted_104)) : createCommentVNode("", true),
                      ...
                      }, "解决", 8, _hoisted_105)) : createCommentVNode("", true),
                      row.status === "triggered" || row.status === "acknowledged" ? (openBlock(), createElementBlock("button", {
                        key: 2,
                        class: "link-btn danger",
                      ...
                      }, "抑制", 8, _hoisted_106)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !foreignAlerts.value.length ? (openBlock(), createElementBlock("tr", _hoisted_107, [..._cache[69] || (_cache[69] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无外网告警记录", -1)
        ...
        ])) : activeTab.value === "alertRules" ? (openBlock(), createElementBlock("section", _hoisted_108, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(alertRules.value, (rule) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_110, [
                      ...
                      }, "停用", 8, _hoisted_112)) : (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn",
                      ...
                      }, "删除", 8, _hoisted_114)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !alertRules.value.length ? (openBlock(), createElementBlock("tr", _hoisted_115, [..._cache[73] || (_cache[73] = [
                  createBaseVNode("td", {
                    colspan: "7",
                    class: "empty"
                  }, "暂无外网告警规则", -1)
        ...
        historyAlert.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_116, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭处置历史",
            ...
            createBaseVNode("p", _hoisted_117, toDisplayString(historyAlert.value.title || "告警 #" + historyAlert.value.id) + " · 当前状态：" + toDisplayString(zh(historyAlert.value.status)), 1),
            alertActionsLoading.value ? (openBlock(), createElementBlock("div", _hoisted_118, "处置历史加载中...")) : !alertActions.value.length ? (openBlock(), createElementBlock("div", _hoisted_119, "暂无处置历史")) : (openBlock(), createElementBlock("div", _hoisted_120, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(alertActions.value, (action) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_121, "操作人 #" + toDisplayString(action.actor_id ?? "-") + " · " + toDisplayString(formatTime(action.created_at)), 1)
                ]);
              }), 128))
            ]))
          ])
        ...
        alertRuleEditorVisible.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("article", _hoisted_122, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭规则编辑",
            ...
            createBaseVNode("label", null, [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="risk_score" data-v-40072466>风险分</option><option value="risk_level" data-v-40072466>风险等级</option><option value="risk_category" data-v-40072466>风险类别</option><option value="confirmed_event" data-v-40072466>确认事件</option><option value="keyword_combo" data-v-40072466>关键词组合</option>', 5)
              ])], 512), [
            ...
            createBaseVNode("div", _hoisted_126, [
              ...
              }, toDisplayString(alertRuleSaving.value ? "保存中..." : "保存规则"), 9, _hoisted_127)
            ])
          ])
        ])) : createCommentVNode("", true),
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-40072466"]]);
