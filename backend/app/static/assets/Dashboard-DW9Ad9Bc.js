import { g as api, d as defineComponent, c as createElementBlock, F as Fragment, i as renderList, o as openBlock, n as normalizeClass, t as toDisplayString, _ as _export_sfc, a as createBaseVNode, j as computed, k as normalizeStyle, l as useModel, m as createVNode, p as withCtx, e as createTextVNode, q as createBlock, s as createCommentVNode, x as mergeModels, r as ref, y as resolveComponent, z as usePermission, A as watch, w as withDirectives, E as ElMessage, B as resolveDirective, C as onMounted, D as nextTick, G as onBeforeUnmount, H as unref, I as vShow, J as cockpitScope, K as KeepAlive, f as reactive, h as useRouter, L as useRoute } from './index-CL6LKzp8.js';
import { i as init, L as LinearGradient } from './index-F2TANFn2.js';
import ForeignWorkspace from './ForeignWorkspace-TmRpbyD8.js';
import { t as topicValueFromLabel, e as eventStatusPill, a as eventStatusLabel } from './EventDispositionDialog-Co-YGOI4.js';
import { O as OpinionDetailModal } from './OpinionDetailModal-DAJzgOen.js';
import './ForeignOpinionDetailModal-MjBhGkid.js';
import './opinion-Cag9WtuS.js';
import './ForeignOpinionListView-BKHTiYA1.js';
import './ForeignEventsView-BZeIyXIK.js';
...
const _hoisted_2 = { class: "cs-domestic" };
const _hoisted_3 = {
  class: "kpi-row",
  "aria-label": "核心指标"
};
const _hoisted_4 = { class: "kpi-card kpi-blue" };
const _hoisted_5 = { class: "kpi-body" };
const _hoisted_6 = { class: "kpi-value" };
const _hoisted_7 = { class: "kpi-card kpi-green" };
const _hoisted_8 = { class: "kpi-body" };
const _hoisted_9 = { class: "kpi-value" };
const _hoisted_10 = { class: "kpi-card kpi-red" };
const _hoisted_11 = { class: "kpi-body" };
const _hoisted_12 = { class: "kpi-value danger" };
const _hoisted_13 = { class: "kpi-card kpi-amber" };
const _hoisted_14 = { class: "kpi-body" };
const _hoisted_15 = { class: "kpi-value" };
const _hoisted_16 = { class: "kpi-body" };
const _hoisted_17 = { class: "kpi-value kpi-status-val" };
const _hoisted_18 = { class: "kpi-foot" };
const _hoisted_19 = { class: "sit-left" };
const _hoisted_20 = { class: "sit-level" };
const _hoisted_21 = { class: "sit-text" };
const _hoisted_22 = { class: "sit-kpis" };
const _hoisted_23 = { class: "sit-kpi" };
const _hoisted_24 = { class: "k" };
const _hoisted_25 = { class: "sit-kpi" };
const _hoisted_26 = { class: "k danger" };
const _hoisted_27 = { class: "sit-kpi" };
const _hoisted_28 = { class: "k" };
const _hoisted_29 = { class: "sit-kpi" };
const _hoisted_30 = { class: "k" };
const _hoisted_31 = { class: "sit-kpi" };
const _hoisted_32 = { class: "k" };
const _hoisted_33 = {
  key: 0,
  class: "sit-action"
};
const _hoisted_34 = { class: "widget-grid" };
const _hoisted_35 = { class: "card widget widget-trend" };
const _hoisted_36 = { class: "w-head" };
const _hoisted_37 = { class: "card widget widget-alert" };
const _hoisted_38 = { class: "scroll-wrap" };
const _hoisted_39 = ["title", "onClick"];
const _hoisted_40 = { class: "ai-body" };
const _hoisted_41 = { class: "ai-title" };
const _hoisted_42 = { class: "ai-meta" };
const _hoisted_43 = {
  key: 0,
  class: "feed-empty"
};
const _hoisted_44 = { class: "card widget widget-source" };
const _hoisted_45 = { class: "card widget widget-sentiment" };
const _hoisted_46 = { class: "card widget widget-feed" };
const _hoisted_47 = { class: "scroll-wrap" };
const _hoisted_48 = ["onClick"];
const _hoisted_49 = { class: "fi-body" };
const _hoisted_50 = { class: "fi-title" };
const _hoisted_51 = { class: "fi-meta" };
const _hoisted_52 = {
  key: 0,
  class: "feed-empty"
};
const _hoisted_53 = { class: "card widget widget-word" };
const _hoisted_54 = { class: "w-head" };
const _hoisted_55 = { class: "card widget widget-geo" };
const _hoisted_56 = {
  key: 0,
  class: "cs-foreign-wrap"
};
const _hoisted_57 = { class: "ht-body" };
const _hoisted_58 = {
  key: 0,
  class: "ht-error"
};
const _hoisted_59 = ["onClick"];
const _hoisted_60 = { class: "ht-event-head" };
const _hoisted_61 = { class: "ht-event-title" };
const _hoisted_62 = { class: "ht-event-meta" };
const _hoisted_63 = {
  key: 0,
  class: "ht-empty"
};
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        withDirectives(createBaseVNode("div", _hoisted_2, [
          createBaseVNode("section", _hoisted_3, [
            createBaseVNode("article", _hoisted_4, [
              ...
              createBaseVNode("div", _hoisted_5, [
                ...
                createBaseVNode("div", _hoisted_6, toDisplayString(stats.total.toLocaleString()), 1),
            ...
            createBaseVNode("article", _hoisted_7, [
              ...
              createBaseVNode("div", _hoisted_8, [
                ...
                createBaseVNode("div", _hoisted_9, toDisplayString(stats.today.toLocaleString()), 1),
            ...
            createBaseVNode("article", _hoisted_10, [
              ...
              createBaseVNode("div", _hoisted_11, [
                ...
                createBaseVNode("div", _hoisted_12, toDisplayString(stats.high_risk.toLocaleString()), 1),
            ...
            createBaseVNode("article", _hoisted_13, [
              ...
              createBaseVNode("div", _hoisted_14, [
                ...
                createBaseVNode("div", _hoisted_15, toDisplayString((stats.event_count || 0).toLocaleString()), 1),
            ...
            createBaseVNode("article", {
              ...
              createBaseVNode("div", _hoisted_16, [
                ...
                createBaseVNode("div", _hoisted_18, toDisplayString(collectorLastRun.value), 1)
              ])
            ], 2)
          ]),
          createBaseVNode("section", {
            ...
            createBaseVNode("div", _hoisted_19, [
              ...
              createBaseVNode("div", _hoisted_21, toDisplayString(situationText.value), 1)
            ]),
            createBaseVNode("div", _hoisted_22, [
              createBaseVNode("div", _hoisted_23, [
                createBaseVNode("span", _hoisted_24, toDisplayString(stats.total.toLocaleString()), 1),
                _cache[21] || (_cache[21] = createBaseVNode("span", { class: "l" }, "总舆情", -1))
              ]),
              createBaseVNode("div", _hoisted_25, [
                createBaseVNode("span", _hoisted_26, toDisplayString(stats.high_risk.toLocaleString()), 1),
                _cache[22] || (_cache[22] = createBaseVNode("span", { class: "l" }, "高风险", -1))
              ]),
              createBaseVNode("div", _hoisted_27, [
                createBaseVNode("span", _hoisted_28, toDisplayString(riskRate.value) + "%", 1),
                _cache[23] || (_cache[23] = createBaseVNode("span", { class: "l" }, "风险率", -1))
              ]),
              createBaseVNode("div", _hoisted_29, [
                createBaseVNode("span", _hoisted_30, toDisplayString(negativeRate.value) + "%", 1),
                _cache[24] || (_cache[24] = createBaseVNode("span", { class: "l" }, "负面率", -1))
              ]),
              createBaseVNode("div", _hoisted_31, [
                createBaseVNode("span", _hoisted_32, toDisplayString((stats.event_count || 0).toLocaleString()), 1),
                _cache[25] || (_cache[25] = createBaseVNode("span", { class: "l" }, "事件", -1))
              ])
            ]),
            unref(can)("reports:read") || unref(can)("reports:export") ? (openBlock(), createElementBlock("div", _hoisted_33, [
          ...
          createBaseVNode("section", _hoisted_34, [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(doubledAlerts.value, (a, i) => {
                    return openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", _hoisted_40, [
                        createBaseVNode("div", _hoisted_41, toDisplayString(a.opinion_title || a.rule_name), 1),
                        createBaseVNode("div", _hoisted_42, toDisplayString(a.rule_name) + " · " + toDisplayString(fmtTime(a.created_at)) + toDisplayString(a.handled ? " · 已处置" : ""), 1)
                      ])
                    ], 10, _hoisted_39);
                  }), 128))
                ], 4),
                !alerts.value.length ? (openBlock(), createElementBlock("div", _hoisted_43, "暂无预警")) : createCommentVNode("", true)
              ])
            ]),
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(doubledNews.value, (n, i) => {
                    return openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", _hoisted_49, [
                        createBaseVNode("div", _hoisted_50, toDisplayString(n.title), 1),
                        createBaseVNode("div", _hoisted_51, toDisplayString(n.source) + " · " + toDisplayString(n.region_name) + " · " + toDisplayString(fmtTime(n.created_at)) + " · 风险 " + toDisplayString(n.risk_score), 1)
                      ])
                    ], 8, _hoisted_48);
                  }), 128))
                ], 4),
                !recentNews.value.length ? (openBlock(), createElementBlock("div", _hoisted_52, "暂无实时快讯")) : createCommentVNode("", true)
              ])
            ]),
            ...
            createBaseVNode("article", _hoisted_55, [
          ...
          [vShow, unref(scope) === "domestic"]
        ]),
        (openBlock(), createBlock(KeepAlive, null, [
          unref(scope) === "foreign" ? (openBlock(), createElementBlock("div", _hoisted_56, [
            createVNode(ForeignWorkspace)
          ])) : createCommentVNode("", true)
        ], 1024)),
        ...
        createVNode(_component_el_drawer, {
          ...
          default: withCtx(() => [
            withDirectives((openBlock(), createElementBlock("div", _hoisted_57, [
              hotTopicError.value ? (openBlock(), createElementBlock("div", _hoisted_58, toDisplayString(hotTopicError.value), 1)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(hotTopicEvents.value, (ev) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_60, [
                      createBaseVNode("span", _hoisted_61, toDisplayString(ev.title), 1),
                      createBaseVNode("span", {
                ...
                !hotTopicLoading.value && hotTopicEvents.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_63, " 暂无相关事件 ")) : createCommentVNode("", true)
              ], 64))
            ])), [
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-72c09135"]]);
