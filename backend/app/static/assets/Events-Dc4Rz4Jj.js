...
import { d as defineComponent, p as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, n as normalizeClass, b as withKeys, v as vModelText, B as createVNode, z as withCtx, T as Transition, A as createCommentVNode, e as createTextVNode, t as toDisplayString, F as Fragment, i as renderList, r as ref, j as computed, g as api, E as ElMessage, N as pollTask, D as resolveDirective, o as openBlock, J as withModifiers, k as normalizeStyle, O as __vitePreload, _ as _export_sfc } from './index-DYwSRqnI.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      try {
        const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-DYwSRqnI.js').then(n => n.Y);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
            ...
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(rows.value, (row, idx) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", _hoisted_16, toDisplayString(row.heat_score), 1),
                  createBaseVNode("td", _hoisted_17, [
                    createBaseVNode("span", {
                      class: normalizeClass(["pill", trendPill(row.trend)])
                    }, toDisplayString(trendText(row.trend)), 3)
                  ]),
                  createBaseVNode("td", _hoisted_18, toDisplayString(row.opinion_count), 1),
              ...
              rows.value.length === 0 && !loading.value ? (openBlock(), createElementBlock("tr", _hoisted_21, [..._cache[16] || (_cache[16] = [
                createBaseVNode("td", {
                  colspan: "11",
                  class: "empty-row"
                }, "暂无事件数据", -1)
...
const Events = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-082d6e04"]]);
