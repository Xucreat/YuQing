...
const _hoisted_17$1 = { class: "card card-pad eff-card" };
...
const _hoisted_24$1 = { class: "report-body" };
const _hoisted_25$1 = { class: "report-p report-muted" };
const _hoisted_26$1 = {
  key: 0,
  class: "dual-row"
};
const _hoisted_27$1 = { class: "dual-val" };
const _hoisted_28$1 = {
  key: 0,
  class: "dual-sub"
};
...
const _hoisted_30$1 = { class: "dual-val" };
const _hoisted_31$1 = {
  key: 2,
  class: "dual-row"
};
const _hoisted_32$1 = { class: "dual-val" };
const _hoisted_33$1 = {
  key: 0,
  class: "dual-sub"
};
const _hoisted_34$1 = { class: "card card-pad sys-card" };
const _hoisted_35$1 = { class: "ai-header" };
const _hoisted_36$1 = { class: "report-meta" };
const _hoisted_37$1 = { class: "meta-item" };
const _hoisted_38$1 = { class: "meta-item" };
const _hoisted_39$1 = { class: "meta-item" };
const _hoisted_40$1 = { class: "report-body" };
const _hoisted_41$1 = {
  key: 0,
  class: "report-p"
};
...
const _hoisted_44$1 = { class: "card card-pad ai-card" };
const _hoisted_45$1 = { class: "ai-header" };
const _hoisted_46$1 = { class: "ai-header-tools" };
const _hoisted_47$1 = { class: "report-meta" };
const _hoisted_48$1 = { class: "meta-item" };
const _hoisted_49$1 = { class: "meta-item" };
const _hoisted_50$1 = { class: "meta-item" };
const _hoisted_51$1 = { class: "report-body" };
const _hoisted_52$1 = {
  key: 0,
  class: "report-p"
};
...
const _hoisted_59$1 = { class: "ai-header" };
const _hoisted_60$1 = {
  key: 0,
  class: "report-p"
};
...
const _hoisted_65$1 = { class: "modal-card history-modal" };
const _hoisted_66$1 = { class: "modal-header" };
const _hoisted_67$1 = { class: "modal-body" };
const _hoisted_68$1 = {
  key: 0,
  class: "history-list"
};
const _hoisted_69$1 = { class: "error-cell" };
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const effectiveRiskSource = computed(() => effectiveRisk.value?.source === "ai" ? "ai" : "rule");
    ...
    const effectiveRiskDesc = computed(() => {
      if (effectiveRiskSource.value === "ai") {
        return "该风险由人工 AI 研判触发且关联告警仍在生效，作为当前对外展示的有效风险。";
      }
      if (effectiveRiskReason.value === "not_analyzed") {
        return "该外网舆情尚未完成任何风险评估。";
      }
      return "当前以系统规则研判为有效风险（无生效中的 AI 告警），AI 研判结果仅作为历史保留。";
    });
                ...
                createBaseVNode("div", _hoisted_9$1, [
                  ...
                  createBaseVNode("div", _hoisted_11$1, [
                    detail.value.matched_keywords && detail.value.matched_keywords.length ? (openBlock(), createElementBlock("p", _hoisted_12$1, [
                      _cache[6] || (_cache[6] = createBaseVNode("span", { class: "kw-label" }, "命中关键词", -1)),
                ...
                createBaseVNode("div", _hoisted_16$1, [
                  createBaseVNode("div", _hoisted_17$1, [
                    createBaseVNode("div", _hoisted_18$1, [
                      _cache[8] || (_cache[8] = createBaseVNode("span", { class: "section-title" }, "当前有效风险", -1)),
                      createBaseVNode("span", {
                        class: normalizeClass(["src-tag", effectiveRiskSource.value === "ai" ? "src-tag-ai" : "src-tag-rule"])
                      }, toDisplayString(effectiveRiskSourceLabel.value), 3)
                    ]),
                    _cache[16] || (_cache[16] = createBaseVNode("div", { class: "detail-divider" }, null, -1)),
                    createBaseVNode("div", _hoisted_19$1, [
                      createBaseVNode("span", _hoisted_20$1, [
                        _cache[9] || (_cache[9] = createTextVNode("风险评分 ", -1)),
                        createBaseVNode("b", {
                          style: normalizeStyle({ color: unref(riskColor)(effectiveRiskScore.value ?? 0) })
                        }, toDisplayString(effectiveRiskScore.value ?? "-"), 5)
                      ]),
                      _cache[12] || (_cache[12] = createBaseVNode("span", { class: "meta-sep" }, "·", -1)),
                      createBaseVNode("span", _hoisted_21$1, [
                        _cache[10] || (_cache[10] = createTextVNode("等级 ", -1)),
                        createBaseVNode("b", null, toDisplayString(riskLevelZh(effectiveRiskLevel.value)), 1)
                      ]),
                      effectiveRiskReason.value ? (openBlock(), createElementBlock("span", _hoisted_22$1, "·")) : createCommentVNode("", true),
                      effectiveRiskReason.value ? (openBlock(), createElementBlock("span", _hoisted_23$1, [
                        _cache[11] || (_cache[11] = createTextVNode("依据 ", -1)),
                        createBaseVNode("b", null, toDisplayString(effectiveRiskReasonText.value), 1)
                      ])) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("div", _hoisted_24$1, [
                      createBaseVNode("p", _hoisted_25$1, toDisplayString(effectiveRiskDesc.value), 1)
                    ]),
                    detail.value.rule_risk ? (openBlock(), createElementBlock("div", _hoisted_26$1, [
                      _cache[13] || (_cache[13] = createBaseVNode("span", { class: "dual-label" }, "规则基线", -1)),
                      createBaseVNode("span", _hoisted_27$1, [
                        ...
                        detail.value.rule_risk.risk_category ? (openBlock(), createElementBlock("span", _hoisted_28$1, "· " + toDisplayString(detail.value.rule_risk.risk_category), 1)) : createCommentVNode("", true)
                      ])
                    ])) : createCommentVNode("", true),
                    detail.value.latest_ai_risk ? (openBlock(), createElementBlock("div", _hoisted_29$1, [
                      _cache[14] || (_cache[14] = createBaseVNode("span", { class: "dual-label" }, "AI 研判", -1)),
                      createBaseVNode("span", _hoisted_30$1, [
                        ...
                        createBaseVNode("span", {
                          class: normalizeClass(["dual-flag", detail.value.latest_ai_risk.in_effect ? "flag-on" : "flag-off"])
                        }, toDisplayString(detail.value.latest_ai_risk.in_effect ? "当前生效" : "仅历史"), 3)
                      ])
                    ])) : createCommentVNode("", true),
                    detail.value.alert ? (openBlock(), createElementBlock("div", _hoisted_31$1, [
                      _cache[15] || (_cache[15] = createBaseVNode("span", { class: "dual-label" }, "关联告警", -1)),
                      createBaseVNode("span", _hoisted_32$1, [
                        ...
                        detail.value.alert.expires_at ? (openBlock(), createElementBlock("span", _hoisted_33$1, " · 有效期至 " + toDisplayString(unref(formatTime)(detail.value.alert.expires_at)), 1)) : createCommentVNode("", true)
                      ])
                    ])) : createCommentVNode("", true)
                  ]),
                  createBaseVNode("div", _hoisted_34$1, [
                    createBaseVNode("div", _hoisted_35$1, [
                      _cache[17] || (_cache[17] = createBaseVNode("span", { class: "section-title" }, "系统规则研判", -1)),
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("div", _hoisted_36$1, [
                      createBaseVNode("span", _hoisted_37$1, [
                        _cache[18] || (_cache[18] = createTextVNode("风险评分 ", -1)),
                        createBaseVNode("b", {
                      ...
                      _cache[21] || (_cache[21] = createBaseVNode("span", { class: "meta-sep" }, "·", -1)),
                      createBaseVNode("span", _hoisted_38$1, [
                        _cache[19] || (_cache[19] = createTextVNode("等级 ", -1)),
                      ...
                      createBaseVNode("span", _hoisted_39$1, [
                        _cache[20] || (_cache[20] = createTextVNode("风险类别 ", -1)),
                        createBaseVNode("b", null, toDisplayString(detail.value.rule_result?.risk_category || "-"), 1)
                      ])
                    ]),
                    createBaseVNode("div", _hoisted_40$1, [
                      detail.value.rule_result?.explanation ? (openBlock(), createElementBlock("p", _hoisted_41$1, toDisplayString(detail.value.rule_result.explanation), 1)) : (openBlock(), createElementBlock("p", _hoisted_42$1, "暂无规则研判解释。"))
                    ]),
                    ruleTermHits.value.length ? (openBlock(), createElementBlock("div", _hoisted_43$1, [
                      _cache[23] || (_cache[23] = createBaseVNode("span", { class: "kw-label" }, "命中风险词", -1)),
                  ...
                  createBaseVNode("div", _hoisted_44$1, [
                    createBaseVNode("div", _hoisted_45$1, [
                      _cache[25] || (_cache[25] = createBaseVNode("span", { class: "section-title" }, "AI 研判报告", -1)),
                      createBaseVNode("div", _hoisted_46$1, [
                        ...
                        detail.value.analysis_runs && detail.value.analysis_runs.length ? (openBlock(), createElementBlock("button", {
                          ...
                          onClick: _cache[0] || (_cache[0] = ($event) => showHistoryModal.value = true)
                        }, "查看分析历史")) : createCommentVNode("", true)
                      ])
                    ]),
                    _cache[31] || (_cache[31] = createBaseVNode("div", { class: "detail-divider" }, null, -1)),
                    createBaseVNode("div", _hoisted_47$1, [
                      createBaseVNode("span", _hoisted_48$1, [
                        _cache[26] || (_cache[26] = createTextVNode("风险评分 ", -1)),
                        createBaseVNode("b", {
                      ...
                      _cache[29] || (_cache[29] = createBaseVNode("span", { class: "meta-sep" }, "·", -1)),
                      createBaseVNode("span", _hoisted_49$1, [
                        _cache[27] || (_cache[27] = createTextVNode("情感 ", -1)),
                        createBaseVNode("b", null, toDisplayString(unref(sentimentText)(detail.value.ai_result?.sentiment || "unknown")), 1)
                      ]),
                      _cache[30] || (_cache[30] = createBaseVNode("span", { class: "meta-sep" }, "·", -1)),
                      createBaseVNode("span", _hoisted_50$1, [
                        _cache[28] || (_cache[28] = createTextVNode("模型 ", -1)),
                    ...
                    createBaseVNode("div", _hoisted_51$1, [
                      detail.value.ai_result?.status === "completed" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                        detail.value.ai_result.summary ? (openBlock(), createElementBlock("p", _hoisted_52$1, toDisplayString(detail.value.ai_result.summary), 1)) : createCommentVNode("", true),
                        detail.value.ai_result.suggestion ? (openBlock(), createElementBlock("p", _hoisted_53$1, toDisplayString(detail.value.ai_result.suggestion), 1)) : createCommentVNode("", true)
                      ], 64)) : detail.value.ai_result?.status === "failed" ? (openBlock(), createElementBlock("p", _hoisted_54$1, " AI 分析失败：" + toDisplayString(detail.value.ai_result.error_message || "请稍后重试"), 1)) : (openBlock(), createElementBlock("p", _hoisted_55$1, "尚未生成 AI 研判报告，点击下方按钮触发分析。"))
                    ]),
                    canAnalyzeAI.value || detail.value.ai_result?.status === "processing" ? (openBlock(), createElementBlock("div", _hoisted_56$1, [
                      ...
                      }, toDisplayString(analyzing.value ? "分析中..." : detail.value.ai_result?.status === "completed" ? "重新触发 AI 分析" : "触发 AI 分析"), 9, _hoisted_57$1)) : createCommentVNode("", true)
                    ])) : createCommentVNode("", true)
                  ]),
                  detail.value.ai_result?.status === "completed" ? (openBlock(), createElementBlock("div", _hoisted_58$1, [
                    createBaseVNode("div", _hoisted_59$1, [
                      _cache[32] || (_cache[32] = createBaseVNode("span", { class: "section-title" }, "AI 告警准入", -1)),
                      createBaseVNode("span", {
                    ...
                    _cache[34] || (_cache[34] = createBaseVNode("p", { class: "report-p report-muted" }, "决定该外网舆情是否参与 AI 告警评估。", -1)),
                    detail.value.ai_alert_admission?.note ? (openBlock(), createElementBlock("p", _hoisted_60$1, "备注：" + toDisplayString(detail.value.ai_alert_admission.note), 1)) : createCommentVNode("", true),
                    canAdmitAI.value ? (openBlock(), createElementBlock("div", _hoisted_61$1, [
                      createBaseVNode("button", {
                        class: "btn btn-secondary",
                        disabled: admissionSaving.value,
                        onClick: _cache[1] || (_cache[1] = ($event) => setAdmission(true))
                      }, "纳入评估", 8, _hoisted_62$1),
                      createBaseVNode("button", {
                        class: "btn btn-secondary",
                        disabled: admissionSaving.value,
                        onClick: _cache[2] || (_cache[2] = ($event) => setAdmission(false))
                      }, "取消纳入", 8, _hoisted_63$1)
                    ])) : createCommentVNode("", true),
                    detail.value.ai_alert_admission_actions && detail.value.ai_alert_admission_actions.length ? (openBlock(), createElementBlock("div", _hoisted_64$1, [
        ...
        showHistoryModal.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_65$1, [
            createBaseVNode("div", _hoisted_66$1, [
              _cache[35] || (_cache[35] = createBaseVNode("div", { class: "modal-title-wrap" }, [
            ...
            createBaseVNode("div", _hoisted_67$1, [
              detail.value && detail.value.analysis_runs && detail.value.analysis_runs.length ? (openBlock(), createElementBlock("div", _hoisted_68$1, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(detail.value.analysis_runs, (run) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("span", _hoisted_69$1, toDisplayString(run.error_message || ""), 1)
                  ]);
                }), 128))
              ])) : (openBlock(), createBlock(_component_el_empty, {
                key: 1,
...
const ForeignOpinionDetailModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a3400698"]]);
...
const _hoisted_74 = { class: "table-wrap" };
const _hoisted_75 = ["onClick"];
const _hoisted_76 = ["checked", "disabled", "onChange"];
const _hoisted_77 = ["onUpdate:modelValue", "onChange"];
...
const _hoisted_85 = { class: "table-wrap tbl-scroll" };
const _hoisted_86 = ["onClick"];
const _hoisted_87 = { class: "title-cell" };
const _hoisted_88 = { class: "dual-cell" };
...
const _hoisted_96 = { class: "alert-scope-note" };
const _hoisted_97 = { class: "toolbar" };
...
const _hoisted_101 = { class: "subtabs" };
const _hoisted_102 = {
  key: 2,
  class: "table-wrap"
};
const _hoisted_103 = { class: "title-cell" };
const _hoisted_104 = { class: "actions" };
...
const _hoisted_115 = { class: "event-provenance" };
const _hoisted_116 = { key: 0 };
const _hoisted_117 = { class: "event-detail-head" };
const _hoisted_118 = { class: "actions" };
const _hoisted_119 = ["disabled"];
const _hoisted_120 = ["disabled"];
const _hoisted_121 = ["disabled"];
const _hoisted_122 = { class: "muted" };
const _hoisted_123 = { class: "event-metrics" };
const _hoisted_124 = { class: "muted" };
const _hoisted_125 = ["href"];
const _hoisted_126 = {
  key: 4,
  class: "panel"
};
const _hoisted_127 = { class: "alert-scope-note" };
const _hoisted_128 = { class: "toolbar" };
...
const _hoisted_132 = { class: "table-wrap" };
const _hoisted_133 = { class: "title-cell" };
const _hoisted_134 = ["title", "onClick", "onKeydown"];
const _hoisted_135 = {
  key: 1,
  class: "alert-title"
};
const _hoisted_136 = { class: "muted" };
const _hoisted_137 = { class: "linked-cell" };
const _hoisted_138 = ["onClick"];
const _hoisted_139 = {
  key: 1,
  class: "muted"
};
const _hoisted_140 = { class: "dual-cell" };
...
const _hoisted_157 = { class: "detail history-dialog" };
const _hoisted_158 = { class: "muted" };
const _hoisted_159 = {
  key: 0,
  class: "muted"
};
...
const _hoisted_162 = { class: "muted" };
const _hoisted_163 = { class: "detail rule-dialog" };
const _hoisted_164 = { class: "muted" };
const _hoisted_165 = ["disabled"];
const _hoisted_166 = { class: "rule-preview" };
const _hoisted_167 = { class: "actions" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function normalizeTab(value) {
      const valid = ["dashboard", "sources", "opinions", "events", "alerts", "alertRules"];
    ...
    function aiHistoryLabel(row) {
      ...
      return ai.in_effect ? `AI ${score}（生效中）` : `AI ${score}（历史）`;
    }
    const ZH_DICT = {
      high: "高",
      medium: "中",
    ...
    function switchTab(tab) {
      if (tab === "alerts" || tab === "alertRules") {
        router.push({ path: "/alerts", query: { tab: tab === "alertRules" ? "rules" : "records", scope: "foreign" } });
        return;
      }
    ...
    function loadTab(tab) {
      ...
      if (tab === "dashboard") loadScheduleStatus();
      if (tab === "sources") {
        loadSourcesView();
        loadScheduleStatus();
      }
...
风险结果`, textAlign: "center", fill: "#1d1d1f", fontSize: 20, fontWeight: 700, lineHeight: 22 } },
    ...
    function sourceTestSucceeded(payload) {
      const sourceTestResult2 = payload || {};
      return Boolean(sourceTestResult2.success ?? sourceTestResult2["ok"] ?? sourceTestResult2.status === "success");
    }
    ...
    async function toggleSource(row) {
      ...
      try {
        await api.patch(`/foreign/sources/${row.id}`, { enabled: !row.enabled, fetch_full_text: false });
    ...
    async function toggleSourceSchedule(row, enabled) {
      if (sourceBusyId.value) return;
      sourceBusyId.value = row.id;
      try {
        await api.patch(`/foreign/sources/${row.id}`, { schedule_enabled: enabled, schedule_interval_minutes: Math.max(Number(row.schedule_interval_minutes || 60), 5), fetch_full_text: false });
        row.schedule_enabled = enabled;
        await loadScheduleStatus();
        ElMessage.success(enabled ? "已启用该来源自动调度" : "已停用该来源自动调度");
      } catch (err) {
        ElMessage.error(err?.response?.data?.detail || "调度设置更新失败");
      } finally {
        sourceBusyId.value = null;
      }
    }
    async function updateSourceSchedule(row) {
      const interval = Math.max(Number(row.schedule_interval_minutes || 60), 5);
      row.schedule_interval_minutes = interval;
      try {
        await api.patch(`/foreign/sources/${row.id}`, { schedule_interval_minutes: interval, fetch_full_text: false });
        await loadScheduleStatus();
      } catch (err) {
        ElMessage.error(err?.response?.data?.detail || "调度间隔更新失败");
      }
    }
    ...
    watch(
      () => route.query.tab,
      (value) => {
        if (value === "alerts" || value === "alertRules") {
          router.replace({ path: "/alerts", query: { tab: value === "alertRules" ? "rules" : "records", scope: "foreign" } });
          return;
        }
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(tabs.filter((item) => item.value !== "alerts" && item.value !== "alertRules"), (tab) => {
          ...
          createBaseVNode("div", _hoisted_4, [
            createBaseVNode("details", _hoisted_5, [
              _cache[35] || (_cache[35] = createBaseVNode("summary", null, "选择来源", -1)),
        ...
        activeTab.value === "dashboard" ? (openBlock(), createElementBlock("section", _hoisted_12, [
          createBaseVNode("div", {
            ...
            _cache[36] || (_cache[36] = createBaseVNode("strong", null, "外网自动采集", -1)),
          ...
          createBaseVNode("div", _hoisted_15, [
            ...
            createBaseVNode("div", _hoisted_16, [
              createBaseVNode("label", _hoisted_17, [
                _cache[38] || (_cache[38] = createTextVNode("统计窗口 ", -1)),
          ...
          visualizationError.value ? (openBlock(), createElementBlock("div", _hoisted_19, [
            ...
            createBaseVNode("div", _hoisted_21, [
              createBaseVNode("div", _hoisted_22, [
                _cache[40] || (_cache[40] = createBaseVNode("span", { class: "fw-kpi-label" }, "文章总数", -1)),
              ...
              createBaseVNode("div", _hoisted_24, [
                _cache[41] || (_cache[41] = createBaseVNode("span", { class: "fw-kpi-label" }, "数据源", -1)),
              ...
              createBaseVNode("div", _hoisted_26, [
                _cache[42] || (_cache[42] = createBaseVNode("span", { class: "fw-kpi-label" }, "风险已完成", -1)),
              ...
              createBaseVNode("div", _hoisted_28, [
                _cache[43] || (_cache[43] = createBaseVNode("span", { class: "fw-kpi-label" }, "已确认事件", -1)),
              ...
              createBaseVNode("div", _hoisted_30, [
                _cache[44] || (_cache[44] = createBaseVNode("span", { class: "fw-kpi-label" }, "外网告警", -1)),
              ...
              createBaseVNode("div", _hoisted_32, [
                _cache[45] || (_cache[45] = createBaseVNode("span", { class: "fw-kpi-label" }, "外网采集", -1)),
            ...
            createBaseVNode("div", _hoisted_34, [
              createBaseVNode("article", _hoisted_35, [
                createBaseVNode("header", _hoisted_36, [
                  _cache[46] || (_cache[46] = createBaseVNode("h3", null, "每日趋势", -1)),
              ...
              createBaseVNode("article", _hoisted_40, [
                createBaseVNode("header", _hoisted_41, [
                  _cache[47] || (_cache[47] = createBaseVNode("h3", null, "外网告警", -1)),
                ...
                !alertFeed.value.length ? (openBlock(), createElementBlock("div", _hoisted_43, "该窗口内暂无外网告警")) : (openBlock(), createElementBlock("div", _hoisted_44, [
                  createBaseVNode("div", _hoisted_45, [
                    createBaseVNode("span", _hoisted_46, [
                      _cache[48] || (_cache[48] = createBaseVNode("i", { class: "fw-sum-dot is-amber" }, null, -1)),
                      createTextVNode("待处置 " + toDisplayString(alertPendingCount.value), 1)
                    ]),
                    createBaseVNode("span", _hoisted_47, [
                      _cache[49] || (_cache[49] = createBaseVNode("i", { class: "fw-sum-dot is-teal" }, null, -1)),
              ...
              createBaseVNode("article", _hoisted_59, [
                createBaseVNode("header", _hoisted_60, [
                  _cache[50] || (_cache[50] = createBaseVNode("h3", null, "数据源分布", -1)),
              ...
              createBaseVNode("article", _hoisted_63, [
                _cache[51] || (_cache[51] = createBaseVNode("h3", null, "风险分布", -1)),
                withDirectives(createBaseVNode("div", {
              ...
              createBaseVNode("article", _hoisted_65, [
                createBaseVNode("header", _hoisted_66, [
                  _cache[52] || (_cache[52] = createBaseVNode("h3", null, "外网热词", -1)),
              ...
              createBaseVNode("article", _hoisted_69, [
                _cache[53] || (_cache[53] = createBaseVNode("h3", null, "事件状态", -1)),
        ...
        activeTab.value === "sources" ? (openBlock(), createElementBlock("section", _hoisted_73, [
          createBaseVNode("div", { class: "toolbar" }, [
            createBaseVNode("button", {
              class: "btn btn-secondary",
              onClick: loadSourcesView
            }, "刷新外网数据源"),
            _cache[54] || (_cache[54] = createBaseVNode("span", { class: "muted" }, "自动调度仅处理启用且 schedule_enabled 的外网来源", -1))
          ]),
            ...
            createBaseVNode("table", null, [
              _cache[57] || (_cache[57] = createBaseVNode("thead", null, [
                createBaseVNode("tr", null, [
                  ...
                  createBaseVNode("th", null, "自动调度"),
                  createBaseVNode("th", null, "间隔"),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(sources.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", null, [
                      ...
                      }, toDisplayString(row.enabled ? "已启用" : "已停用"), 9, _hoisted_75)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("input", {
                        type: "checkbox",
                        checked: row.schedule_enabled,
                        disabled: !row.enabled || sourceBusyId.value === row.id,
                        onChange: ($event) => toggleSourceSchedule(row, $event.target.checked)
                      }, null, 40, _hoisted_76)
                    ]),
                    createBaseVNode("td", null, [
                      withDirectives(createBaseVNode("input", {
                        "onUpdate:modelValue": ($event) => row.schedule_interval_minutes = $event,
                        class: "input number-input",
                        type: "number",
                        min: "5",
                        step: "5",
                        onChange: ($event) => updateSourceSchedule(row)
                      }, null, 40, _hoisted_77), [
                        [
                          vModelText,
                      ...
                      _cache[55] || (_cache[55] = createTextVNode(" 分钟", -1))
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("button", {
                        class: "link-btn",
                ...
                !sources.value.length ? (openBlock(), createElementBlock("tr", _hoisted_81, [..._cache[56] || (_cache[56] = [
                  createBaseVNode("td", {
                    colspan: "5",
                    class: "empty"
                  }, "暂无外网数据源", -1)
        ...
        activeTab.value === "opinions" ? (openBlock(), createElementBlock("section", _hoisted_82, [
          createBaseVNode("div", _hoisted_83, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              _cache[58] || (_cache[58] = createBaseVNode("option", { value: "" }, "全部来源", -1)),
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-28915e0f>全部语言</option><option value="zh" data-v-28915e0f>中文</option><option value="en" data-v-28915e0f>英文</option><option value="mixed" data-v-28915e0f>中英混合</option><option value="unknown" data-v-28915e0f>未知</option>', 5)
            ])], 544), [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-28915e0f>全部风险等级</option><option value="high" data-v-28915e0f>高</option><option value="medium" data-v-28915e0f>中</option><option value="low" data-v-28915e0f>低</option><option value="unknown" data-v-28915e0f>未知</option>', 5)
            ])], 544), [
            ...
            _cache[62] || (_cache[62] = createBaseVNode("span", { class: "muted" }, "当前风险 = 有效告警期内取 AI 研判，否则回退规则研判；AI 历史始终保留", -1))
          ]),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(opinions.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", null, toDisplayString(effOf(row)?.risk_score ?? "-"), 1),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                        class: normalizeClass(["status", { on: effOf(row)?.risk_level === "high" }])
                      }, toDisplayString(zh(effOf(row)?.risk_level)), 3)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                        class: normalizeClass(["src-tag", { ai: effOf(row)?.source === "ai" }])
                      }, toDisplayString(effSourceLabel(row)), 3)
                    ]),
                    createBaseVNode("td", _hoisted_88, [
                      createBaseVNode("span", null, "规则 " + toDisplayString(ruleOf(row)?.risk_score ?? "-"), 1),
                      createBaseVNode("span", _hoisted_89, toDisplayString(aiHistoryLabel(row)), 1)
                    ]),
                    createBaseVNode("td", null, toDisplayString(zh(effOf(row)?.sentiment)), 1),
                    ...
                    createBaseVNode("td", null, [
                      ...
                      !(riskOf(row.id)?.matched_terms || []).length ? (openBlock(), createElementBlock("span", _hoisted_90, "无")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", null, toDisplayString(formatTime(effOf(row)?.evaluated_at)), 1),
                    createBaseVNode("td", null, toDisplayString(effOf(row)?.model_version || "-"), 1),
                    createBaseVNode("td", _hoisted_91, [
                      createBaseVNode("button", {
                        class: "link-btn",
                        disabled: !unref(canAnalyzeRisk),
                        onClick: withModifiers(($event) => analyzeRisk(row.id), ["stop"])
                      }, toDisplayString(ruleOf(row) ? "重新分析" : "分析"), 9, _hoisted_92)
                    ])
                  ], 8, _hoisted_86);
                }), 128)),
                !opinions.value.length ? (openBlock(), createElementBlock("tr", _hoisted_93, [..._cache[63] || (_cache[63] = [
                  createBaseVNode("td", {
                    colspan: "16",
                    class: "empty"
                  }, "暂无外网舆情", -1)
          ...
          opinionTotal.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_94, [
        ...
        ])) : activeTab.value === "events" ? (openBlock(), createElementBlock("section", _hoisted_95, [
          createBaseVNode("div", _hoisted_96, "外网自动聚合：" + toDisplayString(eventAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(eventAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 置信度阈值 " + toDisplayString(eventAutoStatus.value?.confidence_threshold ?? "-") + " · 时间窗口 " + toDisplayString(eventAutoStatus.value?.time_window_hours ?? "-") + " 小时", 1),
          createBaseVNode("div", _hoisted_97, [
            ...
            }, toDisplayString(rebuildingEvents.value ? "重建中..." : "候选 Dry-Run"), 9, _hoisted_98),
            _cache[65] || (_cache[65] = createBaseVNode("span", { class: "muted" }, "候选只进入外网事件表，必须人工确认后才形成正式事件", -1))
          ]),
          eventLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_99, [
          ...
          eventRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_100, [
            _cache[67] || (_cache[67] = createBaseVNode("strong", null, "外网事件运行失败", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(eventRunFailures.value, (run) => {
              return openBlock(), createElementBlock("div", {
                key: run.id,
                class: "event-failure-row"
              }, [
                _cache[66] || (_cache[66] = createBaseVNode("span", { class: "status failed" }, "失败", -1)),
          ...
          createBaseVNode("div", _hoisted_101, [
            createBaseVNode("button", {
              ...
              onClick: _cache[14] || (_cache[14] = ($event) => eventSection.value = "candidates")
            }, "事件候选", 2),
            createBaseVNode("button", {
              class: normalizeClass(["tab", { active: eventSection.value === "confirmed" }]),
              onClick: _cache[15] || (_cache[15] = ($event) => eventSection.value = "confirmed")
            }, "外网事件", 2)
          ]),
          eventSection.value === "candidates" ? (openBlock(), createElementBlock("div", _hoisted_102, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(eventCandidates.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_103, toDisplayString(row.title || "无标题"), 1),
                    ...
                    createBaseVNode("td", _hoisted_104, [
                      ...
                      }, "确认", 8, _hoisted_105)) : createCommentVNode("", true),
                      row.candidate_status === "candidate" ? (openBlock(), createElementBlock("button", {
                        key: 1,
                        class: "link-btn danger",
                        disabled: !unref(canConfirmEvents) || eventActionKey.value === `candidate-reject-${row.id}`,
                        onClick: ($event) => rejectCandidate(row)
                      }, "拒绝", 8, _hoisted_106)) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128)),
                !eventCandidates.value.length ? (openBlock(), createElementBlock("tr", _hoisted_107, [..._cache[68] || (_cache[68] = [
                  createBaseVNode("td", {
                    colspan: "8",
                    class: "empty"
                  }, "暂无外网事件候选", -1)
            ...
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                ...
                !foreignEvents.value.length ? (openBlock(), createElementBlock("tr", _hoisted_113, [..._cache[70] || (_cache[70] = [
                  createBaseVNode("td", {
                    colspan: "12",
                    class: "empty"
                  }, "暂无已确认外网事件", -1)
          ...
          selectedForeignEvent.value ? (openBlock(), createElementBlock("article", _hoisted_114, [
            createBaseVNode("div", _hoisted_115, [
              _cache[73] || (_cache[73] = createBaseVNode("strong", null, "事件溯源", -1)),
              ...
              selectedForeignEvent.value.auto_aggregation?.evidence ? (openBlock(), createElementBlock("details", _hoisted_116, [
                _cache[72] || (_cache[72] = createBaseVNode("summary", null, "聚合证据", -1)),
            ...
            createBaseVNode("div", _hoisted_117, [
              ...
              createBaseVNode("div", _hoisted_118, [
                createBaseVNode("button", {
                  ...
                  onClick: _cache[16] || (_cache[16] = ($event) => closeEvent(selectedForeignEvent.value))
                }, "关闭事件", 8, _hoisted_119),
                createBaseVNode("button", {
                  class: "link-btn",
                  disabled: !unref(canMergeEvents) || eventActionKey.value,
                  onClick: _cache[17] || (_cache[17] = ($event) => mergeEvent(selectedForeignEvent.value))
                }, "合并", 8, _hoisted_120),
                createBaseVNode("button", {
                  class: "link-btn",
                  disabled: !unref(canSplitEvents) || eventActionKey.value,
                  onClick: _cache[18] || (_cache[18] = ($event) => splitEvent(selectedForeignEvent.value))
                }, "拆分", 8, _hoisted_121),
                createBaseVNode("button", {
                  class: "link-btn",
                  onClick: _cache[19] || (_cache[19] = ($event) => selectedForeignEvent.value = null)
                }, "关闭详情")
              ])
            ]),
            createBaseVNode("p", _hoisted_122, toDisplayString(zh(selectedForeignEvent.value.language)) + " · " + toDisplayString(zh(selectedForeignEvent.value.event_status)) + " · " + toDisplayString(selectedForeignEvent.value.opinion_count) + " 篇文章", 1),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectedForeignEvent.value.opinions, (opinion) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_124, toDisplayString(opinion.source_name_snapshot) + " · " + toDisplayString(formatTime(opinion.published_at)), 1),
                createBaseVNode("a", {
                  href: opinion.url,
                  target: "_blank",
                  rel: "noreferrer",
        ...
        ])) : activeTab.value === "alerts" ? (openBlock(), createElementBlock("section", _hoisted_126, [
          createBaseVNode("div", _hoisted_127, "外网自动告警评估：" + toDisplayString(alertAutoStatus.value?.enabled ? "已启用" : "已停用") + " · 调度已注册：" + toDisplayString(alertAutoStatus.value?.scheduler_registered ? "是" : "否") + " · 外部通知：" + toDisplayString(alertAutoStatus.value?.external_notifications_enabled ? "已启用" : "已停用"), 1),
          createBaseVNode("div", _hoisted_128, [
            ...
            }, toDisplayString(alertEvaluating.value ? "评估中..." : "手动 Dry-Run"), 9, _hoisted_129),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => alertFilters.status = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[74] || (_cache[74] = [
              createStaticVNode('<option value="" data-v-28915e0f>全部状态</option><option value="triggered" data-v-28915e0f>待处理</option><option value="acknowledged" data-v-28915e0f>已确认</option><option value="resolved" data-v-28915e0f>已解决</option><option value="suppressed" data-v-28915e0f>已抑制</option><option value="failed" data-v-28915e0f>失败</option>', 6)
            ])], 544), [
              [vModelSelect, alertFilters.status]
            ]),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => alertFilters.severity = $event),
              class: "input",
              onChange: loadAlerts
            }, [..._cache[75] || (_cache[75] = [
              createStaticVNode('<option value="" data-v-28915e0f>全部严重度</option><option value="low" data-v-28915e0f>低</option><option value="medium" data-v-28915e0f>中</option><option value="high" data-v-28915e0f>高</option><option value="critical" data-v-28915e0f>紧急</option>', 5)
            ])], 544), [
              [vModelSelect, alertFilters.severity]
            ]),
            _cache[76] || (_cache[76] = createBaseVNode("span", { class: "muted" }, "告警评估默认关闭 · 外部通知默认关闭 · 当前仅保存站内记录", -1))
          ]),
          _cache[81] || (_cache[81] = createBaseVNode("div", { class: "alert-scope-note" }, " 外网告警只读取外网风险和已确认外网事件；不会进入国内告警、Dashboard、地图、热词或事件链路。 「告警记录值」是触发当时的快照，「当前有效风险」与外网舆情列表使用同一后端判定：告警有效期内取 AI 研判，解除／抑制／过期后回退规则研判。 ", -1)),
          alertLoadError.value ? (openBlock(), createElementBlock("div", _hoisted_130, [
          ...
          alertRunFailures.value.length ? (openBlock(), createElementBlock("div", _hoisted_131, [
            _cache[78] || (_cache[78] = createBaseVNode("strong", null, "外网告警评估失败", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(alertRunFailures.value, (run) => {
              return openBlock(), createElementBlock("div", {
                key: run.id,
                class: "alert-failure-row"
              }, [
                _cache[77] || (_cache[77] = createBaseVNode("span", { class: "status failed" }, "失败", -1)),
                createBaseVNode("span", null, toDisplayString(formatTime(run.finished_at || run.started_at)), 1),
          ...
          createBaseVNode("div", _hoisted_132, [
            createBaseVNode("table", null, [
              _cache[80] || (_cache[80] = createBaseVNode("thead", null, [
                createBaseVNode("tr", null, [
                  ...
                  createBaseVNode("th", null, "告警记录值"),
                  createBaseVNode("th", null, "当前有效风险"),
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(foreignAlerts.value, (row) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_133, [
                      ...
                      }, toDisplayString(row.title || "无标题告警"), 41, _hoisted_134)) : (openBlock(), createElementBlock("strong", _hoisted_135, toDisplayString(row.title || "无标题告警"), 1)),
                      createBaseVNode("div", _hoisted_136, toDisplayString(row.message), 1)
                    ]),
                    createBaseVNode("td", null, [
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("td", _hoisted_137, [
                      ...
                      }, toDisplayString(row.opinion_title_snapshot || "#" + row.foreign_opinion_id), 9, _hoisted_138)) : (openBlock(), createElementBlock("span", _hoisted_139, "-"))
                    ]),
                    createBaseVNode("td", null, toDisplayString(row.event_title_snapshot || (row.foreign_event_id ? "#" + row.foreign_event_id : "-")), 1),
                    createBaseVNode("td", null, toDisplayString(row.risk_score === null || row.risk_score === void 0 ? "-" : row.risk_score) + " / " + toDisplayString(zh(row.risk_level)), 1),
                    createBaseVNode("td", _hoisted_140, [
                      effOf(row) ? (openBlock(), createElementBlock("span", _hoisted_141, toDisplayString(effOf(row)?.risk_score ?? "-") + " / " + toDisplayString(zh(effOf(row)?.risk_level)), 1)) : (openBlock(), createElementBlock("span", _hoisted_142, "-")),
                      effOf(row) ? (openBlock(), createElementBlock("span", {
                        key: 2,
                        class: normalizeClass(["src-tag", { ai: effOf(row)?.source === "ai" }])
                      }, toDisplayString(effSourceLabel(row)), 3)) : createCommentVNode("", true)
                    ]),
                ...
                !foreignAlerts.value.length ? (openBlock(), createElementBlock("tr", _hoisted_148, [..._cache[79] || (_cache[79] = [
                  createBaseVNode("td", {
                    colspan: "13",
                    class: "empty"
                  }, "暂无外网告警记录", -1)
          ...
          createBaseVNode("div", { class: "toolbar" }, [
            ...
            _cache[82] || (_cache[82] = createBaseVNode("span", { class: "muted" }, "外网规则独立管理；新规则保存后默认停用。", -1))
          ]),
          createBaseVNode("div", _hoisted_150, [
            createBaseVNode("table", null, [
              ...
              createBaseVNode("tbody", null, [
                ...
                !alertRules.value.length ? (openBlock(), createElementBlock("tr", _hoisted_156, [..._cache[83] || (_cache[83] = [
                  createBaseVNode("td", {
                    colspan: "7",
                    class: "empty"
                  }, "暂无外网告警规则", -1)
        ...
        historyAlert.value ? (openBlock(), createElementBlock("div", {
          key: 6,
          class: "detail-mask",
          onClick: _cache[23] || (_cache[23] = withModifiers(($event) => historyAlert.value = null, ["self"]))
        }, [
          createBaseVNode("article", _hoisted_157, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭处置历史",
              onClick: _cache[22] || (_cache[22] = ($event) => historyAlert.value = null)
            }, "×"),
            _cache[85] || (_cache[85] = createBaseVNode("h3", null, "外网告警处置历史", -1)),
            createBaseVNode("p", _hoisted_158, toDisplayString(historyAlert.value.title || "告警 #" + historyAlert.value.id) + " · 当前状态：" + toDisplayString(zh(historyAlert.value.status)), 1),
            alertActionsLoading.value ? (openBlock(), createElementBlock("div", _hoisted_159, "处置历史加载中...")) : !alertActions.value.length ? (openBlock(), createElementBlock("div", _hoisted_160, "暂无处置历史")) : (openBlock(), createElementBlock("div", _hoisted_161, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(alertActions.value, (action) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_162, "操作人 #" + toDisplayString(action.actor_id ?? "-") + " · " + toDisplayString(formatTime(action.created_at)), 1)
                ]);
              }), 128))
            ]))
          ])
        ...
        alertRuleEditorVisible.value ? (openBlock(), createElementBlock("div", {
          key: 7,
          class: "detail-mask",
          onClick: _cache[33] || (_cache[33] = withModifiers(($event) => alertRuleEditorVisible.value = false, ["self"]))
        }, [
          createBaseVNode("article", _hoisted_163, [
            createBaseVNode("button", {
              class: "close",
              title: "关闭规则编辑",
              onClick: _cache[24] || (_cache[24] = ($event) => alertRuleEditorVisible.value = false)
            }, "×"),
            createBaseVNode("h3", null, toDisplayString(alertRuleEditingId.value ? "编辑外网告警规则" : "新增外网告警规则"), 1),
            createBaseVNode("label", null, [
              _cache[86] || (_cache[86] = createTextVNode("规则名称", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => alertRuleDraft.name = $event),
                class: "input",
                placeholder: "规则名称"
              }, null, 512), [
            ...
            createBaseVNode("label", null, [
              _cache[88] || (_cache[88] = createTextVNode("规则类型", -1)),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => alertRuleDraft.rule_type = $event),
                class: "input"
              }, [..._cache[87] || (_cache[87] = [
                createStaticVNode('<option value="risk_score" data-v-28915e0f>风险分</option><option value="risk_level" data-v-28915e0f>风险等级</option><option value="risk_category" data-v-28915e0f>风险类别</option><option value="confirmed_event" data-v-28915e0f>确认事件</option><option value="keyword_combo" data-v-28915e0f>关键词组合</option>', 5)
              ])], 512), [
                [vModelSelect, alertRuleDraft.rule_type]
              ])
            ]),
            createBaseVNode("label", null, [
              _cache[89] || (_cache[89] = createTextVNode("风险阈值或条件", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[27] || (_cache[27] = ($event) => alertRuleDraft.conditionsText = $event),
                class: "input",
            ...
            createBaseVNode("label", null, [
              _cache[91] || (_cache[91] = createTextVNode("严重等级", -1)),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[28] || (_cache[28] = ($event) => alertRuleDraft.severity = $event),
                class: "input"
              }, [..._cache[90] || (_cache[90] = [
            ...
            createBaseVNode("label", null, [
              _cache[92] || (_cache[92] = createTextVNode("冷却时间", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[29] || (_cache[29] = ($event) => alertRuleDraft.cooldown_seconds = $event),
                class: "input number-input",
                type: "number",
                min: "0"
              }, null, 512), [
            ...
            createBaseVNode("label", null, [
              _cache[93] || (_cache[93] = createTextVNode("规则说明", -1)),
              withDirectives(createBaseVNode("textarea", {
                "onUpdate:modelValue": _cache[30] || (_cache[30] = ($event) => alertRuleDraft.description = $event),
                class: "input",
                rows: "3",
            ...
            createBaseVNode("label", _hoisted_164, [
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[31] || (_cache[31] = ($event) => alertRuleDraft.is_enabled = $event),
                type: "checkbox",
                disabled: !alertRuleEditingId.value || !unref(canEnableAlertRules)
              }, null, 8, _hoisted_165), [
                [vModelCheckbox, alertRuleDraft.is_enabled]
              ]),
              _cache[94] || (_cache[94] = createTextVNode(" 编辑时启用状态（新规则默认停用，启用仍需外网启用权限）", -1))
            ]),
            createBaseVNode("div", _hoisted_166, [
              _cache[95] || (_cache[95] = createBaseVNode("strong", null, "规则预览", -1)),
              createBaseVNode("pre", null, toDisplayString(rulePreview.value), 1)
            ]),
            createBaseVNode("div", _hoisted_167, [
              createBaseVNode("button", {
                class: "btn btn-secondary",
                onClick: _cache[32] || (_cache[32] = ($event) => alertRuleEditorVisible.value = false)
              }, "取消"),
              createBaseVNode("button", {
                class: "btn btn-primary",
                disabled: alertRuleSaving.value,
                onClick: createAlertRule
              }, toDisplayString(alertRuleSaving.value ? "保存中..." : "保存规则"), 9, _hoisted_168)
            ])
          ])
        ])) : createCommentVNode("", true),
        createVNode(ForeignOpinionDetailModal, {
          modelValue: detailVisible.value,
          "onUpdate:modelValue": _cache[34] || (_cache[34] = ($event) => detailVisible.value = $event),
...
const ForeignWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-28915e0f"]]);
