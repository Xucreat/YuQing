const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DKh7K41d.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, z as usePermission, C as onMounted, w as withDirectives, c as createElementBlock, a as createBaseVNode, n as normalizeClass, b as withKeys, v as vModelText, m as createVNode, p as withCtx, X as Transition, s as createCommentVNode, e as createTextVNode, t as toDisplayString, F as Fragment, i as renderList, J as vModelSelect, H as unref, P as createStaticVNode, r as ref, j as computed, g as api, E as ElMessage, Y as pollTask, W as isPermissionDenied, y as resolveComponent, B as resolveDirective, o as openBlock, L as withModifiers, k as normalizeStyle, Z as __vitePreload, _ as _export_sfc } from './index-BUV7KhH3.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(row) {
      ...
      const { ElMessageBox } = await __vitePreload(async () => { const { ElMessageBox } = await import('./index-BUV7KhH3.js').then(n => n.a4);return { ElMessageBox }},true?__vite__mapDeps([0]):void 0);
      try {
